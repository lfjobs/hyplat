...
import hy.plat.common.page.Pagination;
...
public class BaseManagerImpl<T extends Serializable> implements BaseManager<T> {
	...
	public PageForm getPageForm(int pageNo, int pageSize, String sql,Object[] params) {
		Pagination page=dao.find(sql, params, pageNo, pageSize);
		PageForm pageForm = new PageForm();
		pageForm.setList(page.getList());
		pageForm.setPageNumber(page.getPageNo());
		pageForm.setPageSize(page.getPageSize());
		pageForm.setPageCount(page.getTotalPage());
		pageForm.setRecordCount(page.getTotalCount());
		return pageForm;
	}
	...
	@SuppressWarnings("unchecked")
	@Transactional(readOnly = true)
	public PageForm getPageForm(int pageNo, int pageSize, Finder finder) {
