...
public interface McoService {
	 ...
	 * @return
	 */
	void delDMCO(String ym,String com_id);
	 ...
	 * @return
	 */
	String DelDMCOProDYCO(String groupsh,String ym,String com_id);
	 ...
	 * @return
	 */
	void delDYCO(String ym,String com_id);
	 ...
	 */
	@SuppressWarnings("rawtypes")
	Object[] ProDays(Object[] obj,Class clazz);
