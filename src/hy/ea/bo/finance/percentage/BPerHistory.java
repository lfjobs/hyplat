 ...
 */
public class BPerHistory implements BaseBean {
    ...
    public BPerHistory(String brokerageKey, String brokerageId, Double sbaz, Double tp, Double cjdl, Double sjdl, Double sbtz, Double xjdl, Double khjf, Double ywyj, String principal, Date times, String companyId) {
        this.brokerageKey = brokerageKey;
        this.brokerageId = brokerageId;
        this.sbaz = sbaz;
        this.tp = tp;
