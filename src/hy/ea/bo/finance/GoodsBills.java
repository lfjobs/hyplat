 ...
 * @author 杨金歌
 */
public class GoodsBills implements BaseBean, Cloneable, java.io.Serializable {
    ...
    private String invInvenQuantity;//库存
    private String tradeName;//行业名称
    private String tradeID;//行业id
    private String tradeCode;//行业编码
    private String producttype;//项目分类
    private String productCode;//项目分类编号
    ...
    private String guigeTypeValue;//规格总值
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        GoodsBills other = (GoodsBills) obj;
