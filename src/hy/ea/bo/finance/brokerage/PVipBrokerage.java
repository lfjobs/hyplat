 ...
 */
public class PVipBrokerage implements BaseBean {
    ...
    public PVipBrokerage(String vipbroKey, String vipbroId, Double brokerage, String ppid, String typePpid, String companyId, String vipId) {
        this.vipbroKey = vipbroKey;
        this.vipbroId = vipbroId;
        this.brokerage = brokerage;
        this.ppid = ppid;
