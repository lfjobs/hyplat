 ...
 */
public class PWhoHistory implements BaseBean {
    private String wholesaleKey;
    private String wholesaleId;//批发价历史记录id
    private Double wholesale;//批发价
    private Double factory;//出厂价
    private Double brokerage;//业务佣金
    private Double brokerages;//代理佣金和
    private String investType;//投资类型[设备投资类型 01:教练车 02:创客单车]
