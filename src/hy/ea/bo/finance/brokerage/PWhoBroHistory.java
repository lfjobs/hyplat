 ...
 */
public class PWhoBroHistory implements BaseBean {
    private String whobroKey;
    private String whobroId;//批发价佣金历史记录id
    ...
    public PWhoBroHistory(String whobroKey, String whobroId, Double brokerage, String ppid, String typePpid, String companyId, String wholesaleId) {
        this.whobroKey = whobroKey;
        this.whobroId = whobroId;
        this.brokerage = brokerage;
        this.ppid = ppid;
