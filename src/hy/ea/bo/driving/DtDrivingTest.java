...
public class DtDrivingTest  implements BaseBean,java.io.Serializable {

	// Fields

	private String drivingtestkey;
	private String drivingtestid;
	...
	/** default constructor */
	public DtDrivingTest() {
	}

	/** minimal constructor */
	public DtDrivingTest(String drivingtestid) {
		this.drivingtestid = drivingtestid;
	}

	/** full constructor */
	public DtDrivingTest(String drivingtestid, String drivingprincipalid,
			Date testdate, String examresult, String examtype) {
		this.drivingtestid = drivingtestid;
	...
	public String getDrivingtestkey() {
		return this.drivingtestkey;
	}

	public void setDrivingtestkey(String drivingtestkey) {
		this.drivingtestkey = drivingtestkey;
	}

	public String getDrivingtestid() {
		return this.drivingtestid;
	}

	public void setDrivingtestid(String drivingtestid) {
		this.drivingtestid = drivingtestid;
	}
