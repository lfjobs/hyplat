...
/**
 * ViewSealdocId entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class ViewSealdoc implements java.io.Serializable,BaseBean,ExcelBean{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5719974768050777293L;
	private String key;
	...
	public static String[] columnHeadings() { 
		String[] titles = { "序号", "公文编号", "正式编号", "文件标题", "主题词", "公文类型","缓急","申报人","申报人部门", 
				"申报单位名称","签发（审批）单位","签发（审批）部门","签发（审批）人","处理结果","盖章时间", "合同生效日期", "合同截止日期","甲方公司","甲方责任人","乙方公司","乙方责任人"};
		return titles;
	}
	
	public static String[] columnHeadings1() { 
		String[] titles = { "序号", "公文编号", "正式编号", "文件标题", "主题词", "公文类型","缓急","申报人","申报人部门", 
				"申报单位名称","签发（审批）单位","签发（审批）部门","签发（审批）人", "处理结果","盖章时间"};
		return titles;
	}
	...
	public String[] properties() {
		String[] properties = {
				...
				deptnameofsub,
				subscribername,
				outcome.equals("to Publish") ? "发至分发人" : "存档",
