...
public class ViewUnreaddoc implements java.io.Serializable,BaseBean,ExcelBean{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5880290303024178843L;
	private String key;
	...
	private String readorganizationid;
	private String readerid;
	private String readcompanyid;
	...
	public static String[] columnHeadings() { 
		String[] titles = { "序号", "公文编号", "正式编号", "文件标题", "主题词", "公文类型","缓急","申报人","申报人部门", 
				"申报单位名称","签发（审批）单位","签发（审批）部门","签发（审批）人", "盖章人公司","盖章人部门","盖章人","分发人公司","分发人部门","分发人","收件时间","合同生效日期", "合同截止日期","甲方公司","甲方责任人","乙方公司","乙方责任人"};
		return titles;
	}
	
	public static String[] columnHeadings1() { 
		String[] titles = { "序号", "公文编号", "正式编号", "文件标题", "主题词", "公文类型","缓急","申报人","申报人部门", 
				"申报单位名称","签发（审批）单位","签发（审批）部门","签发（审批）人", "盖章人公司","盖章人部门","盖章人","分发人公司","分发人部门","分发人",
"收件时间"};
		return titles;
	}
	...
	public String getReadorganizationid() {
		return this.readorganizationid;
	}

	public void setReadorganizationid(String readorganizationid) {
		this.readorganizationid = readorganizationid;
	}
	...
	public String getReadcompanyid() {
		return this.readcompanyid;
	}

	public void setReadcompanyid(String readcompanyid) {
	...
	public String getCompanyidofpublisher() {
		return this.companyidofpublisher;
	}
