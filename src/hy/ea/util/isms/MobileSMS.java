...
public class MobileSMS {
	...
	private static final String password_md5 = "6572bdaff799084b973320f43f09b363";//密码
	private static final String apikey = "516386b181c453e21a3c4c8efc274c10";//apikey秘钥（请登录 http://m.5c.com.cn 短信平台-->账号管理-->我的信息 中复制apikey）
	
	public static String sendMessage(String mobile,String param){
		String content = "您好，您的验证码是："+param+"，请于5分钟内正确输入【微分金】";//要发送的短信内容，特别注意：签名必须设置，网页验证码应用需要加添加【图形识别码】。

		//mobile手机号,只发一个号码：13800000001。发多个号码：13800000001,13800000002,...N 。使用半角逗号分隔。
		//连接超时及读取超时设置
