...
public class ToChineseFirstLetter {
    ...
    static final char[] LowercasefirstLetter = { 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'w', 'x', 'y', 'z' }; 
    // 存放国标一级汉字不同读音的起始区位码对应读音(大写)  
    static final char[] UppercasefirstLetter = { 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'J', 'K', 'L', 'M', 'N', 'O', 'P', 'Q', 'R', 'S', 'T', 'W', 'X', 'Y', 'Z' }; 
    // 获取一个字符串的拼音码 
