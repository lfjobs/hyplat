...
public class MobileResponsibilitiesSummaryAction {
	...
	private DetachedCriteria getListSummary() {
		...
		if (search != null && search.equals("search")) {
			...
			if (!"".equals(staffResponsibilities.getDepartmentID())
					&& !staffResponsibilities.getCompanyID().equals(
							staffResponsibilities.getDepartmentID())) {
