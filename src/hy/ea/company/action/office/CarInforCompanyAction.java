...
@Controller
@Scope("prototype")
public class CarInforCompanyAction {
	@Resource
	...
	private List<Object> getList(Map<String, Object> session,
		...
		String sql = "select c.carID,co.companyName,cor.organizationName,c.staffName,"
				...
				+ " where c.companyID = ? and c.state3 between '00' and '01'";
		...
		if (search != null && search.equals("search")) {
			...
			if(carInformation.getOrganizationID()!=null && !"".equals(carInformation.getOrganizationID())){
				sql += " and c.organizationID = ?";
				parms.add(carInformation.getOrganizationID());
			}
