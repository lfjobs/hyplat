...
public class CollectUnitAction {
	@Resource
	...
	public List<Object> getList() {
		...
		String sql = "select t.trackid,c.companyname as comname,co.organizationname,cu.staffname,"
				+ " tr.contactconnections,cc.companyname ,cc.companytel,cc.companyaddr,t.inputdate,"
				+ " t.trackstartdate,t.tarckenddate,t.workaddr,"
				...
				+ " left join dtcontactcompany cc on cc.ccompanyid= tr.foreignkeyid"
	...
	public String showExcel() {
		...
		Object[] parms = (Object[]) list.get(1);
		excelStream = excelService.showExcel(track.columnHeadings2(),
