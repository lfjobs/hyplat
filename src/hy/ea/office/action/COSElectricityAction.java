...
@Controller
@Scope("prototype")
public class COSElectricityAction {
	@Resource
	...
	public String showExcel() {
		...
		CLogBook cLogBook = logBookService.saveCLogBook(organizationID,"导出用电管理", account);
	...
	public String del() {
	    ...
	    CLogBook cLogBook = logBookService.saveCLogBook(organizationID, "删除用电管理(用户名:"+elect.getUsername()+")", account);	
