...
<body style="background: #fff">
		...
		<ul>
			...
			<a id="index">
				<li class="login login_login"><img
					src="<%=basePath %>myPC/images/return2.png" alt="">
					<div>
						<h3>返回首页</h3>
	...
	<div class="content login_con">
		<ul>
			<li><img src="<%=basePath %>myPC/images/login_l.png"
				alt="" class="left"></li>
			<li>
				<div class="right">
					<h2>账户登录</h2>
					<form id="submit" method="post"
						...
						<!-- 隐藏 -->
						<%-- <a href="<%=basePath %>myPC/password.jsp" class="wjmm">忘记密码</a>
					 --%>
					...
					<div class="zhuce">
						<a id="register">立即注册<img
							src="<%=basePath %>myPC/images/right.png" alt="">
						</a>
					</div>
				</div></li>
		</ul>
