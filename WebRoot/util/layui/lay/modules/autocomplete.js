layui.define(['jquery', 'laytpl', 'layer'], function (e) {
    "use strict";
    layui.link('util/layui/css/modules/autocomplete.css');
    var hint = layui.hint(),
        $ = layui.jquery,
        laytpl = layui.laytpl,
        layer = layui.layer,
    ...
    job.prototype.render = function() {
        ...
        if(_config.initdata&&_config.initdata instanceof Array){
        	_config.data[_self.index]=_config.initdata;
        }
...
//        if (!_config.filter) return _self.renderData([]);
    ...
    job.prototype.events = function () {
        ...
        _elem.on('focus', function () {
            _config.filter = this.value, _config.cache ? _self.renderData(_config.data[_self.index]) : _self.pullData() 
        ...
        $(document).on('click', function (e) {
            ...
            if (_e !== undefined) {
                ...
                _elem.val(laytpl(_config.template_val).render(_config.data[_self.index][_e.data("index")])), _config.onselect == undefined || _config.onselect(_config.data[_self.index][_e.data("index")])
            }
