$(document).ready(function(){
	(function($) {
		...
		function renderButton(recordCount, goPageIndex, EventHander, text) {
        	...
        	$goto.click(function() {
        		$.ajax({
					url:basePath + "ea/mobilecontactcompany/ea_getListContactCompany.jspa?pageNumber="+goPageIndex+"&search=search",
					dataType:"json",  
					asnyc:false,
					success:function(data){
						...
						if(data!=null)
						{
							...
							var str = "";
							for(var i in Data){ 
								str+="<li><div class='in'>单位名称："+Data[i].companyName+"</div></li><li><div class='in'>单位地址："+Data[i].companyAddr+"</div></li>";
								str+="<li><div class='in'>单位电话："+Data[i].companyTel+"</div></li><li><div class='in'>单位负责人："+Data[i].cresponsible+"</div></li>";
								str+="<li><div class='in'>单位负责人电话："+Data[i].responsibleTel+"</div></li><li><div class='in'>行业类别："+Data[i].industryType+"</div></li>";
								str+="<li><div class='in'>单位备注："+Data[i].remark+"</div></li>";
							}
							$("#result").html(str);
		...
		$("#tosearch").click(function(){
			var options = {
				url: basePath + "ea/mobilecontactcompany/ea_toSearch.jspa?pageNumber=" + pageNumber,
				dataType: "json",
				asnyc: false,
				success: function(data){
					var str = "";
