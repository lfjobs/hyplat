$(document).ready(function(){
	...
	(function($) {
		...
		function renderButton(recordCount, goPageIndex, EventHander, text) {
        	...
        	$goto.click(function() {
        		$.ajax({
					url:basePath + "ea/mobilesoincumbent/ea_getStaffListForIncumbent.jspa?pageNumber="+goPageIndex+"&search=search",
					dataType:"json",  
					asnyc:false,
					success:function(data){
						...
						for(var i in Data){ 
							...
							str+="<li><div class='in'>国籍："+Data[i].nationality+"</div></li><li><div class='in'>籍贯："+Data[i].nativePlace+"</div></li>";
							...
							str+="<li><div class='in'>录入时间："+Data[i].verifyTime+"</div></li><li><div class='in'>政治面貌："+Data[i].politicsStatus+"</div></li>";
							str+="<li><div class='in'>文化程度："+Data[i].culturalDegree+"</div></li><li><div class='in'>婚姻情况："+Data[i].marriage+"</div></li>";
							str+="<li><div class='in'>健康情况："+Data[i].health+"</div></li><li><div class='in'>银行账号："+Data[i].bankNum+"</div></li>";
		...
		$("#searchStaff").click(function(){
			//ea/mobilesoincumbent/ea_getStaffListForIncumbent.jspa
			var options = {
				url:basePath + "ea/mobilesoincumbent/ea_toSearchCStaff.jspa?pageNumber="+ pageNumber,
				dataType: "json",
				asnyc: false,
				success: function(data){
					var str = "";
