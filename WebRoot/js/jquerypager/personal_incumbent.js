$(document).ready(function(){
	...
	(function($) {
		...
		function renderButton(recordCount, goPageIndex, EventHander, text) {
        	...
        	$goto.click(function() {
        		$.ajax({
					url:basePath + "ea/mobilecosincumbent/ea_toSearchCStaff.jspa?pageNumber="+goPageIndex+"&search=search",
					dataType:"json",  
					asnyc:false,
					success:function(data){
						...
						for(var i in Data){ 
							...
							str+="<li><div class='in'>性别："+Data[i].sex+"</div></li><li><div class='in'>出生日期："+birthday+"</div></li>"
							...
							str+="<li><div class='in'>家庭住址："+Data[i].staffAddress+"</div></li><li><div class='in'>电话："+Data[i].reference+"</div></li>";
							str+="<li><div class='in'>QQ："+Data[i].referenceCode+"</div></li><li><div class='in'>邮箱："+Data[i].referenceOrganization+"</div></li>";
							str+="<li><div class='in'>录入时间："+verifyTime+"</div></li><li><div class='in'>备注："+Data[i].staffDesc+"</div></li>";
						}
						$("#result").html(str);
		...
		$("#searchStaff").click(function(){
			var options = {
				url:basePath + "ea/mobilecosincumbent/ea_toSearchCStaff.jspa?pageNumber="+pageNumber,
				dataType:"json",  
				asnyc:false,
				success:function(data){
					var str = "";
