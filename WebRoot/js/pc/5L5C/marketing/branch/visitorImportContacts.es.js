...
const path1 = basePath + "ea/importContacts/sajax_ea_importContacts.jspa";
const urlPath = {
...
function sendToBackend(dataDTOList) {
    $.ajax({
        url: basePath + "ea/importContacts/sajax_ea_importContacts.jspa",
        type: "POST",
        data: {"data": JSON.stringify(dataDTOList)},
        async: false,
        success: function (data) {
            document.location.href = basePath + "page/WFJClient/pc/5l5C/office/config/importContacts.jsp";
        },
        error: function () {
        }
    });
