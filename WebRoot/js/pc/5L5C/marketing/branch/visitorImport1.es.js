...
const path = basePath + "ea/trilateral/ea_saveImportData1.jspa";
const path1 = basePath + "ea/trilateral/ea_saveImportData.jspa";
console.log('路劲' + basePath + "ea/trilateral/ea_saveImportData.jspa");
const urlPath = {
...
function toExcelSheetDTO(sheet) {
    ...
    sheet.body.filter((item, index) => {
        ...
        list.push({
            ...
            "sector": item[4],
            "phone": item[5],
            "registrationPlatformName": item[6],
            "registrationNo": item[7],
            "registerAccount": item[8],
            "pwd": item[9],
            "uploadProject": item[10],
            "promotionReasons": item[11],
            "distributionService": item[12],
            "serviceTracking": item[13],
            "businessPersonnel": item[14]
        });
        // 将创建的DataDTO对象添加到列表中
    });
...
function sendToBackend(dataDTOList) {
    ...
    $.ajax({
        url: basePath + "ea/trilateral/ea_saveImportData1.jspa",
        type: "POST",
        ...
        success: function (data) {
            var refreshUrl = "ea/trilateral/ea_trilateralDataList.jspa";
