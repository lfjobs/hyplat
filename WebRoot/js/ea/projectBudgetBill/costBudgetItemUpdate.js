...
function toLaunchOrcang(f) {
    ...
    if ($("#ppname").val() == "") {
        ...
        if (editFlag == "edit") {
            url = basePath + "ea/scBudget/ea_toUpdateProjectBill.jspa?billsType="+billsType;
        }
...
function searchGoods(){
    ...
    window.location.href = basePath + "ea/scBudget/ea_toGoodsSearch.jspa?editFlag=edit&billsType="+billsType+"&goodsBillsID="
        +goodsBillsID+"&showFlag=false&cashierBillsId="+cashierBillsId+"&menuId="+menuId+"&typeId="+typeId+"&typeName="+typeName;
}
