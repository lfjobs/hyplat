$(document).ready(function () {
    ...
    $(document).on("click",".org li",function(event){
        ...
        window.location.replace(basePath+"page/WFJClient/pc/5l5C/office/projectBudgetBill/selectMember.jsp?companyID="+companyID+"&orgID="+orgID+"&orgName="+orgName+"&type="+type+"&keyId="+keyId+"&billsType="+billsType);
    })
    //搜索查询
    $("#search").click(function(event){
        event.stopPropagation();
        window.location.replace(basePath+"page/WFJClient/pc/5l5C/office/projectBudgetBill/selectMember.jsp?type="+type+"&keyId="+keyId+"&billsType="+billsType);
