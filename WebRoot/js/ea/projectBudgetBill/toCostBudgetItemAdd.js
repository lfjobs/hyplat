...
function toAddItemBack(){
    var url = "ea_scanningProjectInfo.jspa";
...
$(document).on("click",".ul-list2 li",function(){
    ...
    if($(this).is(".active")){
        ...
        window.location.href = basePath + "ea/scBudget/ea_getProjectItem.jspa?keyNum=" + goodsBillsId +"&editFlag="+editFlag+"&cashierBillsId="+cashierBillsId+"&billsType="+billsType;//&showFlag=${showFlag}&departmentID=${departmentID}&cashierBillsId=${cashierBillsId}";//&menuId="+menuId;
        $(this).removeClass("active");
    }
})