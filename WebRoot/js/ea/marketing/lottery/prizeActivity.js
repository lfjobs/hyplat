...
$(function() {
    ...
    $("#prize_end_time1").mobiscroll(optDateTime).datetime(optDateTime);
    ...
    $("#prize_end_time1").change(function() {
        var begin = $("#prize_begin_time1").val(); //开始时间
        var end = $(this).val(); //结束时间
    });
    ...
    $("#coupon_end_time1").change(function() {
        var begin = $("#coupon_begin_time1").val(); //开始时间
        var end = $(this).val(); //结束时间
    });
