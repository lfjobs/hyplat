$(document).ready(function() {
	...
	function action(com, grid) {
		switch (com) {
			...
			case '导出' :
				var url = basePath
						+ "ea/jobtask/ea_showExcelCompanySummary.jspa?search="
						+ search;
				open(url);
				break;
			case '查询' :
			...
			case '设置每页显示条数' :
				var url = basePath
						+ "ea/jobtask/ea_getCompanyJobTaskListSummary.jspa?search="
						+ search;
				numback(url);
				break;
		}
	...
	$("#tosearch").click(function() {
		...
		$("#postSearchForm")
				.attr(
						"action",
						basePath
								+ "ea/jobtask/ea_toSearchCompanySummary.jspa?pageNumber="
								+ pNumber);
