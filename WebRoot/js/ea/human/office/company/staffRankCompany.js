$(function() {
	...
	function action(com, grid) {
		switch (com) {
			...
			case '导出' :
				url = basePath
						+ "ea/staffrankcompany/ea_showRankCompanyExcel.jspa?pageNumber="
	...
	$("#tosearch").click(function() {
		$("#postSearchForm").attr(
				"action",
				basePath + "ea/staffrankcompany/ea_toRankCompanySearch.jspa?pageNumber="
						+ ppageNumber);
...
function re_load() {
	if (token)
		document.location.href = basePath
				+ "ea/staffrankcompany/ea_getRankCompany.jspa?pageNumber="
