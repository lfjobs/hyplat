$(function() {
	...
	function action(com, grid) {
		switch (com) {
			...
			case '导出' :
				url = basePath
						+ "ea/gamjeomcompany/ea_ShowRewardExcel.jspa?pageNumber="
	...
	$("#tosearch").click(function() { // 查询
		$("#postSearchForm")
				.attr(
						"action",
						basePath
								+ "ea/gamjeomcompany/ea_toRewardSearch.jspa?pageNumber="
								+ ppageNumber);
...
function re_load() {
	if (token)
		document.location.href = basePath
				+ "ea/gamjeomcompany/ea_getRewardPunishmentList.jspa?pageNumber="
...
$(function() {
	...
	$.ajax({
			...
			success: function cbf(data){
                ...
                ts = new TreeSelector($("#deptID")[0], data2, -1);
        		ts.createTree();
			},
