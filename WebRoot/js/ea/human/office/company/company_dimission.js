$(function() {
	...
	function action(com, grid) {
		switch (com) {
			...
			case '导出' :
				url = basePath
						+ "ea/cosdimissionCompany/ea_showExcel.jspa?search="
						+ psearch;
				open(url);
				break;
			case '设置每页显示条数' :
				var url = basePath
						+ "ea/cosdimissionCompany/ea_getListCOSDimissionCompany.jspa?search="
						+ psearch;
				numback(url);
				break;
		}
	...
	$("#searchDim").click(function() {
		$("#cstaffDimForm").attr(
				"action",
				basePath
						+ "ea/cosdimissionCompany/ea_toSearch.jspa?pageNumber="
						+ ppageNumber);
