$(function() {
	...
	function action(com, grid) {
		switch (com) {
			...
			case '导出' :
				url = basePath
						+ "ea/overtimecompany/ea_showOverCompanyExcel.jspa?search="
						+ psearch;
				open(url);
				break;
		}
	...
	$("#tosearch").click(function() {
		$("#postSearchForm").attr(
				"action",
				basePath + "ea/overtimecompany/ea_toOverSearch.jspa?pageNumber="
						+ ppageNumber);
...
function re_load() {
	document.location.href = basePath
			+ "ea/overtimecompany/ea_getOverTimeCompany.jspa?pageNumber="
