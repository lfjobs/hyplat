$(document).ready(function() {
	...
	function action(com, grid) {
		switch (com) {
				...
				if (confirm("确定继续？")) {
					$f
							...
							.attr(
									"action",
									basePath
											+ "/ea/clientPblm/ea_delClientPblm.jspa?pageNumber="
											+ ppageNumber
											+ "&clientPblm.clientPblmID="
											+ address);
			...
			case '导出' :
				var url = basePath
						+ "/ea/clientPblm/ea_showClientPblmExcel.jspa?pageNumber="
			...
			case '设置每页显示条数' :
				var url = basePath
						+ "ea/clientPblm/ea_getClientPblmList.jspa?search="
						+ psearch;
				numback(url);
				break;
		}
				...
				if (address == "") {
					$("#cstaffForm")
							...
							.attr(
									"action",
									basePath
											+ "ea/clientPblm/ea_saveClientPblm.jspa?pageNumber="
											+ ppageNumber);
	...
	$("#tosearch").click(function() {
		...
		$("#postSearchForm").attr(
				"action",
				basePath + "/ea/clientPblm/ea_toSearch.jspa?pageNumber="
						+ ppageNumber);
...
function re_load() {
	if (token)
		document.location.href = basePath
				+ "/ea/clientPblm/ea_getClientPblmList.jspa?pageNumber="
