$(document).ready(function () {
    ...
    $(document).on("click", ".org li", function (event) {
        ...
        if (getParameterByName("type") === "sfpt") {
            window.location.replace(basePath + "page/WFJClient/pc/5l5C/office/config/selectMember.jsp?type=sfpt" + "&companyID=" + companyID + "&orgID=" + orgID + "&orgName=" + orgName);
        } else {
            window.location.replace(basePath + "page/WFJClient/pc/5l5C/office/config/selectMember.jsp?type=fp" + "&companyID=" + companyID + "&orgID=" + orgID + "&orgName=" + orgName);
        }
    })
//搜索查询
    $("#search").click(function (event) {
        if (getParameterByName("type") === "sfpt") {
            event.stopPropagation();
            window.location.replace(basePath + "page/WFJClient/pc/5l5C/office/config/selectMember.jsp?type=sfpt");
        } else {
            event.stopPropagation();
            window.location.replace(basePath + "page/WFJClient/pc/5l5C/office/config/selectMember.jsp?type=fp");
        }
    });
