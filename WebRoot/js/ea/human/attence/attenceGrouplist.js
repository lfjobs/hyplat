$(function() {
	...
	$('.flexme11').flexigrid({
				...
				width : 'auto',
				minwidth : 30,
				title : "考勤组设置"+"&nbsp;&nbsp;&nbsp;&nbsp;考勤组名称：<input type='text' id='ch' style='width:100px'/> &nbsp;<input type='button' value=' 查询 ' id='toSearch' class='input-button'/> ",
				minheight : 80,
				buttons : [{
							name : '添加',
							bclass : 'add',
...
function createRule(){
	select++;
	$(".maintd").append($("#gzdefault").clone(true).attr("id","rule" + select));
