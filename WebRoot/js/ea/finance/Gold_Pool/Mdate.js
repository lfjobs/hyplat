(function() {
	...
	includeCss(basePath+"css/ea/finance/Gold_Pool/Mdate.css");
	var dateopts = {
		beginYear: 2000,
		beginMonth: 1,
		beginDay: 1,
	...
	Mdate.prototype = {
		...
		createDateUi: function() {
			var str = "" + '<section class="getDateBg"></section>' + '<section class="getDateBox" id="getDateBox">' + '<div class="choiceDateTitle">' + '<button id="dateCancel">取消</button>'+ '<button id="dateEmpty" class="center">清空</button>' + '<button id="dateSure" class="fr">确定</button>' + "</div>" + '<div class="dateContent">' + '<div class="checkeDate"></div>' + '<div id="yearwrapper">' + '<ul id="yearUl"></ul>' + "</div>" + '<div id="monthwrapper">' + '<ul id="monthUl"></ul>' + "</div>" + '<div id="daywrapper">' + '<ul id="dayUl"></ul>' + "</div>" + "</div>" + "</section>";
		...
		dateSure: function() {
            ...
            var dateEmpty = d.getElementById("dateEmpty");
        ...
        dateEmpty: function() {
            this.acceptId.setAttribute("data-year", "");
            this.acceptId.setAttribute("data-month", "");
            this.acceptId.setAttribute("data-day", "");
            this.acceptId.value="";
            this.dateCancel()
        },
	};
