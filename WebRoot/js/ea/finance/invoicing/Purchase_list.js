$(function() {
				...
				switch (com) {
					case '添加' :
						document.location.href = basePath
								+ "/ea/purchase/ea_toSavePurchase.jspa?pageNumber="
								+ pNumber;
						break;
					case '查看' :
						if (financialbillID == "") {
						...
						document.location.href = basePath
								+ "/ea/purchase/ea_toPurchase.jspa?pageNumber="
					...
					case '打印预览':
						...
						window.open(basePath + "/ea/purchase/ea_toPrintPurchase.jspa?financialBill.financialbillID="+financialbillID);
                        break;
				}
			}
			// 这一行的单击事件
			...
			$("#tosearch").click(function() {
				$("#SearchForm").attr(
						"action",
						basePath + "/ea/purchase/ea_toSearch.jspa?pageNumber="
