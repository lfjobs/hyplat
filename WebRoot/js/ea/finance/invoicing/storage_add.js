		...
		if (financialbillID == "") {
			$("#PurchaseForm")
					...
					.attr(
							"action",
							basePath
									+ "/ea/storage/ea_saveWareManagement.jspa?pageNumber="
									+ pNumber);
...
function re_load() {
var url = basePath+"/ea/storage/ea_getWareManagementList.jspa?pageNumber="+pNumber+"&pageForm.pageNumber="+$("#pageNumber").attr("value")+"&search="+search+"&sdate="+sdate+"&edate="+edate;
