...
//为弹出框准备下拉表内容
	...
	$("input.JQueryprint").click(function() {
		var financialbillID = $("input#cashierID",
				$("#purchaseForm")).val();
...
function re_load(){
	document.location.href=basePath+"/ea/newstorage/ea_toExamineGoodsBillList.jspa?pageNumber="+pNumber+"&pageForm.pageNumber="+$("#pageNumber").attr("value");
}
