$(function() {
	...
	function action(com, grid) {
		switch (com) {
			case '查看' :
				...
				break;
			case '导出' :
				url = basePath + "/ea/splitgoodsbill/ea_showExcel.jspa?search="
						+ search + "&sdate=" + sdate + "&edate=" + edate+"zz="+zz+"&level="+level+"&sztype="+sztype;
				open(url);
				break;
			case '设置每页显示条数' :
				var url = basePath
						+ "/ea/splitgoodsbill/ea_AsearchGood.jspa?search="
						+ search + "&sdate=" + sdate + "&edate=" + edate+"zz="+zz+"&level="+level+"&sztype="+sztype;
				numback(url);
				break;
			case '查询' :
	...
	$("#tosearch").click(function() {
		...
		$("#SearchForm").attr(
				"action",
				basePath + "/ea/splitgoodsbill/ea_toASearchGood.jspa?zz="+zz+"&level="+level+"&sztype="+sztype+"&pageNumber="
						+ pNumber);
