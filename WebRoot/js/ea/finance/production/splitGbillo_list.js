$(function() {
	...
	function action(com, grid) {
		switch (com) {
			...
			case '设置每页显示条数' :
				var url = basePath
						+ "/ea/splitgoodsbill/ea_OsearchGood.jspa?zz="+zz+"&level="+level+"&sztype="+sztype+"&search="
						+ search + "&sdate=" + sdate + "&edate=" + edate;
				numback(url);
				break;
			case '查询' :
	...
	$("#tosearch").click(function() {
		...
		$("#SearchForm").attr(
				"action",
				basePath + "/ea/splitgoodsbill/ea_toOSearchGood.jspa?zz="+zz+"&level="+level+"&sztype="+sztype+"&pageNumber="
						+ pNumber);
