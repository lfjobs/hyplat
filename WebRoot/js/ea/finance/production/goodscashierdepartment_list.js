$(function() {
	...
	function action(com, grid) {
		switch (com) {
			case '查看' :
				...
				break;
			case '导出' :
				url = basePath + "/ea/goodscashierdepartment/ea_showProExcel.jspa?search="
						+ search + "&sdate=" + sdate + "&edate=" + edate;
				open(url);
				break;
			case '查询历史数据' :
				document.location.href = basePath+ "/ea/goodscashierdepartment/ea_getProCashierList.jspa";
				break;
			case '设置每页显示条数' :
				var url = basePath
						+ "/ea/goodscashierdepartment/ea_getProCashierList.jspa?search="
						+ search + "&sdate=" + sdate + "&edate=" + edate;
				numback(url);
				break;
			case '查询' :
	...
	$("#tosearch").click(function() {
		...
		$("#SearchForm").attr(
				"action",
				basePath + "/ea/goodscashierdepartment/ea_toProSearch.jspa?pageNumber="
						+ pNumber);
