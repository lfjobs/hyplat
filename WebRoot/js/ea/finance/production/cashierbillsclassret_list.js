		...
		switch (com) {
			case '查看' :
				...
				document.location.href = basePath
						+ "ea/cashierbillsclassret/ea_toCashier.jspa?pageNumber="
						+ pNumber + "&cashierBillsVO.cashierBillsID="
						+ cashierBillsID+"&BType="+bill;
				break;
			case '导出' :
				url = basePath
						+ "ea/cashierbillsclassret/ea_showExcel.jspa?search="
						+ search + "&sdate=" + sdate + "&edate=" + edate+"&BType="+bill;
				open(url);
				break;
			case '设置每页显示条数' :
				var url = basePath
						+ "ea/cashierbillsclassret/ea_getCashierList.jspa?search="
						+ search + "&sdate=" + sdate + "&edate=" + edate+"&BType="+bill;
				numback(url);
				break;
			case '查询' :
			...
			case '生成现金申请明细审批单' :
				document.location.href = basePath
						+ "/page/ea/main/finance/production/cashapplybills_frame.jsp";
				break;
		}
	}
	...
	var opt=$("#btype").find("option:selected").text();
		...
		$("#SearchForm")
				.attr(
						"action",
						basePath
								+ "ea/cashierbillsclassret/ea_toSearch.jspa?pageNumber="
								+ pNumber+"&BType="+bill);
...
function re_load() {
	document.location.href = basePath
			+ "ea/cashierbillsclassret/ea_getCashierList.jspa?pageNumber="
...
$(document).ready(function() {
	...
	$("input#ckdocument").click(function() {
		...
		window
				.open(basePath
						+ "ea/cashierbillsclassret/ea_toCashier.jspa?cashierBillsVO.cashierBillsID="
						+ cashierBillsID + "&tohide=tohide&BType="+bill);
	...
	$("input#daochudocument").click(function() {
		...
		url = basePath
				+ "ea/cashierbillsclassret/ea_showExcel.jspa?journalNums="
				+ journalNums+"&BType="+bill;
		open(url);
	...
	function cxwldw(typeCN) {
		...
		var searchurl = basePath
				+ "ea/cashierbillsclassret/sajax_ea_getAjaxCashierList.jspa?";
		$.ajax({
