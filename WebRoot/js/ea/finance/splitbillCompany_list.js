$(function() {
		...
		switch (com) {
			case '查看' :
				...
				document.location.href = basePath
						+ "/ea/splitbillcompany/ea_toSaveCashierBills.jspa?pageNumber="
			...
			case '导出' :
				if(zz=='08'){
					...
					url = basePath + "/ea/splitbillcompany/ea_showExcel.jspa?search="
			...
			case '设置每页显示条数' :
				var url = basePath
						+ "/ea/splitbillcompany/ea_getCashierBillsList.jspa?search="
						+ search + "&sdate=" + sdate + "&edate=" + edate + "&zz=" + zz;
				numback(url);
				break;
			case '查询' :
	...
	$("#tosearch").click(function() {
		$("#SearchForm").attr(
				"action",
				basePath + "/ea/splitbillcompany/ea_toSearch.jspa?pageNumber="
						+ pNumber+ "&zz=" + zz);
    ...
    $("#orgID").change(function() {
                ...
                if (temp.substring(0, 7) != 'company') {
                        getPerson(companyid, this.value);
                } else {
