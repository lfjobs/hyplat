$(function() {
		...
		switch (com) {
			case '查看' :
				...
				document.location.href = basePath
						+ "/ea/taxsummary/ea_toCashier.jspa?pageNumber="
				...
				break;
			case '导出' :
				url = basePath + "/ea/taxsummary/ea_showExcel.jspa?search="
			...
			case '设置每页显示条数' :
				var url = basePath
						+ "/ea/taxsummary/ea_getTaxList.jspa?search=" + search
			...
			case '打印预览' :
				...
				window
						.open(basePath
								+ "ea/dutiable/ea_toprinttax.jspa?cashierBillsVO.cashierBillsID="
								+ cashierBillsID);
				break;
		}
	}
	...
	var opt=$("#btype").find("option:selected").text();
		...
		$("#SearchForm").attr(
				"action",
				basePath + "/ea/taxsummary/ea_toSearch.jspa?pageNumber="
						+ pNumber);
...
function re_load() {
	document.location.href = basePath
			+ "/ea/taxsummary/ea_getTaxList.jspa?pageNumber=" + pNumber
