$(function() {
	...
	function action(com, grid) {
		switch (com) {
			...
			case '设置每页显示条数' :
				var url = basePath
						+ "/ea/statement/ea_getArchivesList.jspa?tt="+tt+"&zz="+zz+"&search="
	...
	$("#tosearch").click(function() {
		$("#SearchForm")
				.attr(
						"action",
						basePath
								+ "/ea/statement/ea_toSearch.jspa?tt="+tt+"&zz="+zz+"&pageNumber="
								+ pNumber);
		document.SearchForm.submit.click();
	});
	$("#toFormsSearch").click(function() {
		
		window.open(basePath + "/ea/statement/ea_toStatements.jspa?tt="+tt+"&zz="+zz+"&sdate="+$("#sdate").val()+"&edate="+$("#edate").val()+"&pageNumber="+ pNumber);
		$("#FormsSearch").jqmHide();
	});
...
function re_load() {
	document.location.href = basePath
			...
			+ "&sdate=" + sdate + "&edate="+ edate+"&search="+ search+"&tt="+tt+"&zz="+zz;
}
