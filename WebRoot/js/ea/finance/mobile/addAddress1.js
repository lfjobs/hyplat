$(document).ready(function(e) {
          ...
          //图片显示，文字提示
            ...
            $("#adds").click(function(){
            		...
            		$("form#addForm")
            		  .attr("target","hidden")
            		  .attr("action",basePath+"ea/refund/ea_saveAddress.jspa?companyId="+companyId);
...
function re_load(){
	window.location.href=basePath+"/ea/refund/ea_refundAddressList.jspa?companyId="+companyId;
}