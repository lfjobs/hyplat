    ...
    function action(com, grid) {
        switch (com) {
            case '添加' :
                ...
                $.ajax({
                    type: "POST",
                    url: basePath + "ea/percentage/sajax_ea_ajaxSelectBPercentage.jspa",
                    data: null,
                ...
                break;
            case '修改' :
                var brokerageId = $('input[name="checkedId"]:checked').val();
                if (typeof(brokerageId) == "undefined" || brokerageId == "") {
                    alert('请选择！');
                    return
                } else {
                    url = basePath + "ea/percentage/ea_toBPercentageUpdate.jspa?bpercentage.brokerageId="+brokerageId
                    open(url);
                }
                break;
            /*case '删除' :
          ...
          /*  case '查询':
            ...
            case '设置每页显示条数' :
                ...
                break;
            case '导出' :
                location.href= basePath + "ea/percentage/ea_BPercentageShowExcel.jspa";
                break;
