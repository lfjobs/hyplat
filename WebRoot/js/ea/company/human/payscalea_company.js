$(function() {
	...
	function action(com, grid) {
		switch (com) {
			...
			case '查询' :
				...
				break;
			case '导出' :
				url = basePath + "ea/payscaleacompany/ea_showExcel.jspa?search="+search;
				open(url);
				break;
			case '设置每页显示条数' :
				var url = basePath + "ea/payscaleacompany/ea_getPayScaleaList.jspa?search="+search;
				numback(url);
				break;
		}
	}
	...
	$("#tosearch").click(function() {
		$("#cstaffSearchForm")
				.attr(
						"action",
						basePath + "ea/payscaleacompany/ea_toSearch.jspa?pageNumber="
								+ ppageNumber);
...
function re_load() {
	if (token)
		document.location.href = basePath
				+ "ea/payscaleacompany/ea_getPayScaleaList.jspa?pageNumber="
