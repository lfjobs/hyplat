$(document).ready(function() {
	...
	function action(com, grid) {
		switch (com) {
			...
			case '导出' :
				var url = basePath
						+ "ea/jobplancompany/ea_showExcel.jspa?search="
			...
			case '设置每页显示条数' :
				var url = basePath
						+ "ea/jobplancompany/ea_getJobPlanList.jspa?search="
						+ search;
				numback(url);
				break;
		}
	...
	$("#tosearch").click(function() {
		...
		$("#postSearchForm")
				.attr(
						"action",
						basePath
								+ "ea/jobplancompany/ea_toSearch.jspa?pageNumber="
								+ pNumber);
