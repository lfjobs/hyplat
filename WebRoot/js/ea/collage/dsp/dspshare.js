...
$(function() {
        ...
        var scroll = $(document).scrollTop(); //滚动高度
            ...
            var Top = $(".ttsw_last").offset().top; //元素距离顶部距离
//              console.log(Height);
//              console.log(Top + '  ' + scroll);
//console.log(Top - Height - Height-scroll);
            if (Top - Height - Height-scroll <= 20) {
...
function loaded(){
    ...
    var url = basePath+"ea/dsp/sajax_ea_getShareVideo.jspa";
    $.ajax({
        url : url,
        type : "get",
        async : false,
