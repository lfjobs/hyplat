        ...
        var picker = {
            init: function () {
                ...
                for (var i = 0; i < option.dateNum; i++) {
                    ...
                    dateStr += '<li class="' + sel + '" data-date="' + m + '-' + d + '"  data-week="'+w+'">' + m + '月' + d + '日&nbsp;星期' + w + '</li>';
                }
                dateStr += '<li></li><li></li>';
                ...
                $('.mt_ok', container).on('tap', function () {
                    ...
                    var week=''+"星期"+ mpDate.find('.selected').data('week')
                    input.val(date + '  ' + week+'  '+time);
                    _this.hidePanel();
                ...
                //初始化原有的数据
                this.setValue(sMonth,sDate,sHours);
            },
            renderHTML: function () {
                var stime = option.timeStart + ':00';
                var etime = option.timeStart + option.timeNum + ':00';
                var html = '<div class="mt_mask"></div><div id="mtimer" class="mt_poppanel"><div class="mt_panel"><h3 class="mt_title">请选择时间</h3><div class="mt_body"><div class="mt_date"><ul><li class="mt_note">上下滚动选取日期</li><li></li></ul></div><div class="mt_time"><ul><li class="mt_note">可选时间：' + stime + '-' + etime + '</li><li></li></ul></div><div class="mt_indicate"></div></div><div class="mt_confirm"><a href="javascript:;" class="mt_ok">确定</a> <a href="javascript:;" class="mt_cancel">取消</a></div></div></div>';
...
//                    date = dateArr[0],
//                    time = dateArr[1],
                var dateItem = $('.mt_date li[data-date="' + m + '-' + d + '"]'),
                      timeItem = $('.mt_time li[data-time="' + h + ':00"]');
