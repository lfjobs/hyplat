$(function(){
  ...
  filechooser.onchange = function() {
    ...
    files.forEach(function(file, i) {
      if (!/\/(?:mp4)/i.test(file.type)) return;
      var reader = new FileReader();
      var li = document.createElement("li");
//        获取视频大小
      var size = file.size / 1024 > 1024 ? (~~(10 * file.size / 1024 / 1024)) / 10 + "MB" : ~~(file.size / 1024) + "KB";
      li.innerHTML = '<i class="up_dele"></i><i class="video_ico"></i><div class="progress"><span></span></div><div class="size">' + size + '</div>';
      $(".add_photo").before($(li));
      reader.onload = function() {
        var result = this.result;
//        var img = new Image();
//        img.src = result;
        $(li).css("background-image", "url("+basePath+"/images/ea/production/scmanage/demo_01.jpg)");
...
//          img = null;
  ...
  //    视频上传，将base64的视频转成二进制对象，塞进formdata上传
