...
$(function(){
	$(".operation").click(function(){
		if($(this).val()=="提交"){
			$("#form").attr("target", "hidden").attr("action",basePath+"ea/sourcingsto/ea_addGoodsReceipt.jspa?&fiveClear="+fiveClear);
	...
	$(".JQueryreturns").click(function(){
		if($(this).val()=="查询"){
			...
			$("#consigneeName").val($("#"+staffId).find("#staffname").text());
			$("#consigneeID").val(staffId);
