...
//				break;
		case '添加':
			...
			document.location.href=pbasePath+"/ea/jobtask/s_ea_addTaskPage.jspa";
...
//				break;
			...
			case '设置每页显示条数' :
				var url = pbasePath
						+ "ea/jobtask/ea_getJobTaskList_a.jspa?staffID="
						+ pstaffID;
				numback(url);
				break;
	...
	$("#tosearch").click(function() {
		...
		$("#postSearchForm").attr("action",
				pbasePath + "ea/jobtask/ea_toSearch_a.jspa");
