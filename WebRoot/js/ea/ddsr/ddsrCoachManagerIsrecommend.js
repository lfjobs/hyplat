$(document).ready(function() {
	...
	function action(com, grid) {
		switch (com) {	
			...
			case '是否推荐' :
				...
				break;	
			case '设置每页显示条数' :
				var url = basePath + "ea/ddsrcoachManager/isrecommend_ea_doDdsrCoachManagerAction.jspa?innerAction=showDdsrCoachList&companyGroupLogo="+companyGroupLogo+"&search=turnpage";
				numback(url);
				break;			
		}
	}
	...
	$(".JQuerySearchSubmit").click(function(){
		...
		$("#searchForm").attr("action",
				basePath + "ea/ddsrcoachManager/isrecommend_ea_doDdsrCoachManagerAction.jspa?innerAction=showDdsrCoachList&datetime=" + dt.getTime());
