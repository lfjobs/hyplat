...
function toLaunchOrcang(f) {
    ...
    if ($("#ppname").val() == "") {
        ...
        var url = basePath + "ea/scBudget/ea_toAddCostBudgetBill.jspa?billsType="+billsType;
        var cashierBillsId = $("#cashierBillsId").val();

        if (editFlag == "edit") {
            url = basePath + "ea/scBudget/ea_toUpdateCostBudgetBill.jspa?billsType="+billsType;
        }
