                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (message.result == "suc") {
                            ...
                            $(".titlep").text("操作成功");
                            $(".div-tingyong").show();
                            let companyId1 = localStorage.getItem("companyId");
                            window.location.href = basePath + "page/WFJClient/pc/5l5C/office/config/inventoryAudit.jsp?companyId=" + companyId1;
                        }
