...
$(document).ready(function () {
	...
	tree.setOnClickHandler(function () {
		...
		var parms="";
		if(treename=="审核管理"){
			parms=basePath+"/ea/checkmanage/ea_getDtMyauditList.jspa";
		}else if(treename=="未审核"){
			parms = basePath + "/ea/checkmanage/ea_getDtMyauditList.jspa?auditorstatus=01";
		}else{
			parms = basePath + "/ea/checkmanage/ea_getDtMyauditList.jspa?auditorstatus=02";
		}
