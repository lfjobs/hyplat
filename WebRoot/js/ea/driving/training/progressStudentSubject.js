...
$(document).ready(function() {
 ...
 $('.JQueryflexme').flexigrid({
		...
		switch (com) {
			...
			case '编辑登记表' :
				...
				window.open(basePath
						...
						+ encodeURI(studentid)+"&docstatus="+docstatus);
				break;
			case '打印登记表' :
				if (studentid == "") {
					alert("请选择");
			...
			case '设置每页显示条数' :
				var url = basePath
						+ "ea/progressstudentsubject/ea_getListOfViewProgressStudentSubject.jspa"
						...
						+"&viewProgressStudentSubject.docstatus="+docstatus;
				numback(url);
				break;
			case '窗口扫描' :
		    ...
		    case '导出' :
		    	var url= basePath
		    	+ "ea/progressstudentsubject/ea_toExportOfViewProgressStudentSubject.jspa"
				+"?search="+ search
		    	+"&viewProgressStudentSubject.docstatus="+docstatus;
		    	open(url);
		    	break;
	...
	$("#tosearch").click(function(){
		...
		$("#SearchForm").attr("action",basePath+ "ea/progressstudentsubject/ea_toSearchOfViewProgressStudentSubject.jspa?pageNumber="+pNumber+"&companyGroupLogo="+companyGroupLogo);
