$(document).ready(function () {
    ...
    $(document).on("click",".org li",function(event){
        ...
        window.location.replace(basePath+"page/WFJClient/pc/5l5C/office/plan/selectMember.jsp?companyID="+companyID+"&orgID="+orgID+"&orgName="+orgName+"&type="+type+"&keyId="+keyId);
    })
    //搜索查询
    $("#search").click(function(event){
        event.stopPropagation();
        window.location.replace(basePath+"page/WFJClient/pc/5l5C/office/plan/selectMember.jsp?type="+type+"&keyId="+keyId);
