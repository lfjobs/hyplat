    ...
    $(".sec-bottom").click(function () {
        ...
        if(type=="") {
            ...
            if(dyq=="") {
                ...
                htmlstr.push("<li data-receiverID='" + dyq + "' data-receiverCompanyID='' data-receiverDeptID='' data-source='03'>");
                htmlstr.push("<div class='z-div'>");
                htmlstr.push("<img class='del-btn' src='" + basePath + "images/ea/office/contract/del.png'>");
            ...
            if (type == "cy" || type == "commitApprove") {//传阅和提交审批
                if (type == "cy") {
                    ulp = basePath
                        + "ea/scBudget/sajax_ea_circularizePlanBudgetBill.jspa";
