    ...
    if (true) {
        ...
        if($("#guigeTypeId").val()!=null && $("#guigeTypeId").val()!=""){
            ...
            $(".ul-con.ggn li").each(function () {
                ...
                console.log("打印："+attr2+";"+amap[attr2]);
