...
$(function () {
    ...
    $(document).on("click", ".div-danwei .div-middle p", function () {
        ...
        if(newDw=="时间"){
            ...
            $("#budgetNumber").attr("placeholder", "自动计算");
            // $("#unitPrice").attr("placeholder", "自动计算");
        }else{
            $("#budgetNumber").removeAttr("readonly");
            // $("#unitPrice").removeAttr("readonly");
            $("#budgetNumber").attr("placeholder", "请输入");
            // $("#unitPrice").attr("placeholder", "请输入");
        }
    ...
    // $('.attri1').on('change', function() {
    //     console.log("触发change事件");
    // });
//     $(document).on("click", ".div-guige-new .div-box ul li .attri1", function (event) {
// console.log("触发change事件");
...
function toLaunchOrcang(f) {
    ...
    if ($("#ppname").val() == "") {
        ...
        var url = basePath + "ea/scBudget/ea_toAddPlanCostBudgetItem.jspa";
    ...
    $.ajax({
        ...
        success: function cbf(data) {
            ...
            if(oList.length==1){
                ...
                if(unitOld != unitNew){
                    getSpecsInfo(oList[0].code,oList[0].parentId,unitNew);
                }
