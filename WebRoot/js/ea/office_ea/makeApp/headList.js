        ...
        success : function(data) {
            ...
            if (pageForm != null && pageForm.list != null && pageForm.list.length > 0) {
                $(pageForm.list).each(function(i, dom) {
                    ...
                    test.push("<img src='"+basePath+this[1]+"' class='left' onerror=\"this.src=\'' + basePath + '/images/zg.png\'\">");
...
function choose(obj) {
    ...
    document.cookie = "staffid2="+encodeURI(staffid);
    document.cookie = "staffname2="+encodeURI(text);
