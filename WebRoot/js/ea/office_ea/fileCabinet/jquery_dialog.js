...
var JqueryDialog = {
	...
	Ok:function(){
		var frm = $("#jd_iframe");	
		// alert(document.getElementById("jd_iframe").contentWindow.document.body.val())
		if (frm[0].contentWindow.Ok()){
			
			/*frm[0].
			$("#showPicture").html("<img src="++""/>");
*/			//window.location.href=basePath+"ea/photomanager/ea_uploadPhotos.jspa";
			JqueryDialog.Close() ;
		}
		else{
			frm[0].focus() ;
