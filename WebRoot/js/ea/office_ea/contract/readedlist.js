...
$(document).ready(function () {
    ...
    $(".archive").click(function(){
        ...
        var docId = $(".ul li.active").attr("id");
        var modulespan = $("li#"+docId).find(".modulespan").text();

        window.location.replace(basePath+"page/ea/main/office_ea/contract/selectArchiveType.jsp?docId="+docId+"&companyID="+companyID+"&module="+modulespan);
    ...
    $(".read-zf").click(function(){
        ...
        var docId = $(".ul li.active").attr("id");
        window.location.href = basePath+"page/ea/main/office_ea/contract/selectMulti.jsp?docId="+docId+"&typee=readed";
    ...
    $(".close-tingyong,.close-confirm").click(function(){
        ...
        if($(".titlep").text()=="操作成功"){
         //   document.location.href = basePath+"ea/contract/ea_getDealFileByState.jspa?state=readedlist";
            ...
            if ($(window).width() > 960) {
                for (var i = 0; i < pageForm.list.length; i++) {
                    ...
                    if ($("#" + obj[0]).length == 0) {
                        ...
                        html.push("<span class='modulespan' style='display: none;'>"+obj[12]+"</span>");
