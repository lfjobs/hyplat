$(document).ready(function () {
    ...
    $(document).on("click",".org li",function(event){
        ...
        window.location.replace(basePath+"page/ea/main/office_ea/contract/selectMember.jsp?companyID="+companyID+"&orgID="+orgID+"&orgName="+orgName+"&typee="+typee+"&docId="+docId);
    })
    //搜索查询
    $("#search").click(function(event){
        event.stopPropagation();
        window.location.replace(basePath+"page/ea/main/office_ea/contract/selectMember.jsp?typee="+typee+"&docId="+docId);
