$(document).ready(function() {
	...
	$("input.JQuerySubmit").click(function() {// 保存
				...
				if (addressID == "") {
					$("#cstaffForm").attr("target", "hidden").attr(
							"action",
							basePath + "ea/onduty/ea_save.jspa?pageNumber="
									+ ppageNumber);
	...
	// $f.attr("action", "<%=basePath%>/ea/onduty/t_ea_save.jspa")
	// document.addressForm.submit.click();
	// });
	$("span.list_remove").click(function() {// 删除点击事件
				...
				$f.attr("action", basePath
								+ "/ea/onduty/t_ea_del.jspa?pageNumber="
								+ ppageNumber);
				document.addressForm.submit.click();
			});
	...
	$("#tosearch").click(function() {
		...
		$("#postSearchForm").attr(
				"action",
				basePath + "/ea/onduty/ea_toSearch.jspa?pageNumber="
						+ ppageNumber);
