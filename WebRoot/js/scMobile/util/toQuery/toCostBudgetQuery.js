...
function toSearch(){
    ...
    switch (menuId) {
        ...
        case "cy":
            console.log("初始项目列表");
            url = "ea/scBudget/ea_toCostBudgetBillList.jspa?tenantFlag="+tenantFlag;
            break;
        case "receive":
            url = "ea/scBudget/ea_toCostBudgetBillReceiveList.jspa";
            break;
        case "sent":
            url = "ea/scBudget/ea_toCostBudgetBillSentList.jspa";
            break;
        default:
            console.log("其他列表");
            url = "ea/scBudget/ea_toCostBudgetBillList.jspa";
    }
