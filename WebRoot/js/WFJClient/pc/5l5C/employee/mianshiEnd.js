...
window.onload = function () {
    ...
    $(".p-bottom").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: basePath + "ea/cosincumbent/sajax_n_ea_getauditionList.jspa?",
            async: true,
            dataType: "json",
            data: {
                "staffID": ln,
    ...
    $(".view").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: basePath + "ea/cosincumbent/sajax_n_ea_deitAuditionky.jspa?",
            async: true,
            dataType: "json",
            data: {
                "auditionKey": ln,
    ...
    $(".view").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: basePath + "ea/cosincumbent/sajax_n_ea_deitAuditionkn.jspa?",
            async: true,
            dataType: "json",
            data: {
                "auditionKey": ln,
