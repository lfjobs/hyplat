...
$.fn.extend({
        ...
        try {
            $(_this._opt.imgTar).on('change', function (e) {
                ...
                reader.onload = function (f) {
                    ...
                    var img = '<p style="display:none;" class="'+'k'+k+'">,-</p><img class="'+'k'+k+'" id="'+'img'+k+'" src="' + f.target.result + '" style="max-width:90%;display:block;margin:1rem auto;" /><input name="propagandaPic" id="'+'kkkkk'+k+'" class="'+'k'+k+'"   type="file"  style="display:none" value="'+_val+'"><p class="'+'k'+k+'"  style="display:none;">,-</p>';
    ...
    upload: function (data) {
        var _this = this,
            filed = _this._opt.uploadField;
        $.ajax({
                url: _this._opt.uploadUrl,
                type: 'post',
                data: $.extend(_this._opt.data, {
                    filed: data
                }),
                cache: false
            })
            .then(function (res) {
                ...
                if (src) {
                    var img = '<p style="display:none;">,-</p><img src="' + src + '" style="max-width:90%;display:block;margin:0 auto;" /><p style="display:none;">,-</p>';
                    _this.insertImage(img);
                } else {
