$(function () {
    ...
    $(".arrow").click(function () {
        ...
        if (type == "2") {
            document.location.href = basePath + "ea/refund/ea_sealAddress2.jspa?type=1&flag=2&comid="+companyId;
        }
    });
    ...
    $(".del_c .delAdd").live("click", function () {
        ...
        $("#form").attr("target", "hidden").attr("action", "ea/refund/ea_delAddr.jspa?flag="+flag);
    ...
    $(".del_c .setDefault").live("click", function () {
        $("#form").attr("target", "hidden").attr("action", basePath + "ea/refund/ea_changeDefault.jspa");
        document.form.submit.click();
        token = 2;
...
function updateData(){
    ...
    if ($(".ul").find("input").eq(0).val() == "") {
        ...
        var location_p = $("#location_p option:selected").text();
        var location_c = $(".location_c option:selected").text();
        var location_d = $(".location_a option:selected").text();
        var str = "refundAddress.rarea=" + location_p + "," + location_c + "," + location_d;
        $("#form").attr("target", "hidden").attr("action", basePath + "ea/refund/ea_RefundAddressAddOrEdit.jspa?" + str + "&flag=" + flag);
        document.form.submit.click();
        token = 2;
    }
}
...
function re_load() {
    if(type=="2"){
        window.location.href = basePath + "ea/refund/ea_sealAddress2.jspa?type="+type+"&flag="+flag+"&companyId=" + companyId;

    }else{
        window.location.href = basePath + "ea/refund/ea_sealAddress.jspa?type="+type+"&flag="+flag+"&companyId=" + companyId;
