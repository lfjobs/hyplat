...
<script type="text/javascript"
	src="<%=basePath %>js/ea/mysl/TaskManageFinished.js"></script>
<script type="text/javascript">
	...
	<div class="main_main">
		...
		<c:import url="../ea/page_navigator.jsp">
			<c:param name="actionPath"
				value="ea/taskmanage/ea_getListByTaskManageFinished.jspa?pageNumber=${pageNumber}&myproject.proid=${myproject.proid}&search=${search}">
			</c:param>
		</c:import>
	</div>
	<!--选择审核人员窗口 -->
