...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	$("#submitResult2").click(function(){
		if ($("#SendForm2 #comments1").val() == "") {
			alert("请填写审核意见");
			return;
		}
		if (confirm("确定执行该操作？")) {
			var index=0;
			var comments=$("#SendForm2 #comments1").val();
		...
		<div class="jqmWindow"
			...
			<table width="100%" id="SearchTable2" cellspacing="20"
				...
				<tr>
					...
					<td align="left"><textarea rows="5" cols="40" name="dtMycheck.comments" id="comments1"  class="ckTextLength" maxlength="1000"></textarea>
