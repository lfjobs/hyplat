...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>卫生检查情况计分表详情</title>
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		<%@ page language="java" pageEncoding="UTF-8"%>
		<%@ taglib uri="/struts-tags" prefix="s"%>
		<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
		<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn"%>
		<%@ page import="com.mysl.bo.administrative.DtMysanitaryinspection" %>
		<%
		...
		<div id="tableprint" align="center">
			...
			<table width="620" border="0" cellpadding="0" cellspacing="0" style="background:#FFFFFF;">
			  ...
			  <tr>
			    ...
			    <td width="25%" align="left">${dtMysanitaryinspection.companyname}</td>
			    <td width="13.5%" align="right">部门：</td>
			    <td width="10%" align="left">${dtMysanitaryinspection.organizationname}</td>
			    <td width="10%" align="center">责任人：${dtMysanitaryinspection.staffname }</td>
			  </tr>
			  <tr>
			    <td width="12%" height="25" align="right">制单人：</td>
			    <td colspan="2" align="left">${dtMysanitaryinspection.staffname}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;制单日期：${fn:substring(dtMysanitaryinspection.addtime, 0, 10)}</td>
			    <td width="11%" align="right" height="10">凭证号：</td>
			    <td width="10%" align="center" height="10"><% 
			    								DtMysanitaryinspection data =(DtMysanitaryinspection)request.getAttribute("dtMysanitaryinspection");
														if (data != null) {
												...
												%><br/>
												${dtMysanitaryinspection.serialnumber}</td>
			  </tr>
			</table>
			<table width="600" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<td width="500"align="left">
						&nbsp;&nbsp;&nbsp;&nbsp;${dtMysanitaryinspection.department}
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="left" width="500">
						<p>&nbsp;&nbsp;&nbsp;&nbsp;${dtMysanitaryinspection.note}</p> 
					</td>
				</tr>
								<tr>
