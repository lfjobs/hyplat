...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="<%=basePath%>js/jqModal/jqModal.js">
         ...
         <script type="text/javascript" src="<%=basePath %>js/ea/mysl/administrative/CateApply.js"></script>
        <script>
	...
	<body>
	     ...
	     <input type="hidden" name="cateapply.id" id="id" />
	     </form>
        <div class="main_main">
                ...
                <tbody>
                    ...
                    <s:iterator value="pageForm.list">
                        <tr id="${id}"  >
                            ...
                            <td>
                                <span id="cateuse">${cateuse}</span>
                            </td>
                            <td>
                                <span id="catenum">${catenum}</span>
                            </td>
                            <td>
                                <span id="cateusername">${cateusername}</span>
                            </td>
                            <td>
                                <span id="Cateusedate">${fn:substring(cateusedate,0,16)}</span>
                            </td>
                            <td>
            ...
            <c:import url="../../ea/page_navigator.jsp">
                <c:param name="actionPath" value="ea/cateapply/ea_getDtMycertificateapplyList.jspa?type=${param.type}&pageNumber=${pageNumber}">
                </c:param>
            </c:import>
        </div>
         <!--搜索窗口 -->
			...
			<form name="postSearchForm" id="postSearchForm" method="post">
				...
				<table width="396" id="cataffSearchTable">
					<tr>
						...
						<td width="261">
							<input name="cateapply.catename" class="ckTextLength" maxlength="40" id="catename"/>
						</td>
					</tr>
					<tr>
						<td align="right">
						...
						<td>
						    <input name="cateapply.cateusername" class="ckTextLength" maxlength="40" id="cateusername"/>
						</td>
					</tr>
					<tr>
						<td align="right">
						...
						<td>
						    <input name="Cateusedate" id="Cateusedate" style="width:180px;height:100%;" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})"/>
						</td>
					</tr>
				</table>
				<div align="center">
		...
		<div class="jqmWindow jqmWindowcss" style="top:10%;width:700px;" id="jqModel">
			 <form name="cateapplyForm" id="cateapplyForm" method="post" >
	        <div class="drag">证书领用申请
		    <div class="close"></div>
		    </div>
			<input type="submit" name="submit" style="display:none"/>
			 <div class="content">
			  <div class="contentbannb">
			     ...
			     <table width="700" height="117" border="0" align="center" cellpadding="0" cellspacing="0" id="cateapplytable" style="margin-top:5px;margin-bottom:5px;">
			      <tr>
			        <td width="80" height="37" align="right">单据编号：</td>
			        <td width="240" height="37">
			        <span id="serialNumber"></span>
			        </td>
			        <td width="90" height="37" align="right">领用人：</td>
			        <td width="290" height="37">
			        <span id="cateusername">${StaffName}</span>
			        </td>
			      </tr>
			      <tr>
			        <td width="80" height="37"  align="right">证书名称：</td>
			        <td width="240" height="37" >
			         <input name="cateapply.catename" class="put3 ckTextLength" maxlength="40" type="text" id="catename" size="20"/>
			        </td>
			        <td width="90" height="37" align="right">数量：</td>
			        <td width="290" height="37">
			         <input name="cateapply.catenum" class="put3 ckTextLength positiveNum" maxlength="8" type="text" id="catenum" size="20"/>
			        </td>
			      </tr>
			      <tr>
			        <td width="80" height="37" align="right">用途：</td>
			        <td width="240" height="37">
			        <input name="cateapply.cateuse" class="put3 ckTextLength" maxlength="40" type="text" id="cateuse" size="20"/>
			        </td>
			        <td width="90" height="37" align="right">领用时间：</td>
			        <td width="290" height="37">
			        <input name="Cateusedate" id="Cateusedate" size="20" class="put3" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})"/>
			        </td>
			      </tr>
			       <tr>
			        <td width="110" height="37" align="right" valign="top">备注：</td>
			        <td width="590" height="37" colspan="3">
			        <textarea name="cateapply.remarks" id="remarks" class="put3 ckTextLength" maxlength="400" style="width:500px; height:80px; border:1px solid #C5D9F1;resize: block;"></textarea>
                    <input type="hidden" name="cateapply.id" id="id" />
					<input type="hidden" name="cateapply.key" id="key" />
					<input type="hidden" name="cateapply.serialNumber" id="serialNumber" />
					<input type="hidden" name="cateapply.addtime" id="addtime" />
                    </td>
			      </tr>
			    </table>
			</div>
