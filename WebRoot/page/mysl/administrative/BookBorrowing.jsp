...
<script type="text/javascript" src="<%=basePath%>js/ea/mysl/administrative/BookBorrowing.js"></script>
</head>
<body>
	<div class="main_main">
		<table class="JQueryflexme">
			<thead>
				<tr class="tablewith">
					...
					<th width="110" align="center">书名</th>
					<th width="110" align="center">数量</th>
					<th width="110" align="center">借阅人签名</th>
			...
			<tbody>
				...
				<s:iterator value="pageForm.list">
					<tr id="${id}">
						...
						<td><span id="bookname">${bookname}</span></td>
						<td><span id="quantity">${quantity}</span></td>
						<td><span id="signature">${signature}</span></td>
		...
		<c:import url="../../ea/page_navigator.jsp">
			<c:param name="actionPath"
				value="ea/bookborrowing/ea_getListByBookBorrowing.jspa?pageNumber=${pageNumber}&search=${search}">
			</c:param>
		</c:import>
	</div>
	<div class="contentbannb jqmWindow windowJqm" style="top: 5%"
		id="jqModel">
		<form name="BookBorrowing" id="BookBorrowing" method="post"
			...
			<div class="content">
				...
				<table width="870 " height="46" border="0" align="center"
					...
					<tr>
						...
						<td align="left"><input name="dtMybookborrowing.companyname" id="companyname"
							readonly="readonly" value="<%=c.getCompanyName()%>" /> <input
							type="hidden" name="dtMybookborrowing.companyid" id="companyid" readonly="readonly"
							value="<%=c.getCompanyID()%>" /></td>
						<td align="right"><span class="xx">*</span>部门：</td>
						<td align="left"><input name="dtMybookborrowing.organizationname"
							id="organizationname" readonly="readonly"
							value="${department[1]}" /> <input type="hidden"
							name="dtMybookborrowing.organizationid" id="organizationid" readonly="readonly"
							value="${department[0]}" /></td>
						<td align="right"><span class="xx">*</span>责任人：</td>
						<td align="left"><input name="dtMybookborrowing.staffname" id="staffname"
							readonly="readonly" value="${staff.staffName}" /> <input
							type="hidden" id="staffid" name="dtMybookborrowing.staffid" readonly="readonly"
							value="${staff.staffID}" /></td>		
					</tr>
					<tr>
						<td align="right"><span class="xx">*</span>单据编号：</td>
						<td align="left"><input name="dtMybookborrowing.serialnumber" id="serialnumber"
							readonly="readonly" /></td>
						<td align="right"><span class="xx">*</span>申请人：</td>
						<td align="left" colspan="3"><input name="dtMybookborrowing.proposername" id="proposername"
							value="${staff.staffName}" /> <input type="hidden"
							id="proposerid" name="dtMybookborrowing.proposerid" readonly="readonly"
							value="${staff.staffID}" /></td>
					</tr>
				</table>
				<table width="870" height="244" border="0" align="center"
					...
					<tr>
						<td align="right"><span class="xx">*</span>图书名称：</td>
						<td align="left" ><input name="dtMybookborrowing.bookname"
							id="bookname"  size="10" class="put3"/></td>
						<td align="right"><span class="xx">*</span>数量：</td>
						<td align="left"><input name="dtMybookborrowing.quantity"
							id="quantity"  size="10" class="put3"/></td>
						<td align="right"><span class="xx">*</span>制单时间：</td>
						<td align="left"><input name="dtMybookborrowing.addtime"
							id="addtime" readonly="readonly" value="自动获得" size="10" /></td>
					</tr>
					<tr>
						<td align="right"><span class="xx">*</span>借阅人签名：</td>
						<td align="left" colspan="5"><input name="dtMybookborrowing.signature"
							id="signature"  size="10" class="put3"/></td>
					</tr>
					<tr>
						<td align="right"><span class="xx">*</span>备注：</td>
						<td colspan="5"><textarea
								name="dtMybookborrowing.note" cols="93" rows="5"
				...
				<table width="870" height="40" border="0" align="center"
					...
					<tr>
						<td colspan="10" align="center"><input type="hidden"
							name="dtMybookborrowing.id" id="id" /> <input type="hidden"
							name="dtMybookborrowing.key" id="key" /> <input type="button"
		...
		<form name="postSearchForm" id="postSearchForm" method="post">
			...
			<table width="396" id="cataffSearchTable">
				<tr>
					...
					<td><input name="dtMybookborrowing.serialnumber" /></td>
				</tr>
				<tr>
					<td align="right">制单时间：</td>
					<td><input name="dtMybookborrowing.addtime"  onfocus="date()"/></td>
				</tr>
				<tr>
					<td align="right">单据状态：</td>
					<td><select name="dtMybookborrowing.status">
