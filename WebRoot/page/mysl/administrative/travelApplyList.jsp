...
<script type="text/javascript" src="<%=basePath%>js/ea/mysl/administrative/travelApply.js"></script>
</head>
<body>
	<div class="main_main">
			...
			<tbody>
				...
				<s:iterator value="pageForm.list">
						<tr id="${id}">
							...
							<td>
								<span id="travelDays">${travelDays}</span>
							</td>
							<td>
								<span id="travelHours">${travelHours}</span>
							</td>
							<td>
								<span id="travelcause">${travelcause}</span>
							</td>
		...
		<c:import url="../../ea/page_navigator.jsp">
			<c:param name="actionPath"
				value="ea/travelapply/ea_getListByTravel.jspa?pageNumber=${pageNumber}&search=${search}&type=${type}">
			</c:param>
		</c:import>
	</div>
		<!--搜索窗口 -->
			...
			<form name="postSearchForm" id="postSearchForm" method="post">
				...
				<table width="396" id="cataffSearchTable">
					<tr>
	                  	...
	                  	<td>
	                  		<input name="dtMytravel.serialnumber" />
	                  	</td>
	                </tr><%--
					<tr>
						<td align="right">
						...
						<td>
							<input name="dtMytravel.staffname" />
						</td>
					</tr>
					--%><tr>
					<td align="right">制单时间：</td>
					<td><input name="dtMytravel.addtime"
						onfocus="date()" />
					</td>
				</tr>
				 <tr>
					<td align="right">单据状态：</td>
					<td><select name="dtMytravel.status">
			...
			<form name="travelForm" id="travelForm" method="post"
				...
				<div class="content">
				  ...
				  <table width="850 " height="50" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:5px; margin-bottom:5px;">
						...
						<td width="220"><input name="dtMytravel.companyname"
				   ...
				   <table width="850" height="210" border="0" align="center"
						...
						<tr>
							<td width="15%" height="34" align="right"><span class="xx">*</span>申请日期：</td>
							<td  colspan="3">
								<input name="dtMytravel.applyDate" onfocus="date(this);" class="input put3 yincang" id="applyDate" size="20" style="margin-left: 2px;" readonly="readonly" />
								<span id="addtime" class="xianshi sty"></span>
							</td>
							
						<tr>
							<td height="34" align="right">
								<span class="xx">*</span>出差日期：
							</td>
							<td colspan="3" class="errortime">
								<input name="dtMytravel.startDate"
									onfocus="daytime(this);" class="input yincang put3" id="startDate"
									size="20" style="margin-left: 2px;" readonly="readonly" />
							
								至
								<input name="dtMytravel.endDate"
									onfocus="daytime(this);" class="input yincang put3"  id="endDate"
									size="20" style="margin-left: 2px;" readonly="readonly" />
							
								计
								<input name="dtMytravel.travelDays" class="input yincang"
									id="travelDays" size="5" style="margin-left: 2px;" readonly="readonly"/>
								
								天
								<input name="dtMytravel.travelHours" class="input yincang" 
									id="travelHours" size="5" style="margin-left: 2px;" readonly="readonly"/>
						...
						<tr>
							<td align="right">
								<span class="xx">*</span>出差原因：
							</td>
							<td colspan="3">
								<textarea name="dtMytravel.travelcause" cols="88" 
									rows="4" class="input yincang ckTextLength put3" maxlength="250" 
									id="travelcause" style="margin-left: 2px;"></textarea>
				  ...
				  <table width="870" height="40" border="0" align="center"
					...
					<tr>
						<td colspan="10" align="center"><input type="hidden"
							name="dtMytravel" id="id" /> <input type="hidden"
							name="dtMytravel.key" id="key" /> 
