...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<%@ page import="com.mysl.bo.administrative.DtMyovertime" %>
		<%
		...
		<div id="tableprint" align="center">
			...
			<table width="620" border="0" cellpadding="0" cellspacing="0" style="background:#FFFFFF;">
			  ...
			  <tr>
			    ...
			    <td width="25%" align="left">${dtMyovertime.companyname}</td>
			    <td width="13.5%" align="right">部门：</td>
			    <td width="10%" align="left">${dtMyovertime.organizationname}</td>
			    <td width="10%" align="center">责任人：${dtMyovertime.staffname}</td>
			  </tr>
			  <tr>
			    <td width="12%" height="25" align="right">制单人：</td>
			    <td colspan="2" align="left">${dtMyovertime.staffname}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;制单日期：${fn:substring(dtMyovertime.addtime, 0, 10)}</td>
			    <td width="11%" align="right" height="10">凭证号：</td>
			    <td width="10%" align="center" height="10"><% DtMyovertime data =(DtMyovertime)request.getAttribute("dtMyovertime");
														if (data != null) {
			...
			<table width="600" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<td colspan="7" align="left">
						&nbsp;&nbsp;&nbsp;&nbsp;自
						<span id="textDate">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${dtMyovertime.overTimeStartDate}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>至
						<span id="textDate">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${dtMyovertime.overTimeEndDate}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
						共：
						<span id="textDate">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${dtMyovertime.overTimeDays}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>天
						<span id="textDate">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${dtMyovertime.overTimeHour}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>小时
						<br />
				...
				<tr>
					...
					<td align="left" width="500">
						&nbsp;&nbsp;&nbsp;&nbsp;${dtMyovertime.overTimeContent}
					</td>
				</tr>
				<tr>
				<td colspan="2" align="center"  style="display:none;" id="anniu">
