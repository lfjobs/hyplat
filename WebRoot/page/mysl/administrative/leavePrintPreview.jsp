...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
	    ...
	    <%@ page import="com.mysl.bo.administrative.DtMyleave" %>
		<%
		...
		<div id="tableprint" align="center">
			...
			<table width="620" border="0" cellpadding="0" cellspacing="0" style="background:#FFFFFF;">
			  ...
			  <tr>
			    ...
			    <td width="25%" align="left">${dtMyleave.companyname}</td>
			    <td width="13.5%" align="right">部门：</td>
			    <td width="10%" align="left">${dtMyleave.organizationname}</td>
			    <td width="10%" align="center">责任人：${dtMyleave.staffname}</td>
			  </tr>
			 <tr>
			    <td width="12%" height="25" align="right">制单人：</td>
			    <td colspan="2" align="left">${dtMyleave.staffname}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;制单日期：${fn:substring(dtMyleave.addtime, 0, 10)}</td>
			    <td width="11%" align="right" height="10">凭证号：</td>
			    <td width="10%" align="center" height="10"><% DtMyleave data =(DtMyleave)request.getAttribute("dtMyleave");
														if (data != null) {
												...
												%>
											${dtMyleave.serialnumber}</td>
			  </tr>
			</table>
			<table width="600" border="0" cellpadding="0" cellspacing="0"
				style="background: #FFFFFF;" class="table">
				<tr>
					<td width="102"height="40" align="center">
						请假类别：	
					</td>
					<td width="250" align="left">
						 <span style="padding-left:5px">${dtMyleave.leaveType}</span>
					</td>
					<td width="102" align="center">
						接管人：
					</td>
					<td width="250" align="left">
						<span style="padding-left:5px">${dtMyleave.leaveReceiver}</span>
					</td>
				</tr> 
				<tr> 
					...
					<td colspan="3" align="left">
						...
						<span style="text-decoration:underline;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${dtMyleave.leaveStartDate}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>至
						<span style="text-decoration:underline;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${dtMyleave.leaveEndDate}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
						共计
						<span style="text-decoration:underline;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${dtMyleave.leaveDays}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>天
						<span style="text-decoration:underline;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${dtMyleave.leaveHour}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>小时
					</td>
				</tr>
				<tr>
					<td width="102" height="50" align="center">
					...
					<td colspan="3" align="left">
						...
						<c:if test="${dtMyleave.leavecasual != null}">${dtMyleave.leavecasual}</c:if>
						<c:if test="${dtMyleave.leavecasual == null}">0</c:if>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>天,
						本月病假累计<span style="text-decoration:underline;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<c:if test="${dtMyleave.leavesick != null}">${dtMyleave.leavesick}</c:if>
						<c:if test="${dtMyleave.leavesick == null}">0</c:if>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>天,
						本次考勤折扣<span style="text-decoration:underline;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${dtMyleave.checkdiscount}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>分
					</td> 
				</tr>
				<tr> 
