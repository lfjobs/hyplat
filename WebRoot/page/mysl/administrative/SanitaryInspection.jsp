...
<script type="text/javascript" src="<%=basePath%>js/ea/mysl/administrative/SanitaryInspection.js"></script>
</head>
<body>
	<div class="main_main">
		<table class="JQueryflexme">
			<thead>
				<tr class="tablewith">
					...
					<th width="110" align="center">办公室</th>
					<th width="110" align="center">得分</th>
		...
		<c:import url="../../ea/page_navigator.jsp">
			<c:param name="actionPath"
				value="ea/sanitaryinspection/ea_getListBySanitaryInspection.jspa?pageNumber=${pageNumber}&search=${search}">
			</c:param>
		</c:import>
	</div>
	<div class="contentbannb jqmWindow windowJqm" style="top: 5%"
		id="jqModel">
		<form name="SanitaryInspection" id="SanitaryInspection" method="post"
			...
			<div class="content">
				...
				<table width="870 " height="46" border="0" align="center"
					...
					<tr>
						...
						<td align="left"><input name="dtMysanitaryinspection.companyname" id="companyname"
							readonly="readonly" value="<%=c.getCompanyName()%>" /> <input
							type="hidden" name="dtMysanitaryinspection.companyid" id="companyid" readonly="readonly"
							value="<%=c.getCompanyID()%>" /></td>
						<td align="right"><span class="xx">*</span>部门：</td>
						<td align="left"><input name="dtMysanitaryinspection.organizationname"
							id="organizationname" readonly="readonly"
							value="${department[1]}" /> <input type="hidden"
							name="dtMysanitaryinspection.organizationid" id="organizationid" readonly="readonly"
							value="${department[0]}" /></td>
						<td align="right"><span class="xx">*</span>责任人：</td>
						<td align="left"><input name="dtMysanitaryinspection.staffname" id="staffname"
							readonly="readonly" value="${staff.staffName}" /> <input
							type="hidden" id="staffid" name="dtMysanitaryinspection.staffid" readonly="readonly"
							value="${staff.staffID}" /></td>		
					</tr>
					<tr>
						<td align="right"><span class="xx">*</span>单据编号：</td>
						<td align="left"><input name="dtMysanitaryinspection.serialnumber" id="serialnumber"
							readonly="readonly" /></td>
						<td align="right"><span class="xx">*</span>申请人：</td>
						<td align="left" colspan="3"><input name="dtMysanitaryinspection.proposername" id="proposername"
							value="${staff.staffName}" /> <input type="hidden"
							id="proposerid" name="dtMysanitaryinspection.proposerid" readonly="readonly"
							value="${staff.staffID}" /></td>
					</tr>
				</table>
				<table width="870" height="244" border="0" align="center"
					...
					<tr>
						<td align="right"><span class="xx">*</span>办公地点：</td>
						<td align="left" ><input name="dtMysanitaryinspection.department"
							id="department"  size="10" class="put3"/></td>
						<td align="right"><span class="xx">*</span>得分：</td>
						<td align="left"><input name="dtMysanitaryinspection.score"
							id="score"  size="10" class="put3"/></td>
						<td align="right"><span class="xx">*</span>制单时间：</td>
						<td align="left"><input name="dtMysanitaryinspection.addtime"
							id="addtime" readonly="readonly" value="自动获得" size="10" /></td>
					</tr>
					<tr>
						<td align="right"><span class="xx">*</span>备注：</td>
						<td colspan="5"><textarea
								name="dtMysanitaryinspection.note" cols="93" rows="5"
				...
				<table width="870" height="40" border="0" align="center"
					...
					<tr>
						<td colspan="10" align="center"><input type="hidden"
							name="dtMysanitaryinspection.id" id="id" /> <input type="hidden"
							name="dtMysanitaryinspection.key" id="key" /> <input type="button"
		...
		<form name="postSearchForm" id="postSearchForm" method="post">
			...
			<table width="396" id="cataffSearchTable">
				<tr>
					...
					<td><input name="dtMysanitaryinspection.serialnumber" /></td>
				</tr>
				<tr>
					<td align="right">制单时间：</td>
					<td><input name="dtMysanitaryinspection.addtime"  onfocus="date()"/></td>
				</tr>
				<tr>
					<td align="right">单据状态：</td>
					<td><select name="dtMysanitaryinspection.status">
