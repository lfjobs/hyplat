    ...
    <div class="div-box">
        ...
        <div class="container">
            <ul class="ul-con">
                ...
                <a href="/page/water/cost.jsp">
                    <li class="clearfix">
                        <p class="p-title">水费管理</p>
                        <p class="p-height">
                            水费管理 水费明细 <br>
                        </p>
                        <div class="div-more">
                ...
                <a href="/page/water/equipment.jsp">
                    <li class="clearfix">
                        <p class="p-title">用水设备</p>
                        <p class="p-height">
