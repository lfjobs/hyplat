...
<body class="bgcolorFFF">
	<div class="wfj12_003">
		...
		<div class="wfj_top">
			<ul>
				<li><a href="resources_1.jsp" target="_self"><img
						src="<%=basePath%>images/contacts/Network/wfj_return_01.png" />
				</a>
				</li>
				<li>
					<div>
				...
				<li><a href="javascript:;"><img
						src="<%=basePath%>images/contacts/Network/iconfont-fenxiang.png" />
				</a>
				</li>
			</ul>
		</div>
			...
			<div class="wfj12_003_hidden">
				<div class="wfj12_003_person">
					<div class="wfj12_003_person_top">
						<div class="wfj12_003_person_topimg">
							<img class="person_topimg"
								src="<%=basePath%>images/contacts/Network/wfj_huiyuan_01.png" /><img
								class="person_position_img"
								src="<%=basePath%>images/contacts/Network/wfj_photo_01.png" />
						</div>
					</div>
						...
						<div class="wfj12_003_width">
							<form action="" id="from1" method="post">
								...
								<table width="100%">
									...
									<tr>
										<td><img
											src="<%=basePath%>images/contacts/Network/wfj_all_Profile_17.png" />
										</td>
									...
									<tr>
										<td><img
											src="<%=basePath%>images/contacts/Network/wfj_all_Profile_09.png" />
										</td>
										<td colspan="2"><input type="text" name="astaff.position"
											value="请输入职位"
											onfocus="if(this.value=='请输入职位'){this.value='';}"
											onblur="if(this.value==''){this.value='请输入职位';}" /></td>
									</tr>
									<tr>
										<td><img
											src="<%=basePath%>images/contacts/Network/wfj_all_Profile_06.png" />
										</td>
							...
							<form action="" id="from2" method="post">
								...
								<table width="100%">
									<tr>
										...
										<td width="15%"><img
											src="<%=basePath%>images/contacts/Network/wfj_shop_info_02.png" />
										</td>
										<td colspan="2"><input type="text"
									...
									<tr>
										<td><img
											src="<%=basePath%>images/contacts/Network/wfj_shop_info_03.png" />
										</td>
									...
									<tr>
										<td><img
											src="<%=basePath%>images/contacts/Network/wfj_shop_info_04.png" />
										</td>
		...
		$(document)
				.ready(
						function(e) {
							...
							$(".wfj12_003_person_topimg").attr(
									"style",
									"margin-top:" + $(window).height() * 0.02
											+ "px;");
							...
							$(".wfj_top").find("li").find("img").attr(
									...
									"height:" + $(window).height() * 0.03
											+ "px;");
							$(".wfj_top").find("li").eq(1).attr("style",
									"width:70%;");

							$(".wfj_top").find("li").eq(1).find("div").attr(
									"style",
									"width:70%;margin:" + $(window).height()
											* 0.0085 + "px auto;height:"
											+ $(window).height() * 0.04
											+ "px;line-height:"
											+ $(window).height() * 0.04
											+ "px; border-radius:"
											+ $(window).height() * 0.02
											+ "px;border:" + $(window).height()
											* 0.003 + "px solid #FFF;");
							$(".wfj_top")
									.find("li")
									.eq(1)
									...
									.attr(
											"style",
											"width:50%;text-align:center;font-size:"
													+ $(window).height()
													* 0.02
													+ "px;background-color:#FFF;height:"
													+ $(window).height()
													* 0.04
													+ "px;line-height:"
													+ $(window).height()
													* 0.04
													+ "px;color:#F74C31; border-top-left-radius:"
													+ $(window).height()
													* 0.015
													+ "px; border-bottom-left-radius:"
													+ $(window).height()
													* 0.015 + "px;");
							$(".wfj_top").find("li").eq(1).find("div").find(
									"li").eq(1).attr(
									"style",
									"width:50%;text-align:center;font-size:"
											+ $(window).height() * 0.02
									...
									.attr(
											...
											"height:"
													...
													* 0.04
													...
													+ $(window).height()
													* 0.04
													+ "px;background-color:#F2F2F2;width:"
													+ $(window).height() * 0.08
													+ "px;float:right;");
							$("#ssex")
									.find("li")
							...
							if ($(window).width() > $(window).height()) {
								...
								if ($(".wfj_top").find("div").find("li").eq(0)
										.css("color") == "rgb(247, 76, 49)"
										&& $(".wfj12_003_person").height() > $(
												".wfj12_003_content").height()) {
									$(".wfj12_003_hidden").css(
											"width",
											parseInt($(".wfj12_003_content")
													.width() + 17)
													+ "px");
								} else if ($(".wfj_top").find("div").find("li")
										.eq(1).css("color") == "rgb(247, 76, 49)"
										&& $(".wfj12_003_company").height() > $(
												".wfj12_003_content").height()) {
									$(".wfj12_003_hidden").css(
											"width",
											parseInt($(".wfj12_003_content")
																...
																.attr(
																		...
																		"width:50%;text-align:center;font-size:"
																				+ $(
																						...
																						.height()
																				* 0.02
																				+ "px;color:#FFF; background-color:#F74C31;height:"
																				+ $(
																						window)
																						.height()
																				* 0.04
																		...
																		"width:50%;text-align:center;font-size:"
																				...
																				* 0.015
																				...
																				+ $(
																						...
																						.height()
																				* 0.015
																				+ "px;background-color:#FFF;color:#F74C31;");
