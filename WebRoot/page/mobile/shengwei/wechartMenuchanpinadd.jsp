	...
	<form name="cstaffForm" id="cstaffForm" method="post" enctype="multipart/form-data">
        ...
        <div style="display: none;">
            ...
            <ul>
                ...
                <li class="product_name">产品发布管理</li>
            </ul>
        </div>
        <div class="pro_name">
            <ul>
                <li>产品名称：<input type="text" name="goodsManage.goodsName" id="goodsname"/></li>
            </ul>
        </div>
        ...
        <div class="pro_text">
            ...
            <div>
                <ul>
                    <li>规格：</li>
                    <li><input type="text" name="goodsManage.standard" /></li>
                </ul>
                <ul>
                    <li>类型：</li>
                    <li>
                        <input type="text"  name="goodsManage.typeID"/></li>
                </ul>
            </div>
            <div>
                <ul>
                    <li>单价：</li>
                    <li><input type="text" name="productPackaging.price"/></li>
                </ul>
                <ul>
                    <li>金额：</li>
                    <li>
                        <input type="text" name="productPackaging.money"/></li>
                </ul>
            </div>
            ...
            <div>
                <ul>
                    <li>代理商：</li>
                    <li><input type="text" name="profitshare.agent"/></li>
                </ul>
                <ul>
                    <li>微分金店：</li>
                    <li>
                        <input type="text" name="profitshare.shop"/></li>
                </ul>
            </div>
            <div>
                <ul>
                    <li>公司：</li>
                    <li><input type="text" name="profitshare.company"/></li>
                </ul>
                <ul>
                    <li>合伙人：</li>
                    <li>
                        <input type="text" name="profitshare.partner"/></li>
                </ul>
            </div>
            <div>
                <ul>
                    <li>营销员：</li>
                    <li><input type="text" name="profitshare.salesman" /></li>
                </ul>
                <ul>
                    <li>消费者积分：</li>
                    <li>
                        <input type="text" name="profitshare.integral" /></li>
                </ul>
            </div>
            <div>
                <ul>
                    <li>责任人：</li>
                    <li class="pro_txt"><input type="text" /></li>
                </ul>
                <ul>
                    <li>包装日期：</li>
                    <li class="pro_txt">
                        <input type="text"  value="<fmt:formatDate value="<%=new Date()%>" pattern="yyyy-MM-dd"/>"/></li>
                </ul>
            </div>
        </div>
