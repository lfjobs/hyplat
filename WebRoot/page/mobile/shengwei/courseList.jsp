  ...
  <head>
	...
	<body bgcolor="#E7E7E7">
		<div class="new">
			<div class="bm_2_con">
				<div class="bm_2_div">
					<img class="imgAuto2" src="images/yd.png" />
				</div>
				<div class="bm_2_div">
		...
		<s:iterator value="courseList" id="list">
			...
			<div class="bm_kuang">
				<div class="bm_pic">
					<a href="<%=basePath%>/ea/shengwei/ListCourse.jspa?weidianType=培训店&courseId=${list[0]}&companyid=${list[5]}&enroll=enroll"><img class="imgAuto" src="<%=basePath %>${list[2]}" />
					</a>
				</div>
				<div class="bm_font">
					<div class="bm_font_xx">
						${list[1]}
					</div>
