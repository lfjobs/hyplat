...
<script type="text/javascript" src="<%=basePath%>js/common/common.js"></script>
    ...
    <body>
        ...
        <c:import url="../../../page_navigator.jsp">
            <c:param name="actionPath" value="ea/goodscashier/ea_getProCashierList.jspa?search=${search}&pageNumber=${pageNumber}&sdate=${sdate}&edate=${edate}">
            </c:param>
        </c:import>
...
<table width="2200" align="center" cellpadding="0" cellspacing="0" class="table" id="goodtable">
  ...
  <span id="balance"></span></td>
   ...
   <td align="center" bgcolor="#FFFFFF">
   <span id="remindedContent"></span>${remindedContent}</td>
  </tr>
</table>
</div>
    </td>
