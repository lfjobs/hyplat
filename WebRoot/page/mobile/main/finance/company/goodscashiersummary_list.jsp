...
<script type="text/javascript" src="<%=basePath%>js/common/common.js"></script>
        ...
        <script language="javascript" type="text/javascript" src="<%=basePath%>js/ea/finance/company/goodscashiersummary_list.js"></script>
    ...
    <body>
        <form  name="CashierBillsform" id="CashierBillsform">
			...
			<input  name="cashierBills.goodsBillsID" id="goodsBillsID" style="display:none"/>
			<s:token/>
        </form>
        <table class="flexme11">
            ...
            <tbody>
             <s:iterator value="pageForm.list">
                        <tr id="${goodsBillsID}">
                            <td>
                                <input type="radio" name="a"  class="JQuerypersonvalue" value="${goodsBillsID}"/>
                            </td>
                              <td>
                            ...
                            <td>
                                ...
                                <span id="afterDiscount"  style="display:none">${afterDiscount}</span>
                                <span id="bankDepotName"  style="display:none">${bankDepotName}</span>
                                <span id="dataDepotName"  style="display:none">${dataDepotName}</span>
                            </td>
                       <td>
                                <span id="goodsName">${goodsName}</span>
                                <span id="defaultStorage"  style="display:none">${defaultStorage}</span>
                            </td>
                             <td>
                             ...
                             <td>
                                ...
                                <span id="standard"  style="display:none">${standard}</span>
                                <span id="mnemonicCode"  style="display:none">${mnemonicCode}</span>
                                <span id="model"  style="display:none">${model}</span>
                                <span id="identifyingCode"  style="display:none">${identifyingCode}</span>
                                <span id="startDate"  style="display:none">${fn:substring(startDate, 0, 10)}</span>
                                <span id="endDate"  style="display:none">${fn:substring(endDate, 0, 19)}</span>
                                <span id="periodDate"  style="display:none">${fn:substring(periodDate, 0, 10)}</span>
                                <span id="batchNumber"  style="display:none">${batchNumber}</span>
                                <span id="costType"  style="display:none">${costType}</span>
                                <span id="payType"  style="display:none">${payType}</span>
                                <span id="priceManage"  style="display:none">${priceManage}</span>
                                <span id="weight" style="display:none">${weight}</span>
                                <span id="boxStandard" style="display:none">${boxStandard}</span>
                                <span id="remindedContent" style="display:none">${remindedContent}</span>
                                    </td>
                             <td>
                             ...
                             <td>
                                ...
                                <span id="subjectsName"  style="display:none">${subjectsName}</span>
                                <span id="depotType"  style="display:none">${depotType}</span>
                                <span id="loan" style="display:none">${loan}</span>
                                <span id="forLoan" style="display:none">${forLoan}</span>
                                </td>
                             <td>
                             ...
                             <td>
                                ...
                                <span id="logistics"  style="display:none">${logistics}</span>
                                <span id="moneySpent" style="display:none">${moneySpent}</span>
                                <span id="ccompanyname" style="display:none">${ccompanyname}</span>
                                <span id="accountNum" style="display:none">${accountNum}</span>
                                <span id="contactConnections" style="display:none">${contactConnections}</span>
                                <span id="contactUserName" style="display:none">${contactUserName}</span>
                                <span id="userAccountNum" style="display:none">${userAccountNum}</span>
                                <span id="phone" style="display:none">${phone}</span>
                                <span id="responsible" style="display:none">${responsible}</span>
                                <span id="accountant" style="display:none">${accountant}</span>
                                <span id="cashier" style="display:none">${cashier}</span>
                                 <span id="companyAddr" style="display:none">${companyAddr}</span>
                                  <span id="companyTel" style="display:none">${companyTel}</span>
                                   <span id="responsibleTel" style="display:none">${responsibleTel}</span>
                                    <span id="industryType" style="display:none">${industryType}</span>
                                     <span id="cresponsible" style="display:none">${cresponsible}</span>
                                     <span id="staffIdentityCard" style="display:none">${staffIdentityCard}</span>
                                  <span id="tel" style="display:none">${tel}</span>
                                   <span id="userQq" style="display:none">${userQq}</span>
                                    <span id="email" style="display:none">${email}</span>
                                     <span id="userAddr" style="display:none">${userAddr}</span>
                            </td>
                            <td>
                                <span id="xsstatus">
                                <s:if test='status=="00"'>
        ...
        <c:import url="../../../page_navigator.jsp">
            <c:param name="actionPath" value="ea/goodscashier/ea_getCashierList.jspa?search=${search}&pageNumber=${pageNumber}&sdate=${sdate}&edate=${edate}">
            </c:param>
        </c:import>
          <!--搜索窗口 -->
        ...
        <div class="jqmWindow" style="width: 400px;right: 25%;top:10%" id="jqModelSearch">
                ...
                <table width="396" id="SearchTable">
					<tr>
						...
						<td >
						<select id="bills" style="width:200px"  name="cashierBills.billsType">
                    ...
                    <tr>
                        <td align="right">
                            公司名称：                        </td>
                      <td>
                        <select id="deptID" name="cashierBills.companyID" ><option value="">请选择公司</option></select>
                        </td>	
                  </tr>
                  <tr>
                   <td align="right">
                            部门名称：                        </td>
                      <td >
                        <select id="orgID" name="cashierBills.departmentID" style="width:200px"><option value="">请选择公司</option></select>
                    </td>
                  </tr>
                   <tr>
                  ...
                  <tr><td align="right">单据状态：</td>
                        <td>
                          <input type="radio" name="cashierBills.cashierStatus" checked="checked" value=""/>全部&nbsp;&nbsp;
                          <input type="radio" name="cashierBills.cashierStatus" value="01"/>待主管审核
                            <input type="radio" name="cashierBills.cashierStatus" value="10"/>作废
                       </td>
                    </tr>
                     <tr><td align="right"></td>
                        <td>
                          <input type="radio" name="cashierBills.cashierStatus" value="02"/>待会计审核
                          <input type="radio" name="cashierBills.cashierStatus" value="03"/>待出纳审核
                           <input type="radio" name="cashierBills.cashierStatus" value="04"/>已审核
                       </td>
                    </tr>
                </table>
            <div align="center">
 ...
 <div class="jqmWindow jqmWindowcss6" style="width: 1200px;top:1%" id="jqModels">
  ...
  <tr>
    ...
    <tr>
       <td height="20" align="right"><span class="STYLE1">公司：</span></td>
    ...
    <tr>
       <td height="20" align="right"><span class="STYLE1">银行账户：</span></td>
       <td ><span id="companyBankNum"></span></td>
       <td align="right"></td>
       <td align="left" ></td>
      <td align="right"><div id="u1170_rtf"></div></td>
       <td width="15%" ></td>
    </tr>
  </table>
...
<table width="2200" align="center" cellpadding="0" cellspacing="0" class="table" id="goodtable">
  <tr>
    ...
    <th align="center" width="100" bgcolor="#E4F1FA">标识条码</th>
    ...
    <th align="center" width="120" bgcolor="#E4F1FA">科目</th>
    ...
    <th align="center" width="120" bgcolor="#E4F1FA">付款方式</th>
    <th align="center" width="120" bgcolor="#E4F1FA">物流方式</th>
    <th align="center" width="120" bgcolor="#E4F1FA">用款原因</th>
  ...
  <tr  >
	...
	<td align="center" bgcolor="#FFFFFF">
     <span id="periodDate"></span></td>
     <td align="center" bgcolor="#FFFFFF">
     <span id="batchNumber"></span></td>
  ...
  <td align="center" bgcolor="#FFFFFF"><span id="remindedContent">${remindedContent}</span></td>
    <td align="center" bgcolor="#FFFFFF">
   <span id="payType"></span></td>
     <td align="center" bgcolor="#FFFFFF">
   <span id="logistics"></span></td>
    <td align="center" bgcolor="#FFFFFF">
   <span id="moneySpent"></span></td>
     <td align="center" bgcolor="#FFFFFF">
   <span id="remindedContent"></span></td>
  </tr>
</table>
</div>
    </td>
