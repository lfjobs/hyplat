				...
				<div class="nav">
					<div class="navLaftBg">
						<div class="navRightBg">
							<div class="mainNav">
								<a href="#" id="n2" class="actived"><span>创收平台(人事)</span> </a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="padder">
					<div class="nav">
						<div class="navLaftBg">
							<div class="navRightBg">
								<div class="mainNav">
									<a href="#" id="n3"><span>创收平台(办公室)</span> </a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="padder">
					<div class="nav">
						<div class="navLaftBg">
							<div class="navRightBg">
								<div class="mainNav">
									<a href="#" id="n4"><span>创收平台(财务)</span> </a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="padder">
					<div class="nav">
						<div class="navLaftBg">
							<div class="navRightBg">
								<div class="mainNav">
									<a href="#" id="n5"><span>创收平台(生产)</span> </a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="padder">
					<div class="nav">
						<div class="navLaftBg">
							<div class="navRightBg">
								<div class="mainNav">
									<a href="#" id="n6"><span>创收平台(营销)</span> </a>
								</div>
							</div>
						</div>
					</div>
