				...
				<div class="nav">
					<div class="navLaftBg">
						<div class="navRightBg">
							<div class="mainNav">
								<a href="#" id="n2" class="actived"><span>办公室(人事)</span> </a>
							</div>
						</div>
					</div>
				</div>
				<div class="secondNav" id="secondNav">
					...
					<div id="subNav2" style="display: none">
						<p class="secondNav">
							...
							--%>
							<a href="#" class="actived" id="t3"
								onclick="parent.daohang.document.location.href='<%=basePath%>/page/mobile/main/human/office/personal_department/personal_incumbent1.jsp'">在职员工</a>
						</p>
						<p class="secondNav">
				...
				<div class="padder">
					<div class="nav">
						<div class="navLaftBg">
							<div class="navRightBg">
								<div class="mainNav">
									<a href="#" id="n3"><span>办公室(办公室)</span> </a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="padder">
					<div class="nav">
						<div class="navLaftBg">
							<div class="navRightBg">
								<div class="mainNav">
									<a href="#" id="n4"><span>办公室(财务)</span> </a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="padder">
					<div class="nav">
						<div class="navLaftBg">
							<div class="navRightBg">
								<div class="mainNav">
									<a href="#" id="n5"><span>办公室(生产)</span> </a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="padder">
					<div class="nav">
						<div class="navLaftBg">
							<div class="navRightBg">
								<div class="mainNav">
									<a href="#" id="n6"><span>办公室(营销)</span> </a>
								</div>
							</div>
						</div>
					</div>
