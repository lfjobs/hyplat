...
<div class="contentbannb " style="width: 643px;top:10%" id="jqModel">
  ...
  <div class="contentbannb">
   ...
   <table width="643" height="367" border="1" align="center" cellpadding="0" cellspacing="0" class="JQueryflexme" id="stafftable" 
   style="margin-top:5px;margin-bottom:5px; table-layout:fixed;border-color: black;">
  <tr>
    <td width="90" align="right" style="width:90px;">员工编号：</td>
