				...
				<div class="nav">
					<div class="navLaftBg">
						<div class="navRightBg">
							<div class="mainNav">
								<a href="#" id="n2" class="actived"><span>招生处(人事)</span> </a>
							</div>
						</div>
					</div>
				</div>
					...
					<div id="subNav2" style="display: none">
						...
						<p class="secondNav">
							<a href="#" class="actived" id="t4"
								onclick="parent.left_tree.document.location.href='<%=basePath%>ea/mobilecosdimission/ea_getListCOSDimission.jspa'">离职员工</a>
						</p>
					</div>
				</div>
			</div>
				...
				<div class="padder">
					<div class="nav">
						<div class="navLaftBg">
							<div class="navRightBg">
								<div class="mainNav">
									<a href="#" id="n3"><span>招生处(办公室)</span> </a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="padder">
					<div class="nav">
						<div class="navLaftBg">
							<div class="navRightBg">
								<div class="mainNav">
									<a href="#" id="n4"><span>招生处(财务)</span> </a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="padder">
					<div class="nav">
						<div class="navLaftBg">
							<div class="navRightBg">
								<div class="mainNav">
									<a href="#" id="n5"><span>招生处(生产)</span> </a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="padder">
					<div class="nav">
						<div class="navLaftBg">
							<div class="navRightBg">
								<div class="mainNav">
									<a href="#" id="n6"><span>招生处(营销)</span> </a>
								</div>
							</div>
						</div>
					</div>
