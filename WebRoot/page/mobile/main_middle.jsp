	...
	background-repeat: repeat-x;
		...
		<script type="text/javascript">
			function Submit_onclick(){
				if(parent.document.getElementById("leftFrame").style.display == "block") {
					...
					//document.getElementById("ImgArrow").src="<%=basePath%>images/plat/main/switch_left.gif";
		...
		<object classid="clsid:BE564711-3713-4e3e-9E78-91B039A4969C" width="2"
			height="2" id="helloBossma">
