...
<head>
    ...
    <script type="text/javascript" charset="utf-8" src="<%=basePath%>js/ea/human/staff/companys.js"></script>
...
<div class="content" style=" margin-top: 20px;">
    <section class="sec-list" style="overflow: hidden auto;height: 830px">
