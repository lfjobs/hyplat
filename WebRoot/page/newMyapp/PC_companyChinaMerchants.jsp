    ...
    <div class="att_con">
        ...
        <ul class="att_list middle">
            <li>
                ...
                <h2>公司申请加入经济平台</h2>
                <a href="<%=basePath%>/ea/newpcend/ea_companyWebsite.jspa?ccompanyId=contactCompany20101230UB4U5884S30000000176&hot=公司&titleJudge=03&seven=01&temporary=MyjiaruCompany"><input type="button" value="申请加入"></a>
            </li>
            <li>
                <img src="<%=basePath%>/page/newMyapp/images/newPCHomepage/ico-ge.png">
                <h2>个人申请加入经济平台</h2>
                <a href="<%=basePath%>/ea/newpcend/ea_companyWebsite.jspa?ccompanyId=contactCompany20101230UB4U5884S30000000176&hot=个人&titleJudge=03&seven=01&temporary="><input type="button" value="申请加入"></a>
            </li>
        </ul>
    </div>
</div>
