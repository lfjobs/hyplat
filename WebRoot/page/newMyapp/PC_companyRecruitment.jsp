...
<head>
    ...
    <script src="<%=basePath %>page/newMyapp/js/PC_companyRecruitment.js" type="text/javascript"></script>
    <script>
		...
		var companyId = '${ccomcom.comanyId}';
...
<div class="content" style="background-color: #f5f5f5;">
    <div class="Certificate_con" style="padding-top: 30px;margin-top: 0;">
        <div class="left">
            <div class="select">
                <div class="post_tab">
                    <h5 class="tit">
