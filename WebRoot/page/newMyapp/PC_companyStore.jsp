...
<head>
    ...
    <script src="<%=basePath %>page/newMyapp/js/PC_companyStore.js" type="text/javascript"></script>
    <script>
    ...
    <div class="">
        <div class="mil_shop_con_">
            <div class="mil_shop_con">
                <div class="shop-sort">
                    <button class="active" data-name="newest">综合排序</button>
                    <button data-name="pop">销量</button>
                    <button data-name="ptop">价格<img src="http://localhost:8080/hyplat/page/newMyapp/images/newPCHomepage/ico-down.png"></button>
                    <button data-name="plow">价格<img src="http://localhost:8080/hyplat/page/newMyapp/images/newPCHomepage/ico-up.png"></button>
                </div>
                <ul class="product">
                    <!-- js拼接 -->
                </ul>
