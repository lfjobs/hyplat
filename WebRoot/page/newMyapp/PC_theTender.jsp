...
<head>
    ...
    <script type="text/javascript" src="<%=basePath %>/page/newMyapp/js/PC_theTender.js"></script>
...
<div id="header">
    ...
    <div class="bid_con">
        ...
        <div class="bottom">
            ...
            <ul class="tit">
                <li class="bid_ing active" date-name="进行中">招标进行中</li>
                <li class="bid_acc" date-name="已结束">招标已结束</li>
            </ul>
            <div class="bot_con">
                <div class="left">
                    <ul id="bid_ing">
...
<script>
    $(document).ready(function(){
        ...
        $(document).on("click",".bid_con .bottom .tit .bid_ing",function(){
            $("#bid_ing").show().siblings().hide();
        });
        $(document).on("click",".bid_con .bottom .tit .bid_acc",function(){
            $("#bid_acc").show().siblings().hide();
        });
