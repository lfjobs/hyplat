...
<body>
	...
	<div class="content con">
		...
		<div class="web_con web_con_det">
				...
				<ul class="web_con_left4">
					<a href="#;">
						<li>
							...
							<p>
								<img src="<%=basePath%>page/newMyapp/images/001.jpg" alt=""><span>今天与大家分享就闲话少说咱们直接进入主题</span>
							</p></li> </a>
					<hr
					...
					<a href="#;">
						<li>
							<h3>交通运输部关于修改修改</h3>
							<p>
								<img src="<%=basePath%>page/newMyapp/images/news.png"><span>《交通运输部关于修改《道路运输从业人才</span>
							</p>
					</li> </a>
					<hr
						style="border-top: 1px solid #ddd;width: 80%;margin: 20px auto 0 auto;">
			...
			<c:if test="${param.nu=='服务' }">
			 <%@ include file="/page/newMyapp/fuwu.jsp" %>
			 </c:if>
			 <!--资料详情  -->
			<c:if test="${param.nup=='资料' }">
			 <%@ include file="/page/newMyapp/zl.jsp" %>
			 </c:if>
			
		</div>
	</div>
	<a href="#header" class="return"><img
		src="<%=basePath%>page/newMyapp/images/return.png"> </a>
	</div>
	<div id="footer">
    ...
    var basePath = "<%=basePath%>";
			...
			$("#pay").click(function() {
				var url = basePath + "page/newMyapp/pay.jsp";
				document.location.href = url;
			});
