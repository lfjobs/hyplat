...
<body>
    ...
    <div class="content pay_con_">
        <div class="pay_con">
            <img src="<%=basePath %>page/newMyapp/images/pay-banner.png" alt="" width="100%">
            <div class="head">
            ...
            <div class="yinhang">
                <ul>
                    <li><img src="<%=basePath %>page/newMyapp/images/nonghang.png" alt="" style="width: 90%;margin-top: 11px;"></li>
                    <li><img src="<%=basePath %>page/newMyapp/images/zhonghang.png" alt="" style="width: 75%;margin-top: 8px;"></li>
                    <li><img src="<%=basePath %>page/newMyapp/images/jianhang.png" alt="" style="width: 90%;margin-top: 11px;"></li>
                    <li><img src="<%=basePath %>page/newMyapp/images/gonghang.png" alt="" style="width: 90%;margin-top: 11px;"></li>
                    <li><img src="<%=basePath %>page/newMyapp/images/zhaohang.png" alt="" style="width: 90%;margin-top: 11px;"></li>
                    <li><img src="<%=basePath %>page/newMyapp/images/jiaohang.png" alt="" style="width: 90%;margin-top: 11px;"></li>
                    <li><img src="<%=basePath %>page/newMyapp/images/renhang.png" alt="" style="width: 90%;margin-top: 11px;"></li>
                    <li><img src="<%=basePath %>page/newMyapp/images/zhifubao.png" alt="" style="width: 75%;margin-top: 8px;"></li>
                </ul>
