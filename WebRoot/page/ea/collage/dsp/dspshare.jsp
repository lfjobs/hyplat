...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>css/ea/collage/phl/dspshare.css?version=202107082">
    <script src="<%=basePath%>js/font-size.js" type="text/javascript" charset="utf-8"></script>
    <script src="<%=basePath%>js/jquery-1.9.1.min.js" type="text/javascript" charset="utf-8"></script>
    <script src="<%=basePath%>js/ea/collage/dsp/dspshare.js?version=20210708" type="text/javascript"
...
<div class="content">
    <section class="box">
        <img src="${video[12]}" class="video-img" alt=""
             onerror="this.src='<%=basePath%>images/ea/collage/dsp/pic_03.png'">
        <div class="nobox" id="acc">

        </div>
        <div class="player">

            <video width="100%" id="video" src="${video[1]}" class="video" data-play="play" webkit-playsinline="true"
                   x-webkit-airplay="true" playsinline="true" x5-video-player-type="h5"
        ...
        <div class="div-xiazai clearfix">
            <div>
                <img src="<%=basePath%>images/ea/collage/dsp/img_03.png"/>
            </div>
            <div>
                <p>数字地球</p>
                <p>思想引领世界</p>
        ...
        <div class="div-right">
            <div class="div-01">
                <div class="div-box <c:if test="${video[11] eq '1'}">active</c:if>">
                    <img src="<%=basePath%>${video[5]}"
                         onerror="this.src='<%=basePath%>images/ea/driving/elkc/head.png'"/>
                </div>
    ...
    <section class="gengduo">
        ...
        <ul class="morevideo">
            <c:forEach items="${pageForm.list}" var="item" varStatus="state">
                <li id="${item[0]}"
                    class="ac <c:if test="${state.index+1 eq fn:length(pageForm.list)}">ttsw_last</c:if>">
...
<div class="fenxiang">
    <div class="box">
        ...
        <ul class="clearfix">
            <li>
                <img src="<%=basePath%>images/ea/collage/dsp/img_34.png"/>
                <p>
                    朋友圈
                </p>
            </li>
            <li>
                <img src="<%=basePath%>images/ea/collage/dsp/img_36.png"/>
                <p>
                    微信好友
                </p>
            </li>
            <li>
                <img src="<%=basePath%>images/ea/collage/dsp/img_38.png"/>
                <p>
                    QQ好友
                </p>
            </li>
            <li>
                <img src="<%=basePath%>images/ea/collage/dsp/img_41.png"/>
                <p>
                    微博
                </p>
            </li>
