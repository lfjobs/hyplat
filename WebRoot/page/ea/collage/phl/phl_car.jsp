...
<head>
	...
	<script src="<%=basePath%>js/ea/collage/phl/phl_car.js" type="text/javascript" charset="utf-8"></script>
...
<div class="content">
	<section>
		<h3 class="clearfix">
			有货拉物流
			<span><a href="<%=basePath%>page/ea/collage/phl/phl_seljoin.jsp?ccompanyID=${param.ccompanyID}">司机加盟</a></span>
		</h3>
		<ul id="carul">
			<%--<li class="clearfix">
			...
			<li class="clearfix">
				<img src="<%=basePath%>images/ea/collage/phl/img_07.png">&lt;%&ndash;<img src="<%=basePath%>images/ea/collage/phl/img_07.png"/>&ndash;%&gt;
				<menu>
			<li>
				车主：吴师傅
			</li>
