...
<html>
	<head>
		...
		<title>五层五清(5L5C)孵化管理平台移动管理系统</title>
...
function register(){
    window.location.href = "<%=basePath%>page/ea/register.jsp?imgLog=1";
}
...
function login(){
    ...
    $('#Login').attr('action', "<%=basePath%>ea/loginwebkit.jspa?");
    document.Login.submit.click();
}
</script>
	</head>
	<body>
	<form name="Login" method="post" id="Login" action=""><input type="submit" name="submit" style="display:none"/><input type="text" value="" name="companyType" style="display:none"/>
	    <div class="main">
		<div class="top">
            <div class="top01">
            	<div class="conter">
            	  <table width="89%" height="252" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td height="52" colspan="4" align="center" class="td01">五层五清(5L5C)孵化管理平台移动管理系统</td>
                    </tr>
                    <tr>
