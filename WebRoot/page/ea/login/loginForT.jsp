...
function login(){
    ...
    if ($("form .error").length) {
     ...
     long=0;
    $('#Login').attr('action', "<%=basePath%>ea/login.jspa?");
    document.Login.submit.click();
}
</script>
	</head>
	<body>
	<form name="Login" method="post" id="Login" action=""><input type="submit" name="submit" style="display:none"/><input type="text" name="companyType" value="00" style="display:none"/>
	    <div class="main">
		<div class="top">
            <div class="top01">
            	<div class="conter">
            	  <table width="89%" height="252" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td height="52" colspan="4" align="center" class="td01">备用[5l5c]平台登录</td>
                    </tr>
                    <tr>
