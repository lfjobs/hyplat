...
.zhengmian {
	background-image: url('<%=basePath%>images/ea/main/zhengpage2.jpg');
...
.fanmian {
	background-image: url('<%=basePath%>images/ea/main/fanmian2.jpg');
	background-position: left;
	width: 230px;
	height: 363px;
	margin-left: 50px;
			...
			<tr>
				<td>
					<div class="zhengmian" id="zhengmiang">
						<table height="360px" width="230px" cellpadding="0"
							cellspacing="0">
							<tr>
				...
				<td>
					<div class="fanmian" id="fanmian">
						<table height="363px" width="230px" cellpadding="0"
							cellspacing="0">
							<tr>
								<td class="biaoti"><br />
								<br />持证须知<br /></td>
							...
							<tr>
								<td align="right"><font
									style="margin-right: 15px; font-weight:bold; font-size:12px"
									id="banbudate">发证日期:<%=str_date1%></font><br/><br/>
								</td>
							</tr>
						</table>
					</div></td>
