...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
     ...
     var basePath = "<%=basePath%>";
		  ...
		  function show(){
		    if (i==0){
		    	window.location.href="<%=basePath%>/page/mobile/activity/activity_publishLogin.jsp";
...
<body style="text-align: center;" onload="show();">
    ...
    <div class="wrapmain">
    	...
    	<table id="rettab" style="width: 360px; height: 350px;padding-top: 20px;">
			<tr>
				<th colspan="2" style="height:50px;font-size: 15px;">注册成功!</th>
			</tr>  
			
			<tr>
			<td height="30">帐&nbsp;&nbsp;&nbsp;&nbsp;号</td><td>
				<span class="ret_td_con" id="ret3">${ret3 }</span>
				<input type="hidden" name="account.accountEmail" id="ret3"value="${ret3 }"/>
			</td>
			</tr> 
			<tr>
			<td height="30">密&nbsp;&nbsp;&nbsp;&nbsp;码</td><td>
				<span class="ret_td_con" id="ret4">${ret4 }</span>
				<input type="hidden" name="account.accountPassword" id="ret4" value="${ret4 }"/>
				<input type="hidden" name="companyType" value="02"/>
			</td>
			</tr> 
			<tr>
