...
<script>
   ...
   function load(){
   	 clearTimeout(t);
   	 pagenumber++;
   	 var url=basePath+"people/manage/sajax_ajaxCompanyAdd.jspa?";
   	 $.ajax({
   		url:url,
   		type:"get",
   		...
   		success:function (data){
   			...
   			if(pageForm!=null&&pageForm.recordCount>0){
   				...
   				for(var i=0;i<list.length;i++){
   					...
   					str.push('<input type="hidden" value="'+s[0]+'"/>');
   					if(s[4]==null||s[4]==''){
   						str.push('<img src="'+basePath+'images/BuildPlatform/xiaotu.png" alt="">')
   					}else{
   						str.push('<img src="'+basePath+s[4]+'" alt="">')
   					}
   				 	
               		str.push('<h4>'+s[1]+'</h4></li>')
   				}				
   			}
