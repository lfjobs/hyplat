...
<div class="content_hidden">
    <div class="content">
        <div class="con login_con">
            <img src="<%=basePath %>images/BuildPlatform/5L5C.png" alt="" class="login_logo">
            <h3>5L5C系统资源平台</h3>
            <form name="loginForm" id="loginForm" method="post">
                <div class="ipt company">
                    <input type="text" placeholder="组织机构" id="institutional" name="companyIdentifier" value="${companyIdentifier }">
                </div>
