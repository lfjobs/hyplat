<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 var date;
	...
	<script
		src="<%=basePath%>js/ea/ccompany/scheduledproduct/scheduledproduct.js"></script>
	<body>
		<form name="scheduledproductform" method="post">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td id="qh_sw" style="width: 10%; margin-left: 5px; height: 611px;" valign="top">
					<div class="qh_gg_nav" style='width:100%'>&nbsp;单据类型</div>
						<div style="position: absolute; width: 130px; overflow: scroll; height: 425px">
