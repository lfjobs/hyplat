...
$(function(){
	...
	$('#save_all').click(function(){
		...
		$("#childrenform").attr("action",basePath + "ea/cdepotmanage/ea_sortChildDepotManage.jspa?pageNumber=${pageNumber}");
		document.childrenform.submit.click();
	});
	$('#goback').click(function(){
	  //   window.parent.location.href=basePath + "ea/cdepotmanage/ea_sortChildDepotManage.jspa?pageNumber=${pageNumber}";
	    parent.document.getElementById("mainframe").src=basePath + "ea/cdepotmanage/ea_getListDepotManageTree.jspa?pageNumber=${pageNumber}&depotID=${depotID}";
	});
});
</script>
</body>
