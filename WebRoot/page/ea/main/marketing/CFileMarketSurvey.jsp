			...
			<table width="100%" cellspacing="0" cellpadding="0" "border="2">
				<tr>
					<td id="qh_sw" style="width: 15%" valign="top">
						<div class="qh_gg_nav">
							&nbsp;
							<span id="frametitle">公司市场调查管理</span>
						...
						<ul id="navigation" style="width: 180px;"
							class="filetree">
							<li>
								<span class="folder" id="tit">公司市场调查管理</span>
								<ul  id="zzgldd">
									<li>
										<span
											class="folder"><a href="<%=basePath%>/ea/cstaff/ea_getListCStaffByCompanyID.jspa?cstaff.status=99" target="admin1">社会人力管理</a></span>
										<ul>
											<li>
