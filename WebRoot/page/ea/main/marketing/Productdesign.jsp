...
<div id="main_main" class="main_main">
			...
			<tr id="${arr[0] }">
				<td>
					<input type="radio" name="a" class="JQuerypersonvalue"
						   value="${arr[0]}" />
					<%--<input type="checkbox" name="a" class="JQuerypersonvalue"
						   value="${arr[0]}" />--%>
				</td>
				<td>
	...
	<c:import url="../../../../page_navigator.jsp">
		<c:param name="actionPath"
				 value="ea/productdesign/ea_getListProductdesign.jspa?pageNumber=${pageNumber}&search=${search}&sdate=${sdate}&edate=${edate}&identifier=${param.identifier}&flexbutton=${param.flexbutton}&ghua=${param.ghua}&fiveClear=${fiveClear}&no=${no}&typeString=${typeString}&devide=${devide}"></c:param>
	</c:import>
</div>
...
<div class="jqmWindow " style="width: 270px; right: 35%; top: 20%"
	...
	<form name="postSearchForm2" id="postSearchForm2" method="post">
		<input type="submit" name="submit" style="display: none"/>
		产品名称${param.identifier}：
		<input name="productDesign.goodsName" style="width:130px;"/>&#160;&#160;&#160;&#160;&#160;
		责任人${param.identifier}：
		<input name="productDesign.staffName" style="width:130px;"/>
		<input type="button" id="toselect2" class="input-button"
			   value=" 查询 " />
	...
	<div id="fabu">
	<input type="hidden" id="isFabu" value="">
	</div>
