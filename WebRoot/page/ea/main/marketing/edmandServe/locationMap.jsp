...
<head>
    ...
    <link rel="stylesheet" href="<%=basePath%>css/ea/edmandServe/locationMap.css"/>
    <style type="text/css">
        #panel {
            position: fixed;
            top: 100px;
...
<header>
    ...
    <div class="div-search">
        <div class="changeCity">全国</div>
        <input type="" id="myInput" placeholder="请输入搜索地址" class="">
        <div class="div-txt">取消</div>
    </div>
</header>
<!-- 地图主体 -->
    ...
    AMap.plugin(['AMap.PlaceSearch', 'AMap.AutoComplete', 'AMap.Geolocation', 'AMap.PlaceSearch', 'AMap.Geocoder'],
        function () {
            ...
            $(document).on('click', ".poibox", function () {
                ...
                address = searchdom[index].address; //地址
