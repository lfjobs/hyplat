					...
					<tr id="${posID}">
                        ...
                        <td>
                            <span id="app" style="display: none;">${app}</span>
                             <span id="siteId" style="display: none;">${siteId}</span>
                             <span id="equipmentNumber" style="display: none;">${equipmentNumber}</span>
                            <span id="hgcode" style="display: none;">${hgcode}</span>
                            <c:choose>
                                <c:when test="${app==''}">不指定</c:when>
                                <c:when test="${app=='01'}">考场练车</c:when>
                                <c:when test="${app=='02'}">停车收费</c:when>
                                <c:when test="${app=='03'}">公司网站</c:when>
                                <c:when test="${app=='04'}">考勤打卡</c:when>
                                <c:when test="${app=='05'}">智能货柜</c:when>
                            </c:choose>
                        </td>
					</tr>
				</s:iterator>
                ...
                <table width="100%" id="addTable">
                    <tr>
                        ...
                        <td><input id="posNum"  style="width:195px"  name="posDevice.posNum" class="posNum"  maxlength="50"/>
                            <input id="posKey"  type="text"  name="posDevice.posKey"  style="display:none;"/>
                            <input id="posID"  type="text"  name="posDevice.posID" style="display:none;"/>
                        </td>
                    ...
                    <tr><td align="right">应用：</td>
                        <td>
                            <select  id = "app" name="posDevice.app"><option value="">不指定</option><option value="01">考场练车</option><option value="02">停车收费</option><option value="03">公司网站</option><option value="04">考勤打卡</option><option value="05">智能货柜</option></select>
                        </td>
                    </tr>
                     <tr class="kclc" style="display:none;"><td align="right">选择场地：</td>
                        <td>
                            <select id = "siteId" name="posDevice.siteId" class="site"></select>
                        </td>
                    </tr>
                     <tr class="kclc" style="display:none;"><td align="right">选择设备：</td>
                        <td>
                            <select  id ="equipmentNumber" class="equip" name="posDevice.equipmentNumber"></select>
                        </td>
                    </tr>
                    <tr class="hgbh" style="display:none;"><td align="right">货柜编号：</td>
                        <td>
                            <select id = "hgbh" name="posDevice.hgcode" class="hg"></select>
                        </td>
                    </tr>
                </table>
                <div align="center">
