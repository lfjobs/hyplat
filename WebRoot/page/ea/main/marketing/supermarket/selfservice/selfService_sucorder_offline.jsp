...
<script src="<%=basePath%>js/ea/marketing/supermarket/selfService_sucorder_offline.js" type="text/javascript"></script>
...
<script>
    ...
    var paymentParams = "${payOffline.params}";
...
<section class="success">
    ...
    <article>
        ...
        <div class="btn">
            ...
            <c:if test='${param.posNum ne null &&param.posNum ne ""}'>
                <a><input type="button" value=" 返回结算首页 " id="backhome"></a>
                <a><input type="button" value=" 返回选择商品 " id="backshop"></a>
            </c:if>
            <c:if test='${param.posNum eq null || param.posNum eq ""}'>
