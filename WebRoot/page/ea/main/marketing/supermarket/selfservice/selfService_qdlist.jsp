...
<head>
    ...
    <script type="text/javascript"
            src="<%=basePath%>js/ea/marketing/supermarket/keyboard/vk_loader.js?vk_layout=CN%20Chinese%20Simpl.%20Pinyin&vk_skin=flat_gray"></script>
    ...
    <script src="<%=basePath%>js/ea/marketing/supermarket/selfService_qdlist.js" type="text/javascript"></script>
    ...
    <script>
        ...
        var token = 0;
        var token1 = 0;
        var  lxType = "${lxType}";//查询类型，0：其他入口进入1：批发商城进入
		$(function(){
            $(".barcode").focus();
...
<section class="comm wet ">
    ...
    <article>
        ...
        <!--头部 end-->
        <!--内容-->
        <form id="form" name="form" class="form1" method="post" target="hidden"
              action="<%=basePath%>ea/sm/ea_payErCode.jspa?posNum=${param.posNum}&ccompanyID=${param.ccompanyID}&companyName=${companyName}">
            ...
            <figure>
                ...
                <ul class="shop">
                    ...
                    <%--<h5 class="name">巧乐兹雪糕草莓口味</h5>--%>
                    <%--<div class="number">--%>
                    <%--<input type="button" value="-" class="min">--%>
                    <%--<input type="text" value="1" class="nub" readonly="readonly">--%>
                    <%--<input type="button" value="+" class="add">--%>
                    <%--</div>--%>
                    <%--<p class="mon" style="display: none;">18.27</p>--%>
                    <%--<p class="money">&yen;<span>18.27</span></p>--%>
                    <%--</li>--%>
                ...
                <div class="btn2">
                    ...
                    <input type="button" value="无码称重" id="wm" style="display: none;">
                </div>
                <div class="btn">

                    <input type="text" value="" placeholder="扫描或手动输入条码" onfocus="onFocus()" onblur="onBlur()" id="ipt"
                           class="barcode" onclick='test(this);'>
        ...
        <%--&lt;%&ndash;<td colspan="2"><input id="btnEnter" type="button" value="确定" ></td>&ndash;%&gt;--%>
        <%--</tr>--%>

        <%--</tbody>--%>
        <%--</table>--%>
        <!--调价弹框-->
        <div class="container div-con-tiaojia" style="display: none;"></div>
        ...
        <div class="div-tiaojia">
            <figure class="figure-tiaojia" id="figure-tiaojia">
                <!--输入密码-->
                <p class="mm-p" style="padding-top: 100px;">请输入调价管理员密码</p>
                <a href="#" class="close"></a>
                <p style="width: 480px;height: 60px;margin: 3% auto 0 auto;position: relative;" class="tiaojia-mm" id="srk">
                    <input type="password" readonly="readonly" class="txtNum jp-s" id="txtNum"/>
                    <i class="i-1"></i>
                    <i class="i-2"></i>
                    <i class="i-3"></i>
                    <i class="i-4"></i>
            ...
            <div style="display: none;" id="sjvalue"></div>
        </div>
                ...
                <ul class="content">
                    ...
                    <li class="right">
                        ...
                        <ul class="con scalemain">
                            ...
                            <li class="weight">
                                <h4>重量：<span><input class="wvalue" type="text" value="0" readonly="readonly">KG</span>
                                </h4>
                            </li>
