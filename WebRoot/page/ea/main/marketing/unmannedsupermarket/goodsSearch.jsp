...
<head>
    ...
    <script src="<%=basePath%>js/ea/unmannedsupermarket/goodsSearch.js" type="text/javascript" charset="utf-8"></script>
</head>
<body>
...
<div class="content_search">
    <section>
        ...
        <a href="#" onclick="javascript:window.history.back();return false;">
            <img src="<%=basePath%>images/unmannedsupermarket/left_jt.png"/></a>
        <input type="search" id="supermarketGoodsName" value="${goodsName}" placeholder="搜索超市商品" autofocus="autofocus"/>
