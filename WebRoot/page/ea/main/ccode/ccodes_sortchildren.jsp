...
$(function(){
	...
	$('#save_all').click(function(){
		...
		$('#childrenID').val(childrenID);
		 $('#childrenform').attr("action","<%=basePath%>ea/ccode/t_ea_sortChildCode.jspa?pageNumber=${pageNumber}");
		document.childrenform.submit.click();
	})
	$('#goback').click(function(){
	   // window.parent.location.href="<%=basePath%>ea/ccode/ea_ccodeManage.jspa?pageNumber=${pageNumber}";
	    parent.document.getElementById("mainframe").src="<%=basePath%>ea/ccode/ea_getCodeListAll.jspa?codeID=${codeID}&pageNumber=${pageNumber}";
	});
