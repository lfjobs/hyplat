...
<link href="<%=basePath%>css/ea/head_min.css" rel="stylesheet"
	type="text/css" />

<link href="<%=basePath%>css/ea/cate_index.css" rel="stylesheet"
	type="text/css" />
<script  type="text/javascript"  src="<%=basePath%>js/ea/tao/select_cate.js"></script>
<script type="text/javascript">
var basePath="<%=basePath%>";
</script>
<style type="text/css">
#globalFuzzyQuery{
font-size:12px;text-indent:24px;list-style-position:inside;list-style-type: decimal;
background-color: #FFFFFF;height: 100%;width:100%;overflow: auto;
}
.glo{
height:30px;background-color:#AEEEEE;}
</style>
</head>
<body>
<body>
	<div id="main">
				...
				<div id="J_CategorySearch" class="category-search"
					...
					<div class="searchbox">
						...
						<input name="q" id="J_SearchKeyWord"  placeholder="请输入关键字"
						class="search-keyword" type="text">
							<button type="button" id="J_SearchButton"
								class="search-submit btn btn-primary">
								<div class="btn-txt">快速找到类目</div>
							</button>
					</div>
				</div>
				<div class="lastused-category  "></div>
				...
				<div class="cate-container" data-spm="1000796">
					<div class="cate-main">
						<div id="cate-cascading">
							<input type="button" class="j_Link" id="J_LinkPrev" value="<<"
							style="position: relative; top: 120px;left: -23px;">
							<input type="button" class="j_Link" id="J_LinkNext" value=">>"
							style="position: relative; top: 120px;left: 876px;">
							<div class="cc-listwrap">
							 	<ol id="J_OlCascadingList" class="cc-list" style="left: 0px;">
									<li class="cc-list-item cs-cateList" tabindex="-1" id="list1" name="1"><div
											class="cc-cbox-filter">
											<input role="textbox" autocomplete="off" class="firstLayer"
												style="width: 176px;" id="0" name="firstLayer">
										</div>
										<div role="tree" class="cc-tree"
											aria-activedescendant="cc-tree-gname449">
											<ul role="listbox" tabindex="-1" hidefocus="-1"
												unselectable="on" class="cc-tree-cont">
												<c:forEach items="${arrayList}" var="l" varStatus="a">
													<li class="cc-tree-group cc-tree-expanded"
													aria-expanded="true" role="treeitem"><div
														class="cc-tree-gname cc-focused cs-type">${l}</div>
													</li>
												</c:forEach>
											</ul>
										</div>
								...
								<ol style="display: none;" id="globalFuzzyQuery"></ol>
							</div>
						</div>
					</div>
				</div>
...
<ul role="listbox" tabindex="-1" hidefocus="-1" unselectable="on" class="cc-cbox-cont" id="cascadeUl" style="display: none;"></ul>
<li class="cc-tree-group cc-tree-expanded" aria-expanded="true" role="treeitem" style="display: none;" id="cascadeLi">
	<div class="cc-tree-gname cc-focused"></div></li>
<ul class="cc-tree-gcont" role="group" style="display: none;" id="ul"></ul>
<li role="treeitem" class="cc-tree-item cc-hasChild-item" style="display: none;" id="li"></li>
<li class="cc-list-item cs-cateList" tabindex="-1"  id="levelMenu" style="display: none;">
	<div class="cc-cbox-filter"><input role="textbox" autocomplete="off" 
	 class="fuzzyQuery"	style="width: 192px;"></div>
	 <div role="combobox" class="cc-cbox" aria-activedescendant="cc-cbox-item723">
	</div></li>
...
"branchApi":"/auction/json/reload_cats.htm?customId=",
...
<div
	class="cateBottom">
	<span
class="cateBtn catePublish cateBtn-disabled"><button
	type="submit"
	hidefocus="true"
	id="J_CatePubBtn"
	disabled="">我已阅读以下规则，现在发布宝贝</button>
</span>
<%-- <span
	id="J_PubLinkWrap"
	class="disabled">
...
class="hidden">
	<a
	href="//upload.taobao.com/auction/spu/search_spu.htm?auction_type=b&amp;auction_id=null&amp;itemNumId=522151583059&amp;isEdit=false">搜索产品</a>
</span>
</span> --%>
</div>
				<div class="agreement">
					<div class="notice">
						<h5>发布须知：</h5>
						淘宝禁止发布侵犯他人知识产权的商品，请确认商品符合知识产权保护的规定
					</div>
					...
					<h5>第五条</h5>
					淘宝，包括淘宝网，域名为 taobao.com；tmall.com(天猫)，域名为 tmall.com；一淘网，域名为
					etao.com。
					<h5>第六条</h5>
					...
					一、查看
					<li><a target="_blank"
						href="//a.taobao.com/detail/2011/12/30/569607/1.php?spm=1.176007.209262.6">旧版《淘宝规则》</a>
					</li>（2011年12月31日前违规适用）
				</div>
				<div style="margin: 0 0 5px;">
					<img width="18" height="18" style="vertical-align: middle;"
						alt="反馈"
						src="//img.alicdn.com/tps/i1/T1TPhsXoRlXXXXXXXX-18-18.png">
						我对类目选择有意见或建议， <a target="_blank"
						href="//ur.taobao.com/survey/view.htm?id=999">跟淘宝说两句</a>
				</div>
	</div>
</body>
</html>
