				...
				<table>
					<tr>
						...
						<td><table border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td >
										<div class="na_back_dh" onclick="document.location.href='<%=basePath%>/ea/cashierbills/ea_getCashierBillsList.jspa?period=01'"><img src="<%=basePath%>images/sytemicon/r5_c3.gif"></img></div>
										<div class="center_a">票据汇总</div></td>
									<td >
										<div class="na_back_dh" onclick="document.location.href='<%=basePath%>/ea/goodscashierdepartment/ea_getProCashierList.jspa?period=01'"><img src="<%=basePath%>images/sytemicon/r5_c5.gif"></img></div>
										<div class="center_a">明细汇总</div></td>
									<td >
										<div class="na_back_dh" onclick="document.location.href='<%=basePath%>/ea/rejectbills/ea_getCashierBillsList.jspa?level=organization'"><img src="<%=basePath%>images/sytemicon/r5_c7.gif"></img></div>
										<div class="center_a">驳回票据汇总</div></td>
									<td >
										<div class="na_back_dh" onclick="document.location.href='<%=basePath%>/ea/archivest/ea_getArchivesList.jspa?tt=z'" align="center">
										<img src="<%=basePath%>images/sytemicon/bumenguidang.png"></img></div>
										<div class="center_a">部门归档管理</div></td>
									<td >
									...
									<td >
										<div class="na_back_dh" onclick="document.location.href='<%=basePath%>/ea/archivest/ea_getCashierBillsList.jspa?tt=z'" align="center">
										<img src="<%=basePath%>images/sytemicon/zichanliushui.png"></img></div>
										<div class="center_a">归档</div></td>
								</tr>
							</table></td>
					</tr>
				</table>
