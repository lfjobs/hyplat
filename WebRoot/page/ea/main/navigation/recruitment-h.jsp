      ...
      <tr>
        <td><table height="90" border="0" align="left" cellpadding="0"
            ...
            <tr>
              ...
              <span style="width: 15px; margin: auto;">面试方式</span></a> </td>
              ...
              <td rowspan="2" align="center"><table border="0" cellspacing="0" cellpadding="0" height="132px">
                  <tr>
                    <td width="40" align="center" valign="top"
											style="background-image: url(<%=basePath%>images/ln01.gif); padding-top: 11px; cursor: pointer"  onClick="document.location.href='<%=basePath%>/page/ea/main/navigation/recruitment-h-1.jsp?'"><table width="90%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                    ...
                    <td width="40" align="center" valign="top"
											style="background-image: url(<%=basePath%>images/ln02.gif); padding-top: 11px; cursor: pointer" onClick="document.location.href='<%=basePath%>/page/ea/main/navigation/recruitment-h-2.jsp?'"><table width="90%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
