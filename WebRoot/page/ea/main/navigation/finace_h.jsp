...
<body>
	<br />
	<table width="90%" cellspacing="0" cellpadding="7" align="center">
		<tr>
		...
		<tr>
			<td><div align="center"></div> <img
				src="<%=basePath%>images/sytemicon/01.png"></img>
				<div>
					<strong>资金申请管理</strong>
				</div></td>
			<td><div class="na_back_img_jt_hx"></div></td>
			<td><div class="na_back_dh" align="center"
					onclick="document.location.href='<%=basePath%>ea/cashapplybills/ea_toCash.jspa?other=other&level=company'">
					<img src="<%=basePath%>images/sytemicon/xianjinshenzhuan.png"></img>
				</div>
				<div class="center_a">现金申转对账管理</div></td>
			<td><div class="na_back_dh" align="center">
					<img src="<%=basePath%>images/sytemicon/weiboshenqing.png"
						onclick="document.location.href='<%=basePath%>ea/cashapplybills/ea_toCash.jspa?weibokuan=weibokuan&level=company'"></img>
				</div>
				<div class="center_a">本公司未拨现金申请</div></td>
			<td><div class="na_back_dh" align="center">
					<img src="<%=basePath%>images/sytemicon/weiboshenqing.png"
						onclick="document.location.href='<%=basePath%>ea/cashapplybills/ea_toCash.jspa?weibokuan=weibokuan&level=company&cother=cother'"></img>
				</div>
				<div class="center_a">其他公司未拨现金申请</div></td>
			<td><div class="na_back_dh" align="center">
					<img src="<%=basePath%>images/sytemicon/yiboshengqing.png"
						onclick="document.location.href='<%=basePath%>ea/cashapplybills/ea_toCash.jspa?other=other&level=company&cother=all'"></img>
				</div>
		...
		<tr>
			<td rowspan="2"><div align="center"></div> <img
			...
			<td>
				<div class="na_back_dh" align="center">
					<img src="<%=basePath%>images/sytemicon/r1_c3.gif"
						onclick="document.location.href='<%=basePath%>/ea/statement/ea_toPage.jspa?zz=00'"></img>
				</div>
		...
		<tr>
			...
			<td>
				<div class="na_back_dh" align="center">
					<img src="<%=basePath%>images/sytemicon/r3_c3.gif"
						onclick="document.location.href='<%=basePath%>/ea/statement/ea_toPage.jspa?zz=01'"></img>
				</div>
			...
			<td>
				...
				<div class="center_a">银行账户管理</div></td>
			--%>
			<td><div class="na_back_dh"
					onclick="document.location.href='<%=basePath%>/ea/beginningbalance/ea_getListIPaddress.jspa?'">
					<img src="<%=basePath%>images/sytemicon/xiangmufeiyongguanli.png"></img>
				</div>
				<div class="center_a">设置期初余额</div></td>
		</tr>
		...
		<tr>
			...
			<td><div class="na_back_img"
					onclick="document.location.href='<%=basePath%>/ea/splitgoodsbill/ea_CsearchGood.jspa?zz=09&level=company&sztype=s'"></div>
		...
		<tr>
			...
			<td><div class="na_back_img"
					onclick="document.location.href='<%=basePath%>/ea/splitgoodsbill/ea_CsearchGood.jspa?zz=07&level=company&sztype=s'"></div>
		...
		<tr>
			...
			<td><div class="na_back_img"
					onclick="document.location.href='<%=basePath%>/ea/splitgoodsbill/ea_CsearchGood.jspa?zz=08&level=company&sztype=s'"></div>
		...
		<tr>
			...
			<td>
				<div class="na_back_dh"
					onclick="document.location.href='<%=basePath%>/page/ea/main/navigation/finace_m.jsp'"
					align="center">
					<img src="<%=basePath%>images/sytemicon/yanhuoguanli.png"></img>
				</div>
				<div class="center_a">总账管理</div>
			...
			<td>
				<div class="na_back_dh"
					onclick="document.location.href='<%=basePath%>/page/ea/main/navigation/finace_gs.jsp'"
					align="center">
		...
		<%--<tr>
			<td rowspan="2"><div class="na_back_img_jt_hx"></div>
			</td>
			<td><div align="center"></div> <img
				src="<%=basePath%>images/sytemicon/04.png"></img>
				<div class="center">
					<strong>银行帐管理</strong>
				</div>
			</td>
