							...
							<td>
								<table border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td><div class="na_back_img"
											onclick="document.location.href='<%=basePath%>/ea/publicreceipts/ea_getListRewardPunishment.jspa?type=c'">
											</div><div class="center_a">奖罚单管理</div>
										</td>
										<td><div class="na_back_img"
											onclick="document.location.href='<%=basePath%>ea/documentsummary/ea_getSummaryDocList.jspa?module=doc&type=company&date=Math.random()'">
