				...
				<td>
					<table height="90" border="0" align="left" cellpadding="0"
						...
						<tr>
							<td width="98" rowspan="2" align="center">
								<a><img width="50" height="50" border="0"
										src="<%=basePath%>images/04.gif" /> <br /> 采购管理</a>
							</td>
							<td width="80" height="62" align="center">
								<a href="#"><img src="<%=basePath%>images/jiatou_01.gif"
										width="56" height="51" border="0" /> </a>
							...
							<td rowspan="2" align="center">
								<table border="0" cellspacing="0" cellpadding="0" height="132px">
									<tr>
										...
										<td width="40" align="center" valign="top"
											style="background-image: url(<%=basePath%>images/dl01.gif); padding-top: 11px; cursor: pointer" onclick="document.location.href='<%=basePath%>/ea/purchase/ea_getChooseWarehousingList.jspa'">
											<table width="90%" border="0" cellspacing="0" cellpadding="0">
												<tr>
													<td height="85px" align="center" valign="top">
														<div style="width: 15px; margin: auto;">
									...
									<tr>
										...
										<td rowspan="2" align="center">
											<table border="0" cellspacing="0" cellpadding="0"
												...
												<tr>
													<td width="40" align="center" valign="top"
														style="background-image: url(<%=basePath%>images/dl01.gif); padding-top: 11px; cursor: pointer" onclick="document.location.href='<%=basePath%>/ea/purchase/ea_getWareManagementList.jspa?type=02'">
													...
													<td width="40" align="center" valign="top"
														style="background-image: url(<%=basePath%>images/dl01.gif); padding-top: 11px; cursor: pointer" onclick="document.location.href='<%=basePath%>/ea/purchase/ea_getInventoryManagementList.jspa?'">
														<table width="90%" border="0" cellspacing="0"
															cellpadding="0">
															<tr>
																<td height="85px" align="center" valign="top">
						...
						<tr>
							...
							<td rowspan="2" align="center">
								<table border="0" cellspacing="0" cellpadding="0" height="132px">
									<tr>
										<td width="40" align="center" valign="top"
											style="background-image: url(<%=basePath%>images/dl01.gif); padding-top: 11px; cursor: pointer" onclick="document.location.href='<%=basePath%>/ea/purchase/ea_getWareManagementList.jspa?type=03'">
											<table width="90%" border="0" cellspacing="0" cellpadding="0">
												<tr>
													<td height="85px" align="center" valign="top">
														<div style="width: 15px; margin: auto;">
				...
				<td>
					<table height="90" border="0" align="left" cellpadding="0"
						...
						<tr>
							<td width="98" rowspan="2" align="center">
								<a><img width="50" height="50" border="0"
										src="<%=basePath%>images/04.gif" /> <br /> 报表中心</a>
							</td>
							<td width="80" height="62" align="center">
								<a href="#"><img src="<%=basePath%>images/jiatou_01.gif"
										width="56" height="51" border="0" />
