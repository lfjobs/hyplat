...
var b=true;
	...
	function baobiao(i){
		var urlaa='';
		if(i=='1'){
			urlaa='<%=basePath%>/ea/splitbill/ea_toSprins.jspa?level=allCompany&zz=06';
		}else if(i=='2'){
			urlaa='<%=basePath%>/ea/splitbill/ea_toSprins.jspa?level=allCompany&zz=07';
		}else if(i=='3'){
			urlaa='<%=basePath%>
	/ea/splitbill/ea_toSprins.jspa?level=allCompany&zz=07';
		}
		window.open(urlaa);
...
<body>
	...
	<table width="90%" cellspacing="0" cellpadding="5" align="center">
		...
		<tr>
			...
			<td><div class="na_back_img_jt_hx"></div> <!-- <td><div class="na_back_img_jt_js"></div> -->
			</td>
		...
		<tr>
			...
			<td><div class="na_back_dh" align="center"
					onclick="document.location.href='<%=basePath%>ea/cashapplybills/ea_toCash.jspa?other=other&level=allCompany'">
					<img src="<%=basePath%>images/sytemicon/xianjinshenzhuan.png"></img>
				</div>
				<div class="center_a">现金申转对账管理</div></td>
			<td><div class="na_back_dh" align="center"
					onclick="document.location.href='<%=basePath%>ea/cashapplybills/ea_toCash.jspa?weibokuan=weibokuan&level=allCompany'">
					<img src="<%=basePath%>images/sytemicon/weiboshenqing.png"></img>
				</div>
				<div class="center_a">未拨现金申请</div></td>
			<td><div class="na_back_dh" align="center"
					onclick="document.location.href='<%=basePath%>ea/cashapplybills/ea_toCash.jspa?other=other&level=allCompany&cother=all'">
		...
		<tr>
			...
			<td>
				<div class="na_back_dh" align="center"
					onclick="document.location.href='<%=basePath%>/ea/statement/ea_toSummaryPage.jspa?zz=00'">
		...
		<tr>
			...
			<td>
				<div class="na_back_dh" align="center"
					onclick="document.location.href='<%=basePath%>/ea/statement/ea_toSummaryPage.jspa?zz=01'">
			...
			<td>
				<div align="center" class="na_back_dh"
					onclick="document.location.href='<%=basePath%>/ea/dockingbank/ea_showDockingBankList.jspa'">
		...
		<tr>
			...
			<!-- <td rowspan="3"><div class="na_back_img_jt_xs"></div> -->
			</td>
			...
			<td><div class="na_back_img"
					onclick="document.location.href='<%=basePath%>/ea/splitgoodsbill/ea_AsearchGood.jspa?zz=09&level=allCompany&sztype=s'"></div>
		...
		<tr>
			...
			<td><div class="na_back_img"
					onclick="document.location.href='<%=basePath%>/ea/splitgoodsbill/ea_AsearchGood.jspa?zz=07&level=allCompany&sztype=s'"></div>
		...
		<tr>
			...
			<td><div class="na_back_img"
					onclick="document.location.href='<%=basePath%>/ea/splitgoodsbill/ea_AsearchGood.jspa?zz=08&level=allCompany&sztype=s'"></div>
		...
		<tr>
			...
			<td>
				<div class="na_back_dh" align="center"
					onclick="document.location.href='<%=basePath%>/ea/warehousing/ea_getInventoryManagementList.jspa?'">
					<img src="<%=basePath%>images/sytemicon/kucunguanli.png"></img>
				</div>
				<div class="center_a">库存管理</div>
			</td>
			<td><div class="na_back_dh" align="center"
					onclick="document.location.href='<%=basePath%>/ea/break/ea_getbreakList.jspa?'">
					<img src="<%=basePath%>images/sytemicon/baosunguanli.png"></img>
				</div>
				<div>报损管理</div></td>
