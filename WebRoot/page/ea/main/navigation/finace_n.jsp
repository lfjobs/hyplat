		...
		<tr>
			<td width="120" ">
				...
				<td><table border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="110">
								<div class="na_back_img" onclick="document.location.href='<%=basePath%>/page/ea/main/finance/invoicing/voucher/csubejst_manger.jsp'"></div>
								<div class="center_a">科目期初管理</div></td>
							<td width="110">
								<div class="na_back_img" onclick=""></div>
								<div class="center_a">物品管理</div></td>
						</tr>
					</table>
			</td>
		</tr>
		<tr>
			<td width="120" >
				...
				<td><table border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="110">
								<div class="na_back_img" onclick="document.location.href='<%=basePath%>/ea/voucher/ea_getVoucherList.jspa?aa=00'"></div>
								<div class="center_a" >凭证录入</div></td>
							<td width="110">
								<div class="na_back_img" onclick="document.location.href='<%=basePath%>/ea/voucher/ea_getVoucherList.jspa?aa=01'"></div>
								<div class="center_a">凭证审核</div></td>
							<td width="110">
								<div class="na_back_img" onclick="document.location.href='<%=basePath%>/ea/voucher/ea_getVoucherList.jspa?aa=02'"></div>
								<div class="center_a">凭证记账</div></td>
							<td width="110">
								<div class="na_back_img" onclick="document.location.href='<%=basePath%>/page/ea/main//finance/invoicing/voucher/voucher_jie.jsp'"></div>
								<div class="center_a">期末月结账</div></td>
						</tr>
					</table>
			</td>
		</tr>
