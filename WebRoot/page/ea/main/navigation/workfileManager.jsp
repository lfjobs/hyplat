			...
			<table width="100%" cellspacing="0" cellpadding="0" "border="2">
				<tr>
					<td id="qh_sw" style="width: 15%" valign="top">
						<div class="qh_gg_nav">
							&nbsp;
							<span id="frametitle">办公资料管理</span>
						...
						<ul id="navigation" style="width: 180px;"
							class="filetree">
											...
											<li>
												<a href="<%=basePath%>ea/fileManage/ea_getaFileManageList.jspa?type=1" target="admin1"><span
													class="file">个人资料管理</span> </a>
											</li>
											<li>
												<a  href="<%=basePath%>ea/fileManage/ea_getaFileManageList.jspa?type=2" target="admin1"><span
													class="file">公共资料管理</span> </a>
											</li>
											<li>
												<a  href="<%=basePath%>ea/corporationPhoto/ea_getCorporationPhotoList.jspa?" target="admin1"><span
													class="file">图片管理</span> </a>
											</li>
											
											<li>
												<a target="admin1"><span
													class="file" id="unex">视频管理</span></a>
											</li>
											<li>
												<a target="admin1"><span
													class="file">ppt管理</span> </a>
											</li>
											
											<li>
												<a target="admin1"><span
													class="file" id="unex">设计图管理</span></a>
											</li>
					...
					<td style="width: 85%;" valign="top">
						<iframe  src="<%=basePath%>ea/fileManage/ea_getaFileManageList.jspa?type=1" style="margin:0px;width:100%;height:560px;" name="admin1" scrolling="no" frameBorder="0"></iframe>
					</td>
				</tr>
			</table>
		</div>
