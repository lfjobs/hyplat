      ...
      <tr>
        <td><table height="90" border="0" align="left" cellpadding="0"
            ...
            <tr>
              ...
              <span style="width: 15px; margin: auto;">企业宣传</span></a> </td>
              ...
              <td rowspan="2" align="center"><table border="0" cellspacing="0" cellpadding="0" height="132px">
                  <tr>
                    <td width="40" align="center" valign="top"
                        ...
                        <tr>
                          <td height="85px" align="center" valign="top"><div style="width: 15px; margin: auto;">视频宣传</div></td>
                        </tr>
                        <tr>
                    ...
                    <td width="40" align="center" valign="top"
                        ...
                        <tr>
                          <td height="85px" align="center" valign="top"><div style="width: 15px; margin: auto;">画册宣传</div></td>
                        </tr>
                        <tr>
                    ...
                    <td width="40" align="center" valign="top"
											style="background-image: url(<%=basePath%>images/ln02.gif); padding-top: 11px; cursor: pointer" onclick="document.location.href='<%=basePath%>/page/ea/main/navigation/recruitment-i-1.jsp?'"><table width="90%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td height="85px" align="center" valign="top"><div style="width: 15px; margin: auto;">演讲宣传</div></td>
                        </tr>
                        <tr>
