                                ...
                                <ul id="zzgldd">
                                    ...
                                    <li>
                                        <span class="folder" id="kczgl">库存账管理</span>
                                         <ul>
	                                    <li>
	                                        <a href="<%=basePath%>/ea/purchase/ea_getinspectList.jspa" target="mainframe">
                                       	 <span class="file" id="yhgl">验货管理</span></a>
	                                    </li>
	                                    <li>
	                                        <a href="<%=basePath%>/page/ea/main/navigation/finace_storage.jsp" target="mainframe">
                                       	 <span class="file" id="rkgl">入库管理</span></a>
	                                    </li>
	                                     <li>
	                                        <a href="<%=basePath%>/page/ea/main/navigation/finace_out.jsp" target="mainframe">
                                       	 <span class="file" id="ckgl">出库管理</span></a>
	                                    </li>
	                                     <li>
	                                        <a href="<%=basePath%>/ea/warehousing/ea_getInventoryManagementList.jspa?" target="mainframe">
                                       	 <span class="file" id="kcgl">库存管理</span></a>
	                                    </li>
	                                    <li>
	                                        <a href="<%=basePath%>/ea/break/ea_getbreakList.jspa?" target="mainframe">
                                    ...
                                    <li>
	                                    ...
	                                    <li>
	                                        <a href="<%=basePath%>/ea/splitbill/ea_getBillsDetailList.jspa?dtype=asset&level=allCompany" target="mainframe">
