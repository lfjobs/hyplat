                        ...
                        <td ><div class="na_back_img_jt_hx"></div></td>     
                            <td><table class="d">
                                    <tr>
                                        ...
                                        <td >
                                        <div class="na_back_img"  onclick="document.location.href='<%=basePath%>/ea/splitbill/ea_toPage2.jspa?level=staff'"></div>
                                        <div class="center_a">收入支出余额管理</div></td>                                     
                                         <td >
                                        <div class="na_back_img" onclick="document.location.href='<%=basePath%>/ea/pbeginning/ea_getList.jspa'"></div>
                                        <div class="center_a">设置个人期初余额</div></td>         
                                    </tr>
                                </table></td>
                    </tr>
                </table>
