  ...
  <body>
    ...
    <tr>
    		<td><div class="na_back_img"  onclick="document.location.href='<%=basePath%>/ea/ccode/ea_ccodeManage.jspa?basic=scode20141029rnzhjs7ap60000000004'"></div>
				<div class="center_a"><strong>项目元素管理</strong></div>
			</td>
			<td><div class="na_back_img" onclick="document.location.href='<%=basePath%>/ea/ccode/ea_ccodeFive.jspa?codeID=scode20141028whpjevz6ge0000000009'"></div>
				<div  class="center_a"><strong>人事项目元素</strong></div>
			</td>
			<td>
				...
				<div  class="center_a"><strong>办公室项目元素</strong></div>
			</td>
			<td>
				...
				<div  class="center_a"><strong>财务项目元素</strong></div>
			</td>
			<td>
				...
				<div  class="center_a"><strong>生产项目元素</strong></div>
			</td>
			<td>
				...
				<div  class="center_a"><strong>营销项目元素</strong></div>
			</td>
    </tr>
    </table>
    </div>
