                                ...
                                <ul>
                                    <li>
                                        <span class="folder" id="szpz">收支凭证</span>
                                         <ul>
	                                    <li>
	                                        <a href="<%=basePath%>/ea/splitbillgroup/ea_getCashierBillsList.jspa?zz=21&sztype=s'" target="mainframe">
                                       	 <span class="file" id="szpzgl">收支凭证管理</span></a>
	                                    </li>
	                                    <li>
	                                        <a href="<%=basePath%>/ea/splitgoodsbill/ea_AsearchGood.jspa?zz=09&level=allCompany&sztype=s" target="mainframe">
                                    ...
                                    <li>
	                                    ...
	                                    <li>
	                                        <a href="<%=basePath%>/ea/splitgoodsbill/ea_AsearchGood.jspa?zz=07&level=allCompany&sztype=s" target="mainframe">
                                    ...
                                    <li>
	                                    ...
	                                    <li>
	                                        <a href="<%=basePath%>/ea/splitgoodsbill/ea_AsearchGood.jspa?zz=08&level=allCompany&sztype=s" target="mainframe">
