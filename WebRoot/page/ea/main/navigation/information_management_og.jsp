							...
							<td>
								<table border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td width="110" align="center">
											<div class="na_back_img" onclick="document.location.href='<%=basePath%>/ea/addressIpGroup/ea_getAddressIpGroupList.jspa?'"></div>
                      						<div class="center_a"><span>IP地址管理</span></div>
										</td>
										<td width="110" align="center">
											<div class="na_back_img" onclick="document.location.href='<%=basePath%>/ea/telmessage/ea_goMessageIndex.jspa?type=group&orgDetail=office'"></div>
                      						<div class="center_a"><span>短信管理</span></div>
										</td>
										<td width="110" align="center">
											<div class="na_back_img" onclick="document.location.href='<%=basePath%>/ea/qqgroup/ea_getQqGroupList.jspa?'"></div>
                      						<div class="center_a"><span>QQ管理</span></div>
										</td>
										<td width="110" align="center">
											<div class="na_back_img" onclick="document.location.href='<%=basePath%>/ea/netdiskgroup/ea_getNetDiskGroupList.jspa?'"></div>
                      						<div class="center_a"><span>网络硬盘管理</span></div>
										</td>
										<td width="110" align="center">
											<div class="na_back_img" onclick="document.location.href='<%=basePath%>/ea/domainnamegroup/ea_getListDomainnameGroup.jspa?'"></div>
                      						<div class="center_a"><span>域名管理</span></div>
										</td>
										<td width="110" align="center">
											<div class="na_back_img" onclick="document.location.href='<%=basePath%>/ea/networkfaxgroup/ea_getListNetworkFaxGroup.jspa?'"></div>
                      						<div class="center_a"><span>网络传真管理</span></div>
										</td>
										<td width="110" align="center">
											<div class="na_back_img" onclick="document.location.href='<%=basePath%>/page/ea/main/telrec/telMain.jsp?type=group'"></div>
							...
							<td>
								<table border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td width="110" align="center">
											<div class="na_back_img" onclick="document.location.href='<%=basePath%>/ea/schedulegroup/ea_getScheduleGroupList.jspa?'"></div>
						...
						<tr>
							...
							<td>
								<table border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td width="110" align="center">
											<div class="na_back_img" onclick="document.location.href='<%=basePath%>/ea/networkgroup/ea_getNetWorkGroup.jspa?'"></div>
                      						<div class="center_a"><span>网络加密管理</span></div>
										</td>
										<td width="110" align="center">
											<div class="na_back_img" onclick="document.location.href='<%=basePath%>/ea/netWorkAnViGroup/ea_getNetWorkAnViGroupList.jspa?'"></div>
