			...
			<table width="100%" cellspacing="0" cellpadding="0" "border="2">
				<tr>
					<td id="qh_sw" style="width: 15%" valign="top">
						<div class="qh_gg_nav">
							&nbsp;
							<span id="frametitle">财务数据设置</span>
						...
						<ul id="navigation" style="width: 200px;"
							class="filetree">
							<li>
								<span class="folder" id="sjsz">财务数据设置</span>
								<ul>
										   ...
										   <li>
											...
											<li>
												<a href="javascript:void(0);"  target="mainframe" >
												<span class="file" id="cksz">仓库设置</span></a>
											</li>
											<li>
												<a href="javascript:void(0);" target="mainframe" >
												<span class="file" id="wldw">往来单位</span></a>
											</li>
											<li>
												<a href="javascript:void(0);"  target="mainframe" >
												<span class="file" id="wlgr">往来个人</span></a>
											</li>
											
											<li>
												<a href="javascript:void(0);"  target="mainframe" >
												<span class="file" id="qcsz">期初设置</span></a>
											</li>
								</ul>
							</li>
						</ul>
