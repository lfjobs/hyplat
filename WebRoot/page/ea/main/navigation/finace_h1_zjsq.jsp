					...
					<td id="qh_sw" style="width: 15%" valign="top">
						...
						<ul id="navigation" style="width: 200px;"
							...
							<li>
								...
								<ul>
									<li>
										<a href="<%=basePath%>ea/cashapplybills/ea_toCashList.jspa?other=other&level=company" target="mainframe">
										<span class="file" id="tit">资金审转对账管理</span></a>
									</li>
									<li>
										<a href="<%=basePath%>ea/cashapplybills/ea_toCashList.jspa?weibokuan=weibokuan&level=company" target="mainframe">
										<span class="file" id="tit">公司未拨现金申请</span></a>
									</li>
									<%-- <li>
										<a href="<%=basePath%>ea/cashapplybills/ea_toCashList.jspa?weibokuan=weibokuan&level=company&cother=cother" target="mainframe">
										<span class="file" id="tit">其他公司未拨现金申请</span></a>
									</li> --%>
									<li>
										<a href="<%=basePath%>ea/cashapplybills/ea_toCashList.jspa?other=other&level=company&cother=all" target="mainframe">
