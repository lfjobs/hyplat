 ...
 window.location.href= action;
  ...
  <tr>
    ...
    <td rowspan="2" align="center"><table border="0" cellspacing="0" cellpadding="0" height="132px">
      <tr>
        <td width="40" align="center" valign="top" style="background-image:url(<%=basePath%>images/dl01.gif); padding-top:11px; cursor:pointer"  onclick="document.location.href='<%=basePath%>/ea/cashierbillsclassret/ea_getCashierList.jspa?BType=00'"><table width="90%" border="0" cellspacing="0" cellpadding="0">
            <tr>
        ...
        --%><td width="40" align="center" valign="top" style="background-image:url(<%=basePath%>images/lv01.gif); padding-top:11px; cursor:pointer"  onclick="document.location.href='<%=basePath%>/ea/cashierbillsclassret/ea_getCashierList.jspa?BType=01'"><table width="90%" border="0" cellspacing="0" cellpadding="0">
            <tr>
        ...
        <td width="40" align="center" valign="top" style="background-image:url(<%=basePath%>images/lv01.gif); padding-top:11px; cursor:pointer"  onclick="document.location.href='<%=basePath%>/ea/cashierbillsclassret/ea_getCashierList.jspa?BType=02'"><table width="90%" border="0" cellspacing="0" cellpadding="0">
            <tr>
        ...
        <td width="40" align="center" valign="top" style="background-image:url(<%=basePath%>images/lv01.gif); padding-top:11px; cursor:pointer"  onclick="document.location.href='<%=basePath%>/ea/cashierbillsclassret/ea_getCashierList.jspa?BType=03'"><table width="90%" border="0" cellspacing="0" cellpadding="0">
            <tr>
        ...
        <td width="40" align="center" valign="top" style="background-image:url(<%=basePath%>images/lv01.gif); padding-top:11px; cursor:pointer"  onclick="document.location.href='<%=basePath%>/ea/cashierbillsclassret/ea_getCashierList.jspa?BType=04'"><table width="90%" border="0" cellspacing="0" cellpadding="0">
            <tr>
        ...
        <td width="40" align="center" valign="top" style="background-image:url(<%=basePath%>images/lv01.gif); padding-top:11px; cursor:pointer"  onclick="document.location.href='<%=basePath%>/ea/cashierbillsclassret/ea_getCashierList.jspa?BType=05'"><table width="90%" border="0" cellspacing="0" cellpadding="0">
            <tr>
        ...
        <td width="40" align="center" valign="top" style="background-image:url(<%=basePath%>images/lv01.gif); padding-top:11px; cursor:pointer" onclick="document.location.href='<%=basePath%>/ea/cashierbillsclassret/ea_getCashierList.jspa?BType=06'" ><table width="90%" border="0" cellspacing="0" cellpadding="0">
            <tr>
        ...
        <td width="40" align="center" valign="top" style="background-image:url(<%=basePath%>images/lv01.gif); padding-top:11px; cursor:pointer" onclick="document.location.href='<%=basePath%>/ea/cashierbillsclassret/ea_getCashierList.jspa?BType=07'" ><table width="90%" border="0" cellspacing="0" cellpadding="0">
            <tr>
        ...
        <td width="40" align="center" valign="top" style="background-image:url(<%=basePath%>images/lv01.gif); padding-top:11px; cursor:pointer"  onclick="document.location.href='<%=basePath%>/ea/cashierbillsclassret/ea_getCashierList.jspa?BType=08'"><table width="90%" border="0" cellspacing="0" cellpadding="0">
            <tr>
        ...
        <td width="40" align="center" valign="top" style="background-image:url(<%=basePath%>images/lv01.gif); padding-top:11px; cursor:pointer"  onclick="document.location.href='<%=basePath%>/ea/cashierbillsclassret/ea_getCashierList.jspa?BType=09'"><table width="90%" border="0" cellspacing="0" cellpadding="0">
            <tr>
  ...
  <tr>
    ...
    <td rowspan="2" align="center"><table border="0" cellspacing="0" cellpadding="0" height="132px">
      <tr>
        ...
        <td width="40" align="center" valign="top" style="background-image:url(<%=basePath%>images/lv01.gif); padding-top:11px; cursor:pointer" onclick="document.location.href='<%=basePath%>/page/ea/main/finance/production/csubejsts/csubejst_manger.jsp'"><table width="90%" border="0" cellspacing="0" cellpadding="0">
            <tr>
        ...
        <td width="40" align="center" valign="top" style="background-image:url(<%=basePath%>images/lv01.gif); padding-top:11px; cursor:pointer" onclick="document.location.href='<%=basePath%>ea/documentcommon/ea_showDocumentModule.jspa?module=finace&date=Math.random()'"><table width="90%" border="0" cellspacing="0" cellpadding="0">
            <tr>
  ...
  <tr>
    ...
    <td rowspan="2" align="center"><table border="0" cellspacing="0" cellpadding="0" height="132px">
      <tr>
        ...
        <td width="40" align="center" valign="top" style="background-image:url(<%=basePath%>images/lv01.gif); padding-top:11px; cursor:pointer" onclick="document.location.href='<%=basePath%>/ea/cashiersummarycompany/ea_getCashierList.jspa'"><table width="90%" border="0" cellspacing="0" cellpadding="0">
            <tr>
        ...
        <td width="40" align="center" valign="top" style="background-image:url(<%=basePath%>images/lv01.gif); padding-top:11px; cursor:pointer" onclick="document.location.href='<%=basePath%>/ea/goodscashier/ea_getProCashierList.jspa'"><table width="90%" border="0" cellspacing="0" cellpadding="0">
            <tr>
        ...
        <td width="40" align="center" valign="top" style="background-image:url(<%=basePath%>images/lv01.gif); padding-top:11px; cursor:pointer" onclick="document.location.href='<%=basePath%>/ea/archivest/ea_getArchivesList.jspa?tt=x'" ><table width="90%" border="0" cellspacing="0" cellpadding="0">
            <tr>
        ...
        <td width="40" align="center" valign="top" style="background-image:url(<%=basePath%>images/lv01.gif); padding-top:11px; cursor:pointer" onclick="document.location.href='<%=basePath%>/page/ea/main/navigation/financial_affairs_a.jsp?'"><table width="90%" border="0" cellspacing="0" cellpadding="0">
            <tr>
    ...
    <td rowspan="2" align="center"><table border="0" cellspacing="0" cellpadding="0" height="132px">
      <tr>
       ...
       <td width="40" align="center" valign="top" style="background-image:url(<%=basePath%>images/lv01.gif); padding-top:11px; cursor:pointer"  ><table width="90%" border="0" cellspacing="0" cellpadding="0">
        ...
        <td width="40" align="center" valign="top" style="background-image:url(<%=basePath%>images/lv01.gif); padding-top:11px; cursor:pointer" onclick="document.location.href='<%=basePath%>/ea/goodsmanage/ea_getAssetsWaterList.jspa'"><table width="90%" border="0" cellspacing="0" cellpadding="0">
            <tr>
