		...
		<div class="main_main">
			<table width="100%" cellspacing="0" cellpadding="0" border="0">
				...
				<td id="qh_sw" style="width: 15%" valign="top">
					<div class="qh_gg_nav">
						&nbsp; <span id="frametitle">督查(审核)管理</span>
							...
							<ul>
								<li><span class="folder">人事督查审核管理</span>
									<ul>
										...
										<li><a target="mainframe"  href="<%=basePath%>/ea/reward/ea_getStaffReward.jspa?ott=01"><span class="file">人事奖励管理</span> </a>
										</li>
										<li><a target="mainframe"  href="<%=basePath%>/ea/attendextleave/ea_getExtleaveExam.jspa?"><span class="file">加班请假审核管理</span> </a>
										</li>
									</ul>
								</li>
								<li><span class="folder">办公室督查审核管理</span>
									<ul>
										<li><a target="mainframe"  ><span class="file">办公室督查管理</span><!-- href="<%=basePath%>/ea/responsible/ea_getResponsibleList.jspa" -->
										</a>
										</li>
										<li><a target="mainframe"  href="<%=basePath%>/ea/reward/ea_getStaffReward.jspa?ott=02"><span class="file">办公室奖励管理</span>
										</a>
										</li>
									</ul></li>
								...
								<li><span class="folder">财务督查审核管理</span>
									<ul>
										<li><a  target="mainframe"   ><span
												class="file">会计审核管理</span><!-- href="<%=basePath%>/ea/accountant/ea_getAccountantList.jspa" -->
										</a>
										</li>
										<li><a target="mainframe" ><span class="file">出纳审核管理</span> </a><!-- href="<%=basePath%>ea/cashier/ea_getCashierList.jspa" -->
										</li>
										<li><a target="mainframe" href="<%=basePath%>/ea/archivest/ea_getCashierBillsList.jspa?tt=z'"><span class="file">办公室归档管理</span> </a>
										</li>
									</ul>
								</li>
