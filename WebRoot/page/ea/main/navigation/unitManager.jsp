						...
						<ul id="navigation" style="width: 180px;"
							class="filetree">
							          <li><span class="folder">生产管理</span>
							            <ul>
							            <li>
							              <a href="<%=basePath%>page/ea/main/navigation/product_procedure.jsp?fiveClear=2"><span class="file">办公室生产</span></a>
							            </li>
											...
											<li>
												<a target="admin1"><span
													class="file">企业所属单位管理</span> </a>
											</li>
											<li>
												<a  target="admin1"><span
													class="file">经营范围</span> </a>
											</li>
											<li>
												<a  target="admin1"><span
													class="file">企业证件管理</span> </a>
											</li>
											
											<li>
												<a  target="admin1"><span
													class="file" id="unex">企业资质评定管理</span></a>
											</li>
											<li>
												<a target="admin1" href="<%=basePath%>ea/contactcompany/ea_getListContactCompany.jspa?flag=web&gtype=office"><span
													class="file">公司网站</span> </a>
											</li>
