                                ...
                                <ul id="zzgldd">
                                    <li>
                                        ...
                                        <ul id="zzul">
                                            <li>
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="#" onclick="tonclick('kmqcgl')">
                                                        <span class="file" id="kmqcgl">科目期初管理</span></a>
                                                    </li>
                                                     <li>
                                                        <a href="#" onclick="tonclick('wpgl')">
                                            ...
                                            <li>
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="#" onclick="tonclick('zzgl')">
                                                        <span class="file" id="zzgl">总账管理</span></a>
                                                    </li>
                                                    <li>
                                                        <a href="#" onclick="tonclick('mxzgl')">
                                                        <span class="file" id="mxzgl">明细账管理</span></a>
                                                    </li>
                                                    <li>
                                                        <a href="#" onclick="tonclick('xsz')">
                                                        <span class="file" id="xsz">序时账</span></a>
                                                    </li>
                                                    <li>
                                                        <a href="#" onclick="tonclick('kmyeb')">
                                    ...
                                    <%--<li>
                                        <span class="folder" id="kczgl">库存账管理</span>
                                         <ul>
                                        <li>
	                                        <a href="#" onclick="tonclick('shgl')">
                                       	 <span class="file" id="shgl">收货管理</span></a>
	                                    </li>
	                                    <li>
	                                        <a href="#" onclick="tonclick('yhgl')">
                                       	 <span class="file" id="yhgl">验货管理</span></a>
	                                    </li>
	                                    <li>
	                                        <a href="#" onclick="tonclick('rkgl')">
                                       	 <span class="file" id="rkgl">入库管理</span></a>
	                                    </li>
	                                     <li>
	                                        <a href="#" onclick="tonclick('ckgl')">
                                       	 <span class="file" id="ckgl">出库管理</span></a>
	                                    </li>
	                                     <li>
	                                        <a href="#" onclick="tonclick('kcgl')">
                                       	 <span class="file" id="kcgl">库存管理</span></a>
	                                    </li>
	                                    <li>
	                                        <a href="#" onclick="tonclick('bsgl')">
                                       	 <span class="file" id="bsgl">报损管理</span></a>
	                                    </li>
                                                 <li>
                                                    <a href="#" onclick="tonclick('chhs')">
                                    ...
                                    <li>
                                        <span class="folder" id="ysyfgl">应付应收管理</span>
                                         <ul>
                                        <li>
                                            <a href="#" onclick="tonclick('ysgl')">
                                         <span class="file" id="ysgl">应收管理</span></a>
                                        </li>
                                        <li>
                                            <a href="#" onclick="tonclick('yfgl')">
                                         <span class="file" id="yfgl">应付管理</span></a>
                                        </li>
                                         <li>
                                            <a href="#" onclick="tonclick('ysmx')">
                                         <span class="file" id="ysmx">应收明细</span></a>
                                        </li>
                                         <li>
                                            <a href="#" onclick="tonclick('yfmx')">
                                    ...
                                    <li>
                                        ...
                                        <li>
                                         ...
                                         <li>
                                            <a href="#" onclick="tonclick('gzbb')">
                                         <span class="file" id="gzbb">工资报表</span></a>
                                        </li>
                                         <li>
                                            <a href="#" onclick="tonclick('gzft')">
                                         <span class="file" id="gzft">工资分摊</span></a>
                                        </li>
                                        <li>
                                            <a href="#" onclick="tonclick('jjgz')">
                                    ...
                                    <li>
                                        <span class="folder" id="xsgl">销售管理</span>
                                         <ul>
                                        <li>
                                            <a href="#" onclick="tonclick('khgl')">
                                         <span class="file" id="khgl">客户管理</span></a>
                                        </li>
                                        <li>
                                            <a href="#" onclick="tonclick('xsdh')">
                                         <span class="file" id="xsdh">销售订货</span></a>
                                        </li>
                                         <li>
                                            <a href="#" onclick="tonclick('xsfh')">
                                         <span class="file" id="xsfh">销售发货</span></a>
                                        </li>
                                         <li>
                                            <a href="#" onclick="tonclick('xsth')">
                                         <span class="file" id="xsth">销售退货</span></a>
                                        </li>
                                        <li>
                                            <a href="#" onclick="tonclick('xsdb')">
