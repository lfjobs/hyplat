      ...
      <tr>
        <td><table height="90" border="0" align="left" cellpadding="0"
            ...
            <tr>
              ...
              <span style="width: 15px; margin: auto;">招聘登记管理</span></a> </td>
              ...
              <td rowspan="2" align="center"><table border="0" cellspacing="0" cellpadding="0" height="132px">
                  <tr>
                    <td width="40" align="center" valign="top"
                        ...
                        <tr>
                          <td height="85px" align="center" valign="top">自投简历录入登记</td>
                        </tr>
                        <tr>
                    ...
                    <td width="40" align="center" valign="top"
                        ...
                        <tr>
                          <td height="85px" align="center" valign="top"><div  class="na_bace_img" style="width: 15px; margin: auto;"><font style="font-size: 11px; Line-height: normal">基本信息审核</font></div></td>
                        </tr>
                        <tr>
                    ...
                    <td width="40" align="center" valign="top"
											style="background-image: url(<%=basePath%>images/ln02.gif); padding-top: 11px; cursor: pointer"><table width="90%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td height="85px" align="center" valign="top"><div class="na_bace_img" style="width: 15px; margin: auto;"><font style="font-size: 11px; Line-height: normal">人员证件审核</font></div></td>
                        </tr>
                        <tr>
                    ...
                    <td width="40" align="center" valign="top"
											style="background-image: url(<%=basePath%>images/ln02.gif); padding-top: 11px; cursor: pointer"><table width="90%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td height="85px" align="center" valign="top"><div class="na_bace_img" style="width: 15px; margin: auto;"></div></td>
                        </tr>
                        <tr>
