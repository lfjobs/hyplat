			...
			<table width="100%" cellspacing="0" cellpadding="0" "border="2">
				<tr>
					<td id="qh_sw" style="width: 15%" valign="top">
						<div class="qh_gg_nav">
							&nbsp;
							<span id="frametitle">网络安全管理</span>
						...
						<ul id="navigation" style="width: 180px;"
							class="filetree">
										<li>
								<span class="folder" id="tit">网络安全管理</span>
										<ul>
											<li>
												<a href="<%=basePath%>ea/network/ea_getNetWork.jspa?" target="admin1"><span
													class="file">网络加密管理</span> </a>
											</li>
											<li>
												<a href="<%=basePath%>ea/netWorkAntiVirus/ea_getNetWorkAntiVirusList.jspa?" target="admin1"><span
													class="file">网络杀毒管理</span> </a>
											</li>
											<li>
												<a target="admin1"><span
													class="file">网络建设1</span> </a>
											</li>
											<li>
												<a target="admin1"><span
													class="file">带宽建设2</span> </a>
											</li>
											<li>
												<a target="admin1"><span
													class="file">网络安全建设3</span> </a>
											</li>
											<li>
												<a target="admin1"><span
													class="file">服务器建设4</span> </a>
											</li>
											<li>
												<a target="admin1"><span
													class="file">终端建设</span> </a>
											</li>
						</ul>
							</li>
						</ul>
					...
					<td style="width: 85%;" valign="top">
						<iframe  src="<%=basePath%>ea/network/ea_getNetWork.jspa?" style="margin:0px;width:100%;height:100%;" name="admin1" scrolling="no" frameBorder="0"></iframe>
					</td>
				</tr>
			</table>
		</div>
