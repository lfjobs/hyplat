			...
			<table width="100%" cellspacing="0" cellpadding="0" "border="2">
				<tr>
					<td id="qh_sw" style="width: 15%" valign="top">
						<div class="qh_gg_nav">
							&nbsp;
							<span id="frametitle">资金申请管理</span>
						...
						<ul id="navigation" style="width: 200px;"
							class="filetree">
							<li>
								<span class="folder" id="zjsqgl">资金申请管理</span>
								<ul>
									
										   <li>
												<a href="javascript:void(0);" target="mainframe"  >
												<span class="file" id="xjsqzz">现金申转对账</span></a>
											</li>
											<li>
												<a href="javascript:void(0);"  target="mainframe" >
												<span class="file" id="wbxjsq">未拨现金申请</span></a>
											</li>
											<li>
												<a href="javascript:void(0);" target="mainframe" >
												<span class="file" id="ybxjsq">已拨现金申请</span></a>
											</li>
								</ul>
							</li>
						</ul>
