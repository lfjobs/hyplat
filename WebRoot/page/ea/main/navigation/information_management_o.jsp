							...
							<td>
								<table border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td width="110" align="center">
											<div class="na_back_img" onclick="document.location.href='<%=basePath%>/ea/addressIpCompany/ea_getListIPaddress.jspa?'"></div>
                      						<div class="center_a"><span>IP地址管理</span></div>
										</td>
										<td width="110" align="center">
											<div class="na_back_img" onclick="document.location.href='<%=basePath%>/ea/telmessage/ea_goMessageIndex.jspa?type=current&orgDetail=office'"></div>
                      						<div class="center_a"><span>短信管理</span></div>
										</td>
										<td width="110" align="center">
											<div class="na_back_img" onclick="document.location.href='<%=basePath%>/ea/qqcompany/ea_getQqCompanyList.jspa?'"></div>
                      						<div class="center_a"><span>QQ管理</span></div>
										</td>
										<td width="110" align="center">
											<div class="na_back_img" onclick="document.location.href='<%=basePath%>/ea/netdiskcompany/ea_getNetDiskCompanyList.jspa?'"></div>
                      						<div class="center_a"><span>网络硬盘管理</span></div>
										</td>
										<td width="110" align="center">
											<div class="na_back_img" onclick="document.location.href='<%=basePath%>/ea/domainnamecompany/ea_getListDomainnameCompany.jspa?'"></div>
                      						<div class="center_a"><span>域名管理</span></div>
										</td>
										<td width="110" align="center">
											<div class="na_back_img" onclick="document.location.href='<%=basePath%>/ea/networkfaxcompany/ea_getListNetworkFaxCompany.jspa?'"></div>
							...
							<td>
								<table border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td width="110" align="center">
											<div class="na_back_img" onclick="document.location.href='<%=basePath%>/ea/schedulecompany/ea_getScheduleCompanyList.jspa?'"></div>
						...
						<tr>
							...
							<td>
								<table border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td width="110" align="center">
											<div class="na_back_img" onclick="document.location.href='<%=basePath%>/ea/networkcompany/ea_getNetWorkCompany.jspa?'"></div>
                      						<div class="center_a"><span>网络加密管理</span></div>
										</td>
										<td width="110" align="center">
											<div class="na_back_img" onclick="document.location.href='<%=basePath%>/ea/netWorkAnViCompany/ea_getNetWorkAnViCompanyList.jspa?'"></div>
