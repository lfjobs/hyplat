...
<script type="text/javascript" src="<%=basePath%>js/common/common.js"></script> 
		...
		<script type="text/javascript"
			src="<%=basePath%>js/ea/office_ea/contactcompany/piaowubaobiao.js"></script>
		<script type="text/javascript">
		 var ccompanyID = '';
				...
				<tbody>
					...
					<s:iterator value="pageForm.list">
						<tr id="${ticketbusinessid}" class="trclass">
							...
							<td>
								<c:if test="${piaowumanager.airTankLevel == ''}"><span>无</span></c:if>
								<span id="airTankLevel">${airTankLevel}</span>
							</td>
							<td>
								<c:if test="${piaowumanager.positionLamp == ''}"><span>无</span></c:if>
								<span id="positionLamp">${positionLamp}</span>
							</td>
							<td>
