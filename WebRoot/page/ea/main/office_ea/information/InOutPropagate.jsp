...
<script type="text/javascript" src="<%=basePath%>js/common/common.js"></script>
        ...
        <script src="<%=basePath%>js/ea/office_ea/information/InOutPropagate.js"></script>
	...
	<body >
        <div class="main_main">
                ...
                <tbody> 
                    <s:iterator value="pageForm.list" status="number">
                        <tr id="${propagateID}"  >
                            ...
                            <td>
                            	<span style="display:none" id = "corganizationID">${corganizationID}</span>${oName}
                            </td>
                            <td>
            ...
            <c:import url="../../../page_navigator.jsp">
                <c:param name="actionPath" value="ea/inoutpropagate/ea_getInOutPropagateList.jspa?pageNumber=${pageNumber}&search=${search}">
                </c:param>
            </c:import>
        </div>
    <div class="jqmWindow jqmWindowcss" style="top: 10%;width: 450px;" id="jqModel">
			 <form name="cstaffForm" id="cstaffForm" method="post" >
  				...
  				<table align="center" cellpadding="5px" cellspacing="10px" name="stafftable" id="stafftable"> 
				    <tr>
				    	<td align="right">
				    		编号：
				    	</td>
				    	...
				    	<td>
				    		<s:select list="orgnizationList" id="corganizationID" name="propagate.corganizationID" listKey="organizationID" listValue="organizationName" headerKey="" headerValue="请选择"></s:select>
				    	</td>
				    </tr>
				    <tr>
				      	<td align="right">
       ...
       <!--搜索窗口 -->
        <div class="jqmWindow" style="width: 300px;right: 25%;;top: 10%" id="jqModelSearch">
