...
<script src="<%=basePath%>js/ea/office_ea/information/AddressIP.js"></script>
...
<div id="main_main" class="main_main">
		...
		<tbody>
		 <%
          ...
          <tr class="td_bg01 saveAjax" id="${ipID}">
            <td class="td_bg01">
              <input type="radio" name="a"  class="JQuerypersonvalue" value="${ipID}"/>
            </td>
            <td class="td_bg01">
                <span><%=number%></span>
			</td>
            ...
            <td class="td_bg01">
               ...
               <span id="ipKey" style="display:none">${ipKey}</span>
			   <span id="ipID" style="display:none">${ipID}</span>
			</td>     
          </tr>
          <%
               number++; %>
 ...
 <c:import url="../../../page_navigator.jsp">
				<c:param name="actionPath"
					value="ea/addressip/ea_getListIPaddress.jspa?pageNumber=${pageNumber}&search=${search}"></c:param>
</c:import>
</div>
            ...
            <form name="postSearchForm" id="postSearchForm" method="post">
                ...
                <table id="cataffSearchTable">
                    <tr>
                        ...
                        <td>         
                             <s:select id="userName"  headerKey="" headerValue="请选择" list="staffList" listKey="staffName" listValue="staffName" name="addressIP.userName" theme="simple" ></s:select>
                        </td>
                    </tr>
					<tr>
                        <td>
			   ...
			   <td>
			     <table width="550" height="117" border="0" align="center" cellpadding="0" cellspacing="0" id="stafftable2" style="margin-top:5px;margin-bottom:5px;">
			      <tr>
			        ...
			        <td width="148" ><input name="addressIP.ipCode" type="text" id="ipCode" size="20"/></td>
			      ...
			      <tr>
			        <td height="41"  align="right">电脑型号：</td>
			        <td ><input  id="computerModel" type="text"  class="input"  name="addressIP.computerModel" size="20"/></td>
			        <td align="right" height="41">IP地址：</td>
			        <td width="212"><input id="ipAddress"   type="text"  class="input" name="addressIP.ipAddress" size="30"/>
			        <input name="addressIP.ipID" type="hidden" id="ipID" size="20"/>
			        <input type="hidden" name="addressIP.ipKey" id="ipKey" /></td>
			        </tr>
			    </table>
		       </td>
			  </tr>
