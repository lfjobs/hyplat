...
<script type="text/javascript" src="<%=basePath%>js/common/common.js"></script> 
		...
		<script type="text/javascript"
			src="<%=basePath%>js/jquery.messager.js"></script>
				<script type="text/javascript"
			src="<%=basePath%>js/ea/office_ea/CollectPersonal.js"></script>
		<script type="text/javascript">
	...
	<form name="Auditform" id="Auditform">
		...
		<c:import url="../../page_navigator.jsp">
			<c:param name="actionPath"
				value="/ea/collectpersonal/ea_getTracklist.jspa?search=${search}&pageNumber=${pageNumber}&sdate=${sdate}&edate=${edate}&staffname=${staffname}">
			</c:param>
		</c:import>
		</div>
		<!--搜索窗口 -->
...
$(function(){   
	setTimeout(function(){ 			
	  	  $("div.bDiv").css({"height":parent.document.getElementById("mainframe6").offsetHeight-122+"px"});
	    },100);
