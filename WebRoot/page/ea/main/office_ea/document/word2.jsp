...
<%
	...
	SOACtrl.webOpen(basePath + docPath, 2, subscriberName, fileTypedoc);
	// -------- SOAOFFICE 服务器端编程结束 ------------------------ //
%>
...
<HTML>
					...
					<TR vAlign="top">
						...
						<TD style="OVERFLOW-X: hidden" width="144" height="100%">
							<DIV class="mnpMenuTop" id="mnpMenuTop"
								...
								<DIV class="menuItem">
									<A href="javascript:jsStartHandDraw();">领导圈阅签字</A>
								</DIV>
								<DIV class=mnpMenuBorder style="WIDTH: 141px"></DIV>
								<%
									if (fileType == "W" || fileType.equals("W")) {
								...
								<DIV class="menuItem">
									<A href="javascript:jsSave2();">直接保存文档</A>
								</DIV>
								<DIV class="menuItem">
									<A href="javascript:jsSubmitSave2();">提交页面保存文档</A>
								</DIV>
								<DIV class=mnpMenuBorder style="WIDTH: 141px"></DIV>
								<%
									if (fileType == "W" || fileType.equals("W")) {
	...
	//}				
		...
		document.all("SOAOfficeCtrl").EnableFileCommand(3) = true;//保存
