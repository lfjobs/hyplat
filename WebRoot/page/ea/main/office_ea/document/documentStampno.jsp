...
<html>
	<head>
		...
		<title>未盖章公文</title>
		<script src="<%=basePath%>js/ea/office_ea/document/documentStampno.js?version=20210220"></script>
		...
		<div id="wsp">
				...
				<tbody>
					...
					<s:iterator value="pageForm.list">
						...
						<td class="trtip">
							...
							<td class="td_bg01">
								<span id="subscribetime">${fn:substring(subscribetime,0,19)}</span>
							</td>
						</tr>
						<%
							number++;
			...
			<c:import url="../../../page_navigator.jsp">
				<c:param name="actionPath"
					value="ea/documentflow/ea_getSealDocList.jspa?pageNumber=${pageNumber}&search=${search}&finishType=seal">
				</c:param>
			</c:import>
		</div>
		
		<form id="sealForm" name="sealForm">
