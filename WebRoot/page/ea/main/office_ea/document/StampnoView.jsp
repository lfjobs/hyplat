...
<html>
	<head>
		...
		<script src="<%=basePath%>js/ea/office_ea/document/StampnoView.js"></script>
	...
	<body>
		...
		<div class="operate">
			...
			&nbsp;|&nbsp;
			<input type="button" value="至分发人" class="greyBtn" id="noapprove"
				onclick="Approve();" />
			<!--<input type="button" value="存档" class="greyBtn" id="reject"
				onclick="Finish();" />
			&nbsp;|&nbsp;
		--></div>
		<div id="wspv">
				...
				<table class="table" cellspacing="0" cellpadding="5" id="wspView">
					...
					<tr>
						...
						<td align="left">
							...
							<input type="hidden" id="sealerName" value="${document.sealerName}" />
					...
					<tr>
						...
						<td colspan="2">
							<span id="drafterComment">${document.subscriberComment}</span>
					...
					<tr>
						...
						<td colspan="2">
							...
							<s:iterator id="doc" value="attachlist">
								<a href="#"
									onclick="OpenOffice2('${filePath}','${fileType}','2','双方签字盖章')">${fileShowName}.${ext}</a>
							</s:iterator>
					...
					<tr>
						...
						<td colspan="2">
							<textarea style="width: 80%;" name="comment" id="sealComment"></textarea>
