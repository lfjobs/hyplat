...
<html>
	<head>
		...
		<script src="<%=basePath%>js/ea/office_ea/document/documentReadyes.js?version=20210220"></script>
<link rel="stylesheet"
	...
	<body>
		...
		<div id="wsp">
				...
				<tbody>
					...
					<s:iterator value="pageForm.list">
						<tr class="docs" id="${docid}">
							...
							<td class="td_bg01">
								<span id="readtime">${fn:substring(readtime,0,19)}</span>
							</td>
			...
			<c:import url="../../../page_navigator.jsp">
				<c:param name="actionPath"
					value="ea/documentflow/ea_getReadDocList.jspa?pageNumber=${pageNumber}&search=${search}&finishType=readyes">
				</c:param>
			</c:import>
		</div>
		...
		<form name="PublishForm" id="PublishForm" method="post">
			<div class="jqmWindow" style="width: 300px; right: 15%; top: 10%;"
				...
				<center>
					<table width="200" id="PublishTable" style="margin-top: 5px;">
						<tr>
							<td align="left">
