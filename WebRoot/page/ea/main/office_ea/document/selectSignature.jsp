...
function CheckValue(theForm)
{
  ...
  return;
	...
	var url = basePath+"ea/enterprisestamp/sajax_n_ea_queryStampFileInfo.jspa?type=sign";
		$.ajax({
			url : encodeURI(url),
			type : "get",
			async : true,
...
<td align=center>
  ...
  <tr>
    ...
    <td align=left  nowrap class="TDStyle">请选择您要加盖的电子手写签名</td>
  </tr>
  <tr>
    <td align=right  nowrap class="TDStyle"></td>
    <td><select name=WordList id="selectbox" style='width:240 px;'>
