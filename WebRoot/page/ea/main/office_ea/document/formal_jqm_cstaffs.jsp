...
//		.jqDrag('.drag');// 添加拖拽的selector
	...
	function action(com, grid){
		switch (com) {
			case '查询':
				...
				break;
			case '设置每页显示条数':
			var url=basePath + "ea/documentcommon/ea_getStaffformalList.jspa?search="+psearch+"&parameter=${parameter}&oid=${oid}";
				numback(url);
				break; 
		}
	}
	...
	$(".JQueryflexme tr[id]").click(function(){
     ...
     $("#searchStaff").click(function(){
         $("#cstaffSearchForm").attr("action", basePath + "ea/documentcommon/ea_toSearchCStaff.jspa?pageNumber="+ppageNumber);
		...
		<div class="main_main">
			...
			<c:import url="../../../page_navigator.jsp">
				<c:param name="actionPath"
					value="ea/documentcommon/ea_getStaffformalList.jspa?search=${search}&pageNumber=${pageNumber}&parameter=${parameter }&oid=${oid }">
				</c:param>
			</c:import>
		</div>
		<!--搜索窗口 -->
