...
<html>
	<head>
		...
		<title>共享</title>
		<script src="<%=basePath%>js/ea/office_ea/document/documentShare.js"></script>
		...
		<div id="wsp">
			...
			<c:import url="../../../page_navigator.jsp">
				<c:param name="actionPath"
					value="ea/documentinfo/ea_getShareDocuments.jspa?pageNumber=${pageNumber}&search=${search}&searchType=${searchType}">
				</c:param>
			</c:import>
		</div>
