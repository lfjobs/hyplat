...
//		.jqDrag('.drag');// 添加拖拽的selector
	...
	function action(com, grid){
		switch (com) {
		       case '添加' :
				...
				var url = basePath
							+ "ea/contactcompany/ea_toSaveJsp.jspa?showType=add&date="+new Date();
			...
			case '修改' :
				...
				var url = basePath
						+ "ea/contactcompany/ea_toSaveJsp.jspa?showType=edit&contactCompany.ccompanyID="+opertionID+"&date="+new Date();
				window.open(url, '','scrollbars=yes,resizable=yes,channelmode');
				break;
			case '查询':
				...
				break;
			case '设置每页显示条数':
			var url=basePath + "ea/documentcommon/ea_getListContactCompany.jspa?search="+psearch+"&parameter=${parameter}&oid=${oid}";
				numback(url);
				break; 
		}
	}
	...
	$(".JQueryflexme tr[id]").click(function(){
     ...
     $("#searchStaff").click(function(){
         $("#cstaffSearchForm").attr("action", basePath + "ea/documentcommon/ea_toSearchCCompany.jspa?pageNumber="+ppageNumber);
		...
		<div class="main_main">
				...
				<tbody>
					...
					<s:iterator value="pageForm.list">
						<tr id="${ccompanyID}">
							...
							<td>
								<span id="responsibleTel" class="datas">${responsibleTel}</span>
							</td>
							<td>
			...
			<c:import url="../../../page_navigator.jsp">
				<c:param name="actionPath"
					value="ea/documentcommon/ea_getListContactCompany.jspa?search=${search}&pageNumber=${pageNumber}&parameter=${parameter }&oid=${oid }">
				</c:param>
			</c:import>
		</div>
		<!--搜索窗口 -->
			...
			<div class="jqmWindow" style="width: 400px;right: 25%;top: 10%" id="jqModelSearch">
	                ...
	                <table id="cataffSearchTable">
	                    ...
	                    <tr>
	                        ...
	                        <td >
	                            <input name="contactCompany.companyName" type="text" size="25"/>
	                        </td>
	                    </tr>
