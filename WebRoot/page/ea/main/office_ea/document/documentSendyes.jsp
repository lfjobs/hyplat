...
<html>
	<head>
		...
		<title>已发公文</title>
		<script src="<%=basePath%>js/ea/office_ea/document/documentSendyes.js?version=20210220"></script>
		...
		<div id="wsp">
				...
				<tbody>
					...
					<s:iterator value="pageForm.list">
						<tr class="docs" id="${docid}">
							...
							<td class="td_bg01">
								<span id="publishtime">${fn:substring(publishtime,0,19)}</span>
							</td>
						</tr>
						<%
							number++;
			...
			<c:import url="../../../page_navigator.jsp">
				<c:param name="actionPath"
					value="ea/documentflow/ea_getPublishDocList.jspa?pageNumber=${pageNumber}&search=${search}&finishType=publishyes">
				</c:param>
			</c:import>
		</div>
