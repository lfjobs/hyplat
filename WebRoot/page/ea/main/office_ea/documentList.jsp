...
<div class="content">
    <section class="sec-nav sec-hide">
        ...
        <ul class="clearfix">
            ...
            <li class="clearfix">
                <p class="query"><img src="<%=basePath%>/images/ea/office/contract/selectp/del.png"/>回收站</p>
            </li>
            <li class="clearfix">
                <p class="print-p"><img src="<%=basePath%>/js/jqModal/css/images_blue/send16.png"/>传阅</p>
            </li>
            <li class="clearfix">
        ...
        <ul class="ul">
            ...
            <li class="clearfix">
                <div class="title-pc">
                    <div class="sex" style="width: 10%;">
                        <img class="img-01" src="http://localhost:8080/images/ea/office/contract/selectp/img_02.png">
                        <img class="img-02" src="http://localhost:8080/images/ea/office/contract/selectp/img_03.png">
                    </div>
                    <div class="ln-p" title="0001" style="width:10%!important;">0001</div>
            ...
            <li class="clearfix">
                <div class="title-pc">
                    ...
                    <div class="ln-p" title="0001" style="width:10%!important;">0002</div>
                    <div class="sn-p" title="ffff字【2023】第0001号" style="width:20%!important;">
                        ffff字【2023】第0001号
                    </div>
                    <div class="oask-p" title="总部服务(创收)平台" style="width:30%!important;">总部服务(创收)平台</div>
            ...
            <li class="clearfix">
                <div class="title-pc">
                    ...
                    <div class="ln-p" title="0001" style="width:10%!important;">0003</div>
                    <div class="sn-p" title="ffff字【2023】第0001号" style="width:20%!important;">
                        ffff字【2023】第0001号
                    </div>
                    <div class="oask-p" title="总部服务(创收)平台" style="width:30%!important;">总部服务(创收)平台</div>
            ...
            <li class="clearfix">
                <div class="title-pc">
                    ...
                    <div class="ln-p" title="0001" style="width:10%!important;">0004</div>
                    <div class="sn-p" title="ffff字【2023】第0001号" style="width:20%!important;">
                        ffff字【2023】第0001号
                    </div>
                    <div class="oask-p" title="总部服务(创收)平台" style="width:30%!important;">总部服务(创收)平台</div>
            ...
            <li class="clearfix">
                <div class="title-pc">
                    ...
                    <div class="ln-p" title="0001" style="width:10%!important;">0005</div>
                    <div class="sn-p" title="ffff字【2023】第0001号" style="width:20%!important;">
                        ffff字【2023】第0001号
                    </div>
                    <div class="oask-p" title="总部服务(创收)平台" style="width:30%!important;">总部服务(创收)平台</div>
