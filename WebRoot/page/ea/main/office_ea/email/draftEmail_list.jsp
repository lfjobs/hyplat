...
<script type="text/javascript" src="<%=basePath%>js/common/common.js"></script>
		...
		<link href="<%=basePath%>css/plat/validate.css" rel="stylesheet"
			type="text/css" />
...
$(function(){ 
 $(".jqmWindow").jqm({
   ...
   $('.JQueryflexme').flexigrid({
                    ...
                    width: 'auto',
                    minwidth: 30,
                    title:  parent.tree.getSelectedItemText(),
                    minheight: 80,
                    buttons: [{  
                        name: '转发',
                        bclass: 'add',
					...
					if (reciveID != "") {
                        ...
                        case '删除':
                          //  if(confirm("是否确定删除？")){
							...
							//	{
							//	 $("#reciveID").attr("value",reciveID);
							//	  $("#emailForm").attr("action", basePath+"ea/email/ea_delEmail.jspa?status='03'");
               				  //   document.emailForm.submit.click();
							//	}
                            //}
                var reciveID = "";
...
function downLoadAttach(filePath) {
	...
	<body>
		<form method="post" id="emailForm" name="emailForm">
			<%-- 不告诉你--%>
			<input id="reciveID" name="reciveID" type="hidden" />
			<input type="submit" name="submit" style="display: none" />
			<input id="emailStatus" name="emailStatus" value="addresserStatus"
				type="hidden" />
			<%--<input id="emailStatus" name="emailStatus" value="${emailStatus}"
				type="hidden" />--%>
			<input id="listStatus" name="listStatus" value="draftEmail"
				type="hidden" />
		</form>
		<div class="main_main">
			<table class="JQueryflexme">
				...
				<tbody>
					<s:iterator value="pageForm.list">
						<tr id="${emailID}">
							<td>
								<input name="chss" type="checkbox" value="${emailID}" />
							</td>
							<td>
								<span id="addresseeName">${addresseeName}</span>
							</td>
							<td>
							...
							<td>
								<span id="emailDate">${emailDate}</span>
								<span id="emailID" style="display: none"> ${emailID}</span>
							</td>
						</tr>
					</s:iterator>
				</tbody>
			...
			<c:import url="../../../page_navigator.jsp">
				<c:param name="actionPath"
					value="ea/email/ea_saveEmailDraft.jspa?emailStatus=${emailStatus}"></c:param>
			</c:import>
		</div>
		<form name="cstaffForm" id="cstaffForm" method="post">
			...
			<div class="contentbannb jqmWindow jqmWindowcss2" style="top: 10%"
				...
				<div class="content">
					...
					<table width="450" border="0" id="stafftable" align="center"
						cellpadding="0" cellspacing="0"
						style="margin-top: 5px; margin-bottom: 5px;">
						<tr>
							<td>
								<table width="430" height="340" border="0" id="stafftable2"
									...
									<tr>
										...
										<td width="330">
											<input type="text" id="addresseeName" readonly="readonly"
												name="addresseeName" size="30" id="reciveName" />
										</td>
									</tr>
									<tr>
										<td width="100" height="60" align="right">
										...
										<td width="330">
											<input type="text" id="title" readonly="readonly" size="30"
												name="title" />
										</td>
									</tr>
									<tr>
										...
										<td colspan="5">
											<div style="width: 300px;" id="attach"></div>
										</td>
									...
									<tr>
										...
										<td colspan="5">
											<textarea name="content" readonly="readonly" cols="40"
