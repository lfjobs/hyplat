...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script src="<%=basePath%>js/ea/office_ea/extralDoc/auditList.js"></script>
	...
	<body>
		...
		<div id="draft">
			...
			<c:import url="../../../page_navigator.jsp">
				<c:param name="actionPath"
					value="ea/extralflow/ea_getUnfinishedList.jspa?type=examine&pageNumber=${pageNumber}&search=${search}">
				</c:param>
			</c:import>
		</div>
		...
		<form id="rejectForm" name="rejectForm">
			<div class="jqmWindow"
				...
				<center>
					<table cellspacing="25" id="rejecttable">
						<tr>
							<td align="right">
								<textarea cols="40" rows="5" name="docComplaint.suggestion">添加驳回理由......</textarea>
						...
						<tr>
							...
							<td colspan="2" align="center">
								<input type="button" value="驳回" class="input-button"
									id="toReject" onclick="examine('reject');" />
								<input type="hidden" value="" id="hidreg" name="docComplaint.Id" />
								<input type="hidden" value="reject" name="jump" />
							</td>
						</tr>
		...
		<form id="passForm" name="passForm">
			<div class="jqmWindow"
				...
				<center>
					...
					<table cellspacing="15" id="passtable">
						<tr>
							<td>
								<textarea cols="40" rows="5" name="docComplaint.suggestion">添加处理意见......</textarea>
								<input type="hidden" name="document.companyIDofSealer"
									id="hidcompany" />
								<input type="hidden" name="document.deptIDofSealer" id="hiddept" />
								<input type="hidden" name="document.sealerID" id="hidsealer" />
						...
						<tr>
							<td align="center">
								<input type="button" value="返还投诉处理人" class="input-button"
									id="toDealer" onclick="examine('dealer');" />
								<input type="button" value="转他人审批" class="input-button"
									id="toAudit" onclick="selectPeople('transfer');" />
								<input type="button" value="转至盖章" class="input-button"
									id="toSeal" onclick="selectPeople('seal');" />
								<input type="hidden" value="" id="hidpass"
									name="docComplaint.Id" />
								<input type="hidden" value="" id="hidjump" name="jump" />
							</td>
						</tr>
			...
			<div class="jqmWindow"
				...
				<table width="100%" cellspacing="10" id="viewtable">
					...
					<tr>
						...
						<td align="left" colspan="2"><span id="auditTime"></span>
...
dateFmt:'yyyy-MM-dd', minDate:'#F{$dp.$D(\'startDate\')}'})"
					...
					<div align="center" style="margin-top: 10px;">
						...
						<input name="global" type="hidden" value="examine">
					</div>
				</center>
			</div>
		</form>
		<form name="SendForm2" id="SendForm2" method="post">
			<div class="jqmWindow"
				style="width: 360px; height: 210px; right: 25%; top: 10%"
				id="jqModelSend2">
				<input type="submit" name="submit" style="display: none" />
				<div class="drag">
					选择人员
				...
				<center>
					<table width="300" id="SearchTable2" cellspacing="10"
						cellpadding="2">
						<tr>
							<td align="right">
								收件人公司：
							...
							<td align="left">
								<select id="companyIDofSealer" name="document.companyIDofSealer"
									style="width: 150px;">
									<option value="">
						...
						<tr>
							...
							<td align="left">
								<select id="deptIDofSealer" name="document.deptIDofSealer"
									style="width: 150px;">
									<option value="">
						...
						<tr>
							...
							<td align="left">
								<select name="document.sealerID" id='sealerID'
									style="width: 150px;">
									<option value="">
					...
					<div align="center">
						<input type="hidden" value="" id="sealortrans" />
						<input type="button" class="input-button" id="nosend2"
							value=" 发送 " onclick="examine('sealortrans');" />
					</div>
