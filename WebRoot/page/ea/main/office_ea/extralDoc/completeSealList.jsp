...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script src="<%=basePath%>js/ea/office_ea/extralDoc/completeSealList.js"></script>
		...
		<div id="draft">
			...
			<c:import url="../../../page_navigator.jsp">
				<c:param name="actionPath"
					value="ea/extralflow/ea_getfinishedList.jspa?type=seal&pageNumber=${pageNumber}&search=${search}">
				</c:param>
			</c:import>
		</div>
