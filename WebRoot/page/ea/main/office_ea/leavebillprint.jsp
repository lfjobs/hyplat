...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script language="javascript" type="text/javascript"
			src="<%=basePath%>js/ea/finance/leavebillprint.js"></script>
		<style type="text/css">
		.table {
			...
			<table width="600" border="0" cellpadding="0" cellspacing="0"
				...
				<tr align="center">
					...
					<td width="250" align="left">
						 <span style="padding-left:5px">${publicreceiptsChild.leaveType}</span>
					</td>
					<td width="80" align="right">
						接管人：
					</td>
					<td width="250" align="left">
						<span style="padding-left:5px">${publicreceiptsChild.leaveReceiver}</span>
					</td>
				</tr> 
				<tr> 
				...
				<tr>
					<td width="102" height="50" align="right">
						考勤折扣：
					</td>
					<td colspan="3" align="left">
						...
						本次考勤折扣<span style="text-decoration:underline;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${publicreceiptsChild.checkdiscount}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>分
					</td> 
				</tr>
				<tr> 
