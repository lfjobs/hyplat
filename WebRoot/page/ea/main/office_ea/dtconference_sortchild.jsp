...
$(function(){
	...
	$('#save_all').click(function(){
		...
		document.childrenform.action = "<%=basePath%>ea/dtconference/ea_sortChildDtcon.jspa?newState="+newState;
		document.childrenform.submit.click();
	})
	$('#goback').click(function(){
		document.childrenform.action = "<%=basePath%>ea/dtconference/ea_getDtconferenceList.jspa?newState="+newState;
		document.childrenform.submit.click();
	});
...
<div id="body_02">
          <table width="100%" height="26" align="center" cellspacing="0" cellpadding="1" style="font-size:12px;" class="bannb_01">
            <tr>
                <td height="24" align="left" valign="top" class="txt01" >会议流程排序</td>
            </tr>
          </table>
            ...
            <table width="99%" height="37" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="22%">当前会议流程排序：</td>
                  <td width="8%" align="center">&nbsp;</td>
                  <td width="48%">重新排序</td>
              </tr>
 		    </table>
            <table width="99%" height="300px" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="46%" align="right">
                	<SELECT name="staff" id="select1" size="15" style="width: 120">
                		<s:iterator value="dtconList">
		        			<option value="<s:property value='conferenceid' />"><s:property value="flowname" />
		        		</s:iterator>	
                	</SELECT>
				</td>
