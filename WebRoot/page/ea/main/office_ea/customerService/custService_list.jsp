...
<script type="text/javascript" src="<%=basePath%>js/common/common.js"></script> 
        ...
        <script language="javascript" type="text/javascript" src="<%=basePath%>js/ea/office_ea/customerService/custService_list.js"></script>
			...
			document.onkeydown = function(evt){//捕捉回车 
				...
				if (key == 13) { //判断是否是回车事件。
					if($("input#journalNum").val()==''){
		   			...
		   			if($("input#journalNum").val()!=''){
		       			$("#SearchForm").attr("action", basePath+"ea/custService/ea_toSearchByCondition.jspa?pageNumber="+pNumber);
    ...
    <body>
            ...
            <tbody>
             <c:forEach var='arr' items="${pageForm.list}">
					<tr id="${arr[0] }">
						...
						<td>
							<span id="consultStatus">${arr[16]}</span>
						</td>
						<td>
        ...
        <c:import url="../../../page_navigator.jsp">
            <c:param name="actionPath" value="ea/custService/ea_getCashierToPage.jspa?search=${search}&pageNumber=${pageNumber}&sdate=${sdate}&edate=${edate}">
            </c:param>
        </c:import>
          <!--搜索窗口 -->
        ...
        <div class="jqmWindow" style="width: 380px;right: 30%;top:10%" id="jqModelSearch">
                ...
                <table width="326" id="SearchTable">
                    ...
                    <tr>
                        <td align="right">查询单据：</td>
						<td >
					    	<select id="consultStatus" style="width:200px"  name="cashierBillsVO.consultStatus">
					    	<option value="" selected="selected" >全部</option>
					    	<option value="01">待营销审核</option>
					    	<option value="02">待人事审核</option>
					    	<option value="03">已审核</option>
					    	<option value="10">驳回作废</option>
            ...
            <div class="jqmWindow" style="width: 240px;right: 40%;top: 25%" id="DaYin">
	            <form name="searchDaYinForm" id="searchDaYinForm" method="post">
	            	<input type="submit" name="submit" style="display:none"/>
	                <div class="drag">
	                    查询打印
	                    <div class="close">
	                ...
	                <table width="230" id="servicePrintTable">
	                    <tr>
	                        <td align="right">责任人：</td>
	                        <td class = "serviceDayin">
	                         <s:select list="%{#request.stafflist}"  style="width:80px"  headerKey="" headerValue="请选择"  listKey="staffID" name="cashierBillsVO.staffID"  listValue="staffName"   theme="simple" >
	                         </s:select>
	                        </td>
	                    </tr>
	                    <tr>
                        <td width="35%"  align="right" class="txt02">
                          ...
                          <td width="40%" class="sd">
                            <input name="sdate" class="sdate" onfocus="date(this);"/>
                        </td>
                    </tr>
                     <tr>
                        <td width="35%"  align="right" class="txt02">
                          ...
                          <td width="40%" class="ed">
                            <input name="edate" class="edate" onfocus="date(this);"/>
                        </td>
                    </tr>
	              	</table>
	                <div align="center">
