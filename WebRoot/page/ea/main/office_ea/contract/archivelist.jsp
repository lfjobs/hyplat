...
<head lang="zh">
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>css/ea/office_ea/contract/archivedlist.css?version=20230518"/>
    <%--<script src="<%=basePath%>js/font-size.js" type="text/javascript" charset="utf-8"></script>--%>
    <script src="<%=basePath%>js/jquery-1.9.1.min.js" type="text/javascript" charset="utf-8"></script>
    <script src="<%=basePath%>js/ea/office_ea/contract/archivedlist.js" type="text/javascript" charset="utf-8"></script>
    <title>&lrm;</title>
        ...
        <ul class="ul">
            ...
            <li class="clearfix" id="${item.docId}">
                <div class="title-pc">
                    ...
                    <div class="date-p" title="归档日期">归档日期</div>
    ...
    <section class="sec-list"  id="phone-sec">
        <ul class="ul">
            <c:forEach  items="${pageForm.list}" var="item" varStatus="v">
                ...
                <p class="p-wq">${fn:substring(item.guidangTime,0,10)}</p>
                </li>
            </c:forEach>
