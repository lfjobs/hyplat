...
<head lang="zh">
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>css/ea/office_ea/contract/archiveTree.css"/>
    ...
    <script src="<%=basePath%>js/ea/office_ea/contract/archiveTree.js" type="text/javascript" charset="utf-8"></script>

    <title>&lrm;</title>
    <script type="text/javascript">
        var module = "<%=session.getAttribute("module")%>"

       var adtId = "${param.adtId}";
...
<div class="content">
    ...
    <section class="sec-search">
        <div class="box clearfix">
            ...
            <input type="text" name="" id="search" placeholder="搜索文件名称" />
        </div>
