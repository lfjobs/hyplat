...
<head lang="zh">
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>css/ea/office_ea/contract/auditlist.css"/>
    <%--<script src="<%=basePath%>js/font-size.js" type="text/javascript" charset="utf-8"></script>--%>
    <script src="<%=basePath%>js/jquery-1.9.1.min.js" type="text/javascript" charset="utf-8"></script>
    <script src="<%=basePath%>js/ea/office_ea/contract/auditlist.js" type="text/javascript" charset="utf-8"></script>
    <title>&lrm;</title>
...
<div class="content">
    ...
    <section class="sec-nav sec-hide">
        ...
        <ul class="clearfix" >
            ...
            <li class="clearfix">
                <p class="reject"><img src="<%=basePath%>images/ea/office/contract/selectp/reject1.png"/>审核驳回</p>
            </li>

            <li class="clearfix" >
                <p class="adopt"><img src="<%=basePath%>images/ea/office/contract/selectp/seal16.png"/>同意至盖章签字</p>
            </li>
            <li class="clearfix">
                <p class="transfer"><img src="<%=basePath%>js/jqModal/css/images_blue/examine16.png"/>转交审批</p>
            </li>
        ...
        <ul class="ul">
            ...
            <li class="clearfix" id="${item.docId}">
                <div class="title-pc">
                    ...
                    <div class="date-p" title="申报日期">申报日期</div>
            ...
            <c:forEach  items="${pageForm.list}" var="item" varStatus="v">
                ...
                <div class="title-pc">
                    ...
                    <div class="docNum-p" title="${item[7]}">${item[7] eq null?'无':item[7]}</div>
