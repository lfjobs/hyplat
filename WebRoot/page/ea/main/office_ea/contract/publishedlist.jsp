...
<head lang="zh">
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>css/ea/office_ea/contract/publishedlist.css"/>
    <%--<script src="<%=basePath%>js/font-size.js" type="text/javascript" charset="utf-8"></script>--%>
    <script src="<%=basePath%>js/jquery-1.9.1.min.js" type="text/javascript" charset="utf-8"></script>
    <script src="<%=basePath%>js/ea/office_ea/contract/publishedlist.js" type="text/javascript" charset="utf-8"></script>
    <title>&lrm;</title>
...
<div class="content">
    ...
    <section class="sec-nav sec-hide">
        ...
        <ul class="clearfix" >
            ...
            <li class="clearfix">
                <p class="sec-zf"><img src="<%=basePath%>images/ea/office/contract/selectp/pub.png"/>分发</p>
            </li>
            <li class="clearfix">
        ...
        <ul class="ul">
            ...
            <li class="clearfix" id="${item.docId}">
                <div class="title-pc">
                    ...
                    <div class="date-p" title="分发日期">分发日期</div>
            ...
            <c:forEach  items="${pageForm.list}" var="item" varStatus="v">
                ...
                <div class="title-pc">
                    ...
                    <div class="docNum-p" title="${item[11]}">${item[11] eq null?'无':item[11]}</div>
