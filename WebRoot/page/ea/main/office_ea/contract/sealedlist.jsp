...
<head lang="zh">
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>css/ea/office_ea/contract/sealedlist.css"/>
    <%--<script src="<%=basePath%>js/font-size.js" type="text/javascript" charset="utf-8"></script>--%>
    <script src="<%=basePath%>js/jquery-1.9.1.min.js" type="text/javascript" charset="utf-8"></script>
    <script src="<%=basePath%>js/ea/office_ea/contract/sealedlist.js" type="text/javascript" charset="utf-8"></script>
    <title>&lrm;</title>
...
<div class="content">
    ...
    <section class="sec-nav sec-hide">
        ...
        <ul class="clearfix" >
            ...
            <li class="clearfix">
                <p class="down"><img src="<%=basePath%>images/ea/office/contract/selectp/preview.png"/>查看签约人脸视频</p>
            </li>
            <li class="clearfix">
        ...
        <ul class="ul">
            ...
            <li class="clearfix" id="${item.docId}">
                <div class="title-pc">
                    ...
                    <div class="date-p" title="盖章日期">盖章日期</div>
