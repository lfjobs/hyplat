...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>css/ea/office_ea/contract/selectWlgr.css?version=20250517"/>
    <%--<script src="<%=basePath%>js/font-size.js" type="text/javascript" charset="utf-8"></script>--%>
    <script src="<%=basePath%>js/jquery-1.9.1.min.js" type="text/javascript" charset="utf-8"></script>
    <script src="<%=basePath%>js/ea/office_ea/contract/selectWlgr.js" type="text/javascript" charset="utf-8"></script>
...
<div class="content">
    <section class="headNav">
        <ul>
            ...
            <li><p><a href="javascript:nav('3','${param.docId}','${param.typee}')"><img src="<%=basePath%>images/ea/office/contract/selectp/dxseleted.png">往来个人</a></p></li>
    ...
    <p class="resulttip">该用户尚未注册</br>你可以点击下方红色按钮邀请注册</p>
