...
<head lang="zh">
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>css/ea/office_ea/contract/auditedlist.css"/>
    <%--<script src="<%=basePath%>js/font-size.js" type="text/javascript" charset="utf-8"></script>--%>
    <script src="<%=basePath%>js/jquery-1.9.1.min.js" type="text/javascript" charset="utf-8"></script>
    <script src="<%=basePath%>js/ea/office_ea/contract/auditedlist.js" type="text/javascript" charset="utf-8"></script>
    <title>&lrm;</title>
        ...
        <ul class="ul">
            ...
            <li class="clearfix" id="${item.docId}">
                <div class="title-pc">
                    ...
                    <div class="date-p" title="审核日期">审核日期</div>
