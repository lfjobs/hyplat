...
<head lang="zh">
    ...
    <script src="<%=basePath%>js/ea/office_ea/contract/sendedlist.js" type="text/javascript" charset="utf-8"></script>
    <title>&lrm;</title>
...
<div class="content">
    ...
    <section class="sec-nav sec-hide">
        ...
        <ul class="clearfix" >
            ...
            <li class="clearfix" >
                <p class="trans"><img src="<%=basePath%>js/jqModal/css/images_blue/send16.png"/>转发</p>
            </li>
