...
<head lang="zh">
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>css/ea/office_ea/contract/readedlist.css"/>
    <%--<script src="<%=basePath%>js/font-size.js" type="text/javascript" charset="utf-8"></script>--%>
    <script src="<%=basePath%>js/jquery-1.9.1.min.js" type="text/javascript" charset="utf-8"></script>
    <script src="<%=basePath%>js/ea/office_ea/contract/readedlist.js" type="text/javascript" charset="utf-8"></script>
    <title>&lrm;</title>
...
<div class="content">
    ...
    <section class="sec-nav sec-hide">
        ...
        <ul class="clearfix" >
            ...
            <li class="clearfix">
                <p class="archive"><img src="<%=basePath%>js/jqModal/css/images_blue/archive16.png"/>归档</p>
            </li>
            <li class="clearfix" >
                <p class="read-zf"><img src="<%=basePath%>images/ea/office/contract/selectp/transmit16.png"/>转发</p>
            </li>
            <li class="clearfix gr">
                <p class="read-share"><img src="<%=basePath%>images/ea/office/contract/selectp/share16.png"/>共享</p>
            </li>
            <li class="clearfix">
        ...
        <ul class="ul">
            ...
            <c:forEach  items="${pageForm.list}" var="item" varStatus="v">
                ...
                <div class="title-pc">
                    ...
                    <div class="docNum-p" title="${item[7]}">${item[7]}</div>
                    <div class="docNum-p" title="${item[11]}">${item[11]}</div>
                ...
                <span class="modulespan" style="display: none;">${item[12]}</span>
                </li>
            </c:forEach>
