...
<head lang="zh">
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>css/ea/office_ea/contract/selectArchiveType.css"/>
    ...
    <script src="<%=basePath%>js/ea/office_ea/contract/selectArchiveType.js" type="text/javascript" charset="utf-8"></script>
