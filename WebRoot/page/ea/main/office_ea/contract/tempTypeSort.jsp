...
<head lang="zh">
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>css/ea/office_ea/contract/tempTypeSort.css"/>
    <script src="<%=basePath%>js/jquery-1.9.1.min.js" type="text/javascript" charset="utf-8"></script>

    <script src="<%=basePath%>js/ea/office_ea/contract/tempTypeSort.js" type="text/javascript" charset="utf-8"></script>
    ...
    <table width="99%" height="204" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td width="46%" align="right">
                <ul class="ul-select" id="select1">
                  <s:iterator value="childlist" var="item">
                   <li id="${item.temptId}">${item.templateTypeName}</li>
                    </s:iterator>

                </ul>
                <%--<select name="staff" id="select1" size="15" style="width:130px; height:350px">--%>
                    <%--<s:iterator value="childlist">--%>
                    <%--<option value="<s:property value='temptId' />"><s:property value="templateTypeName" />--%>
                        <%--</s:iterator>--%>
                <%--</select>--%>
            </td>
            ...
            <td width="50%">
                ...
                <%--<select name="staff1" id="select2" size="15" style="width:130px; height:350px">--%>
