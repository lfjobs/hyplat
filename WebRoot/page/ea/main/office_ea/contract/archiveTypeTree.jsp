...
<head lang="zh">
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>css/ea/office_ea/contract/archiveTypeTree.css"/>
    ...
    <script src="<%=basePath%>js/ea/office_ea/contract/archiveTypeTree.js" type="text/javascript" charset="utf-8"></script>
