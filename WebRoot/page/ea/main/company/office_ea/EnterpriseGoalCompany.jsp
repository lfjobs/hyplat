...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <script src="<%=basePath%>js/jquery.js" type="text/javascript"></script>
        ...
        <script src="<%=basePath%>js/ea/company/office_ea/EnterpriseGoalCompany.js"></script>
	...
	<body >
        <div class="main_main">
            ...
            <c:import url="../../../page_navigator.jsp">
                <c:param name="actionPath" value="ea/goalC/ea_getEnterpriseGoalList.jspa?pageNumber=${pageNumber}">
                </c:param>
            </c:import>
        </div>
        <!--搜索窗口 -->
