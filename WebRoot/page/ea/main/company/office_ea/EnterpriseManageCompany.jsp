...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="<%=basePath %>js/ea/company/office_ea/EnterpriseManageCompany.js"></script> <script>
	...
	<body >
        <div class="main_main">
            ...
            <c:import url="../../../page_navigator.jsp">
                <c:param name="actionPath" value="ea/manageC/ea_getEnterpriseManageList.jspa?pageNumber=${pageNumber}">
                </c:param>
            </c:import>
        </div>
