...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="<%=basePath %>js/ea/company/office_ea/EnterpriseLogoGroup.js"></script>
        <script>
        	var token = 0;
	...
	<body >
        <div class="main_main">
            ...
            <c:import url="../../../page_navigator.jsp">
                <c:param name="actionPath" value="ea/logoo/ea_getEnterpriseLogoList.jspa?pageNumber=${pageNumber}&search=${search}">
                </c:param>
            </c:import>
        </div>
         <!--搜索窗口 -->
        <div class="jqmWindow " style="width:300px;right: 45%; top:10%" id="jqModelSearch">
            <form  id="postSearchForm"  name="postSearchForm" method="post">
                <div class="drag">
                    查询信息
                    <div class="close">
                    </div>
