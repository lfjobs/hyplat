...
<script type="text/javascript" src="<%=basePath%>js/common/common.js"></script>
        ...
        <script src="<%=basePath%>js/ea/company/office_ea/networkFaxCompany.js"></script>
	...
	<body >
        <div class="main_main">
            ...
            <c:import url="../../../page_navigator.jsp">
                <c:param name="actionPath" value="ea/networkfaxcompany/ea_getListNetworkFaxCompany.jspa?pageNumber=${pageNumber}&search=${search}">
                </c:param>
            </c:import>
        </div>
