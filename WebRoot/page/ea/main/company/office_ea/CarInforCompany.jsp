...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script src="<%=basePath%>js/ea/company/office_ea/CarInforCompany.js"></script>
	...
	<body >
        <div class="main_main">
            ...
            <c:import url="../../../page_navigator.jsp">
                <c:param name="actionPath" value="ea/carcompany/ea_getCarInformationList.jspa?pageNumber=${pageNumber}&search=${search}">
                </c:param>
            </c:import>
        </div>
