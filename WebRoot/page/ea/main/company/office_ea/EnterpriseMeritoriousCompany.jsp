...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="<%=basePath %>js/ea/company/office_ea/EnterpriseMeritoriousCompany.js"></script>
        <script>
           var token = 0;
  ...
  <body >
        <div class="main_main">
            ...
            <c:import url="../../../page_navigator.jsp">
                <c:param name="actionPath" value="ea/meritoriousC/ea_getEnterpriseMeritoriousList.jspa?pageNumber=${pageNumber}&search=${search}">
                </c:param>
            </c:import>
        </div>
