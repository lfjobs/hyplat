...
<script src="<%=basePath%>js/ea/company/office_ea/domainNameGroup.js"></script>
...
<div id="main_main" class="main_main">
 ...
 <c:import url="../../../page_navigator.jsp">
				<c:param name="actionPath"
					value="ea/domainnamegroup/ea_getListDomainnameGroup.jspa?pageNumber=${pageNumber}&search=${search}"></c:param>
</c:import>
</div>
