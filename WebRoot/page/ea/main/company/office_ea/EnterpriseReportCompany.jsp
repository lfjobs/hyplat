...
<script type="text/javascript" src="<%=basePath%>js/common/common.js"></script> 
        ...
        <script type="text/javascript" src="<%=basePath %>js/ea/company/office_ea/EnterpriseReportCompany.js"></script>
        <script>
	...
	<body >
        <div class="main_main">
            ...
            <c:import url="../../../page_navigator.jsp">
                <c:param name="actionPath" value="ea/reportC/ea_getEnterpriseReportList.jspa?pageNumber=${pageNumber}">
                </c:param>
            </c:import>
        </div>
             <!--搜索窗口 -->
            ...
            <form class="postSearchForm"  id="postSearchForm"  method="post" name="postSearchForm">
                ...
                <table id="cataffSearchTable">
                    <tr>
                        ...
                        <td>         
                           <input name="eenterpriseReport.reportDate" />  
                        </td>
                    </tr>
					<tr>
                        <td>
                        ...
                        <td>
                           <input name="enterpriseReport.reportContent" />
                        </td>
                    </tr>
                </table>
