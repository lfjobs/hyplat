...
<script type="text/javascript" src="<%=basePath%>js/jqModal/jqModal.js"></script>
		<script src="<%=basePath%>js/ea/company/office_ea/corporationPhotolistGroup.js"></script>
...
<body>
 ...
 <c:import url="../../../page_navigator.jsp">
				<c:param name="actionPath"
					value="ea/corporationPhotogroup/ea_getCorporationPhotoList.jspa?pageNumber=${pageNumber}&search=${search}"></c:param>
</c:import>
</div>
