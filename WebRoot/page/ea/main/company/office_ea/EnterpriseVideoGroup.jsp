...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="<%=basePath %>js/ea/company/office_ea/EnterpriseVideoGroup.js"></script>
        <script>
        	 var token = 0;
	...
	<body >
        <div class="main_main">
            ...
            <c:import url="../../../page_navigator.jsp">
                <c:param name="actionPath" value="ea/enterprisevideogroup/ea_getEnterpriseVideoList.jspa?pageNumber=${pageNumber}">
                </c:param>
            </c:import>
        </div>
        	  <!--搜索窗口 -->
