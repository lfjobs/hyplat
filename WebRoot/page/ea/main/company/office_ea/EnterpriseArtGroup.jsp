...
<script type="text/javascript" src="<%=basePath%>js/common/common.js"></script> 
		...
		<script type="text/javascript" src="<%=basePath%>js/ea/company/office_ea/EnterpriseArtGroup.js"> </script>
		...
		<div class="main_main">
			...
			<c:import url="../../../page_navigator.jsp">
				<c:param name="actionPath"
					value="ea/enterpriseartC/ea_getEnterpriseArtList.jspa?pageNumber=${pageNumber}&search=${search}">
				</c:param>
			</c:import>
		</div>
		 <!--搜索窗口 -->
