...
<script type="text/javascript" src="<%=basePath%>js/common/common.js"></script>
        ...
        <script src="<%=basePath%>js/ea/company/office_ea/qqGroup.js"></script>
        ...
        <div class="main_main">
          ...
          QQ号
            ...
            <c:import url="../../../page_navigator.jsp">
                <c:param name="actionPath" value="ea/qqgroup/ea_getQqGroupList.jspa?pageNumber=${pageNumber}&search=${search}">
                </c:param>
            </c:import>
        </div> 
