...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="<%=basePath %>js/ea/product/productdesignCompany.js"></script>   
            <script>
            var companyID  = "";
        ...
        <div class="main_main">
						...
						<tr id="${arr[0] }">
							...
							<td>
								<c:if test="${arr[13]!=null}">
									<a href="#" class="accessoriesUrl1" onclick="OpenWord('${arr[13]}','1')">查看附件</a>
							...
							<td>
								<c:if test="${arr[14]!=null}">
									<a href="#" class="accessoriesUrl2" onclick="OpenWord('${arr[14]}','1')">查看附件</a>
							...
							<td>
								<c:if test="${arr[15]!=null}">
									<a href="#" class="accessoriesUrl3" onclick="OpenWord('${arr[15]}','1')">查看附件</a>
            ...
            <c:import url="../../../page_navigator.jsp">
				<c:param name="actionPath"
					value="ea/productdesignC/ea_getListProductdesign.jspa?pageNumber=${pageNumber}&search=${search}&sdate=${sdate}&edate=${edate}"></c:param>
			</c:import>
        </div>
            ...
            <form class="postSearchForm"  id="postSearchForm"  method="post"  name="postSearchForm">
                ...
                <table id="cataffSearchTable">
                  <tr>
						...
						<td>
							<select id="departmentID" name="productDesign.departmentID">
								<option value="">
									请选择部门
								</option>
							</select>
