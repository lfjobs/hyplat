...
<script type="text/javascript" src="<%=basePath%>js/common/common.js"></script> 
        ...
        <script type="text/javascript" src="<%=basePath%>js/ea/company/human/staffdimpay_company.js">
        </script>
	...
	<body >
        <div class="main_main">
            ...
            <c:import url="../../../page_navigator.jsp">
                <c:param name="actionPath" value="ea/staffdimpaycompany/ea_getStaffDimPayList.jspa?pageNumber=${pageNumber}&staffName=${staffName}&sdate=${sdate}&edate=${edate}&search=${search}&staffcategoryid=${staffcategoryid}&arg=${arg}">
                </c:param>
            </c:import>
        </div>
