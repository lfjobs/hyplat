...
<script type="text/javascript" src="<%=basePath%>js/common/common.js"></script> 
        ...
        <script type="text/javascript" src="<%=basePath%>js/ea/company/human/payscalea_company.js"></script>
        ...
        <div class="main_main">
           ...
           PK金
            ...
            <c:import url="../../../page_navigator.jsp">
                <c:param name="actionPath" value="ea/payscaleacompany/ea_getPayScaleaList.jspa?pageNumber=${pageNumber}&search=${search }">
                </c:param>
            </c:import> 
        </div>
            ...
            <form name="cstaffForm" id="cstaffForm" method="post" enctype="multipart/form-data">
                ...
                <table width="690" height="211" border="0" align="center" cellpadding="0" cellspacing="0" id="stafftable">
                    <tr>
                        ...
                        <td>
                        <input name="payscale.position" class="model3 put3" id="position" size="20"/>                       
                        </td>
						<td align="right">&nbsp;</td>
                        <td>&nbsp;</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td ><input name="payscale.timingMoney" class="model3  isNaN" id="timingMoney" size="20"/></td>
                    ...
                    <tr>
                        ...
                        <td><input name="payscale.alimony" class="model3 isNaN" id="alimony" size="20"/></td>
                    </tr>
                    <tr>
