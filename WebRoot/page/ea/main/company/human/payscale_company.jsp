...
<script type="text/javascript" src="<%=basePath%>js/common/common.js"></script> 
        ...
        <script src="<%=basePath%>js/ea/human/cstaff.js">
          ...
          <script type="text/javascript" src="<%=basePath%>js/ea/company/human/payscale_company.js"></script>
        ...
        <div class="main_main">
           ...
           PK金
            ...
            <c:import url="../../../page_navigator.jsp">
                <c:param name="actionPath" value="ea/payscalecompany/ea_getPayScaleList.jspa?search=${search}&pageNumber=${pageNumber}">
                </c:param>
            </c:import>
        </div>
            ...
            <form name="cstaffForm" id="cstaffForm" method="post">
                ...
                <table width="690" height="211" border="0" align="center" cellpadding="0" cellspacing="0" id="stafftable">
                    ...
                    <tr>
                        ...
                        <td><input name="payscale.basePay" class="model3" id="basePay" size="20"/></td>
                        <td align="right">职务职责级别：</td>
                        <td><input name="payscale.positionPay" class="model3" id="positionPay" size="20"/></td>
                    </tr>
                    
                     <tr>
                        <td align="right">月考评：</td>
                        <td><input name="payscale.pushMoney" class="model3 " id="pushMoney" size="20"/></td>
                        <td align="right">月度任务：</td>
                        <td><input name="payscale.timingMoney" class="model3 " id="timingMoney" size="20"/></td>                    </tr>
                    <tr>
                        
                        <td align="right">月季年目标：</td>
                        <td><input name="payscale.goaltasks" class="model3 " id="goaltasks" size="20"/></td>
                         <td align="right">计件工资：</td>
                        <td><input name="payscale.piecerate" class="model3 " id="piecerate" size="20"/></td>
                    </tr>
                     <tr>
                        <td align="right">全勤奖：</td>
                        <td><input name="payscale.paAward" class="model3 " id="paAward" size="20"/></td>
                         <td height="27" align="right">奖励工资：</td>
                        <td><input name="payscale.awardPay" class="model3 " id="awardPay" size="20"/></td>
                    </tr>
                      <tr>
                        <td align="right">孝道金：</td>
                        <td><input name="payscale.pietypay" class="model3 " id="pietypay" size="20"/></td>
                         <td height="27" align="right">竞职金：</td>
                        <td><input name="payscale.campaignpay" class="model3 " id="campaignpay" size="20"/></td>
                    </tr>
                     <tr>
                        <td align="right">通讯补助：</td>
                        <td><input name="payscale.telecompay" class="model3 " id="telecompay" size="20"/></td>
                         <td height="27" align="right">生活补助：</td>
                        <td><input name="payscale.living" class="model3 " id="living" size="20"/></td>
                    </tr>
                     <tr>
                    	<td height="27" align="right">特殊人才工资：</td>
                        <td><input name="payscale.stPay" class="model3 " id="stPay" size="20"/></td>
                        <td height="27" align="right">保密工资：</td>
                        <td><input name="payscale.secrecyPay" class="model3 " id="secrecyPay" size="20" /></td>
                    </tr>
                    <tr>
                        <td align="right">安全奖：</td>
                        <td><input name="payscale.safetyAward" class="model3" id="safetyAward" size="20"/></td>
                         <td height="27" align="right">PK金：</td>
                        <td><input name="payscale.pkpay" class="model3" id="pkpay" size="20"/></td>
                    </tr>
                    <tr>
                    	<td height="27" align="right">全部都计：</td>
                        <td><input  class="model3" id="totalPay" size="20" readonly="readonly"/></td>
                         <td align="right">周末加班：</td>
                        <td><input name="payscale.workWeek" class="model3 " id="workWeek" size="20"/></td>
                    </tr>
                    <tr>
                         <td height="27" align="right">晚上加班： </td>
                        <td><input name="payscale.workNight" class="model3 " id="workNight" size="20"/></td>
                        <td height="27" align="right">节假日加班：</td>
                        <td><input name="payscale.workHolidays" class="model3 " id="workHolidays" size="20" /></td>
                    </tr>
                    <tr>
                        <td align="right">考勤工资：</td>
                        <td><input name="payscale.kkqnpay" class="model3" id="kkqnpay" size="20"/></td>
                        <td width="147" align="right">津贴费用：</td>
                        <td ><input name="payscale.expenseAllowances" class="model3" id="expenseAllowances" size="20"/></td>
                    </tr>
                    <tr>
                         <td align="right">折扣费用： </td>
                        <td><input name="payscale.discountedCost" class="model3" id="discountedCost" size="20"/></td>
                         <td align="right">个人保险费：</td>
                        <td><input name="payscale.premium" class="model3" id="premium" size="20"/></td>
                    </tr>
                    <tr>
                    	<td align="right">单位保险费：</td>
                        <td><input name="payscale.unpremium" class="model3" id="unpremium" size="20"/></td>
