...
$(function(){ 
    $('.flexme11').flexigrid({
	 ...
	 function action(com, grid){
        switch (com) {
         case '设置每页显示条数':
			var url="<%=basePath%>ea/clogbook/ea_getListCLogBook.jspa?search="+search+"&sdate="+sdate+"&edate="+edate;
				numback(url);
				break;
		 case '查询':
              $("#jqModelSearch").show();
        ...
        $(".close").click(function(){
         ...
         $("#tosearch").click(function(){
                    ...
                    $("#SearchForm").attr("action",  "<%=basePath%>ea/clogbook/ea_toSearch.jspa?pageNumber=${pageNumber}");
		...
		<form name="caccountList" method="post">
			<div class="main_main">
				...
				<c:import url="../../page_navigator.jsp">
					<c:param name="actionPath" value="ea/clogbook/ea_getListCLogBook.jspa?pageNumber=${pageNumber}&search=${search}&sdate=${sdate}&edate=${edate}"></c:param>
				</c:import>
				<s:token />
			</div>
		</form>
