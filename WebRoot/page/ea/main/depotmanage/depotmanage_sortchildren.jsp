...
$(function(){
	...
	$('#save_all').click(function(){
		...
		$("#childrenform").attr("action","<%=basePath%>ea/depotmanage/ea_sortChildDepotManage.jspa?pageNumber=${pageNumber}");
		document.childrenform.submit.click();
	})
	$('#goback').click(function(){
	  //   window.parent.location.href="<%=basePath%>ea/depotmanage/ea_sortChildDepotManage.jspa?pageNumber=${pageNumber}";
	    parent.document.getElementById("mainframe").src="<%=basePath%>ea/depotmanage/ea_getListDepotManageTree.jspa?pageNumber=${pageNumber}&depotID=${depotID}";
	});
...
<form name="childrenform" method="post" id="childrenform" action="">
<input type="submit" name="submit" style="display: none" />
	<input value="${depotID}" name="depotID" type="hidden" />
          ...
          <table width="100%" height="26" align="center" cellspacing="0" cellpadding="1" style="font-size:12px;" class="bannb_01">
            ...
            <table width="99%" height="37" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="22%" align="right">当前代码排序</td>
            ...
            <table width="99%" height="204" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="46%" align="right">
                	<SELECT name="staff" id="select1" size="15" style="width:120px; height:240px">
                		<s:iterator value="children" id="childrens">
		        			<option value="<s:property value='#childrens.depotID' />"><s:property value="#childrens.depotName" /></option>
		        		</s:iterator>	
                	</SELECT>
				</td>
                ...
                <td width="50%">
                	<SELECT name="staff1" id="select2" size="15" style="width:120px; height:240px">
                 		<%-- 将被重排的机构--%>
                	</SELECT>
				</td>
              </tr>
