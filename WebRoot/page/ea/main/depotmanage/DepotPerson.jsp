...
<script type="text/javascript" src="<%=basePath%>js/common/common.js"></script>
	...
	<script type="text/javascript" src="<%=basePath%>js/ea/depotmanage/DepotPerson.js"></script>
	...
	<body>
		...
		<c:import url="../../page_navigator.jsp">
                <c:param name="actionPath" value="ea/depotperson/ea_getListDepotPerson.jspa?depotPerson.depotID=${depotPerson.depotID}&pageNumber=${pageNumber}&search=${search}">
                </c:param>
            </c:import>
		</div>
			</form>
