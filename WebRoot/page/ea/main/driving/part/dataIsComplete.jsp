...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript"
			src="<%=basePath%>/js/ea/driving/part/dataIsComplete.js"></script>
   ...
   var  depotName='';
	...
	var dataIsComplete='${dtDrivingPrincipal.dataIsComplete}';
	var URL="";
	var staffID="";
	...
	<body>
				...
				<tbody>
					...
					<s:iterator value="pageForm.list" var="driving">
						<tr id="${driving[1]}">
							...
							<td>
								<span id="dataIsComplete">${driving[35]=='00'?'齐全':'不齐全'}</span>
							</td>		
						</tr>
						<%
							number++;
		...
		--%>
			<div>
				<iframe src="" name="mainframe13" style="width:100%;height:200px;"
					marginwidth="0"  marginheight="0" frameborder="0"
					id="mainframe13"  border="0" framespacing="0"  
					vspale="0"> </iframe>
			</div>
		</div>
		...
		<form name="cstaffForm" id="cstaffForm" method="post">
			...
			<input type="hidden" name="dtDrivingPrincipal.dataIsComplete" id="dataIsComplete"/>		
          ...
          <form name="SearchForm" id="SearchForm" method="post">
            	<input type="submit" name="submit" style="display:none"/>
            			报名时间：
							...
							<input type="text" id="sdate" name="dtDrivingPrincipal.searchStaDateOne" size="9" onfocus="date(this)"
									/>至
							<input type="text" id="edate" name="dtDrivingPrincipal.searchEndDateOne" size="9" onfocus="date(this)"
									/>
                           姓名： 
                 ...
                 个人身份证号：<input name="dtDrivingPrincipal.studentcard" size="11"/></td>
                    教练员：
                     ...
                     车牌号：<input name="dtDrivingPrincipalType.carNumber" size="8"/>报考车型：
                     <s:select id="registrationcarid"
									...
									theme="simple"></s:select>
                   		<input type="hidden" name="dtDrivingPrincipal.dataIsComplete" value="${dtDrivingPrincipal.dataIsComplete}"/>
