...
<script src="<%=basePath%>js/ea/driving/part/driving_training.js"></script>
...
<c:import url="../../../page_navigator.jsp">
				<c:param name="actionPath"
					value="ea/training/ea_getListDtDrivingTrainingInfor.jspa?pageNumber=${pageNumber}&dtDrivingAppointmentRecord.drivingprincipalid=${dtDrivingAppointmentRecord.drivingprincipalid}&dtDrivingAppointmentRecord.docstatus=${dtDrivingAppointmentRecord.docstatus}">
				</c:param>
			</c:import>
