...
<script type="text/javascript" src="<%=basePath%>js/ea/driving/driving_list_tongji_test.js"></script>
...
<div id="main_main" class="main_main">
  <table   class="JQueryflexme">
	  	<thead>
		 	    <tr>
		            ...
		            <th width="80" align="center" >测试结果</th> 
		            <th width="145" align="center" >第一次测试时间</th> 
		            <th width="135" align="center" >第一次测试扣分项目</th>
		            <th width="100" align="center" >第一次学员得分</th>
		            <th width="100" align="center" >第一次测试结果</th>
		            <th width="100" align="center" >第一次测试考官</th>
		            <th width="145" align="center" >第二次测试时间</th> 
		            <th width="135" align="center" >第二次测试扣分项目</th>
		            <th width="100" align="center" >第二学员得分</th>
		            <th width="100" align="center" >第二测试结果</th>
		            <th width="100" align="center" >第二次测试考官</th>
	      		</tr>
	    </thead>
		<tbody>
			<% int i=1; %>
          <s:iterator value="pageForm.list" var="ls">
	          <tr  id="${ls[10]}">
	         	 	<td >
						<input type="checkbox" name="id" class="chx data" value="${ls[10]}" ${extensionStaffCoach==null?'disabled':''} ${extensionStaffCoach==null?'checked':''} />
					</td>
	            	<td >
		                <span> <%=i%></span>
		            </td>
					...
					<td >
		               <span id="firstExamPoints" style="display:none;">${ls[16]}</span>
					...
					<td >
						<span id="firstExamresult" style="display:none;">${ls[23]}</span>
					...
					<td >
		                <span id="secondExamPoints" style="display:none;">${ls[19]}</span>
					...
					<td >
						<span id="secondExamresult" style="display:none;">${ls[21]}</span>
 ...
 <c:import url="../../page_navigator.jsp">
				<c:param name="actionPath"
					value="ea/driving/ea_toSearchStatisticsOfTest.jspa?pageNumber=${pageNumber}&docstatus=${docstatus}&sdate=${sdate}&edate=${edate }&search=${search}&other=${other}&extensionStaffCoach=${extensionStaffCoach}&dtDrivingPrincipal.studentid=${dtDrivingPrincipal.studentid}"></c:param>
</c:import>
...
<div id="jqmWindow2" class="jqmWindow"
	...
	<div align="center">
		<iframe name="ifr" id="ifr" width="100%" height="280px" s
