...
<script src="<%=basePath%>js/ea/driving/potentialCustomerSummary.js"></script>
		...
		<form name="lForm" id="lForm" method="post">
			...
			<table class="staffappraisal">
				...
				<c:param name="actionPath"
					value="ea/customermanage/ea_getPotentialListSummary.jspa?pageNumber=${pageNumber}&search=${search}&status1=${status1}&type=${type}"></c:param>
			</c:import>
			<s:token></s:token>
			</div>
		</form>
