...
<body style="overflow: scroll;">
	<div class="content" style="width:100%;margin-top: 10px;">
		<table width="99%" border="0" align="center" cellpadding="0"  style="margin-top: 5px;"
			cellspacing="0"  >
			<tr>
				<td height="25" align="center"><span style="font-size: x-large;">${sdate }至${edate}(年度)教练培训质量排行榜</span></td>
			</tr>
		</table>
				...
				<table id="stafftable" width="99%" align="center" cellpadding="0" border="1" style="margin-top: 0px;margin-bottom: 0px;"
					...
					<thead>
					     <tr>
					    	 ...
					    	 <s:iterator value="#request.testMonthlyList" var="t">
					    	 	<td colspan="3"><s:property value="#t"/></td>
					    	 </s:iterator>
					    	 <td colspan="3">合计</td>
					     </tr>
					     <tr>
					...
					<tbody>
						<s:iterator value="#request.listOfListOfCoachsOfqualifiedOfAnnual" status="i" var="array">
						 	<tr>
