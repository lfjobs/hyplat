...
<script type="text/javascript" src="<%=basePath%>js/ea/driving/driving_list_fenxi.js"></script></head>
<body>
...
<div id="main_main" class="main_main">
 ...
 <c:import url="../../page_navigator.jsp">
				<c:param name="actionPath"
					value="ea/driving/ea_getAnalysisList.jspa?pageNumber=${pageNumber}&docstatus=${docstatus}&sdate=${sdate}&edate=${edate }&search=${search}&other=${other}"></c:param>
</c:import>
</div>
</form>
