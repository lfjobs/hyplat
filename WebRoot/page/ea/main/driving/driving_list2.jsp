...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript"
			src="<%=basePath%>js/ea/driving/driving_list2.js"></script>
   ...
   var  depotName='';
	...
	<body>
				...
				<tbody>
					...
					<s:iterator value="pageForm.list" var="driving">
						<tr id="${driving[1]}">
							...
							<td>
								<span id="studentstatus">${driving[21]=='02'?'未预约':'已预约'}</span>
		...
		<div class="jqmWindow" style="width: 320px; right: 35%; top: 15%;height: 120px"
				id="jqModelSearchss">
				<form name="fencheForm" id="fencheForm" method="post">
					<input type="submit" name="submit" style="display: none" />
					<input type="hidden" id="docstatus"
					...
					<table width="320">
						<tr>
							...
							<td>
								<input type="text" id="coachname" name="dtDrivingPrincipalType.coachname" class="put3" readonly="readonly" style="width: 100px;background-color: #E6E6E6"/>
								<input type="hidden" id="coachid"
									name="dtDrivingPrincipalType.coachid" />
							</td>
						</tr>
						<tr>	
							<td align="right">
							...
							<td>
								<input type="text" id="carNumber" name="dtDrivingPrincipalType.carNumber" class="put3" readonly="readonly" style="width:100px;background-color: #E6E6E6"/>
				...
				<div class="content">
					...
					<table width="850" border="0" id="stafftable2" align="center"
						...
						<tr>
							...
							<td width="80">
								<input type="text" id="companyName" readonly="readonly" style="border: 0;background-color:#DAE7F6;width: 180px "
									value="${companyName}" />
							</td>
							<td width="80" height="35" align="right">
								部门：
							...
							<td width="80">
								<input type="text" id="organizationname" readonly="readonly"  style="border: 0;background-color:#DAE7F6 "/>
							</td>
							<td width="80" height="35" align="right">
								责任人：
							</td>
							<td width="80">
								<input type="text" id="responsiblePersonsID"  readonly="readonly" style="border: 0;background-color:#DAE7F6 "/>
							</td>
						...
						<tr>
							...
							<td width="80">
								<input type="text" id="registrationdate" readonly="readonly"  style="border: 0;background-color:#DAE7F6 "/>
							</td>
							<td width="80" height="35" align="right">
								车型：
							</td>
							<td width="80">
								<input type="text" id="registrationcarname" readonly="readonly" style="border: 0;background-color:#DAE7F6 " />	
							</td>
							<td width="80" height="35" align="right">
								姓名：
							</td>
							<td width="80">
								<input type="text" id="studentname" readonly="readonly" style="border: 0;background-color:#DAE7F6 "/>
							</td>
						...
						<tr>
							...
							<td width="80">
								<input type="text" id="studentsex"  readonly="readonly" style="border: 0;background-color:#DAE7F6 "/>
							</td>
							<td width="80" height="35" align="right">
								电话：
							</td>
							<td>
								<input type="text" id="studentphone"  readonly="readonly" style="border: 0;background-color:#DAE7F6 "/>
							</td>
							<td width="80" height="35" align="right">
								身份证号：
							</td>
							<td width="80">
								<input type="text" id="studentcard"  readonly="readonly" style="border: 0;background-color:#DAE7F6 "/>
							</td>
						...
						<tr>
							...
							<td>
								<input type="text" id="resgistrationmedicaldate"  readonly="readonly" style="border: 0;background-color:#DAE7F6 "/>
							</td>
							<td width="80" height="35" align="right">
								是否合格：
							</td>
							<td width="80">
								<input type="text" id="istrues"  readonly="readonly" style="border: 0;background-color:#DAE7F6 "/>		
							</td>
							<td width="80" height="35" align="right">
								操作时间：
							</td>
							<td width="80">
								<input type="text" id="operationdate"  readonly="readonly" style="border: 0;background-color:#DAE7F6 " />
							</td>
						...
						<tr>
							...
							<td width="80" >
								<input type="text" id="reason" readonly="readonly"  style="border: 0;background-color:#DAE7F6;width: 180px  "/>
								...
								<input type="hidden" id="studentstatus"
									name="studentstatus" value="${studentstatus}"/>	
							...
							<td width="80">
								<input type="text" id="coachname"   readonly="readonly" style="border: 0;background-color:#DAE7F6;width: 180px  "/>
							</td>
						</tr>
					</table>
				</div>
		...
		<div class="jqmWindow" style="width: 400px;right: 25%;;top: 10%;" id="jqModelSearch">
          <form name="SearchForm" id="SearchForm" method="post">
            ...
            <div class="drag">
                ...
                <table width="396" id="cataffSearchTable"  style="margin: 0px;">
		              <tr align="left">
		                        <td  align="right">
		                           姓名：</td>
								<td  align="left">
									<input name="dtDrivingPrincipal.studentname"  class="ckTextLength" maxlength="20"/>
		                        </td>
		              </tr>
              
                    <tr align="left">
                        <td align="right">个人身份证号：</td>
                     	<td align="left"><input name="dtDrivingPrincipal.studentcard" class="ckTextLength" maxlength="36"/></td>
                    </tr>
                    <tr align="left">
                        <td align="right">教练员：</td>
                     <td align="left"><input name="dtDrivingPrincipalType.coachname"  class="ckTextLength" maxlength="20"/></td>
                    </tr>
                    <tr align="left">
                        <td align="right">车牌号：</td>
                     <td align="left"><input name="dtDrivingPrincipalType.carNumber" class="ckTextLength" maxlength="20"/></td>
                    </tr>
                    <tr align="left">
                        <td align="right">报考车型：</td>
                     <td align="left"><s:select id="registrationcarid"
									name="dtDrivingPrincipal.registrationcarid"
									list="examinationList" listKey="codeID" listValue="codeValue" headerKey="" headerValue="请选择"
                   ...
                   <tr align="left">
                   		...
                   		<td align="left">
                   			<select name="conditions">
                   				...
                   				<option value="conditionsFalse">待处理</option>
                   				<option value="conditions">已处理</option>
                   			</select>
                   		</td>
                   	</tr>
                </table>
