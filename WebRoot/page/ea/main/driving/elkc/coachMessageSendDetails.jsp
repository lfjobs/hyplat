...
<div class="wrap_page">
	<div class="mes_wrap">
        ...
        <c:if test="${map.entplist!=null}">
            <div class="mes_part clearfix">
                <div class="mes_L">图片</div>
                <div class="mes_R mes_img_box clearfix">
                    <c:forEach items="${map.entplist}" var="l">
	...
	<div class="receive_wrap">
		...
		<div class="receive clearfix">
			<c:forEach items="${map.ensalist}" var="s">
				<div class="receive_box">
					<img src="<%=basePath%>${s[1]}" alt="" onerror="this.src='<%=basePath%>images/ea/driving/elkc/head.png'">
					<span>${s[2]}</span>
				</div>
			</c:forEach>
		</div>
