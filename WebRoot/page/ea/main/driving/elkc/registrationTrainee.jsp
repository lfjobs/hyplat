...
<head>
    ...
    <script type="text/javascript" src="<%=basePath%>js/ea/driving/elkc/student_info.js"></script>
...
<div class="main_main">
    <table class="JQueryflexme" cellpadding="0" cellspacing="0">
        ...
        <s:iterator value="pageForm.list" var="list">
            <tr id="${list[0]}">
                ...
                <td>
                    <span id="staffCode">${list[1]}</span>
                </td>
                <td>
                    <span id="staffName">${list[2]}</span>
                </td>
                <td>
                    <span id="sex">${list[3]==1?"男":"女"}</span>
                </td>

                <td>
                    <span id="cardnum">${list[4]}</span>
                </td>
                <td>
                    <span id="phone" >${list[5]}</span>
                </td>
                <td>
                    <span id="brith" class="datas">${list[6]}</span>
                </td>
                <td>
                    <span id="trainType">${list[7]}</span>
                </td>
                <td>
                    <span id="companyName">${list[8]}</span>
                </td>
            </tr>
            <%
                number++;
    ...
    <c:import url="../../../page_navigator.jsp">
        <c:param name="actionPath"
                 value="/ea/coachreserv/ea_registrationTrainee.jspa?search=${search}&pageNumber=${pageNumber}&aa=${aa }&flexbutton=${param.flexbutton}&cstaff.status=${cstaff.status}&showType=${showType}&parameter=${parameter}">
        </c:param>
    </c:import>
