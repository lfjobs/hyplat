...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript"
			src="<%=basePath%>js/ea/driving/driving_list_baokaixue.js"></script>
...
<script type="text/javascript" src="<%=basePath%>js/ea/ccodes_add.js"></script>
	...
	<body>
				...
				<tbody>
					...
					<s:iterator value="pageForm.list" var="driving">
						<tr id="${driving[1]}">
							...
							<td>
								<span id="studentCode">${driving[31]==null?'暂未分配':driving[31]}</span>
							</td>
							<td>
							...
							<td>
								<span id="studentstatus">${driving[21]=='05'?'已报开学':'未报开学'}</span>
		...
		<div class="jqmWindow" style="width: 450px; right: 30%; top: 20%;height: 160px"
				id="jqModelSearchss">
				<form name="baokaixueForm" id="baokaixueForm" method="post">
					<input type="submit" name="submit" style="display: none" />
					<div class="drag">
						报开学
						<div class="close">
					...
					<table width="450"  >
						<tr align="center">
							...
							<td align="left">
								<input type="text"
									name="dtDrivingPrincipal.schoolopendate" onfocus="WdatePicker({skin:'whyGreen',dateFmt: 'yyyy-MM-dd'})"  class="put3" size="10"/>
						...
						<tr align="center">
							...
							<td align="left">
								<input type="text"
									name="dtDrivingPrincipal.studentPeriods" onfocus="WdatePicker({skin:'whyGreen',dateFmt: 'yyyy-MM'})"  class="put3" size="10"/>
							</td>
						</tr>
						<tr align="center">
							<td align="right">
							...
							<td align="left">
								是<input type="radio"  name="dtDrivingPrincipal.ifPay" value="true" />&nbsp;&nbsp;否<input type="radio"  name="dtDrivingPrincipal.ifPay" value="false" checked="checked"/>
							</td>
						</tr>
						<tr align="center">
							<td align="right">
							...
							<td align="left">
								<input type="text"  name="dtDrivingPrincipal.money" class="put3" size="10"/> 
							</td>
						</tr>
					</table>
					<div align="center">
