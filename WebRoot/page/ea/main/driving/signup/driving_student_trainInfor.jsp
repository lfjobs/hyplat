...
<script src="<%=basePath%>js/ea/driving/signup/driving_student_trainInfor.js"></script>
<script type="text/javascript" src="<%=basePath%>js/flexigrid.js"></script>
  ...
  <table class="contact">
  	<thead>
	    <tr>
	      ...
	      <th width="100" align="center" >科目类型</th>
    ...
    <s:iterator value="beanList">
          <tr class="td_bg01 saveAjax trclass" >
		            ...
		            <td class="td_bg01"><span id="shuttleAddress">${operationname=='01'?'科一':operationname=='02'?'科二':operationname=='03'?'科三':'科四'}</span>
      				</td>
      				<td class="td_bg01"><span id="shuttleAddress">${notes}</span>
      				</td>
      				<td class="td_bg01"><span id="shuttleAddress">${operationname=='01'?'科一':operationname=='02'?'科二':operationname=='03'?'科三':'科四'}</span>
      				</td>
      				<td class="td_bg01"><span id="shuttleAddress">${operatinid}</span>
      				</td>
