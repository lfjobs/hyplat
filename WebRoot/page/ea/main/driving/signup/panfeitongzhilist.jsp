...
<script type="text/javascript" src="<%=basePath%>js/ea/driving/panfeitongzhi.js"></script>
			...
			<table class="JQueryflexme">
				<thead>
					<tr>
						...
						<th width="100" align="center">气瓶类型</th>
						<th width="100" align="center">出厂日期</th>
				...
				<tbody>
					...
					<s:iterator var="item" value="pageForm.list" status="index">
						<tr id="${item[0]}">
							...
							<td><span id="cylinderType">${item[2]}</span></td>
							<td><span id="cylinderModel">${item[3]}</span></td>
							<td><span id="licensenumber">${item[4]}</span></td>
							<td><span id="certificateNumber">${item[8]}</span>
							</td>
							<td><span id="leavdate">${item[9]}</span>
							</td>
							<td><span id="unistalldate">${fn:substring(item[10], 0, 10)}</span>
							</td>
							<td><span id="manufactureCompany"> ${fn:substring(item[11], 0, 10)}</span>
							</td>
							<td><span id="manufactureCompany">${item[7]}</span>
