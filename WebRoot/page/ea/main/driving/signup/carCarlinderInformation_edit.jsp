    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <table class="table" width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
          	...
          	<input type="text" STYLE="display:none" id="userstaffID" value = "${obj[42] }"/>
            <td width="50">&nbsp;</td>
            <td width="65">气瓶编号</td>
            <td width="50">类型</td>
            ...
            <td width="50">树脂</td>
            <td width="65">制造国别</td>
            <td class="bor_r">制造代号</td>
          </tr>
          <tr id="informationline">
            <td bgcolor="#4eccc8" id="addline"><strong style="color:white" id="deleteline">添加</strong></td>
            <td><input type="text" name = "carCylinderInformation.cylinderNum" class="textType" value="${obj[0] }"/> <span id="carlinderID" style="display:none"> ${obj[41] }</span></td>
            <td><select style="width:70px;" id="carlindertype" name = "carCylinderInformation.cylinderType">
        <option value="--请选择--">--请选择--</option>
          <option value="G:钢瓶">G:钢瓶</option>
          <option value="C:缠绕瓶">C:缠绕瓶</option>
        </select></td>
            <td><input type="text" class="textType" name="carCylinderInformation.designThickness" value="${obj[2] }"/></td>
            <td>
            <select style="width:88px;" id="carlindermodel" name="carCylinderInformation.cylinderModel" style="display:none">
            <option value="${obj[3] }">${obj[3] }</option>
        	</select>
        </td>
            <td><input type="text" class="textType" name="carCylinderInformation.manufactureCompany" value="${obj[4] }"/></td>
            <td><input type="text" class="textType" onfocus="date(this)" name="carCylinderInformation.leavefactorydate" value="${obj[5] }"/></td>
            <td><input type="text" class="textType" name="carCylinderInformation.volume" value="${obj[6] }"/></td>
            <td><input type="text" class="textType" name="carCylinderInformation.weight" value="${obj[7] }"/></td>
            <td><input type="text" class="textType" name="carCylinderInformation.nominalworkpressure" value="${obj[8] }"/></td>
            <td><input type="text" class="textType" name="carCylinderInformation.hydraulicTestPressure" value="${obj[9] }"/></td>
            <td><input type="text" class="textType" name="carCylinderInformation.texture"  value="${obj[10] }"/></td>
            <td><input type="text" class="textType" name="carCylinderInformation.fiber" value="${obj[11] }"/></td>
            <td><input type="text" class="textType" name="carCylinderInformation.resin" value="${obj[12] }"/></td>
            <td><input type="text" class="textType" name="carCylinderInformation.manufacturingcountry" value="中国" value="${obj[13] }"/></td>
            <td class="bor_r"><input type="text" class="textType" name="carCylinderInformation.madecode" value="${obj[14] }"/></td>
          </tr>
        </table>
      ...
      <tr>
        ...
        <table class="table" width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td><input type="text" class="textType" name="carCylinderInformation.licensenumber" value="${obj[15] }" /><span id="carnum">${obj[15] }</span></td>
            <td><input type="text" class="textType" name="carCylinderInformation.registrationcode" value="${obj[16] }"/></td>
            <td><input type="text" class="textType" name="carCylinderInformation.certificateNumber" value="${obj[17] }"/></td>
            <td><input type="text" class="textType" name="carCylinderInformation.area" value="${obj[18] }" /></td>
            <td><input type="text" class="textType" name="carCylinderInformation.licenseplatetype" value="${obj[19] }"/></td>
            <td><input type="text" class="textType" name="carCylinderInformation.chassisnumber" value="${obj[20] }"/></td>
            <td><input type="text" class="textType" name="carCylinderInformation.enginenumber" value="${obj[21] }"/></td>
            <td><input type="text" class="textType" name="carCylinderInformation.installationunit" value="${obj[22] }"/></td>
            <td><input type="text" class="textType" name="carCylinderInformation.installationnumber" value="${obj[23] }"/></td>
            <td><input type="text" class="textType" name="carCylinderInformation.certifyingauthority" value="${obj[24] }"/></td>
            <td><input type="text" class="textType" onfocus="date(this)" name="carCylinderInformation.installationdate" value="${fn:substring(obj[25], 0, 10)}"/></td>
            <td class="bor_r"><input type="text" class="textType" onfocus="date(this)" name="carCylinderInformation.issuedate" value="${fn:substring(obj[26], 0, 10)}"/></td>
          </tr>
        </table>
        </td>
      </tr>
      ...
      <tr>
        <td>
          <div class="tj" style="width:100%; float:left; height:80px; ">
              <input name="save" class = "jquemsubmit" type="button" value="保存" style="margin-top:30px;">
              <input name="" type="button" value="返回" style="margin-left:20px; margin-top:30px;" onclick="window.location.href='<%=basePath%>ea/productregister/ea_getListProductregister.jspa'">
          </div>
        </td>
      </tr>
     </table>
