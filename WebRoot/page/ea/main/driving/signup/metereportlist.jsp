...
<script type="text/javascript" src="<%=basePath%>js/ea/driving/metroreport.js"></script>
				...
				<tbody>
					...
					<s:iterator var="item" value="pageForm.list" status="index">
						<tr id="${item[0]}">
							...
							<td><span id="certificateNumber">${item[5]}</span>
							</td>
							<td><span id="manufactureCompany">${item[6]}</span>
							</td>
