      ...
      <tr>
        ...
        <table class="table" width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr id="informationline">
            ...
            <td><select style="width:70px;" id="carlindertype" name = "carcymap[0].cylinderType">
        ...
        <span> ${obj[3] }</span>
            ...
            <td><input type="text" class="textType" name="carcymap[0].hydraulicTestPressure"/><span> ${obj[9] }</span></td>
            <td><input type="text" class="textType" name="carcymap[0].texture" value="0CrMo"/><span> ${obj[10] }</span></td>
            ...
            <td style="display:none"><input type="text" name="carcymap[0].status" value="01"/></td>
          </tr>
        </table>
