...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript"
			src="<%=basePath%>js/ea/driving/driving_list_fenche.js"></script>
				...
				<tbody>
					...
					<s:iterator value="pageForm.list" var="driving">
						<tr id="${driving[1]}">
							...
							<td>
								<span id="studentstatus">${driving[21]=='05'?'未分车':'已分车'}</span>
            ...
            <div class="drag">
              ...
              <tr>
                    ...
                    <tr>
                     ...
                     <td><input name="dtDrivingPrincipal.studentcard" /></td>
                    </tr>
                    <tr>
                        <td align="right">教练员：</td>
                     <td><input name="dtDrivingPrincipalType.coachname" /></td>
                    </tr>
                    <tr>
                        <td align="right">车牌号：</td>
                     <td><input name="dtDrivingPrincipalType.carNumber" /></td>
                    </tr>
                    <tr>
                        <td align="right">报考车型：</td>
                     <td><s:select id="registrationcarid"
