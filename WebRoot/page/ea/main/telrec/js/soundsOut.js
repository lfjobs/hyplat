$(document).ready(function() {
	...
	function action(com, grid) {
		switch (com) {
			...
			case '设置每页显示条数' :
				...
				var url = basePath + "ea/tel/tel_soundOutRecords.jspa?search="
	...
	$("#searchStaff").click(function() {
		...
		$("#postSearchForm").attr(
				"action",
				basePath + "ea/tel/tel_searchSoundOutRecords.jspa?pageNumber="
						+ pNumber);
...
function re_load() {
	if (token) {
		document.location.href = basePath
				+ "ea/tel/tel_soundsOutRecords.jspa?pageNumber=" + pNumber
