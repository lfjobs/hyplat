...
<script type="text/javascript" src="<%=basePath%>js/common/common.js"></script> 
        ...
        <script language="javascript" type="text/javascript" src="<%=basePath%>js/ea/human/examine/humanExamine_list.js"></script>
			...
			document.onkeydown = function(evt){//捕捉回车 
				...
				if (key == 13) { //判断是否是回车事件。
					if($("input#journalNum").val()==''){
		   			...
		   			if($("input#journalNum").val()!=''){
		       			$("#SearchForm").attr("action", basePath+"ea/humanExamine/ea_toSearch.jspa?pageNumber="+pNumber);
    ...
    <body>
        ...
        <c:import url="../../../page_navigator.jsp">
            <c:param name="actionPath" value="ea/humanExamine/ea_getHumanList.jspa?search=${search}&pageNumber=${pageNumber}&sdate=${sdate}&edate=${edate}">
            </c:param>
        </c:import>
        <!--搜索窗口 -->
                ...
                <table width="326" id="SearchTable">
                    ...
                    <tr>
						...
						<td >
					    	...
					    	<option value="1" selected="selected" >待人事审核</option>
