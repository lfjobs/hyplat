...
$(function(){
	...
	<body>
		<div class="main_main">
			...
			<c:import url="../../../../page_navigator.jsp">
				<c:param name="actionPath"
					value="ea/logbooksummary/ea_getListLogBook.jspa?pageNumber=${pageNumber}&aa=zz&search=${search}&sdate=${sdate}&edate=${edate}">
				</c:param>
			</c:import>
		</div>
		...
		<div class="jqmWindow" style="width: 500px; right: 25%; top: 10%"
			...
			<form name="postDaYinForm" id="postDaYinForm" method="post">
				...
				<div align="center">
					...
					<input name="search" type="hidden" value="search" />
					<input id="pagevalue" type="hidden" value="zz" />
				</div>
			</form>
		</div>
		...
		<!--加解锁窗口 -->
		<!--
        <div class="jqmWindow" style="width: 500px;right: 25%;top: 10%"  id="jqModelLock">
        	<form name="postLockForm" id="postLockForm"  method="post">
            	<input type="submit" name="submit"  style="display:none"/>
                <div class="drag">
                    工作日志加锁
                    <div class="close">
                ...
                <table width="493" id="lockTable">
                  <tr>
                        <td align="right">
                            	时间：
                        </td>
                  		<td>
                            <input name="sdate" id="sdate"   onfocus="date(this);"/>至<input name="edate" id="edate" onfocus="date(this);"/>
                        </td>
                  </tr>
                   
              </table>
                <div align="center">
                    <input type="button" class="input-button"  id="toLock" value="加锁" /><input type="button" class="input-button"  id="unLock" value="解锁" />
                </div>
           </form>
        </div>
        -->
