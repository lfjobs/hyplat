...
.STYLE2 {
	...
	<body
		...
		<table id="content" width="940px" align="center" cellpadding="0" cellspacing="0"
			class="table">
			<tr>
				<td height="32" colspan="${fn:length(add)+fn:length(cut)+(arg==1?34:33)}" align="center">
			...
			<c:set value="0" var="discount" />
				<tr>
					...
					<td>
                         ${entity.pietypay }
						<c:set value="${result+entity.pietypay}" var="result"></c:set>
                     </td>
                       <td>
                          ${entity.campaignpay }
						<c:set value="${result+entity.campaignpay}" var="result"></c:set>
                     </td>
                       <td>
                           ${entity.telecompay }
						<c:set value="${result+entity.telecompay}" var="result"></c:set>
                     </td>
                       <td>
                          ${entity.living }
						<c:set value="${result+entity.living}" var="result"></c:set>
                     </td>
					<!-- 奖励积分 -->
					<td align="center">
			...
			<tr>
				...
				<td colspan="${fn:length(add)+fn:length(cut)+(arg==1?10:9)}" align="center">
				</td>
			</tr>
		</table>
		<script>
