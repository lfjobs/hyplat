...
<script type="text/javascript" src="<%=basePath%>js/common/common.js"></script> 
        ...
        <script type="text/javascript" src="<%=basePath%>js/ea/human/office/production/SalaryIntergral.js">
        </script>
	...
	<body >
        <div class="main_main">
            ...
            <c:import url="../../../../page_navigator.jsp">
                <c:param name="actionPath" value="ea/logbooksummary/ea_getListLogBookIntegral.jspa?pageNumber=${pageNumber}&staffName=${staffName}&sdate=${sdate}&edate=${edate}&search=${search}&staffcategoryid=${staffcategoryid}&arg=${arg}">
                </c:param>
            </c:import>
        </div>
