...
<script type="text/javascript" src="<%=basePath%>js/common/common.js"></script> 
        ...
        <script src="<%=basePath%>js/ea/human/office/production/staffpayScale.js"></script>
    ...
    <body>
        ...
        <div class="main_main">
            ...
            <c:import url="../../../../page_navigator.jsp">
                <c:param name="actionPath" value="ea/payscale/ea_getStaffPayScaleList.jspa?search=${search}&pageNumber=${pageNumber}">
                </c:param>
            </c:import>
            <div>
            ...
            <form name="cstaffForm" id="cstaffForm" method="post" enctype="multipart/form-data">
                ...
                <table width="690" height="211" border="0" align="center" cellpadding="0" cellspacing="0" id="stafftable">
                    <tr>
                        ...
                        <td ><input type="text"  class="model3" value='' id="staffName" readonly="readonly" size="20"/></td>
                        <td align="right">员工编号：</td>
                        <td><input  class="model3" id="staffCode" readonly="readonly"  size="20"/> </td>
                    </tr>
                    <tr>
                        <td width="147" align="right">性别：</td>
                        <td ><input type="text"  class="model3" value='' readonly="readonly"  id="sex" size="20"/></td>
                        <td align="right">身份证号：</td>
                        <td><input  class="model3" id="staffIdentityCard" readonly="readonly"  size="20"/> </td>
                    </tr>
                    <tr>
                        <td width="147" align="right">岗位级差：</td>
                        <td ><input type="text"  class="model3" value='' readonly="readonly"  id="scale" size="20"/></td>
                        <td align="right">职务：</td>
                        <td><input  class="model3" id="position" readonly="readonly"  size="20"/> </td>
                    </tr>
                     <tr>
                        <td align="right">职务职责级别：</td>
                        <td><input  class="model3 isfloat" id="positionPay" readonly="readonly"  size="20"/></td>
                    ...
                    <tr>
                        ...
                        <td><input class="model3" readonly="readonly"  id="paAward" size="20"/></td>
