...
.xx {
	...
	margin-right: 2px;
		...
		<script
			src="<%=basePath%>js/ea/human/office/production/orgPost_list.js"></script>
			...
			<div id="main_main">
				...
				<table class="JQueryflexme">
					...
					<tbody id="tbwid">
						...
						<tr id="sa" style="display: none" class="td_bg01 saveAjax model2">
							...
							<td class="td_bg01">
								<input name="postSureNum"id="postSureNum" />
							</td>
								<td class="td_bg01">
								<input name="SpecialpostNum"id="SpecialpostNum" value="自动生成" readonly="readonly"/>
							</td>
							<td class="td_bg01">
						...
						<c:forEach var='arr' items="${pageForm.list}">
							<tr id="${arr[0]}" class="td_bg01 saveAjax" class="trclass">
								...
								<td class="td_bg01">
									...
									<input class="model1" value="${arr[1]}" name="postName" id="postName"/>
								</td>
								<td class="td_bg01">
								...
								<td class="td_bg01">
									...
									<input class="model1 " value="${arr[4]==null ? "0" : arr[4]}" name="postSureNum" />人
								</td>
								<td class="td_bg01">
									<span id="SpecialpostNum">${arr[12]==null ? "0" : arr[12]}</span>
									<input class="model1 " value="${arr[12]==null ? "0" : arr[12]}" name="SpecialpostNum" readonly="readonly"/>
									人
								</td>
								<td class="td_bg01">
				...
				<c:import url="../../../../page_navigator.jsp">
					<c:param name="actionPath"
						value="ea/departmentpost/ea_getOrgPostListByOrg.jspa?departmentPost.organizationID=${departmentPost.organizationID }&pageNumber=${pageNumber}">
					</c:param>
				</c:import>
			</div>
		</form>
