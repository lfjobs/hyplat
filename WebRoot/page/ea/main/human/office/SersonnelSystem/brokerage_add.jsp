...
<head>
    ...
    <script type="text/javascript" src="<%=basePath%>js/ea/human/office/SersonnelSystem/brokerage_add.js"></script>
    <style type="text/css">
        #apDiv1 {
            position: absolute;
            left: 707px;
...
<form name="CostSheetForm" id="CostSheetForm" method="post"
    ...
    <div id="maindiv">
        ...
        <div id="Layer2" style="width: 1100px; height: 500px;overflow:auto;">
            ...
            <table id='edit' width='100%'>
                <s:iterator value="pclist" var="pc">
                    <%--<tr>
                        <td>${pc.fcomName==""||pc.fcomName==null?"应用于所有子公司":pc.fcomName}</td>
                    </tr>--%>
                    <tr>
                        <td>
                            <div class="wfj11_111">
                                <div class="wfj11_111_width">
                                    <table width="70%">
                                        ...
                                        <tr class="wfj11_111_height">
                                            <td style="padding-left:5px;" align="left">
                                                <input id="cpname" name="ppname" readonly="readonly"
                                                       style="width:100%;border:0px;text-align:left;"
                                                       class="cpname cp" value="${pc.ppname }"/>
                                            </td>
                                            <td align="right">
                                                <input name="rePrice" readonly
                                                       class="jisuan model1 fou posnumred cp brokerage" id="ls"
                                                       style="display:inline;width:100%;height:99%; border:0px; text-align: right;"
                                                       value="${pc.rePrice }"/>
                                                <input type="hidden" name="ppid" id="ppID" class="cpid cp"/>
                                            </td>
                                            <td align="right">
                                                <input id="cc" name="efPrice" readonly
                                            ...
                                            <s:iterator value="#pc.vallist" var="dl">
                                                <td align="right">
                                                    <input readonly class="jisuan model1 fou posnumred cp brokerage"
                                                           style="display:inline;width:100%;height:99%; border:0px; text-align: right;"
                                                           value="${dl[2]}"/>
                                            ...
                                            <td align="right">
                                                <input name="brokerage" id="yj" size="3" class="cp yewu brokerage"
                                                       readonly style="width:100%; border:0px; text-align: right;"
                                                       value="${pc.brokerage }"/>
                                            </td>
                                            <td align="right" id="tzTypeEdit">
                                                    ${pc.tzType=='01'?"教练车":pc.tzType=='02'?"创客单车":pc.tzType=='03'?"超市":"无"}
                                            </td>
                                    ...
                                    <!-- 业务佣金分配比例表 -->
                                    <table class="tbleft" width="60%"
                                           style="z-index:999;position: absolute;top: 30%;left: 20%;background: #fff;display:none;">
                                        ...
                                        <s:iterator value="#pc.yjlist" var="zx" status="zxi">
                                            <tr>
                                                ...
                                                <s:iterator value="#pc.pmlist" var="hx" status="hxi">
                                                    ...
                                                    <td align="right">
                                                        <span class="jbs${zxi.index}${hxi.index+1 }"></span>
                                                        <script type="text/javascript">
                                                            $(function () {
                                                                var a = "${pc.brokerage}";
                ...
                <div class="wfj11_111_width">
                    <table width="70%">
                        ...
                        <tr class="wfj11_111_height">
                            <td style="padding-left:5px;" align="left">
                                <input id="cpname" name="ppname" readonly="readonly"
                                       style="width:100%;border:0px;text-align:left;" class="cpname cp"
                                       value="${pc.ppname }"/>
                            </td>
                            <td align="right">
                                <input name="rePrice" type="number"
                                       class="jisuan model1 fou posnumred cp brokerage" id="ls"
                                       step="0.00001"
                                       style="display:inline;width:100%;height:99%; border:0px; text-align: right;"
                                       value="${pc.rePrice }"/>
                            ...
                            <td align="right">
                                <input id="cc" name="efPrice" type="number" step="0.00001"
                                       class="jisuan model1 fou posnumred cp brokerage"
                                       style="display:inline;width:100%;height:99%;border:0px; text-align: right;"
                                       value="${pc.efPrice }"/>
                            </td>
                            ...
                            <c:forEach items="${dlList}" var="dl" varStatus="idxStatus">
                                <td align="right">
                                    <input name="setupSub[${idxStatus.index}].amount" id="${dl.ppID}"
                                           type="number" class="jisuan model1 fou posnumred cp dl brokerage qian"
                                           step="0.00001"
                                           style="display:inline;width:100%;height:99%; border:0px; text-align: right;"
                                           value="0"/>
                                    <input type="hidden" name="setupSub[${idxStatus.index}].typePpid" class="cp"
                                           value="${dl.ppID}"/>
                                </td>
                            </c:forEach>
                            <td align="right">
                                <input name="brokerage" id="yj" size="3" type="number"
                                       class="cp brokerage yewu" step="0.00001"
                                       style="width:100%; height:99%; border:0px; text-align: right;"
                                       value="${pc.brokerage }"/>
                            </td>
                            <td align="right">
                                <select name="tzType" style="width:100%;height:99%; border:0px; text-align: right;"
                                        class="cp" id="cp">
                                    <option value>无</option>
                                    <option value="01">教练车</option>
                                    <option value="02">创客单车</option>
                    ...
                    <table width="70%">
                        <s:iterator value="pclist" var="pc">
                            ...
                            <tr class="wfj11_111_height">
                                ...
                                <td align="right">
                                    <input name="rePrice" class="jisuan model1 fou posnumred cp brokerage" id="ls"
                                           type="number"
                                           style="display:inline;width:100%;height:99%; border:0px; text-align: right;"
                                           step="0.00001"
                                           value="${pc.rePrice }"/>
                                ...
                                <c:if test="${empty pc.vallist }">
                                    <c:forEach items="${dlList}" var="dl" varStatus="idxStatus">
                                        <td align="right">
                                            <input name="setupSub[${idxStatus.index}].amount"
                                                   id="${dl.ppID}" type="number"
                                                   class="jisuan model1 fou posnumred cp dl brokerage editDlyj qian"
                                                   style="display:inline;width:100%;height:99%; border:0px; text-align: right;"
                                                   step="0.00001" value="0"/>
                                            <input type="hidden" name="setupSub[${idxStatus.index}].typePpid" class="cp"
                                                   value="${dl.ppID}"/>
                                        </td>
                                    </c:forEach>
                                    ...
                                    <c:forEach items="${dlList}" var="dl" varStatus="idxStatus">
                                        <c:forEach items="${pc.vallist}" var="dlp">
                                            <c:if test="${dlp[3] == dl.ppID }">
                                                <td align="right">
                                                    <input name="setupSub[${idxStatus.index}].amount" id="${dlp[3]}"
                                                           type="number"
                                                           class="jisuan model1 fou posnumred cp dl brokerage editDlyj qian"
                                                           style="display:inline;width:100%;height:99%; border:0px; text-align: right;"
                                                           step="0.00001"
                                                           value="${dlp[2]}"/>
                                                    <input type="hidden" name="setupSub[${idxStatus.index}].typePpid"
                                                           class="cp" value="${dlp[3]}"/>
                                                </td>
                                ...
                                <td align="right">
                                    <input name="brokerage" id="yj" size="3" type="number" step="0.00001"
                                ...
                                <td align="right">
                                    <select name="tzType" style="width:100%;height:99%; border:0px; text-align: right;"
                                            class="cp" id="cp"
                                            value=${pc.tzType=='01'?"教练车":pc.tzType=='02'?"创客单车":pc.tzType=='03'?"超市":"无"}>
                                        <option value>无</option>
                                        <option value="01">教练车</option>
                                        <option value="02">创客单车</option>
                                        <option value="03">超市</option>
                        ...
                        <s:iterator value="yjlist" var="zx" status="zxi">
                            <tr>
                                ...
                                <s:iterator value="main" var="hx" status="hxi">
                                    ...
                                    <td align="right">
                                        <span class="jbs${hxi.index+2 }"></span>
                                    </td>
                                </s:iterator>
                            </tr>
                        </s:iterator>
        ...
        <div style="margin-top:10px;">
            <p>
                设计佣金责任人：
                <input type="text" class="inputbottom" size="15" value="${productDesign.yjstaname}"/>
                &nbsp;&nbsp;&nbsp;设计佣金日期：
                <input type="text" name="productDesign.PackagingDate" class="inputbottom" id="PackagingDate"
                       value="<fmt:formatDate value="${productDesign.yjdate}" pattern="yyyy-MM-dd" />" size="20">
            </p>
        </div>
        </s:if>
        <s:else>
        <div style="margin-top:10px;">
            <p>
                设计佣金责任人：
                <input type="text" class="inputbottom" size="15" value="<%=acc.getStaffName() %>"/>
                &nbsp;&nbsp;&nbsp;设计佣金日期：
                <input type="text" name="productDesign.PackagingDate" class="inputbottom" id="PackagingDate"
                       value="<fmt:formatDate value="<%=new Date()%>" pattern="yyyy-MM-dd" />" size="20">
            </p>
        </div>
        </s:else>
...
<form name="selectxmForm" id="selectxmForm" method="post" enctype="multipart/form-data">
    <input type="submit" name="submit" style="display: none"/>
    <div class="jqmWindow jqmWindowcss1" style="top: 5%; left: 53%;" id="xmjqModel">
        <div class="content1" style="width: 100%; height: 400px;">
            ...
            <table width="99%" height="33" id="searchxm" border="0"
                   align="center" cellpadding="0" cellspacing="0" style="margin-top: 5px; background: #FFFFFF;">
                <tr>
                    ...
                    <td height="33">
                        ...
                        <input type="button" class="btn02 xzxm" name="button5" value="新增"/>
                    ...
                    <td width="100">
                        <a id="xmzy">
                            共&nbsp;&nbsp; <span style="color: red" id="xmzycount"></span> &nbsp;&nbsp;页
                        </a>
                    </td>
                </tr>
            </table>
                ...
                <tr>
                            ...
                            <tr id="menuTreeTrid-1" sizcache="1" sizset="0">
                                <td>
                                    ...
                                    <div class="text_tree" id="treeg"
                                        ...
                                        <iframe src="<%=basePath%>page/ea/main/finance/invoicing/oprojecttree.jsp?codeID=scode201410284shpd9x4fa0000000005&title=项目分类"
                                                width="600" height="300"></iframe>
                                    </div>
                                    <div class="mohuc text_tree"
                                         style="overflow: auto; z-index: 99; height: 280px;display:none;"></div>
                                    <div style="margin-top:5px;float:right;">
                                        模糊查询<input type="text" size="10" id="inputmoc"/>
                                        <input type="button" class="btncon" id="moc">
                                    </div>
                                </td>
                            </tr>
                        </table>
                    ...
                    <td width="80%" valign="top" align="left">
                        <div style="margin-top: 2px;  height: 310px; width: 100%; overflow: auto;">
                            ...
                            <table width='99%' align='center' id='xmtable' cellpadding='0' cellspacing='0'
                                   class='table'>
                                <thead>
...
<%------------------------------------部门树和人 ------------------------------------%>
<form name="selectdeptForm" id="selectdeptForm" method="post" enctype="multipart/form-data">

    <input type="submit" name="submit" style="display: none"/>
    <div class="jqmWindow jqmWindowcss1" style="top: 5%; left: 53%;" id="deptjqModel">
        <div class="content1" style="width: 100%; height: 400px;">
            <div class="contentbannb">
                <div class="drag">组织机构</div>
            </div>
            <table width="99%" height="33" id="searchdept" border="0" align="center" cellpadding="0" cellspacing="0"
                   style="margin-top: 5px; background: #FFFFFF;">
                <tr>
                    <td width="100" align="right">员工姓名：</td>
                    <td width="142">
                        <input class="input" id="parameterrm" size="10" style="margin-left: 2px;"/>
                        <input type="hidden" id="selectdept"/>
                        <input type="hidden" id="selectdeptname"/>
                        <input type="hidden" id="deptpos"/>
                    </td>
                    <td height="33">
                        <input type="button" class="btn02" id="searchdeptbtn" name="button7" value="查询"/>
                        <input type="button" class="btn02" id="qddept" name="button5" value="确定"/>
                        <input type="button" class="btn02 JQueryreturns" name="button4" value="关闭"/>
                    </td>
                    <td width="80"><a id="dpsy" title="0">上一页</a></td>
                    <td width="80"><a id="dpxy" title="0">下一页</a></td>
                    <td width="100">
                        <a id="dpzy">共&nbsp;&nbsp; <span style="color: red" id="dpzycount"></span>&nbsp;&nbsp;页 </a>
                    </td>
                </tr>
            </table>
            <table width="99%" border="0" align="center" cellpadding="0"
                            ...
                            <tr id="menuTreeTrid-1" sizcache="1" sizset="0">
                                <td>
                                    <div class="text_tree"
                                        ...
                                        <iframe src="<%=basePath%>page/ea/main/finance/invoicing/organizationtree.jsp"
...
<script type="text/javascript">
    ...
    /* if(parseFloat($(".ver").eq(2).val())>0 && $("#tz_type").html() == "无")
     prompt("请选择正确的投资设备类型"); */
</script>
</body>
</html>
