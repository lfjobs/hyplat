...
<head>
    ...
    <script
            src="<%=basePath%>js/ea/human/office/SersonnelSystem/productDesign.js"></script>
...
<div id="main_main" class="main_main">
    <table class="address">
        ...
        <c:forEach var='arr' items="${pageForm.list}">
            <tr id="${arr[0] }">
                <td>
                    <c:if test="${butt eq 'check'}">
                        <input type="checkbox" name="a"
                               value="${arr[0]}"/>
                    </c:if>
                    <c:if test="${butt ne 'check'}">
                ...
                <td>
                    <span id="productCode">${arr[5]}</span>
                </td>
                <td>
                    <span id="barCode">${arr[22]}</span>
                </td>
                <td>
                ...
                <!--
							<td>
								<span id="category">${arr[16]}</span>
							</td>
							<td>
								<span id="price">${arr[17]}</span>
							</td>
							<td>
								<span id="money">${arr[18]}</span>
							</td>
						 -->
                <td>
                    <span class="costPrice">${arr[17]}</span>
                </td>
                <td>
                    <span class="salePrice">${arr[16]}</span>
                </td>
                <td>
                    <span>${arr[23]}</span><%--批发价--%>
                </td>
                <td>
                    <span>${arr[24]}</span><%--VIP价--%>
                </td>
                <td>
                    <span>${arr[25]}</span><%--活动价--%>
                </td>
                <td>
                    <span id="weight">${arr[10]}</span>
                </td>
                    <%-- 		<s:if test="flexbutton=='publish'">
                            <td>
    ...
    <c:import url="../../../../page_navigator.jsp">
        <c:param name="actionPath"
                 value="ea/productdesign/ea_getListProductdesign.jspa?pageNumber=${pageNumber}&search=${search}&sdate=${sdate}&edate=${edate}&identifier=${param.identifier}&flexbutton=${param.flexbutton}&ghua=${param.ghua}&fiveClear=${fiveClear}&no=${no}&typeString=${typeString}&devide=${devide}&showweixin=${showweixin}"></c:param>
    </c:import>
</div>
...
<div class="jqmWindow " style="width: 270px; right: 35%; top: 20%"
    ...
    <form name="postSearchForm2" id="postSearchForm2" method="post">
        <input type="submit" name="submit" style="display: none"/>
        商品名称${param.identifier}：
        <input name="productDesign.goodsName" width="130px;"/> &nbsp;&nbsp;&nbsp;&nbsp;
        责任人${param.identifier}：
        <input name="productDesign.staffName" width="130px;"/> &nbsp;&nbsp;&nbsp;&nbsp;
        条码${param.identifier}：
        <input name="productDesign.barCode" width="130px;"/>
        <input type="button" id="toselect2"
               value=" 查询 " class="input-button"/>
        <input name="search" type="hidden" value="001"/>
        <input name="fiveClear" type="hidden" id="fiveClear" value="${fiveClear}"/>
    </form>
</div>
    ...
    <form name="cstaffForm" id="cstaffForm" method="post">
        ...
        <table id="stafftable" cellpadding="0" cellspacing="0"
                    ...
                    <table width="100%" id="ms">
                        <tr>
                            <td height="30" align="left" colspan="2">
                                ...
                                <div class="divCTL"><input type="button" id="xzcpfl" value="选择产品分类"
                                                           style="width: 100px;"/></div>
                                <div class="divFL" style="display:none;">
                                    <select name="prdCategory" id="prdCategory" size="5" multiple="multiple"
                                            style="width:150px;">
                                    </select>
                                </div>
                            </td>
                            ...
                            <td align="left" width="100" colspan="2">
                                <%--<span id="typeID"></span>--%>
                                <select name="productDesign.weiDianType" onchange="check()" id="weiDianType"
                                        style="width: 60px;">
                            ...
                            <td rowspan="4" colspan="2">
                                <div contenteditable="" id="post_article_content"
                                     style="border:1px solid #000; width: 252px;height: 120px;overflow: hidden;"></div>
                        ...
                        <tr>
                            ...
                            <td width="100">
                                <input name="productDesign.money" id="moneyi" class="input"
                            ...
                            <td>
                                <input name="productDesign.weight"  id="weight" style="margin-left: 2px;width: 50px"/>
                            </td>
                            <td align="right">
                                数&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;量：
                            </td>--%>
                            ...
                            <td width="100">
                                <input name="productDesign.stockSize" id="stockSize" class="input"
                                       style="margin-left: 2px;width: 50px"/>
                            </td>
                        ...
                        <tr style="display: none;" id="banzheng">
                            ...
                            <td colspan="3" align="left">
                                <input name="productDesign.certificateCost" class="isNaN"
                                       style="margin-left: 2px;width: 50px"/>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4" align="left" height="25"><input type="button" id="shuju2" value="选择配件"
            ...
            <tr>
                <td colspan="9">
                    <table width="100%" id="pj">
                        ...
                        <!-- <th align="center" bgcolor="#FFFFFF">单位</th> -->
            ...
            <tr style="height: 20px">
                <td height="20" align="left" colspan="4"><input type="button" id="newline" value=" 添加产品价格类别"
                ...
                <td colspan="4">
                    <table width="100%" id="ms">
                        ...
                        <tr class="checkgoods" id="kelong1">
                            <td align="center" bgcolor="#FFFFFF" height="26">
                                <input type="text" name="productPriceCategory.category" value="零售价"
                                       style="margin-left: 2px;width: 60px;" readonly="readonly"/>
                            </td>
                            <td align="center" bgcolor="#FFFFFF">
                                <input name="productPriceCategory.price" class="jisuan put3 input" id="price1"
                                       style="margin-left: 2px;width: 50px"/>
                            </td>
                            <td align="center" bgcolor="#FFFFFF">
                                <input name="productPriceCategory.money" class="input" id="money1"
                                       style="margin-left: 2px;width: 50px"/>
                            </td>
                        ...
                        <tr id="kelong" style="display:none;">
                            ...
                            <td align="center" bgcolor="#FFFFFF">
                                <input name="price" class="jisuan isNaN price" id="price"
                                       style="margin-left: 2px;width: 50px"/>
                            </td>
                            <td align="center" bgcolor="#FFFFFF">
