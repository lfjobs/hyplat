...
<script type="text/javascript" src="<%=basePath%>js/common/common.js"></script> 
        ...
        <script src="<%=basePath%>js/ea/human/office/SersonnelSystem/cstaff_audition.js"></script>
    ...
    <body>
        ...
        <div class="main_main">
            ...
            <c:import url="../../../../page_navigator.jsp">
                <c:param name="actionPath" value="ea/saudition/ea_getauditionList.jspa?pageNumber=${pageNumber}&status=0">
                </c:param>
            </c:import>
        </div>
