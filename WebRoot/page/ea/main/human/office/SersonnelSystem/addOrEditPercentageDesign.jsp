...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script language="javascript" type="text/javascript" src="<%=basePath%>js/ea/human/office/SersonnelSystem/supermarketDesign.js"></script>
					...
					<tr>
						...
						<nobr>
							<input type="button"  class="menubtn JQuerySubmitgd" 
								value="保存" /><input type="button" class="menubtn addline" name="button3"
								value="增行" /><input type="button" class="menubtn" name="button3"
