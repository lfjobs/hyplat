...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script
			src="<%=basePath%>js/ea/human/office/company/companyDownProduct.js"></script>
		...
		<div id="main_main" class="main_main">
				...
				<% int number = 1; %>
					<c:forEach var='arr' items="${pageForm.list}">
						<tr id="${arr[0] }">
							...
							<td>
								<span id="updateUser">${arr[19]}</span>
							</td>
							<td>
			...
			<c:import url="../../../../page_navigator.jsp">
				<c:param name="actionPath"
					value="ea/companytestproduct/ea_getCompanyDownProduct.jspa?pageNumber=${pageNumber}&search=${search}&sdate=${sdate}&edate=${edate}&identifier=${param.identifier}&flexbutton=${param.flexbutton}&ghua=${param.ghua}&fiveClear=${fiveClear}"></c:param>
			</c:import>
		</div>
		...
		<div class="jqmWindow " style="width: 270px; right: 35%; top: 20%"
			...
			<form name="postSearchForm" id="postSearchForm" method="post">
				<input type="submit" name="submit" style="display: none" />
					...
					<input name="fiveClear" type="hidden" value="${fiveClear}" />
			</form>
		</div>
