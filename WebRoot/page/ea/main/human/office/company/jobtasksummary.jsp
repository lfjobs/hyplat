...
<script type="text/javascript" src="<%=basePath%>js/common/common.js"></script> 
		...
		<script src="<%=basePath%>js/ea/human/office/company/jobtasksummary.js"></script>
		...
		<div id="main_main" class="main_main">
			...
			<c:import url="../../../../page_navigator.jsp">
				<c:param name="actionPath"
					value="ea/jobtask/ea_getCompanyJobTaskListSummary.jspa?pageNumber=${pageNumber}&search=${search}"></c:param>
			</c:import>
		</div>
		...
		<div class="jqmWindow jqmWindowcss3" style="width: 500px;top: 10%;" id="jqModelSearch">
				...
				<table width="495" id="cataffSearchTable">
					...
					<tr>
						...
						<td width="366"><input name="jobTaskVO.startDate" onfocus="date(this);" />至<input 
							name="jobTaskVO.endDate" onfocus="date(this);" />
						</td>
					</tr>
					<tr>
						<td align="right">
						...
						<td>
							<select id="deptID" name="jobTaskVO.companyID">
								<option value="">
									请选择公司
								</option>
							</select>
					...
					<tr>
						...
						<td width="366">
							<select id="orgID" name="jobTaskVO.organizationID">
								<option value="">
									请选择部门
								</option>
							</select>
