...
<script type="text/javascript" src="<%=basePath%>js/common/common.js"></script> 
        ...
        <script src="<%=basePath%>js/ea/human/office/company/companyAppraisalSummary.js"></script>
...
-->
	...
	<body >
        <div class="main_main">
            ...
            <c:import url="../../../../page_navigator.jsp">
                <c:param name="actionPath" value="ea/staffappraisalsummary/ea_getcompanyAppraisalList.jspa?pageNumber=${pageNumber}&search=${search}&startdate=${startdate}&enddate=${enddate}">
                </c:param>
            </c:import>
        </div>
  ...
  <table width="883" border="0" align="center" cellpadding="1" cellspacing="1" style="background:#FFFFFF;" class="table" id="staffappr">
    ...
    <tr>
      ...
      <td rowspan="3">职责得分</td>
        <td colspan="4" align="left"><label>
          <input name="staffappraisal.responsibility1" type="text" class="positionPay" id="responsibility1" size="4" value="0"  style="height:12px"/>
        </label></td>
    ...
    <tr>
      ...
      <td>责任心</td>
      <td colspan="4" align="left"><input name="staffappraisal.responsibility2" class="positionPay"  type="text" id="responsibility2" style="height:12px" size="4" value="0"/></td>
    </tr>
    <tr>
      <td height="15" class="kptd">3</td>
 
      <td>原则性</td>
      <td colspan="4" align="left"><input name="staffappraisal.responsibility3" class="positionPay"  type="text" id="responsibility3" style="height:12px" size="4" value="0"/></td>
    </tr>
    <tr>
      ...
      <td colspan="4" align="left"><input name="staffappraisal.achievements1" class="work" type="text" id="achievements1" size="4" style="height:12px" value="0"/></td>
      <td rowspan="3" align="center">15</td>
    ...
    <tr>
      ...
      <td>工作量是否饱和</td>
      <td colspan="4" align="left"><input name="staffappraisal.achievements2" class="work" type="text" id="achievements2" size="4" style="height:12px" value="0"/></td>
    </tr>
     <tr>
      <td height="15" class="kptd">6</td>
 
      <td>工作质量</td>
      <td colspan="4" align="left"><input name="staffappraisal.achievements3" class="work" type="text"  id="achievements3" size="4" value="0" style="height:12px"/></td>
    </tr>
     <tr>
      ...
      <td colspan="4" align="left"><input name="staffappraisal.task1" class="achievement" type="text" id="task1" size="4" value="0" style="height:12px"/></td>
      <td rowspan="3" align="center">15</td>
     ...
     <tr>
      ...
      <td>目标是否明确</td>
      <td colspan="4" align="left"><input name="staffappraisal.task2" type="text" class="achievement" id="task2" size="4" value="0" style="height:12px"/></td>
    </tr>
     <tr>
      <td height="15" class="kptd">9</td>
 
      <td>任务完成主动性</td>
      <td colspan="4" align="left"><input name="staffappraisal.task3" type="text" class="achievement" id="task3" size="4" value="0" style="height:12px"/></td>
    </tr>
     <tr>
      ...
      <td colspan="4" align="left"><input name="staffappraisal.ability1" class="stPay" type="text" id="ability1" size="4" value="0" style="height:12px"/></td>
      <td rowspan="3" align="center">15</td>
     ...
     <tr>
      ...
      <td>管理能力</td>
      <td colspan="4" align="left"><input name="staffappraisal.ability2" class="stPay" type="text" id="ability2" size="4" value="0" style="height:12px"/></td>
    </tr>
     <tr>
      <td height="15" class="kptd">12</td>
 
      <td>综合素质能力</td>
      <td colspan="4" align="left"><input name="staffappraisal.ability3" class="stPay" type="text" id="ability3" size="4" value="0" style="height:12px"/></td>
    </tr>
     <tr>
      ...
      <td colspan="4" align="left"><input name="staffappraisal.manner1" type="text" class="chuqin" id="manner1" size="4" value="0" style="height:12px"/></td>
      <td rowspan="3" align="center">15</td>
     ...
     <tr>
      ...
      <td>工作主动性</td>
      <td colspan="4" align="left"><input name="staffappraisal.manner2" type="text" class="chuqin" id="manner2" size="4" value="0" style="height:12px"/></td>
    </tr>
     <tr>
      <td height="15" class="kptd">15</td>
 
      <td>文明礼貌素质</td>
      <td colspan="4" align="left"><input name="staffappraisal.manner3" type="text" class="chuqin" id="manner3" size="4" value="0" style="height:12px"/></td>
    </tr>
     <tr>
    ...
    <form name="postSearchForm" id="postSearchForm" method="post">
        ...
        <div class="jqmWindow jqmWindowcss3" style="width:500px;top: 10%" id="jqModelSearch">
                ...
                <table id="cataffSearchTable">
                  ...
                  <td width="342">
                   <input name="staffappraisalsummary.staffCode" />
                        </td>
                  </tr>
                    <tr>
                        <td align="right">
                            员工姓名：                        </td>
                  <td>
                            <input name="staffappraisalsummary.staffName" />
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                            公司名称：                        </td>
                        <td>
                            <select  name="staffappraisalsummary.companyID" id="companyID"><option value="">请选择公司</option></select>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
