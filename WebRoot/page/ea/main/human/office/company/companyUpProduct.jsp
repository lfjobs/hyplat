...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script
			src="<%=basePath%>js/ea/human/office/company/companyUpProduct.js"></script>
		...
		<div id="main_main" class="main_main">
			...
			<c:import url="../../../../page_navigator.jsp">
				<c:param name="actionPath"
					value="ea/companytestproduct/ea_getCompanyUpProduct.jspa?pageNumber=${pageNumber}&search=${search}&sdate=${sdate}&edate=${edate}&identifier=${param.identifier}&flexbutton=${param.flexbutton}&ghua=${param.ghua}&fiveClear=${fiveClear}"></c:param>
			</c:import>
		</div>
