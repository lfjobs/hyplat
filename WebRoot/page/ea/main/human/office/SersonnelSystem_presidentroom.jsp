...
<head> 
<title>董事长室</title>
<%@include file="/page/common1.jsp" %><%@include file="/page/common1.jsp"%>
 ...
 <!-- 无限级导航菜单div -->
	<div id="mydroplinemenu" class="droplinebar">
		<ul class="zero">
			...
			<li><a href="javascript:;" onclick="window.parent.document.getElementById('rightFrame').src='<%=basePath%>/page/ea/main/navigation/presidentroom_production.jsp'">(生产)</a>
				</li>
