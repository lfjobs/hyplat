...
<!-- 无限级导航菜单div -->
	<div id="mydroplinemenu" class="droplinebar">
		<ul class="zero">
			...
			<li><a href="javascript:;" onclick="window.parent.document.getElementById('rightFrame').src='<%=basePath%>/page/ea/main/navigation/executiveoffice_production.jsp'">生产)</a>
				</li>
