...
<body >
	...
	<div id="mydroplinemenu" class="droplinebar">
		<ul class="zero">
			...
			<c:if test="${companyID!='company20140515JQKSD5MW6C0000002853'}">
				<li>
					<a href="javascript:;" onclick="window.parent.document.getElementById('rightFrame').src='<%=basePath%>/page/ea/main/navigation/teachingAffairsDepartment-production.jsp'">(生产)</a>
				</li>
			</c:if>
