...
<script type="text/javascript">
    ...
    if(dp=="2"){
        if(coID==""){
            ...
            text = basePath+"ea/restaurant/ea_scancode.jspa?scancode=07${coID}&tj=${sccid}&companyId=${companyId}&waiterID=${waiterID}";
        }
...
<div class="wrap_page" style="background: #fafafa;">
    ...
    <div class="order_detail" style="margin-bottom:20px;">
