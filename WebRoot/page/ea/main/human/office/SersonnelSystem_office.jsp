...
<body>
	...
	<div id="mydroplinemenu" class="droplinebar">
		<ul class="zero">
			...
			<li><a href="javascript:;" onclick="window.parent.document.getElementById('rightFrame').src='<%=basePath%>/page/ea/main/navigation/Office_officeManager.jsp'">(办公室)</a>
				</li>
			...
			<li><a href="javascript:;" onclick="window.parent.document.getElementById('rightFrame').src='<%=basePath%>/page/ea/main/navigation/Office_production.jsp'">(生产)</a>
				</li>
