...
<script type="text/javascript" src="<%=basePath%>js/flexigrid.js"></script>
<script src="<%=basePath%>js/ea/human/adance/attendextleave_examine.js"></script>
		...
		<input type="submit" name="submit" style="display:none" />
			...
			<c:import url="../../../page_navigator.jsp">
				<c:param name="actionPath"
					value="ea/attendextleave/ea_getExtleaveExam.jspa?pageNumber=${pageNumber}&search=${search}">
				</c:param>
			</c:import>
		</div>
	</form>
