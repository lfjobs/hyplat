...
$(function(){
	...
	$('#save_all').click(function(){
		...
		document.childrenform.action = "<%=basePath%>ea/organization/t_ea_sortChildOrganization.jspa?pageNumber=${pageNumber}";
		document.childrenform.submit.click();
//		document.all.childrenform.submit();
	})
	$('#goback').click(function(){
		document.childrenform.action = "<%=basePath%>ea/organization/ea_getOrganizationListAll.jspa?pageNumber=${pageNumber}";
		document.childrenform.submit.click();
//		document.all.childrenform.submit();
	});
          ...
          <table width="100%" height="26" align="center" cellspacing="0" cellpadding="1" style="font-size:12px;" class="bannb_01">
            ...
            <table width="99%" height="37" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="22%" align="right">当前机构排序</td>
