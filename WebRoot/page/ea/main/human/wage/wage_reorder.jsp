...
<title>排序页面</title>
<%@ page language="java" pageEncoding="UTF-8" import="hy.ea.util.Constant"%>
...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
	String REORDERURL = Constant.REORDERURL;
	String url = request.getAttribute(REORDERURL).toString();
%>
...
<div id="body_02">
          <table width="100%" height="26" align="center" cellspacing="0" cellpadding="1" style="font-size:12px;" class="bannb_01">
            <tr>
                <td height="24" align="left" valign="top" class="txt01" >排序功能</td>
            </tr>
          </table>
              ...
              <tr>
                <td width="46%" align="right">
                	<SELECT name="staff" id="select1" size="15" style="width: 120">
                		<s:iterator value="children" var="arr">
...
$(function(){
	...
	$('#save_all').click(function(){
		...
		document.childrenform.action = basePath + url + "ea_sortChildOrganization.jspa?pageNumber=${pageNumber}&childrenID="+childrenID;
		document.childrenform.submit.click(); 
	});
	$('#goback').click(function(){
		document.childrenform.action = basePath + url + "ea_findItem.jspa?pageNumber=${pageNumber}";
		document.childrenform.submit.click(); 
	}); 
});
</script>
