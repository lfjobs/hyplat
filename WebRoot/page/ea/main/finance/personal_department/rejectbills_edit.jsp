...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script language="javascript" type="text/javascript"
			src="<%=basePath%>js/ea/finance/rejectbills_edit.js"></script>
		<style type="text/css">
.hide {
	border-left: 0px;
	border-right: 0px;
...
#apDiv1 {
	...
	<body style="overflow-y:auto">
		<%-- 用来显示审核章 --%>
		<div id="apDiv1"></div>
		<form name="taxsummaryForm" id="taxsummaryForm" method="post"
			...
			<div class="content1" style="width: 100%;">
				...
				<table width="99%" border="0" align="center" id="table5"
					...
					<tr>
						...
						<td>
							${cashierBills.referenceCode}
						</td>
						<td align="right">
							<span class="STYLE1">邮箱：</span>
						</td>
						<td>
							${cashierBills.referenceOrganization}
						</td>
						<td align="right">
							<span class="STYLE1">地址：</span>
						</td>
						<td>
							${cashierBills.staffAddress}
						</td>
						<td width="10%" align="right">
    ...
    var search="${search}";
    var taxstatusDu="${cashierBillsVO.status}";
    var sdate="${sdate}";
    var edate="${edate}";
    var tsdate="${tsdate}";
    var tedate="${tedate}";
