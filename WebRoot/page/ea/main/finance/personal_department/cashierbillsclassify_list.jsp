...
<script type="text/javascript" src="<%=basePath%>js/common/common.js"></script> 
		...
		<script language="javascript" type="text/javascript"
			src="<%=basePath%>js/ea/finance/cashierbillsclassify_list.js"></script>
        	...
        	document.onkeydown = function(evt){//捕捉回车 
    			...
    			if (key == 13) { //判断是否是回车事件。
					...
					if($(this).val()==""){
						...
						$("#SearchForm").attr("action", basePath+"/ea/cashierbills/ea_toSearch.jspa?pageNumber="+pNumber+"&level="+level);
	...
	<body>
		...
		<c:import url="../../../page_navigator.jsp">
			<c:param name="actionPath"
				value="ea/cashierbillsclassify/ea_getCashierBillsList.jspa?search=${search}&pageNumber=${pageNumber}&sdate=${sdate}&edate=${edate}&BType=${BType }&level=${level}">
			</c:param>
		</c:import>
		<!--搜索窗口 -->
