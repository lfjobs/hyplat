...
<script src="<%=basePath%>js/ea/human/cstaff.js"></script>
 <script language="javascript" type="text/javascript" src="<%=basePath%>js/ea/finance/company/cashierbillssummary_edit.js"></script>
   <style type="text/css"> 
	.hide{ 
	 border-left: 0px; 
	 border-right: 0px; 
...
<form name="cashierTallyForm" id="cashierTallyForm" method="post" enctype="multipart/form-data"> 
        ...
        <input type="hidden" value="${cashierBillsVO.cashierBillsID}" id="cashierBillsID" name="cashierBillsID"/>
<div class="content1" style="width:100%;">
  ...
  <tr>
    ...
    <tr>
       <td height="25" align="right"><span class="STYLE1">公司：</span></td>
...
<table width="3000" align="center" cellpadding="0" cellspacing="0" class="table" id="goodtable">
  <tr>
    ...
    <th align="center"  width="140" bgcolor="#E4F1FA">费用类别</th>
    <th align="center" width="140" bgcolor="#E4F1FA">科目</th>
    <th align="center"  width="140" bgcolor="#E4F1FA">库房管理</th>
