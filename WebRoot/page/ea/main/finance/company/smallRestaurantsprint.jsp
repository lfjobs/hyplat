...
<html>
  ...
  <body>
    <div>
        ...
        <c:if test="${cashierBills.privateRoom !=null || cashierBills.waiter !=null}">
		<div class="settlement">

			<ul>
				<li>桌号：</li>
				<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${cashierBills.privateRoom}</li>
			</ul>
		</div>
		</c:if>
		<div class="settlement">
		<c:if test="${dto.receiveaddress !=null}">
			<ul>
				<li>收货地址：</li>
				<li>${dto.receiveaddress}</li>
			</ul>
			</c:if>
			<ul>
				<li>下单用户：</li>
		...
		<div class="bott">
            <table>
                ...
                <tr>
                    <td class="logo">
                        <img src="<%=basePath%>${comp.logoPath}" />${comp.companyName}</td>
                </tr>
            </table>
        </div>
