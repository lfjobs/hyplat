...
<script src="<%=basePath%>js/ea/human/cstaff.js"></script>
 <script language="javascript" type="text/javascript" src="<%=basePath%>js/ea/finance/company/dutiablesummary_edit.js"></script>
   <style type="text/css"> 
	.hide{ 
	 border-left: 0px; 
	 border-right: 0px; 
  ...
  <script type="text/javascript">
    ...
    var search="${search}";
    var statusDu='${statusDu }';
</script>

<body>
<form name="cashierTallyForm" id="cashierTallyForm" method="post" enctype="multipart/form-data"> 
		<input type="text" name="statusDu" value="${statusDu }" style="display:none"/>
         <input type="submit" name="submit" style="display:none"/>
<div class="content1" style="width:100%;">
  <div class="contentbannb">
  	<div class="divtx">报税单据汇总详细信息</div>
  </div>
...
<table width="99%" height="158px" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:5px">
  <tr>
    <td valign="top">
<div id= "Layer1" style= "position:absolute; width:100%; height:158px; overflow: scroll;">
...
<s:token></s:token>
  ...
  <iframe name="hidden" width="100%" height="100"></iframe>
