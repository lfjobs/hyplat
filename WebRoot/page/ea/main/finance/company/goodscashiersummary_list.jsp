...
<script type="text/javascript" src="<%=basePath%>js/common/common.js"></script> 
		...
		<script language="javascript" type="text/javascript"
			src="<%=basePath%>js/ea/finance/company/goodscashiersummary_list.js"></script>
		<script type="text/javascript"
	...
	var treeids = "<%=c.getCompanyID()%>";
			...
			document.onkeydown = function(evt){//捕捉回车 
    			...
    			if (key == 13) { //判断是否是回车事件。
        			...
        			if($("input#journalNum").val()!=''){
			        	$("#SearchForm").attr("action", basePath+"ea/goodscashier/ea_toSearch.jspa?pageNumber="+pNumber);
	...
	<body>
		<form name="CashierBillsform" id="CashierBillsform">
			...
			<input name="cashierBills.goodsBillsID" id="goodsBillsID"
				style="display: none" />
			<s:token />
		</form>
		...
		<c:import url="../../../page_navigator.jsp">
			<c:param name="actionPath"
				value="ea/goodscashier/ea_getCashierList.jspa?search=${search}&pageNumber=${pageNumber}&sdate=${sdate}&edate=${edate}&period=${period}">
			</c:param>
		</c:import>
		<!--搜索窗口 -->
			...
			<div class="jqmWindow" style="width: 400px; right: 25%; top: 10%"
				...
				<table width="396" id="SearchTable">
					...
					<tr>
						...
						<td>
							<input id="goodsName" style="width: 195px"
								name="cashierBills.goodsName" />
						</td>
					</tr>
					<tr>
						<td align="right">
						...
						<td>
							<input id="goodsCoding" style="width: 195px"
								name="cashierBills.goodsCoding" />
						</td>
					</tr>
					<tr>
						<td align="right">
						...
						<td>
							<select id="deptID" name="cashierBills.companyID">
					...
					<tr>
						...
						<td>
							<select id="orgID" name="cashierBills.departmentID">
								<option value="">
									请选择公司
								</option>
							</select>
					...
					<tr>
						...
						<td>
							<select name="cashierBills.staffID" id='person'>
								<option value="">
									请选择部门
								</option>
							</select>
					...
					<tr>
						...
						<td>
							<input id="cuID" style="width: 195px"
								name="cashierBills.contactUserName" />
							<a id="wlgr" href="#">选择</a>
						</td>
					</tr>
				</table>
			...
			<div class="jqmWindow jqmWindowcss1" style="top: 4%;"
				...
				<div class="content1" style="width: 100%">
					...
					<table width="99%" border="0" align="center" cellpadding="0"
						cellspacing="0"
						style="margin-top: 5px; margin-bottom: 5px; height: 350px;">
						<tr>
							<td width="99%" valign="top" align="left">
								<div id="body_02cc"
									style=" margin-top: 2px; display: none; height: 350px; width: 100%; overflow: scroll;">
								</div>
							</td>
						</tr>
					</table>
		...
		<form name="selectuserForm" id="selectuserForm" method="post"
			...
			<div class="jqmWindow jqmWindowcss1" style="top: 5%;"
				...
				<div class="content1" style="width: 100%">
					...
					<table width="99%" border="0" align="center" cellpadding="0"
						cellspacing="0"
						style="margin-top: 5px; margin-left: 5px; height: 350px;">
						<tr>
							<td width="99%" valign="top" align="left">
								<div id="body_02cu"
									style="margin-top: 2px; display: none; height: 350px; width: 100%; overflow: scroll;">
		...
		<form name="cstaffForm" id="cstaffForm" method="post">
			<div class="jqmWindow jqmWindowcss6" style="overflow:hidden;width: 750px; top: 1%"
				id="jqModels">
				<div class="drag">
					出纳明细单
					<div class="close"></div>
				...
				<div class="content">
					...
					<table width="99%" border="0" id="table3" align="center"
						...
						<tr>
							...
							<td>
								<span id="companyBankNum"></span>
							</td>
							<td align="right"></td>
							<td align="left"></td>
							<td align="right">
								<div id="u1170_rtf"></div>
							</td>
							<td width="15%"></td>
						</tr>
					</table>
					<table width="99%" height="180px" border="0" align="center"
						cellpadding="0" cellspacing="0" style="margin-top: 5px">
						<tr>
							<td valign="top">
								<div id="Layer1"
									style="position: absolute; width: 99%; height: 175px; overflow: scroll;">
									<table width="3000" align="center" cellpadding="0"
										...
										<c:forEach var="var" items="${cashierlist}"></c:forEach>
										<tr>
											<td height="25" align="center" bgcolor="#FFFFFF">
												<span id="startDate">${fn:substring(var[0], 0, 10)}</span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span id="endDate">${fn:substring(var[1], 0, 10)}</span>
											</td>

											<td align="center" bgcolor="#FFFFFF">
												<span id="periodDate">${fn:substring(var[2], 0, 10)}</span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span id="batchNumber">${var[3]}</span>
											</td>

											<td align="center" bgcolor="#FFFFFF">
												<span id="goodsCoding">${var[4]}</span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span id="defaultStorage">${var[5]}</span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span id="goodsName">${var[6]}</span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span id="typeID">${var[0]}</span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span id="mnemonicCode">${var[7]}</span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span id="model">${var[8]}</span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span id="standard">${var[9]}</span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span id="identifyingCode">${var[10]}</span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span id="goodsVariableID">${var[11]}</span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span id="quantity">${var[12]}</span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span id="weight">${var[13]}</span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span id="boxStandard">${var[14]}</span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span id="priceManage">${var[15]}</span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span id="price">${var[16]}</span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span id="money">${var[17]}</span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span id="costType">${var[18]}</span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span id="subjectsName">${var[19]}</span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span id="depotType">${var[20]}</span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span id="loan">${var[21]}</span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span id="forLoan">${var[22]}</span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span id="direction">${var[23]}</span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span id="balance">${var[24]}</span>
											</td>
										</tr>
									</table>
								</div>
					...
					<table width="99%" border="0" id="table4" align="center"
						...
						<tr>
							...
							<td>
								<span id="contactConnections"></span>
							</td>
						</tr>
					</table>
