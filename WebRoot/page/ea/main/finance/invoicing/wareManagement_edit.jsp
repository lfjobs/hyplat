...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script language="javascript" type="text/javascript"
			src="<%=basePath%>js/ea/finance/invoicing/wareManagement_edit.js"></script>
		<style type="text/css">
.hide {
	border-left: 0px;
	border-right: 0px;
			...
			<div class="content1" style="width: 100%;">
				...
				<table width="99%" border="0" id="table3" align="center"
					...
					<tr>
						...
						<td>
							<input type="hidden" name="financialBillsGood.financialgoodID"
								id="cashierID" value="${financialBillsGood.financialgoodID}" />
							<input type="hidden" name="financialBill.financialgoodKey"
							...
							<div id="Layer1"
								...
								<table width="1500" align="center" cellpadding="0"
									...
									<tr>
										...
										<th align="center" width="140" bgcolor="#E4F1FA">
											<span id="reQuantity" style="display:none">收货数量</span><span id="aa">操作</span>
										</th>
									...
									<s:iterator value="BillsGoodList">
										<tr class="xggoods">
											...
											<td align="center" bgcolor="#FFFFFF">
												<span id="pware">${pware}</span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span id="parea">${parea}</span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span id="pframe">${pframe}</span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
											...
											<td align="center" bgcolor="#FFFFFF">
												<span name="paymentType">${paymentType}</span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span name="logisticsType">${logisticsType}</span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span name="remindContent">${remindContent}</span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<input class="input put3" size="5" style="margin-left: 2px; display: none" name="reQuantity" id="reQuantity"/>
												<span id="aa"><a href="#" class="klsc"><img 
													src="<%=basePath%>images/admin_images/gtk-del.png"
													width="16" height="16" title="删除" border="0" /></a></span>
											</td>
										</tr>
									</s:iterator>
								</table>
				...
				<table width="99%" border="0" id="table4" align="center"
					...
					<tr>
						...
						<td width="15%">
							<span id="ccompanyname" class="qk">${contactCompanyView1.companyName}</span>
						</td>
						<td width="10%" align="right">
							<span class="STYLE1">单位电话：</span>
						</td>
						<td width="15%">
							<span id="companyTel" class="qk">${contactCompanyView1.companyTel}</span>
						</td>
						<td width="10%" align="right">
							<span class="STYLE1">单位负责人：</span>
						</td>
						<td width="15%">
							<span id="cresponsible" class="qk">${contactCompanyView1.cresponsible}</span>
						</td>
						<td width="10%" align="right">
							<span class="STYLE1">银行账号：</span>
						</td>
					...
					<tr>
						...
						<td>
							<span id="responsibleTel" class="qk">${contactCompanyView1.responsibleTel}</span>
						</td>
						<td align="right">
							<span class="STYLE1">公司地址：</span>
						</td>
						<td>
							<span id="companyAddr" class="qk">${contactCompanyView1.companyAddr}</span>
						</td>
						<td align="right">
							<span class="STYLE1">行业类别：</span>
						</td>
						<td>
							<span id="industryType" class="qk">${contactCompanyView1.industryType}</span>
						</td>
						<td height="30" align="right">
						...
						<td>
							<div align="left">
								<span id="contactConnections" class="qk">${contactCompanyView1.contactConnections}</span>
							</div>
						</td>
					</tr>
				</table>
