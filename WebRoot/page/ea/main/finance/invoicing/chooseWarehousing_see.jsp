...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>${financialBill.billsType}查看审核</title>
		...
		<script language="javascript" type="text/javascript"
			src="<%=basePath%>js/ea/finance/invoicing/chooseWarehousing_see.js"></script>
		<style type="text/css">
.hide {
	border-left: 0px;
	border-right: 0px;
			   ...
			   <table width="100%" border="0" align="center" cellpadding="0"
					...
					<tr>
						<td height="30" align="left">
						    <input type="button" 
				                class="menubtn grey" name="button3"value="保存" disabled="disabled"/><input type="button" 
								...
								class="menubtn grey" name="button" value="删除新增行" disabled="disabled"/><input type="button" 
				...
				<table width="800" border="0" id="table3" align="center"
					...
					<tr>
						<td height="30" width="80" align="right">
							单据编号：
						</td>
						<td width="170">
							...
							<input type="hidden" name="financialBill.financialbillKey"
							 ...
							 <input type="text" class="inputbottom" style="width: 170px;"
				...
				<table width="800" height="158px" border="0" align="center"
					...
					<tr>
						<td valign="top">
							<div id="Layer1"
								style="position: absolute; width: 800px; height: 160px; overflow: auto;">
								<table width="800" align="center" cellpadding="0"
									...
									<tr>
										...
										<th align="center" bgcolor="#E4F1FA" id="reQuantity" >
											收货数量
										</th>
										<th align="center" bgcolor="#E4F1FA">
											品名编号
									...
									<s:iterator value="warehouseList">
										<tr class="xggoods">
											...
											<td align="center" bgcolor="#FFFFFF">
												<span id="isQualify">${isQualify}</span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span id="price">${price}</span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span>${isQualify*price}</span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
