...
<script type="text/javascript" src="<%=basePath%>js/common/common.js"></script> 
		...
		<script language="javascript" type="text/javascript"
			src="<%=basePath%>js/ea/finance/invoicing/marketResearch_list.js"></script>
		<script type="text/javascript"
	...
	<body>
		...
		<c:import url="../../../page_navigator.jsp">
			<c:param name="actionPath"
				value="/ea/purchase/ea_getMarketResearchList.jspa?search=${search}&pageNumber=${pageNumber}&sdate=${sdate}&edate=${edate}&type=04">
			</c:param>
		</c:import>
