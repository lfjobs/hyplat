...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
 <%@ page language="java" pageEncoding="UTF-8" %>
        ...
        <script language="javascript" type="text/javascript" src="<%=basePath%>js/ea/finance/invoicing/voucher/examine_print.js"></script>
<style type="text/css">
.table {
...
<body>
<c:forEach items="${baseList}" var="l" varStatus="a">
<center>
...
<table width="620"  border="0" cellspacing="0"  style="background:#FFFFFF;">
  <tr><td height="30" width="300">&nbsp;<span style="font-size: 25px;position: relative;left:250px">${l.VTName}凭证</span></td>
...
<br>
	<tr>
		<td width="270px" style="font-size: 15px;">${l.VTJc} 字  第  ${l.journalnum} 号</td>
		<td width="270px" style="font-size: 15px;">凭证日期 ${l.voucherdate}</td>
		<td width="270px" style="font-size: 15px;">会计期间    ${fp.year} 年 ${fn:substring(l.voucherdate,4,6)} 期  </td>
		<td class="u1">1/1</td>
	</tr>
</table>
...
<br><br>
	<tr align="center" style="font-weight: bold;">
		<td width="240px" height="65"><span style=" font-size: 20px;">科目编号</span>
			<input type="hidden" value="${l.voucherid}" class="cherid"></td>
...
<br><br><br>
	<tr>
		...
		<td width="220px" style="font-size: 15px;">制单    ${l.makepeople}</td>
		<td width="200px" style="font-size: 15px;">记账    ${l.tallypeople}</td>
		<td width="200px" style="font-size: 15px;">审核    ${l.auditingpeo}</td>
