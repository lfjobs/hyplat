	...
	<body style="background:#ffffff;border-top:5px solid #c5d9f1;">
		...
		<div id="maindiv">
		  ...
		  <table class="linetable" id="table3" cellpadding="10" cellspacing="5" width="650px">
			   <tr><td align="center" colspan="6" id="titlestyle" ><span></span><input type="hidden" name="cashierBills.billsType"/>
			   ...
			   <input type="hidden" name="billsType" value="${billsType}"/>
				...
				<td align="right">公司：</td>
					<td><input type="text" readonly class="inputbottom" style="width: 180px;"
						name="cashierBills.companyName" value="<%=c.getCompanyName()%>" />
									...
									<tr id="kelong1" class="checkgoods">
										...
										<div class="tdiv">
											<input id="quantity" name="quantity" 
												class="model1 jisuan fou posnumred" style="display:inline;width:100%;height:100%;border:0px;" />
												</div>
										</td>
										<td align="center" bgcolor="#FFFFFF">
										<div class="tdiv">
										...
										<div class="tdiv">
											<input id="price" name="price" class="jisuan model1 fou posnumred"
												 style="display:inline;width:100%;height:100%;border:0px;" />
										   </div>
										</td>
										<!-- 总金额 -->
										<td align="center" bgcolor="#FFFFFF">
									...
									<!-- 目标起时间 -->
										...
										<div class="tdiv">
											<input id="quantity" name="quantity" 
												...
												style="display:inline;width:98%;height:100%;" />
												</div>
										</td>
										<td align="center" bgcolor="#FFFFFF">
										<div class="tdiv">
