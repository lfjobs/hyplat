...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>凭证记账</title>
		...
		<script src="<%=basePath%>js/ea/finance/invoicing/voucher/accounting_list.js" 
			type="text/javascript" ></script>
		<style type="text/css">
			.button{
				line-height:10px;
  ...
  <body>
    <div id="main_main" class="main_main">
    		...
    		<table class="fexlist">
    		 <thead>
    			<tr>
    				...
    				<th width="70" align="center">凭证日期</th>
    				<th width="70" align="center">凭证号码</th>
    				<th width="70" align="center">凭证类别</th>
    				<th width="78" align="center">凭证来源</th>
    				<th width="70" align="center">借方金额</th>
    				<th width="78" align="center">贷方金额</th>
    				<th width="92" align="center">制单人</th>
    				<th width="60" align="center">部门</th>
    				<th width="78" align="center">审核人员</th>
    				<th width="78" align="center">记账人员</th>
    				<th width="80" align="center">记账时间</th>
			 ...
			 <tbody class="tbody">
			 	<c:forEach items="${pageForm.list}" var="l" varStatus="a">
			 	 	<tr id="${l.voucherid}" class="main"> 
			 			...
			 			<td><span class="spans">${l.tallypeople}</span></td>
			 			<td><span class="spans">${l.tallydate}</span></td>
			 			<td>
				 			<c:if test="${l.vouchercategory==3}">
				 			<span class="spans">已审核</span>
				 			</c:if>
							<c:if test="${l.vouchercategory==4}">
				 			<span class="spans">退记账</span>
				 			</c:if>
				 			<c:if test="${l.vouchercategory==5}">
				 			<span class="spans">已记账</span>
				 			</c:if>
			 			</td>	 			
			 		</tr>
			 	</c:forEach>
		...
		<c:param name="actionPath"
			value="ea/voucher/ea_getVoucherExamineList.jspa?pageNumber=${pageNumber}&search=${search}&otype=pzjz">
		</c:param>
	</c:import>
    	</div>
