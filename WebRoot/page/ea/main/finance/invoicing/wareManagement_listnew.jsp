...
<script type="text/javascript" src="<%=basePath%>js/common/common.js"></script>
		...
		<script language="javascript" type="text/javascript"
			src="<%=basePath%>js/ea/finance/invoicing/wareManagement_listnew.js"></script>
		<script type="text/javascript"
	...
	<body>
		...
		<c:import url="../../../page_navigator.jsp">
			<c:param name="actionPath"
				value="/ea/newsales/ea_getWareManagementList.jspa?search=${search}&pageNumber=${pageNumber}&sdate=${sdate}&edate=${edate}&billStatus=${billStatus}">
			</c:param>
		</c:import>
