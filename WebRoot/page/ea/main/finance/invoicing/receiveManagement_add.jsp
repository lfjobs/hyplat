...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script language="javascript" type="text/javascript"
			src="<%=basePath%>js/ea/finance/invoicing/receiveManagement_add.js"></script>
		<link rel="stylesheet" type="text/css"
	...
	$(document).ready(function() {
		...
		$.ajax({
					...
					success : function cbf(data) {
						...
						var ts3 = new TreeSelector($("#deptIDdr")[0], data1,
								-1);
						ts3.createTree();
					},
					...
					<tr>
						...
						<td>
							<input type="text" id="companyTel" style="width: 160px;"
								...
								class="isNaN ckTextLength inputbottom telephone" maxlength="30"/>
						</td>
						<td height="30" align="right">
						...
						<td align="left">
							...
							value="${financialBill.staffPhone}" class="isNaN ckTextLength inputbottom telephone" maxlength="30"/>
						</td>
					</tr>
					<tr>
						<td height="30" align="right">
						...
						<td>
							<input type="text" id="purchaseDate" style="width: 160px;" placeholder="单击选择采购日期"
						...
						<td valign="top">
							<div id="Layer1"
								...
								<table width="1000" align="center" cellpadding="0"
									...
									<c:forEach items="${billgoodlist}" var="list" varStatus="ltm">
									 <tr>
										...
										<td align="center" bgcolor="#FFFFFF">
											<span id="gm2">${list.goodsName}</span>
										</td>
										<td align="center" bgcolor="#FFFFFF">
										...
										<td align="center" bgcolor="#FFFFFF">
										    <span id="drName2">${financialBill.drdepotName}</span>
										</td>
										<td align="center" bgcolor="#FFFFFF">
										...
										<td align="center" bgcolor="#FFFFFF">
										    <input name="money" readonly="readonly" class="input"
												id="money" size="5" style="border:0px;height:100%;" value="${list.money}"/>
										</td>
									...
									<tr id="kelong" style="display: none;overflow:auto" >
										<td height="30" width="50" align="center" bgcolor="#FFFFFF">
										...
										<td align="center" bgcolor="#FFFFFF" style="width: 50px">
											<input type="hidden" name="goodsID" id="goodsID"  />						
											<span style="color:red;">*</span>
											<input type="text" readonly="readonly" class="panduan input" style="border:0px;height:100%;" size="10"
												placeholder="点击选择物品" name="goodsName" id="goodsName"/>
										</td>	
										<td align="center" bgcolor="#FFFFFF">
										...
										<td align="center" bgcolor="#FFFFFF">
										    <input name="goodsNum" id="goodsCoding" size="10" style="border:0px;height:100%;" readonly="readonly">
											 <input name="goodsnumber" id="goodsNum" size="8" type="hidden"
												style="border:0px;height:100%;" readonly="readonly"/>
										<td align="center" bgcolor="#FFFFFF">
					                       <input name="batch" id="batch" size="5" style="border:0px;height:100%;">
										</td>
										<td align="center" bgcolor="#FFFFFF">
										...
										<td align="center" bgcolor="#FFFFFF">
										    <span style="color:red;">*</span>
											<input name="financialBill.drdepotName" value="${financialBill.drdepotName}" placeholder="单击选择入库位置" 
											   id="drchoosedepotName" type="text" readonly="readonly" class="panduan input" style="border:0px;height:100%;" size="10">
										    <input type="hidden" name="financialBill.drdepotID" value="${financialBill.drdepotID}" id="drchoosedepotID"/>								</td>
										<td align="center" bgcolor="#FFFFFF">
										    <span style="color:red;">*</span><input maxlength="10" name="price" class="jisuan isNaN " id="price"
												size="5" style="border:0px;height:100%;"  readonly="readonly" />
										</td>
										<td align="center" bgcolor="#FFFFFF">
											<span style="color:red;">*</span>
										   <input maxlength="10" name="quantity" id="quantity" class="jisuan" 
