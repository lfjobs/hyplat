...
<script type="text/javascript" src="<%=basePath%>js/common/common.js"></script>
		...
		<script language="javascript" type="text/javascript"
			src="<%=basePath%>js/ea/finance/invoicing/accept_list.js"></script>
		<script type="text/javascript"
	...
	<body>
		...
		<c:import url="../../../page_navigator.jsp">
			<c:param name="actionPath"
				value="/ea/purchase/ea_getPurchaseList.jspa?search=${search}&pageNumber=${pageNumber}&sdate=${sdate}&edate=${edate}$type=00">
			</c:param>
		</c:import>
		...
		<div class="jqmWindow" style="width: 400px; right: 30%; top: 10%"
				...
				<table width="396px"  >
					...
					<tr>
						...
						<td>
							<select id="taxstatus" style="width:200px"  name="financialBill.billStatus">
					    		<option value="00" selected="selected" >未收货</option>
					    		<option value="01">已收货</option>
					    	</select>
						</td>
					</tr>
				</table>
