...
<script type="text/javascript" src="<%=basePath%>js/common/common.js"></script>
		...
		<script language="javascript" type="text/javascript"
			src="<%=basePath%>js/ea/finance/invoicing/storage_list.js"></script>
		<script type="text/javascript"
		...
		<script type="text/javascript">
			...
			document.onkeydown = function(evt){//捕捉回车 
    			...
    			if (key == 13) { //判断是否是回车事件。
        			...
        			if($("input#journalNum").val()!=''){
			        	$("#SearchForm").attr("action", basePath+"ea/purchase/ea_toWareSearch.jspa?pageNumber="+pNumber+"&taxstatusDu="+taxstatusDu);
	...
	<body>
		...
		<c:import url="../../../page_navigator.jsp">
			<c:param name="actionPath"
				value="/ea/storage/ea_getWareManagementList.jspa?search=${search}&pageNumber=${pageNumber}&sdate=${sdate}&edate=${edate}&tsdate=${tsdate}&tedate=${tedate}">
			</c:param>
		</c:import>
