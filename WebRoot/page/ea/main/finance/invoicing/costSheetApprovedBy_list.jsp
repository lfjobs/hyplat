...
<script type="text/javascript" src="<%=basePath%>js/common/common.js"></script> 
		...
		<script language="javascript" type="text/javascript"
			src="<%=basePath%>js/ea/finance/invoicing/costSheetApprovedBy_list.js"></script>
		<script type="text/javascript"
	...
	<body>
		<form name="costSheetForm" id="costSheetForm">
			<input type="submit" name="submit" style="display: none" />
			<input name="costSheetBill.csbID" id="csbID" style="display: none;"/>
			<input type="hidden" name="costSheetBill.billStatus" id="billStatus"/>
			<input name="type" id="type" style="display: none;" value="${type}"/>
			<s:token />
		</form>
		...
		<c:import url="../../../page_navigator.jsp">
			<c:param name="actionPath"
				value="/ea/costsheetapprovedby/ea_getApprovedByList.jspa?search=${search}&pageNumber=${pageNumber}&sdate=${sdate}&edate=${edate}&type=${type}">
			</c:param>
		</c:import>
					...
					<tr>
						...
						<!-- 
							<select id="status" style="width:200px"  name="status">
					    		...
					    		<option value="billStatus">历史数据</option>
					    	</select> -->
					    	<select id="status" style="width:200px"  name="costSheetBill.billStatus">
