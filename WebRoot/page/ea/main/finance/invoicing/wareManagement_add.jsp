...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script language="javascript" type="text/javascript"
			src="<%=basePath%>js/ea/finance/invoicing/wareManagement_add.js"></script>
		<link rel="stylesheet" type="text/css"
			...
			<div class="content1" style="width: 100%;">
				...
				<table width="99%" border="0" id="table3" align="center"
					...
					<tr>
						...
						<td>
							<span id="billsType">${billStatus=='07'?"销售出库":"出库单"}</span>
						</td>
						<td align="right">
							责任人：
						</td>
						...
						<span id="staffName">
							...
							<input type="text" id="partnerName"
								name="financialBill.staffName" value="${financialBill.staffName==null?ManStaffName:financialBill.staffName}" size="15" />
							<a href="#"
						...
						<td valign="top">
							<div id="Layer1"
								...
								<table width="1500" align="center" cellpadding="0"
									...
									<tr id="kelong" style="display: none" class="kelong">
										<td height="30" align="center" bgcolor="#FFFFFF">
											<input id="numbers" name="numbers" class="input" size="2" readonly="readonly" />
										</td>
										<td align="center" bgcolor="#FFFFFF">
										<input type="hidden" name="inventoryID" id="inventoryID" />
											<input name="weizhi" id="weizhi" style="display: none;"/>
											<span id="weizhi"></span>
										</td>
										<td align="center" bgcolor="#FFFFFF">
											<input type="hidden" name="goodsID" id="goodsID" />
											<input type="hidden" name="goodsNum" id="goodsNum" class="goodsNum" />
										...
										<td align="center" bgcolor="#FFFFFF">
											<input name="quantity" class="jisuan isNaN put3" id="quantity" readonly="readonly" value="1"
				...
				<table width="99%" border="0" align="center" cellpadding="0"
					...
					<tr>
						<td height="30" align="center">
							...
							<input type="button" class="btn001 JQueryunitret" name="button" id="danwei"
								value="重置往来单位" />
							<input type="button" class="btn001 JQuerypersonret" name="button" id="peoples"
								value="重置往来个人" />
							<input type="button" class="btn001 JQuerySubmitgd" name="button3"
								value="提交审核" />
							<input type="button" class="btn001 JQueryClose" id="fanhui" name="button2"
								value="返回" />
						</td>
					</tr>
				</table>
