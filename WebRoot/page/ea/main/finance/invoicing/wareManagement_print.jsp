...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script src="<%=basePath%>/js/ea/finance/invoicing/wareManagement_print.js" type="text/javascript"></script>
		<style type="text/css">
	...
	<body>
		...
		<div id="tableprint" align="center">
			...
			<table width="620" cellpadding="0" cellspacing="0" class="table">
				...
				<s:iterator value="BillsGoodList" status="number">
					<tr>
						...
						<!-- 金额-->
						<td align="right" bgcolor="#FFFFFF">
							<span class="moneysum" id="amount">${amount}</span>
						</td>
						<!-- 付款方式-->
						<td align="left" bgcolor="#FFFFFF">
							${paymentType}
			...
			<table width="620" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<td width="190">
						${contactCompanyView1.companyName}
					</td>
					<td width="60" align="center">
						单位电话
					</td>
					<td width="90">
						${contactCompanyView1.companyTel}
					</td>
					<td width="83" align="center">
						单位负责人
					</td>
					<td width="120">
						${contactCompanyView1.cresponsible}
					</td>
				</tr>
				<tr>
					...
					<td colspan="3">
						${contactCompanyView1.companyAddr}
					</td>
					<td align="center">
						单位往来关系
					</td>
					<td>
						${contactCompanyView1.contactConnections}
					</td>
				</tr>
				<tr>
					<td height="15" align="center">
					...
					<td>
						${contactUser1.staffName}
					</td>
					<td align="center">
						电话
					</td>
					<td>
						${contactUser1.reference}
					</td>
					<td align="center">
						个人身份证号
					</td>
					<td>
						${contactUser1.staffIdentityCard}
					</td>
				</tr>
				<tr>
					<td height="15" align="center">
					...
					<td>
						${contactUser1.referenceCode}
					</td>
					<td align="center">
						邮箱
					</td>
					<td>
						${contactUser1.referenceOrganization}
					</td>
					<td align="center">
						个人往来关系
					</td>
					<td>
						${contactUser1.relation}
					</td>
				</tr>
				<tr>
					<td height="15" align="center">
