...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script src="<%=basePath%>/js/ea/finance/invoicing/wareManagement_printnew.js" type="text/javascript"></script>
		<style type="text/css">
			...
			<table width="620" cellpadding="0" cellspacing="0" class="table">
				...
				<s:iterator value="BillsGoodList" status="number">
					<tr>
						...
						<!-- 金额-->
						<td align="center" bgcolor="#FFFFFF">
							<span class="moneysum" id="amount">${money}</span>
						</td>
						<!-- 付款方式-->
						<td align="center" bgcolor="#FFFFFF">
							${financialBill.paymentType}
						</td>
						<!-- 物流方式-->
						<td align="center" bgcolor="#FFFFFF">
