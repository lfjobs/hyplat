...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script language="javascript" type="text/javascript"
			src="<%=basePath%>js/ea/finance/invoicing/Purchase_add.js"></script>
		<link rel="stylesheet" type="text/css"
					...
					<tr>
						...
						<td>
							<input type="hidden" id="partnerID" name="financialBill.staffID"
								readonly="readonly" value="${financialBill.financialbillID==null?ManStaffId:financialBill.financialbillID}"/>
							<input type="text" id="partnerName"
								name="financialBill.staffName" value="${financialBill.staffName==null?ManStaffName:financialBill.staffName}" size="15" class="notnull input" />
							<a href="#"
								...
								<table width="1300" align="center" cellpadding="0"
									...
									<tr id="kelong" style="display: none">
										...
										<td align="center" bgcolor="#FFFFFF">
										    <input type="hidden" name="purchasemode" id="purchasemode" />
										    <span id="purchasemode"></span>
										</td>
										<td align="center" bgcolor="#FFFFFF">
										...
										<td align="center" bgcolor="#FFFFFF">
											<input maxlength="10" name="quantity" class="positiveNum jisuan isNaN put3"
												id="quantity" size="3" style="margin-left: 2px;" />
										</td>
										<td align="center" bgcolor="#FFFFFF">
											<input maxlength="10" name="unitPrice" class="jisuan isNaN put3" id="price"
										...
										<td align="center" bgcolor="#FFFFFF">
											<input type="hidden"  id="cashApplyBillsID" name="cashApplyBillsID" />
											<input name="appropriationmoney" readonly="readonly" class="input"
												id="appropriationmoney" size="5" style="margin-left: 2px;" />
										</td>
										<td align="center" bgcolor="#FFFFFF">
										...
										<td align="center" bgcolor="#FFFFFF">
											...
											<input type="text" readonly="readonly"
												value="${subjectsName}" class="panduan" size="8"
				...
				<table width="99%" height="30" border="0" align="center"
					...
					<tr>
						<td bgcolor="#FFFFFF" colspan="3">
							<input type="button" class="ACT_btn" name="button4" value="选择拨款物品"
								id="shuju" />
					...
					<tr>
						...
						<td width="15%">
							...
							<input type="hidden" id="companyTel"
								name="financialBill.ccompanyTel" />
						</td>
						<td width="10%" align="right">
				...
				<table width="99%" border="0" align="center" id="table5"
					...
					<tr>
						...
						<td width="15%">
							...
							<input type="hidden" id=contactUserID name="financialBill.cstaffID" value="${financialBill.cstaffID}" />
				...
				<div class="content1" style="width: 100%; height: 400px;">
					...
					<table width="99%" height="33" id="searchgood" border="0"
						...
						<tr>
							...
							<td width="80">
								<input name="typeID" class="input" id="typeID" size="25"
									style="margin-left: 2px;" />
							</td>
							<td height="33">
							<nobr>
