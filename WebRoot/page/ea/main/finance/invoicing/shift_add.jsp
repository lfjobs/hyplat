...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script language="javascript" type="text/javascript"
			src="<%=basePath%>js/ea/finance/invoicing/shift_add.js"></script>
		<link rel="stylesheet" type="text/css"
			...
			<div class="content1" style="width: 100%;">
				...
				<div id="Layer1"
					...
					<table width="100%" align="center" cellpadding="0" cellspacing="0"
						...
						<tr>
						<th></th>
						<th colspan="4">移动前位置</th>
						<th colspan="7"></th>
						<th colspan="4">移动后位置</th>
						<th></th>
						</tr>
						<tr>
						...
						<s:iterator begin="1" end="20">
							<tr id="kelong${aa }" class="xggoods">
								...
								<td align="center" bgcolor="#FFFFFF">
									<span class="xx" style="display: none;">*</span><input id="shiftQuantity" name="shiftQuantity" class="jisuan" size="5" style="margin-left: 2px; display: none"/>
								</td>
								<td align="center" bgcolor="#FFFFFF">
								<span class="xx" style="display: none;">*</span>
											<select class="warehouse" id="ku" style="width: 60px; display: none;" title="1" name="ku">
										...
										<td align="center" bgcolor="#FFFFFF">
										<span class="xx" style="display: none;">*</span>
												<select class="warehouse" id="qu" style="width: 60px; display: none;" title="2" name="qu">
													<option value="" >无</option>
												</select>
										</td>
										<td align="center" bgcolor="#FFFFFF">
										<span class="xx" style="display: none;">*</span>
												<select class="warehouse" id="jia" style="width: 60px; display: none;" title="3" name="jia">
													<option value="" >无</option>
												</select>
										</td>
										<td align="center" bgcolor="#FFFFFF">
										<span class="xx" style="display: none;">*</span>
											<select class="warehouse" id="wei" style="width: 60px; display: none;" title="4" name="wei">
												<option value="" >无</option>
											</select>
										</td>
								<td align="center" bgcolor="#FFFFFF">
