    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var getcodeurl = basePath
                + "ea/percentage/sajax_ea_getListCCodeByPID.jspa?codeID=" + codeID + "&date="
            ...
            tree.setOnClickHandler(function () {
                //给父页面元素赋值
                $(window.parent.$("#codeId").val(tree.getSelectedItemId()));
                $(window.parent.$("#codeName").val(tree.getItemText(tree.getSelectedItemId())));
                tree.deleteChildItems(tree.getSelectedItemId());
                var getcodeurl = basePath
                    + "ea/percentage/sajax_ea_getListCCodeByPID.jspa?date="
                    + new Date().toLocaleString();
