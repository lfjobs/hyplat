			...
			<table width="620" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					<td height="25" align="center" style="font-weight: bold">
					    ...
					    &nbsp; ${cashierBills.status=='22'?"草稿":cashierBills.status=='12'?"未收货"
					    :cashierBills.status=='13'?"已收货":cashierBills.status=='05'?"待会计审核"
					    :cashierBills.status=='06'?"待出纳审核":cashierBills.status=='07'?"已三审通过"
					    :cashierBills.status==null?"":"驳回作废"}
					    </div>
					</td>
				</tr>
			</table>
			...
			<table width="620" cellpadding="0" cellspacing="0" class="table">
				...
				<s:iterator value="warehouseList" status="number">
					<tr>
						...
						<!-- 金额-->
						<td align="center" bgcolor="#FFFFFF">
							<span  class="monsum" id="amount">${money}</span>
						</td>
						<!-- 供应商-->
						<td align="center" bgcolor="#FFFFFF">
							${ccompanyName}
