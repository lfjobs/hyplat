...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script language="javascript" type="text/javascript"
			src="<%=basePath%>js/ea/finance/invoicing/stocktaking_edit.js"></script>
		<link rel="stylesheet" type="text/css"
					...
					<table width="100%" align="center" cellpadding="0" cellspacing="0"
						...
						<s:iterator value="BillsGoodList" >
							<tr id="kelong" class="xggoods">
								...
								<td align="center" bgcolor="#FFFFFF">
									<span id="stocktakingQuantity">${stocktakingQuantity}</span>
								</td>
								<td align="center" bgcolor="#FFFFFF">
									<span id="stocktakingresults">${stocktakingresults}</span>
								</td>
								<td align="center" bgcolor="#FFFFFF">
									<span id="remindContent">${remindContent}</span>
								</td>
								<td align="center" bgcolor="#FFFFFF">
									<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
								</td>
