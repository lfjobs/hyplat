...
<div class="header">
    <ul>
        <li style="width: 10%;" ><a  href="javascript:history.go(-1);"><img src="<%=basePath %>images/ea/finance/NewPhoneOrders/sellerOrder/left.png" class="ulp"></a></li>
...
<input type="hidden" id="android" value="${param.android}">
