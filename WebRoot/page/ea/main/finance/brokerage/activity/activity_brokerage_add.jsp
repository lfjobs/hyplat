...
<head>
    ...
    <script type="application/javascript" src="<%=basePath%>js/ea/finance/brokerage/activity/activity_brokerage_add.js"></script>
</head>
<body>
<section class="commission des">
        ...
        <figure>
            ...
            <div class="tab-com">
                <table style="display: none" id="first_td">
                    <tr><%--表格克隆模板--%>
                        ...
                        <td class="td-0" style="display: none">
                            <input type="number" class="brokerages" data-id="brokerages" name="">
                        </td>
                        <td class="td-1"></td>
                        <td class="td-2"></td>
                ...
                <div class="tab-com-box">
                    <form id="addActivity">
                        <input type="hidden" value="${agencyTypeList.get(0).ppID}" name="actPrice.sbtzId">
                        <input type="hidden" value="${agencyTypeList.get(1).ppID}" name="actPrice.tpId">
                        <input type="hidden" value="${agencyTypeList.get(2).ppID}" name="actPrice.sbazId">
                        <input type="hidden" value="${agencyTypeList.get(3).ppID}" name="actPrice.sjdlId">
                        <input type="hidden" value="${agencyTypeList.get(4).ppID}" name="actPrice.xjdlId">
                        <input type="hidden" value="${agencyTypeList.get(5).ppID}" name="actPrice.cjdlId">
                        <input type="hidden" value="${agencyTypeList.get(6).ppID}" name="actPrice.khjfId">
    ...
    <div class="alert-com">
        ...
        <div class="alert_com">
            ...
            <div class="tab">
                <p>*注:该页面只展示已设置零售价佣金并且未设置活动价佣金的产品</p><br>
