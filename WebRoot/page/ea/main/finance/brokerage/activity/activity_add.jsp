...
<section class="commission add-act">
    ...
    <article>
        ...
        <figure>
            ...
            <div class="grid-1">
                <form action="" enctype="multipart/form-data" method="POST" id="addActivity">
                    <ul class="left">
                        <li>
                            <p>活动名称</p>
                            <h5>
                                <input type="text" value="" name="activity.activityName" id="activityName">
                                <input type="hidden" value="${activityType}" name="activity.type">
                            </h5>
                        </li>
                        <li>
                            <p>起时间</p>
                            <h5>
                                <input type="text" name="startTime" id="begin" value="">
                            </h5>
                        </li>
                        <li>
                            <p>止时间</p>
                            <h5>
                                <input type="text" name="endTime" id="end" value="">
                            </h5>
                        </li>
                        <li>
                            <p>活动图片</p>
                        ...
                        <li>
                            <p>活动详情</p>
                            <textarea id="xq" name="activity.activityDescribe"></textarea>
                        </li>
                    </ul>
                </form>
            </div>
            ...
            <ul class="footer">
                <li>
                    添加活动责任人<input type="text" readonly="readonly" value="${cac.staffName}">
                </li>
                <li>
                    添加活动日期<input type="text" readonly="readonly" value="${myDate}">
                </li>
            </ul>
        </figure>
        <!--内容 end-->
...
<script type="application/javascript">
    $(function () {
        ...
        var now = year + '-' + getNow(month) + "-" + getNow(date) + " " + h + ':' + m + ":" + s;
    ...
    $("#sure").click(function () {
        ...
        post_flag = true;
         $.ajax({
         type: "POST",
         url: basePath + "ea/activityPrice/sajax_ea_addActivity.jspa",
         cache: false,
         data: new FormData($('#addActivity')[0]),
         processData: false,
         contentType: false,
