        ...
        <figure>
            ...
            <div class="tab-com">
                ...
                <div class="tab-com-box">
                    <form id="updateWholesale">
                        <table width="1700">
                            <tbody>
                            <tr>
                                <td class="td-0" style="display: none">
                                    <input type="text" name="wholesale.wholesaleId" value="${pWholesales[0]}"
                                           class="">
                                </td>
                                <input type="hidden" id="brokerages" name="wholesale.brokerages"
                                       class="calculate brokerages"
                                       value="${pWholesales[4]}"><%--代理佣金和--%>
                                ...
                                <td class="td-4"><input type="number" value="${product.price}" id="showWholesale"
                                                        class="calculate showWholesale"></td>
                                <td class="td-3"><input type="number" value="${pWholesales[1]}"  class="calculate wholesale"
                                                        data-value="${pWholesales[1]}" id="wholesale"
                                                        name="wholesale.wholesale">
                                </td>

                                <td class="td-5"><input type="number" value="${pWholesales[2]}" placeholder="请输入"
                                                        id="cost" class="calculate cost"
                                                        name="wholesale.factory" data-value="${pWholesales[2]}"></td>
                                <td class="td-6">
                                    <!--[if supportFields]>
                                ...
                                <td class="td-13"><input type="number" value="${pWholesales[3]}" id="ywyj" class="calculate ywyj"
                                                         name="wholesale.brokerage" data-value="${pWholesales[3]}">
                                </td>
                                <td class="td-14">
                                    <select name="wholesale.investType" class="selector">
                                        <option value="00" <c:if test="${pWholesales[5]=='00'}">selected</c:if>>选择投资类别
                                        </option>
                                        <option value="01" <c:if test="${pWholesales[5]=='01'}">selected</c:if>>教练车
                                        </option>
                                        <option value="02" <c:if test="${pWholesales[5]=='02'}">selected</c:if>>创客单车
                                        </option>
                                        <option value="03" <c:if test="${pWholesales[5]=='03'}">selected</c:if>>超市
                                        </option>
                                    </select>
                                </td>
                            </tr>
...
<script type="application/javascript">
    $(function () {
        ...
        $("#sure").click(function () {
            var cost_flag = false;
            var num = 1;
            $("form input[type='number']").not(".showWholesale").each(function () {
            ...
            if (Number(sj).toFixed(2) == Number(facto).toFixed(2)) {
                ...
                $.ajax({
                    type: "POST",
                    url: basePath + "ea/wholesale/sajax_ea_updateBrokeragePercent.jspa",
                    data: $("#updateWholesale").serialize(),
                    success: function (data) {
                        var member = eval("(" + data + ")");
