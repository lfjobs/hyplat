...
<div id="main_main" class="main_main">
    <table class="address">
        ...
        <c:forEach var='arr' items="${pageForm.list}">
            <tr id="${arr[0]}">
                ...
                <td>
                    <p id="price">${arr[7]}</p><%--系统零售价--%>
                </td>
                <td>
                    <span class="showPrice">${arr[8]}</span><%--展示零售价--%>
                </td>
                <td>
    ...
    <c:import url="../../../../page_navigator.jsp">
        <c:param name="actionPath"
                 value="ea/retail/ea_selectRetailList.jspa?pageNumber=${pageNumber}&search=${search}&showweixin=${showweixin}"></c:param>
    </c:import>
</div>

<iframe name="hidden" frameborder="0" noresize="noresize" border="0" framespacing="0" height="0"></iframe>

<script type="text/javascript" src="<%=basePath%>js/ea/finance/brokerage/retail/retail.js"></script>
</body>
</html>
