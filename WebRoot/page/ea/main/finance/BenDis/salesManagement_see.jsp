    ...
    <div style=" width: 650px;">
		...
		<table class="table" style="width: 639px;">
			...
			<tr height="22">
				...
				<td width="193px" ><font size="2">${cashi[6]}</font></td>
			</tr>
			<tr height="22">
				<td><font size="2">付款人：</font></td>
				<td><font size="2" id="goodsName">${cashi[10]}</font></td>
				<td><font size="2">物品总数量：</font></td>
				<td><font size="2">${cashi[3]}</font></td>
			</tr>
		</table>
		...
		<table>
			<tr>
				...
				<td width="160px;"></td>
				<td width="230px;"  ><font size="2">制单日期：</font><font size="2">${cashi[9]}</font></td>
			</tr>
		</table>
    </div>
    </center>
