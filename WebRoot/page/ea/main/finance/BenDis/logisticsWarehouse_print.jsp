...
<html>
    ...
    <script type="text/javascript">
    	...
    	$(function(){
    		...
    		$(".JQueryprint").click(function(){
    			open(basePath+"ea/logware/ea_getPreviewPageData.jspa?type=01&cashierBills.cashierBillsID="+$("#cashiId").val());
    		});
  ...
  <body>
	...
	<div>
		<div style="position: relative;top: 30px;left: 400px;width: 100px;"><font color="#15428b" style="font-weight:bold;">物流出库单</font></div>
