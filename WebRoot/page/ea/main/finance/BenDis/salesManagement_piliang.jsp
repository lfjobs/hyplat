...
.table td {
  ...
  <div>
  	<center>
	  	...
	  	<c:forEach items="${arrayList}" var="list" varStatus="a">
	  		<div>
    		<span><font style="font-weight:bold;" size="3">微分金销售出库单</font></span>
    		</div>    	<br/><br/>
	  	<div style="border: 1px solid #000;height: 220px;position: relative;">
	  		<c:set var="objs" value="${list['obj']}" scope="request"></c:set>
	  		<table>
	    		<tr>
	    			...
	    			<td align="right"  width="370px" rowspan="2">
	    				<table>
	    					<tr>
	    						...
	    						<td><font>
							<%
								Object[] obj=(Object[])request.getAttribute("objs");
	    					...
	    					<tr>
	    						<td align="center"><font  size="2">${list['obj'][1]}</font></td>
	    					</tr>
	    				</table>	
	    			</td>
	    		</tr>
	    		<tr>
	    			<td align="left"><font size="2" style="font-weight:bold;">订单编号：</font><font size="2">${list['obj'][2]}</font></td>
	    		</tr>
	    	</table>
	
			<table class="table" style="width: 639px;">
				
				<tr height="22">
					<td width="120px" ><font size="2">仓库名称：</font></td>
					<td width="193px" ><font size="2">物流库</font></td>
					<td width="120px" ><font size="2">仓库地址：</font></td>
					<td width="193px" ><font size="2">${list['obj'][6]}</font></td>
				</tr>
				<tr height="22">
					<td><font size="2">付款人：</font></td>
					<td><font size="2" id="goodsName">${list['obj'][10]}</font></td>
					<td><font size="2">物品总数量：</font></td>
					<td><font size="2">${list['obj'][3]}</font></td>
				</tr>
			</table>
			<table style="font-size: 3px;width: 639px;" cellpadding="0" cellspacing="0" class="table">
				<thead>
				...
				<tbody id="goodsTbody">
					<c:forEach items="${list['list']}" var="l" varStatus="a">
					<tr>
						<td>${a.index+1}</td>
						<td>${l.goodsNum}</td>
						<td>${l.goodsName}</td>
			...
			<tr>
					<td  width="240px;"><font size="2">发货人：</font><font size="2"></font></td>
					<td width="250px;"></td>
					<td ><font size="2">领料人：</font><font size="2"></font></td>
				</tr>
				<tr>
					<td  width="240px;"><font size="2">制单人：</font><font size="2">${list['obj'][8]}</font></td>
					<td width="250px;"></td>
					<td ><font size="2">制单日期：</font><font size="2">${list['obj'][9]}</font></td>
				</tr>
			</table>
	  	</div>
