...
<html>
  <head>
	...
	<script src="<%=basePath%>js/ea/finance/BenDis/goldOutWarehouse_list.js" type="text/javascript"></script>
 	...
 	<form id="form" name="form" action="" method="post">
  	...
  	<c:import url="../../../page_navigator.jsp">
		<c:param name="actionPath"
			value="ea/goldStock/ea_getGoldOfTheHomePage.jspa?type=01&pageNumber=${pageNumber}">
		</c:param>
	</c:import>
