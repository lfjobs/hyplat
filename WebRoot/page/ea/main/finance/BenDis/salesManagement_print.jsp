...
<html>
    ...
    <script type="text/javascript">
    	...
    	$(function(){
    		...
    		$(".JQueryprint").click(function(){
    			open(basePath+"/ea/salesman/ea_getPreviewPageData.jspa?type=01&cashierBills.cashierBillsID="+$("#cashiId").val());
    		});
  ...
  <body>
	...
	<div>
		<div style="position: relative;top: 30px;left: 400px;width: 150px;"><font color="#15428b" style="font-weight:bold;">微分金销售出库单</font></div>
		<div style="position: relative;top: 60px;left:10px;width:900px;">
			<table>
				<tr height="30px;">
					<td><font size="2" color="#4F4F4F">出库编号：</font></td>
				...
				<tr height="25px;">
					<td><font size="2" color="#4F4F4F">付款人：</font></td>
					<td><input type="text" class="inputbottom" value="${cashi[10]}" readonly="readonly" style="width: 140px;"></td>
					<td><font size="2" color="#4F4F4F">仓库名称：</font></td>
					<td><input type="text" class="inputbottom" value="物流库" readonly="readonly" style="width: 140px;"></td>
