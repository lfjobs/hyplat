...
<head>
    ...
    <script src="<%=basePath%>js/ea/finance/Gold_Pool/wfj_scoreCoin.js"></script>
...
<body style="background:#fff;">
    ...
    <div class="wrap_page">
        <div class="jifen_pay_wrap">
            <div class="jifen_pay">
                <div class="jifen_paynum"><fmt:formatNumber value="${bp.bonusPointScore==null?0:bp.bonusPointScore }" groupingUsed="true"/></div>
                <div>现有积分</div>
            </div>
        </div>
        
        <div class="inp_box">
            <input type="text" class="gold_inp" placeholder="请输入充值积分">
        </div>
