...
<html>
  <head>
	...
	<script src="<%=basePath%>js/ea/finance/BenDis/logisticsStorage_list.js" type="text/javascript"></script>
 	...
 	<form id="form" name="form" action="" method="post">
	  	<table class="fexlist" id="table">
	  		<thead>
	  			<tr id="titleTr">
	  				...
	  				<th align="center" width="100">入库编号</th>
	  				...
	  				<th align="center" width="70">入库时间</th>
	  			</tr>
	  		</thead>
	  		<tbody>
  	...
  	<c:import url="../../../page_navigator.jsp">
		<c:param name="actionPath"
			value="ea/logstor/ea_getHomePageInformationList.jspa?type=00&pageNumber=${pageNumber}">
		</c:param>
	</c:import>
