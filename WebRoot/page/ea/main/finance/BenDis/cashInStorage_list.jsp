...
<html>
  <head>
	...
	<script src="<%=basePath%>js/ea/finance/BenDis/cashInStorage_list.js" type="text/javascript"></script>
 	...
 	<form id="form" name="form" action="" method="post">
  	...
  	<c:import url="../../../page_navigator.jsp">
		<c:param name="actionPath"
			value="ea/cashStock/ea_getCashOfTheHomePage.jspa?type=00&pageNumber=${pageNumber}">
		</c:param>
	</c:import>
