...
<script src="<%=basePath%>js/ea/human/cstaff.js"></script>
 <script language="javascript" type="text/javascript" src="<%=basePath%>js/ea/finance/production/cashierbillsclassret_edit.js"></script>
   <style type="text/css"> 
	.hide{ 
	 border-left: 0px; 
	 border-right: 0px; 
...
<table width="3000" align="center" cellpadding="0" cellspacing="0" class="table" id="goodtable">
  <tr>
    ...
    <th align="center" bgcolor="#E4F1FA">事由</th>
