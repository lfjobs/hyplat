...
%><html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script language="javascript" type="text/javascript"
			src="<%=basePath%>js/ea/finance/production/goodscashierdepartment_list.js"></script>
		<script type="text/javascript"
	...
	<body>
		...
		<c:import url="../../../page_navigator.jsp">
			<c:param name="actionPath"
				value="/ea/goodscashierdepartment/ea_getProCashierList.jspa?search=${search}&pageNumber=${pageNumber}&sdate=${sdate}&edate=${edate}&period=${period}">
			</c:param>
		</c:import>
			...
			<div class="jqmWindow" style="width: 400px; right: 25%; top: 10%;"
				...
				<table width="396" id="SearchTable">
					<tr>
						...
						<td><select name="cashierBills.billsType" id="btype"></select>
						</td>
					</tr>
					<tr>
						<td align="right">
					...
					<tr>
						...
						<td>
							<s:select list="%{#request.stafflist}" style="width:200px"
								...
								name="cashierBills.staffID" listValue="staffName" theme="simple">
							</s:select>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<select id="departmentID" name="cashierBills.departmentID"
								style="width: 200px">
								<option value="">
									请选择
								</option>
		...
		<form name="cstaffForm" id="cstaffForm" method="post">
			<div class="jqmWindow jqmWindowcss6" style="width: 1200px; top: 1%"
				id="jqModels">
				<div class="drag">
					出纳明细单
					<div class="close"></div>
