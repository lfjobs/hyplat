...
<script type="text/javascript" src="<%=basePath%>js/common/common.js"></script> 
        ...
        <script language="javascript" type="text/javascript" src="<%=basePath%>js/ea/finance/production/splitGbilla_list.js"></script>
    ...
    <body>
        ...
        <c:import url="../../../page_navigator.jsp">
            <c:param name="actionPath" value="/ea/splitgoodsbill/ea_AsearchGood.jspa?zz=${zz}&level=${level}&sztype=${sztype}&search=${search}&pageNumber=${pageNumber}&sdate=${sdate}&edate=${edate}&period=${period}">
            </c:param>
        </c:import>
                ...
                <table width="396" id="SearchTable">
					<tr>
						...
						<s:select list="%{#request.billsType}" id="types"
								headerKey="" headerValue="请选择" name="goodsCashierBillsVO.billsType"
                    ...
                    <tr>
                        ...
                        <td>
                            <select id="deptID" name="balanceChange.companyID">
                    ...
                    <tr>
                     ...
                     <tr><td align="right">物品名称：</td>
                        <td><input id="goodsName"  style="width:195px"  name="goodsCashierBillsVO.goodsName" /></td>
                    </tr>
                     <tr><td align="right">物品编码：</td>
                         <td><input id="goodsCoding"  style="width:195px"  name="goodsCashierBillsVO.goodsCoding" /></td>
                    </tr>
                   <tr>
                  ...
                  <tr>
                   <td align="right">
                           往来单位：                        </td>
                        <td><input id="ccID"  style="width:195px"  name="goodsCashierBillsVO.ccompanyname" /><a id="wldw" href="#">选择</a></td>
                  </tr>
                  <tr>
                   <td align="right">
                            往来个人：                        </td>
                        <td><input id="cuID"  style="width:195px" name="goodsCashierBillsVO.contactUserName" /><a id="wlgr" href="#">选择</a></td>
                  </tr>
                </table>
            <div align="center">
