<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
	...
	<head>
		...
		<script type="text/javascript"
			src="<%=basePath%>js/ea/finance/production/goodscashierdetail_list.js"></script>
		<script type="text/javascript"
		...
		<script type="text/javascript">
			...
			document.onkeydown = function(evt){//捕捉回车 
    			...
    			if (key == 13) { //判断是否是回车事件。
        			...
        			if($("input#journalNum").val()!=''){
			        	$("#SearchForm").attr("action", basePath+"/ea/goodscashierdepartment/ea_toProSearch.jspa?pageNumber="+pNumber);
	...
	<body>
		<table class="flexme11">
			...
			<tbody>
				<s:iterator value="pageForm.list" >
					<tr id="${cashierBillsID}-${goodsCoding}">
						<td>
		...
		<c:import url="../../../page_navigator.jsp">
			<c:param name="actionPath"
				value="/ea/splitbill/ea_getBillsDetailList.jspa?search=${search}&pageNumber=${pageNumber}&dtype=${dtype}&level=${level}">
			</c:param>
		</c:import>
			...
			<div class="jqmWindow" style="width: 400px; right: 25%; top: 10%;"
				...
				<table width="396" id="SearchTable">
					<tr class="btypetr">
						...
						<td><select name="goodsCashierBillsVO.billsType" id="btype"></select>
						</td>
					</tr>
					<tr>
						<td align="right">
						...
						<td>
							<input id="journalNum" style="width: 195px"
								name="goodsCashierBillsVO.journalNum" />
						</td>
					</tr>
					<s:if test="level=='allCompany'">
						<tr>
	                        <td align="right">
	                            	公司名称：
	                        </td>
	                        <td>
	                            <select id="deptID" name="goodsCashierBillsVO.companyID">
                    ...
                    <s:if test="level=='allCompany'||level=='company'"></s:if>
                    <tr>
                        <td align="right">
                            	部门名称：
                        </td>
                        <td width="314">
                            <select id="orgID" name="goodsCashierBillsVO.departmentID">
                            <option value="">
                               	 请选择<s:if test="level=='allCompany'">公司</s:if>
                            </option>
                            </select>
                        </td>
                    </tr>
					<tr>
						...
						<td>
						<s:if test="level=='organization'">
							<s:select list="%{#request.stafflist}" style="width:200px"
								headerKey="" headerValue="请选择" listKey="staffID"
								name="goodsCashierBillsVO.staffID" listValue="staffName" theme="simple">
							</s:select>
						</s:if>
						<s:else>
						<select name="goodsCashierBillsVO.staffID" id='person'>
                                <option value="">
                                    	请选择部门
                                </option>
                            </select>
					...
					<tr>
						...
						<td>
							<input id="goodsName" style="width: 195px"
								name="goodsCashierBillsVO.goodsName" />
						</td>
					</tr>
					<tr>
						<td align="right">
						...
						<td>
							<input id="goodsCoding" style="width: 195px"
								name="goodsCashierBillsVO.goodsCoding" />
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input id="ccID" style="width: 195px"
								name="goodsCashierBillsVO.ccompanyname" />
							<a id="wldw" href="#">选择</a>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input id="cuID" style="width: 195px"
								name="goodsCashierBillsVO.contactUserName" />
							<a id="wlgr" href="#">选择</a>
						</td>
					</tr>
				</table>
		...
		<form name="selectcompanyForm" id="selectcompanyForm" method="post"
			...
			<input type="submit" name="submit"
				style="display: none; width: 1300px" />
		...
		<form name="cstaffForm" id="cstaffForm" method="post">
			<div class="jqmWindow jqmWindowcss6" style="width: 1000px; top: 1%; left: 60%;overflow-x: scroll;"
				id="jqModels">
				<div class="drag">
					出纳明细单
					<div class="close"></div>
				...
				<div class="content" style="width: 1200px;">
					...
					<table width="99%" border="0" id="table3" align="center"
						...
						<tr>
							...
							<td>
								${cashierBillsVO.companyBankNum}
							</td>
							<td align="right">
								票据支票管理:
							</td>
							<td align="left">
								${cashierBillsVO.billCheck}
							</td>
							<td align="right"></td>
							<td width="15%" align="left"></td>
						</tr>
					</table>
					<table width="99%" height="200px" border="0" align="center"
						cellpadding="0" cellspacing="0" style="margin-top: 5px">
						<tr>
							<td valign="top">
								<div id="Layer1"
									style="position: absolute; width: 100%; height: 195px; overflow: scroll;">
									<table width="2200" align="center" cellpadding="0"
										cellspacing="0" class="table" id="goodtable">
										<tr>
											<th height="30" align="center" bgcolor="#E4F1FA">
												款源日期
											</th>
											<th align="center" bgcolor="#E4F1FA">
												入账日期
											</th>
											<th width="75" align="center" bgcolor="#E4F1FA">
												有效日期
											</th>
											<th width="110" align="center" bgcolor="#E4F1FA">
												批号/期号
											</th>
											<th align="center" bgcolor="#E4F1FA">
												品名编号
											...
											<th width="60" align="center" bgcolor="#E4F1FA">
												类型
											</th>
											<th width="60" align="center" bgcolor="#E4F1FA">
												品牌
										...
										<tr>
											...
											<td align="center" bgcolor="#FFFFFF">
												<span id="periodDate"></span>${periodDate}
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span id="batchNumber"></span>${batchNumber}
											</td>
											...
											<td align="center" bgcolor="#FFFFFF">
												<span id="typeID"></span>${typeID}
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span id="mnemonicCode"></span>${mnemonicCode}
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span id="model"></span>${model}
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span id="standard"></span>${standard}
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span id="identifyingCode"></span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span id="goodsVariableID"></span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
											...
											<td align="center" bgcolor="#FFFFFF">
												<span id="depotType"></span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span id="loan"></span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
												<span id="forLoan"></span>
											</td>
											<td align="center" bgcolor="#FFFFFF">
											...
											<td align="center" bgcolor="#FFFFFF">
												<span id="remindedContent"></span>${remindedContent}
											</td>
										</tr>
									</table>
								</div>
