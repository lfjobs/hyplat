...
<%@page import="hy.ea.bo.Company"%>
	<head>
		...
		<script language="javascript" type="text/javascript"
			src="<%=basePath%>js/ea/finance/production/statements_edit1.js"></script>
		<link rel="stylesheet" type="text/css"
			...
			<div class="content1" style="width: 100%;">
				...
				<table width="99%" border="0" id="table3" align="center"
					...
					<tr>
						...
						<td align="left" id="dept">
							...
							<input type="hidden" name="historyCashierBills.departmentID"
								value="${historyVO.departmentID}" />
				...
				<table width="99%" border="0" align="center" id="table5"
					...
					<tr>
						...
						<td>
							<span id="userQq" class="qk">${historyCashierBills.referenceCode}</span>
						</td>
						<td align="right">
							<span class="STYLE1">邮箱：</span>
						</td>
						<td>
							<span id="email" class="qk">${historyCashierBills.referenceOrganization}</span>
						</td>
						<td align="right">
							<span class="STYLE1">地址：</span>
						</td>
						<td>
							<span id="userAddr" class="qk">${historyCashierBills.staffAddress}</span>
						</td>
						<td width="10%" align="right">
