...
<script type="text/javascript" src="<%=basePath%>js/common/common.js"></script> 
		...
		<script type="text/javascript" src="<%=basePath%>js/ea/finance/competent_list.js"></script>
	...
	<body>
	<form name="Competentform" id="Competentform">
		...
		<c:import url="../../../../page_navigator.jsp">
			<c:param name="actionPath"
				value="/ea/competent/ea_getDutiableList.jspa?search=${search}&pageNumber=${pageNumber}&sdate=${sdate}&edate=${edate}&tsdate=${tsdate}&tedate=${tedate}&taxstatusDu=${taxstatusDu}">
			</c:param>
		</c:import>
				...
				<table width="396" id="SearchTable">
					...
					<tr>
						...
						<td>
					    	...
					    	<option value="1" selected="selected" >待主管审核</option>
