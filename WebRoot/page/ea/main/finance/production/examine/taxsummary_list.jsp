...
<script type="text/javascript" src="<%=basePath%>js/common/common.js"></script> 
		...
		<script language="javascript" type="text/javascript"
			src="<%=basePath%>js/ea/finance/taxsummary_list.js"></script>
		<script type="text/javascript"
		...
		<script type="text/javascript">
			...
			document.onkeydown = function(evt){//捕捉回车 
    			...
    			if (key == 13) { //判断是否是回车事件。
        			...
        			if($("input#journalNum").val()!=''){
			        	$("#SearchForm").attr("action", basePath+"ea/dutiable/ea_toSearch.jspa?pageNumber="+pNumber);
	...
	<body>
		<form name="Dutiableform" id="Dutiableform">
