...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script language="javascript" type="text/javascript"
			src="<%=basePath%>js/ea/finance/competent_edit.js"></script>
		<style type="text/css">
.hide {
	border-left: 0px;
	border-right: 0px;
...
#apDiv1 {
	...
	<body>
		<%-- 用来显示审核章 --%>
		<div id="apDiv1"></div>
		<form name="CompetentForm" id="CompetentForm" method="post"
			enctype="multipart/form-data">
			<input type="text" name="taxstatusDu" value="${taxstatusDu }"
				style="display: none" />
			...
			<div class="content1" style="width: 100%;">
				...
				<table width="99%" border="0" id="table3" align="center"
					...
					<tr>
						...
						<td>
							${cashierBillsVO.billsType}
						</td>
						<td align="right">
							制单日期：
						</td>
						<td>
							${fn:substring(cashierBillsVO.cashierDate, 0, 10)}
						</td>
					</tr>
					...
					<tr>
						...
						<td align="right"><span class="STYLE1">报税日期：</span></td>
						<td align="left">${fn:substring(cashierBillsVO.taxDate, 0, 10)}</td>
						<td align="right"></td>
									...
									<s:iterator value="pageForm.list">
										<tr class="xggoods">
											...
											<td align="center" bgcolor="#FFFFFF">
												${fn:substring(endDate, 0, 19)}
											</td>

											<td align="center" bgcolor="#FFFFFF">
												${fn:substring(periodDate, 0, 10)}
											</td>
											<td align="center" bgcolor="#FFFFFF">
												${batchNumber}
											</td>
				...
				<table width="99%" border="0" id="table4" align="center"
					...
					<tr>
						...
						<td width="15%">
							${cashierBillsVO.companyTel}
						</td>
						<td width="10%" align="right">
							<span class="STYLE1">单位负责人：</span>
						</td>
						<td width="15%">
							${cashierBillsVO.cresponsible}
						</td>
						<td width="10%" align="right">
							<span class="STYLE1">银行账户：</span>
						</td>
						<td width="15%">
							${cashierBillsVO.accountNum}
						</td>
					</tr>
					<tr>
						...
						<td>
							${cashierBillsVO.responsibleTel}
						</td>
						<td align="right">
							<span class="STYLE1">公司地址：</span>
						</td>
						<td>
							${cashierBillsVO.companyAddr}
						</td>
						<td align="right">
							<span class="STYLE1">行业类别：</span>
						</td>
						<td>
							${cashierBillsVO.industryType}
						</td>
						<td height="30" align="right">
							<span class="STYLE1">单位往来关系：</span>
						</td>
						<td>
							${cashierBillsVO.contactConnections}
						</td>
					</tr>
				</table>
				<table width="99%" border="0" align="center" id="table5"
					...
					<tr>
						...
						<td width="15%">
							${cashierBillsVO.staffIdentityCard}
						</td>
						<td align="right">
							<span class="STYLE1">银行账号：</span>
						</td>
						<td>
							${cashierBillsVO.userAccountNum}
						</td>
					</tr>
					<tr>
				...
				<table width="99%" border="0" align="center" cellpadding="0"
					...
					<tr>
						<td height="30" align="center">
							<input type="hidden" name="cashierBills.taxstatus" id="taxstatusDu" value="${cashierBillsVO.taxstatus}" />
							...
							<input type="button" class="btn001 JQuerySubmitbh"" name="button4" value="驳回" />   
       						<input type="button" class="btn001 JQuerySubmit"" name="button4" value="转经理审核" />    
