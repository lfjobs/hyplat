...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script language="javascript" type="text/javascript"
			src="<%=basePath%>js/ea/finance/manager_edit.js"></script>
		<style type="text/css">
.hide {
	border-left: 0px;
	border-right: 0px;
...
#apDiv1 {
	...
	<body>
		<%-- 用来显示审核章 --%>
		<div id="apDiv1"></div>
		<form name="Managerform" id="Managerform" method="post"
			enctype="multipart/form-data">
			<input type="text" name="taxstatusDu" value="${taxstatusDu }" style="display: none" />
					...
					<tr>
						<td height="30" align="center">
							...
							<input type="button" class="btn001 JQuerySubmitbh"" name="button4" value="驳回" />   
       						<input type="button" class="btn001 JQuerySubmit"" name="button4" value="转财务审核" />  
