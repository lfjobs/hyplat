...
<script type="text/javascript" src="<%=basePath%>js/common/common.js"></script> 
		...
		<script type="text/javascript"
			src="<%=basePath%>js/jquery.messager.js"></script>
				<script type="text/javascript"
			src="<%=basePath%>js/ea/finance/audit_list.js"></script>
		<script type="text/javascript">
	...
	<form name="Auditform" id="Auditform">
		...
		<c:import url="../../../../page_navigator.jsp">
			<c:param name="actionPath"
				value="/ea/audit/ea_getDutiableList.jspa?search=${search}&pageNumber=${pageNumber}&sdate=${sdate}&edate=${edate}&tsdate=${tsdate}&tedate=${tedate}&taxstatusDu=${taxstatusDu}">
			</c:param>
		</c:import>
				...
				<table width="396" id="SearchTable">
					...
					<tr>
						...
						<td>
					    	...
					    	<option value="3" selected="selected" >待财务审核</option>
