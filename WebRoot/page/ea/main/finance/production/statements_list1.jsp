...
html{
	overflow: hidden;
		...
		<script language="javascript" type="text/javascript"
			src="<%=basePath%>js/ea/finance/production/statements_list1.js"></script>
		<script type="text/javascript"
	...
	<body>
		...
		<c:import url="../../../page_navigator.jsp">
			<c:param name="actionPath"
				value="/ea/archivest/ea_getArchivesList.jspa?tt=z&search=${search}&pageNumber=${pageNumber}&sdate=${sdate}&edate=${edate}">
			</c:param>
		</c:import>
		...
		<div class="jqmWindow" style="width: 400px; right: 30%; top: 10%"
				...
				<table width="396px"  >
					...
					<tr>
						...
						<td>
							<s:select style="width:200px" list="%{#request.billTypes}"
								headerKey="" headerValue="全部" name="historyVO.billsType"
					...
					<tr>
						...
						<td>
							<input id="deparchivesNum" style="width: 195px"
								name="historyRelation.deparchivesNum" />
						</td>
					</tr>
					<tr>
						<td align="right">
						...
						<td>
								<input id="nuDate" name="nuDate" onfocus="date(this);"
								style="width: 195px" />
						</td>
					</tr>
					<tr>
						...
						<td>
							<select name="historyVO.departmentID" style="width: 200px"
								id="departmentID">
								<option value="">
									请选择
								</option>
					...
					<tr>
						...
						<td>
							<s:select list="%{#request.stafflist}" style="width:200px"
								...
								name="historyVO.staffID" listValue="staffName"
								theme="simple">
							</s:select>
						</td>
					</tr>
			...
			<!-- 添加 -->
			<div class="jqmWindow" style="width: 930px; right: 10%; top: 10%" id="jqmAdd">
				...
				<input type="submit" name="submit" style="display: none" />
				<input type="text" name="button" style="display: none" />
				<table>
				<tr>
				<td>
				<table width="99%" height="33" id="searchdocument" align="center"
					...
					<tr>
						...
						<td>
							...
							<input type="button" class="btn001" name="button1" id="add"
								value="添加" />
							</td>
							<td>
								<input type="button" class="btn001" name="button2" id="delButton"
								value="删除" />
								</td>
								<td>
								<input type="button" class="btn001" name="button3" id="save"
								value="保存" />
								</td>
								<td>
				...
				<tr><td>
					<table width="99%" border="0" align="center" cellpadding="0"
						cellspacing="0"
						style="margin-top: 5px; margin-bottom: 5px; height: 260px;">
						<tr>
							<td width="99%" valign="top" align="left">
								<div id="body_08cu"
									style="margin-top: 2px; height: 290px; width: 925px; overflow: scroll;">
									<table width='900px' align='center' id='gostable'
