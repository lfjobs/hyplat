...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script src="<%=basePath%>js/ea/ddsr/ddsrCoachManager.js"></script>
	...
	<body >
        <div class="main_main">
			...
			<c:import url="../../page_navigator.jsp">
                <c:param name="actionPath" value="ea/ddsrcoachManager/ea_doDdsrCoachManagerAction.jspa?innerAction=showDdsrCoachList&pageNumber=${pageNumber}&search=turnpage">
                </c:param>
            </c:import>            
        </div> 
                ...
                <div class="drag">编辑
  				...
  				<table cellpadding="0px" cellspacing="0px" name="stafftable" id="stafftable" width="710" style="margin-left: 5px;" height="103"> 
				    <tr>
					 ...
					 <tr>
				    	<td height="25" align="right" width="100">驾证日期：</td>
					 ...
					 <tr>
				    	<td height="25" align="right" width="100">教证日期：</td>
				    	<td width="200"><input type="text" name="coach.coacCertificateDate" id="coacCertificateDate" 
								onfocus="WdatePicker({lang:'zh-cn', dateFmt:'yyyy-MM-dd', onpicked:function(){;}})"
								readonly="readonly" class="put3" /></td>
					 </tr>					 
					 <tr>
            ...
            <form method="post" name="searchForm" id="searchForm">
                ...
                <div class="drag">查询
  				...
  				<table cellpadding="0px" cellspacing="0px" name="searchstafftable" id="searchstafftable" width="350" style="margin-left: 5px;" height="103"> 
					...
					<tr>
				    	<td height="25" align="right" width="100">是否推荐：</td>
				    	<td width="200"><select name="searchIsrecommend" id="searchIsrecommend">
						  <option value="">请选择</option>
