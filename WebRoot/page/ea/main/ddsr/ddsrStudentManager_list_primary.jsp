...
<script src="<%=basePath%>js/ea/ddsr/ddsrStudentManager_list_primary.js"></script>
...
var  searchDangQian='${searchDangQian}';
var  searchZhuangtai='${searchZhuangtai}';
	...
	<body>
        <div class="main_main">
			...
			<c:import url="../../page_navigator.jsp">
                <c:param name="actionPath" value="ea/coachreservationrecordcontent/refprimary_doDdsrStudentManagerAction.jspa?innerAction=showDdsrStudentList&pageNumber=${pageNumber}&search=turnpage">
                </c:param>
            </c:import>            
        </div> 
