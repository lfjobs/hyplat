...
<script src="<%=basePath%>js/ea/ddsr/coachreservationrecord.js"></script>
<style type="text/css">
.JQueryflexme .record{
	cursor: pointer;
}
...
<body>
        <div class="main_main">
            <table class="JQueryflexme">
                <thead>
                    <tr>
                        ...
                        <s:iterator value="arrayDateList" var="dt" >
                    ...
                    <s:iterator value="pageForm.list" var="list" status="number">
                    	<tr  id="<s:property value="#list[2]"/>">
	                    	 <td width="110" align="center">
	                    		 ...
	                    		 <div><span id="coac_carNumber"><s:property value="#list[4]"/></span></div>
	                         ...
	                         <s:iterator value="arrayDateList" var="dt" status="status">
	                        	<td width="140" align="center" id="<s:property value="#list[2]"/>@<s:property value="#dt"/>" class="record is${fn:trim(fn:split(list[status.index+9],'@')[1])}" >
	                        		<div><span>早间 |上午|下午|夜间 </span></div>
	                        		<div><span>${fn:split(list[status.index+9],'@')[0]}</span></div>
	                      		</td>
	                       	 </s:iterator> 
                        </tr>
                    </s:iterator>
            ...
            <c:import url="../../page_navigator.jsp">
                <c:param name="actionPath" value="ea/coachreservationrecord/ea_getListCoachReservationRecord.jspa?pageNumber=${pageNumber}&search=${search}&dssrsubject.subjType=${dssrsubject.subjType}">
                </c:param>
            </c:import>
        </div> 
 ...
 <div class="jqmWindow" style="width: 420px; right: 40%;; top: 15%" 
			...
			<form name="SearchForm" id="SearchForm" method="post" action="">
				...
				<table width="420" id="cataffSearchTable">
					...
					<tr>
				    	<td  align="right" width="100">准教类型：</td>
				    	<td width="200"><select name="ddsrcoach.coacTeachtype" id="coacTeachtype">
						  <option value="">请选择</option>
				    ...
				    <tr>
				    	<td  align="right" width="100">教练星级：</td>
				    	<td width="200"><select name="ddsrcoach.coacStar" id="coacStar">
						  <option value="">请选择</option>
					...
					<tr>
				    	<td  align="right" width="100">教练状态：</td>
				    	<td width="200"><select name="ddsrcoach.coacStatus" id="coacStatus">
						  <option value="">请选择</option>
