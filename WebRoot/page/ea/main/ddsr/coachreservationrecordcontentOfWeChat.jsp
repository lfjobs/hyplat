...
<script src="<%=basePath%>js/ea/ddsr/coachreservationrecordcontentOfWeChat.js"></script>
	...
	<div id="main_main" class="main_main">
		<table class="JQueryflexme" width="100%">
			<tbody>
				...
				<tr id="${rereKey}">
						<th  align="center" colspan="2"><input type="button" class="input-button" id="isSubmit2" value=" 确定预约 "
			style="cursor: hand" /></th>
				</tr>
					...
					<tr title="index<%=number%>"  id="${rereKey}">
						...
						<th >
								<c:if test="${rerePeoplesum==0}"><input type="checkbox" name="check"
									class="JQuerypersonvalue" value="${rereKey}" autocomplete="off"/></c:if>
						</th>
					</tr>
					<tr><td  align="center">序号</td><td ><span><%=number%></span></td></tr>	
						...
						<td ><span id="sex">${ddsrcoach.dtHrStaff.sex}</span>
						</td>
						</tr>
						<tr>
						<td  align="center">教练驾龄</td>
						<td ><span id="coacReleasedate">${ageOfSchool}</span>
						</td>
						</tr>
						<tr><td  align="center">教练教龄</td>
						<td ><span id="coacReleasedate">${ageOfSchool}</span>
						</td>
						</tr>
						
						<tr><td  align="center">预约日期</td>
						<td ><span id="rereAppdate">${fn:substring(rereAppdate,0,11)}</span>
						</td>
						</tr>
						<tr><td  align="center">预约班次</td>
						<td >
						...
						<tr><td  align="center">预约时段</td>
						<td ><span id="rereStadateRereEnddate">${rereStadate}~${rereEnddate}</span>
						</td>
						</tr>
						
						<tr><td  align="center">预约科目</td>
						<td ><span id="rereSubjects">
							<c:choose>
						...
						<td ><span id="rerePeoplesum">${rerePeoplesum}</span>
						</td></tr>
						<tr>
...
<!-- 隐藏from  学员选择多个预约时间段 -->   
<form name="ReservationRecoardFormYuYue" id="ReservationRecoardFormYuYue" method="post" action="">
   			<input type="submit" name="submit" style="display: none" />
