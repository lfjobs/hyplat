...
<script src="<%=basePath%>js/ea/ddsr/coachreservationrecord_foreign.js"></script>
<style type="text/css">
.JQueryflexme .record{
	cursor: pointer;
}
	...
	<body>
        <div class="main_main">
                    ...
                    <s:iterator value="pageForm.list" var="list" status="number">
                    	<tr  id="<s:property value="#list[2]"/>">
	                    	 <td width="110" align="center">
	                    		 <div><span><s:property value="#list[3]"/></span></div>
	                    		 <div><span><s:property value="#list[4]"/></span></div>
	                         </td>
            ...
            <c:import url="../../page_navigator.jsp">
                <c:param name="actionPath" value="ea/coachreservationrecord/foreign_ea_getListCoachReservationRecord.jspa?pageNumber=${pageNumber}&search=${search}&dssrsubject.subjType=${dssrsubject.subjType}&dssrstudent.studKey=${dssrstudent.studKey}&ddsrcoach.coacStatus=${ddsrcoach.coacStatus}&ddsrcoach.coacTeachtype=${ddsrcoach.coacTeachtype }&ddsrcoach.coacStar=${ddsrcoach.coacStar }&studKey=${param.studKey}&studName=${param.studName}">
                </c:param>
            </c:import>
        </div> 
