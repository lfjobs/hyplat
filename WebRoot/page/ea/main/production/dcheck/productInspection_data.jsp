...
<html>
  <head>
    ...
    <script type="text/javascript" src="<%=basePath%>js/ea/production/dcheck/productInspection_data.js"></script>
		  			...
		  			<table class="table">
		  				<thead>
		  					<tr>
		  						...
		  						<th width='128px;'>预算数量</th>
		  						<th width='128px;'>生产量</th>
		  						<th width='128px;'>合格量</th>
		  						<th width='128px;'>不合格量</th>
		  						<th width='160px;'>检验人</th>
		  						<th width='70px;'>操作</th>
		  					</tr>
		  				</thead>
		  				<div>
