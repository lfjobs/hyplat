...
<body>
    ...
    <div class="wrap_page">
        <form name="groupform" id="groupform" action="<%=basePath%>ea/scm/ea_saveGroup.jspa?type=${type}" method="post">
            <div class="group_inp">
                <input type="text" placeholder="分组名称" name="materialGroup.groupname" id="groupname"/>
                <textarea placeholder="分组描述" name="materialGroup.groupdesc" id="groupdesc"></textarea>
            </div>
            <a href="javascript:;" class="group_btn" onclick="createGroup()">创 建 分 组</a>
