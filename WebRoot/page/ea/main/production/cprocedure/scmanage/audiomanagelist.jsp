...
<body>
    ...
    <div class="wrap_page clearfix">
        <a href="<%=basePath%>ea/scm/ea_newOrEditorGroup.jspa?type=noaudio"  class="suc_wrap">
       ...
       <c:forEach items="${list}" var="item">
        ...
        <a href="<%=basePath%>ea/scm/ea_findFilelist.jspa?materialContent.fileType=02&materialGroup.groupname=${item.groupname}&materialGroup.mgId=${item.mgId}"  class="suc_wrap">
