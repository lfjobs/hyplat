...
<body>
    ...
    <div class="wrap_page">
           <div class="no_img_wrap"></div>
            <a href="<%=basePath%>ea/scm/ea_uploadFileIndex.jspa?materialGroup.mgId=${materialGroup.mgId}&materialGroup.groupname=${materialGroup.groupname}&type=${type}" class="group_btn" >上 传 视 频</a>
    </div>
    <!--  header end  -->
    <script>
