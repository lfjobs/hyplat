...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>js/ea/production/cprocedure/productStorage_print.js"></script>
...
var str="";
  ...
  <body>
    <div>
    	<div style="position: relative;top: 20px;text-align: center;width: 800px;">
    		<span><font size="5" style="font-weight:bold;color: #15428b">产品入库单</font></span>
    	</div>
    	<div style="position: relative;top: 40px;text-align: center;width: 800px;">
    		<table style="width: 100%;"	class="ttable">
   				<tr height="20">
   					...
   					<td width="250px"><span><font class='font' size="2">单据编号：</font></span>
    						<span><input type="text" class="inputbottom" value="${ut.journalnum}" readonly="readonly">
    						<input type="hidden" id="cashiId" value="${ut.cashierbillsid}"></span></td>
   					<td width="170px"><span><font class='font' size="2">仓库名称：</font></span>
    						<span><input type="text" class="inputbottom" value="${ut.drdepotName}" readonly="readonly"></span></td>
   				</tr>
    			<tr height="20px;">
    				<td></td>
    				<td><span><font class='font' size="2">产品名称：</font></span>
    						<span><input type="text" class="inputbottom" value="${ut.goodsname}" readonly="readonly"></span></td>
    				<td><span><font class='font' size="2">产品编号：</font></span>
    						<span><input type="text" class="inputbottom" value="${ut.goodsnum}" readonly="readonly"></span></td>
    				<td><span><font class='font' size="2">规&nbsp;&nbsp;格：</font></span>
    						<span><input type="text" class="inputbottom" value="${ut.standard}" readonly="readonly"></span></td>
    			</tr>
    			<tr height="20px;">
    				<td></td>
    				<td><span><font class='font' size="2">入库数量：</font></span>
    						<span><input type="text" class="inputbottom" value="${ut.quantity}" readonly="readonly"></span></td>
    				<td><span><font class='font' size="2">产品单价：</font></span>
    						<span><input type="text" class="inputbottom" value="${ut.price}" readonly="readonly"></span></td>
    				<td><span><font class='font' size="2">产品总价：</font></span>
    						<span><input type="text" class="inputbottom" value="${ut.money}" readonly="readonly"></span></td>
    			</tr>
    		</table>
    	</div>
    	<div style="position:relative;top: 60px;left:10px;border: 1px solid #90D5D5;width: 800px;height: 250px;overflow-y:scroll;">
    		<table class="table">
    		<thead>
    			<tr height="27">
    				<th width="42">序号</th>
    	...
    	<div style="position:relative;top: 75px;left:10px;width: 800px;height: 40px;">
    	<span><span><font class='font' size="2">责 任 人：</font></span>
    						<span><input type="text" class="inputbottom" style="width: 150px;" readonly="readonly" value="${ut.staffName}"></span></span>
    	<span style="float: right;"><span><font class='font' size="2">制单日期：</font></span>
    						<span><input type="text" id="date" class="inputbottom" style="width: 150px;" readonly="readonly" value="${ut.cashierDate}"></span></span>
    		
    	</div>
    	<div style="position:relative;top:75px;" id="examine">
