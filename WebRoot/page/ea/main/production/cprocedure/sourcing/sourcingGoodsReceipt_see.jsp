  ...
  <iframe name="hidden"  style="display: none;"></iframe>
    <center>
    	<div style="width: 864px;margin-top: 2%;">
    		<div style="width:100%;height:40px;font-size: 30px;color:#000;">采购收货单</div>
    		<div style="width: 100%;height:74px;">
    			<table style="width: 100%;height: 100%;">
    				...
    				<tr style="height: 32%;">
    					<td>
    						<span  style="width: 80px; text-align: right;">负&nbsp;&nbsp;&nbsp;责&nbsp;&nbsp;&nbsp;人：</span>
    						<span><input type="text" class="inputbottom" style="width: 170px;border-color: #000;" readonly="readonly" value="${c.staffName}"></span>
    					</td>
    					<td>
    					...
    					<td>
    						...
    						<span><input type="text" class="inputbottom" style="width: 170px;border-color: #000;" name="financialBill.goodsReceiptDate" value="${f.goodsReceiptDate}"></span>
    					</td>
    				</tr>
    			</table>
    		</div>	
	    				...
	    				<tbody>
			    					<c:forEach items="${goodsList}" var="list" varStatus="a">
			    						<tr>
			    							...
			    							<td><span style="width: 50px;overflow: hidden;">${list.reQuantity}</span></td>
