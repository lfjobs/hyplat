...
<html>
  <head>
    ...
    <title>采购入库添加页面</title>
    <script src="<%=basePath%>js/jquery.js" type="text/javascript"></script>
	<script type="text/javascript" src="<%=basePath%>js/ea/production/cprocedure/sourcing/sourcingStorage_add.js"></script>	
    			...
    			<table style="width: 100%;height: 100%;">
    				<tr style="height: 25%;">
    					...
    					<td style="width: 32%;">
    						...
    						<span><input type="text" class="inputbottom" style="width: 180px;" readonly="readonly" value="${journalNum}"></span>
    					</td>
    					<td>
    				...
    				<tr style="height: 25%;">
    					...
    					<td>
    						<span  style="width: 80px; text-align: right;">选&nbsp;择&nbsp; 仓&nbsp;库：</span>
    						<span>
    							<input type="text" class="inputbottom" style="width: 180px;" id="depotName" name="financialBill.depotName" readonly="readonly" >
    							<input type="hidden" id="depotID" name="financialBill.depotID">
    						</span>
    					</td>
    				</tr>
    				<tr style="height: 25%;">
    				...
    				<tr style="height: 25%;">
    					<td>
    						...
    						<span><input type="text" class="inputbottom" style="width: 180px;" name="financialBill.purchaseDate" id="cashierDate" readonly="readonly" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"></span>
    					</td>
    					<td>
    						<span  style="width: 80px; text-align: right;">责&nbsp;&nbsp;&nbsp;任&nbsp;&nbsp;&nbsp;人：</span>
    						<span>
    							<input type="text" class="inputbottom" id="staffsName" name="cashierbills.staffName" style="width: 180px;" readonly="readonly" >
    							<input type="hidden" name="cashierbills.staffID" id="staffsID">	
    						</span>
    					</td>
    					<td>
    						<span  style="width: 80px; text-align: right;">选&nbsp;择&nbsp; 科&nbsp;目：</span>
    						<span>
    							<input type="text" class="inputbottom" id="tosubjects" style="width: 180px;" name="financialBill.subjectName" readonly="readonly">
    							<input type="hidden" value="" id="subjectsid" name="financialBill.subjectID" />
    						</span>
    					</td>
    				</tr>
    			</table>
