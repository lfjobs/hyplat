...
<html>
  <head>
    ...
    <title>采购收货添加页面</title>
    <script src="<%=basePath%>js/jquery.js" type="text/javascript"></script>
	<script type="text/javascript" src="<%=basePath%>js/ea/production/cprocedure/sourcing/sourcingGoodsReceipt_ins.js"></script>	
  ...
  <iframe name="hidden"  style="display: none;"></iframe>
    <center>
    	<div style="border: 1px solid #999999;width: 60%;height: 70%;margin-top: 4%;">
    		<div style="background-color: #009DD9;width:100%;height:8%;font-size: 30px;color:#fff;padding-top: 2%;">采购收货</div>
    			...
    			<table style="width: 100%;height: 100%;">
    				...
    				<tr style="height: 32%;">
    					<td>
    						...
    						<span>
    							<input type="text" class="inputbottom" style="width: 180px;" name="financialBill.consigneeName" id="consigneeName" readonly="readonly" value="${f.consigneeName}">
    							<input type="hidden" name="financialBill.consigneeID" value="${f.consigneeID}" id="consigneeID">
    						</span>
    					</td>
    					<td>
    					...
    					<td>
    						...
    						<span><input type="text" class="inputbottom" style="width: 180px;" name="financialBill.goodsReceiptDate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"></span>
    					</td>
    				</tr>
    			</table>
    		</div>	
