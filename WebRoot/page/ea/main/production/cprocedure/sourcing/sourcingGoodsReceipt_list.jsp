...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>js/ea/production/cprocedure/sourcing/sourcingGoodsReceipt_list.js"></script>
  ...
  <body>
	...
	<c:import url="../../../../page_navigator.jsp">
		<c:param name="actionPath"
			value="ea/inspection/ea_inspectionList.jspa?pageNumber=${pageNumber}&fiveClear=${fiveClear}">
		</c:param>
	</c:import>
  </body>
</html>
