...
<head lang="en">
    ...
    <script type="text/javascript" src="<%=basePath%>/js/ea/production/cprocedure/forum/cf_OtherAttention.js"></script>
    <script>
...
<header>
   <ul>
       <li style="width: 10%;">
           <a href="javascript:###;" onclick="javascript: window.history.go(-1);return false;"><img src="<%=basePath%>/images/BuildPlatform/left_jt.png"></a>
       </li>
       <li style="width: 80%;">关注</li>
       <li style="width: 10%; display: none;"><img src="<%=basePath%>/images/BuildPlatform/ico-search.png" alt="" id="search"></li>
