...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>场地分配${type}页面</title>
		...
		<script src="<%=basePath%>js/ea/production/cprocedure/fieldDistribution_add.js"  type="text/javascript" ></script>
		...
		<script type="text/javascript">
			...
			var productId="";
			var treegr;
			var category="${category}",grType="${grType}";
		</script>
		<style type="text/css">
			.ta .tdName{
				text-align: right;
  ...
  <body>
  <center>
  <form method="post"  onSubmit="return Validator.Validate(this,3)"  id="form" name="form">
  			...
  			<div>
  				<table class="ta">
  					<tr>
  						...
  						<td width="30px;"></td>
  						<td class="tdContent" width="250px;"><input type="text" id="projectName" class="projectName succ" readonly="readonly"
  								placeholder="点击选择项目" value="${fieldDistribution.ppName}">
  							  <input type="hidden" class="projectName" name="fieldDistribution.ppName" value="${fieldDistribution.ppName}">
  							  <input type="hidden" class="projectId" name="fieldDistribution.proDocumentsID" value="${fieldDistribution.proDocumentsID}">
  							  <input type="hidden" class="productCode" name="fieldDistribution.productCode" value="${fieldDistribution.productCode}"></td>
					...
					<td class="tdName">结束时间：</td>
  					...
  					<tr>
  						...
  						<td></td>
  						<td class="tdContent"><input type="text" id="duty" class="duty" name="fieldDistribution.duty" value="${fieldDistribution.duty}"></td>
  					</tr>
  					<tr>
  					...
  					<tr style="height: 90px;">
  						...
  						<td></td>
  						<td class="tdContent"><textarea maxlength="250" style="width: 162px;height: 70px;overflow: auto;" id="remarks" class="remarks" name="fieldDistribution.remarks" value="${fieldDistribution.remarks}"></textarea></td>
  					</tr>
  				</table>
  			</div>
						...
						<tr>
							<td width="100%" valign="top" align="left">
								<div id="body_02"
									...
									<table align='center' id='gotable' cellpadding='0'
										cellspacing='0' class='table' >
										<thead>
										<tr>
