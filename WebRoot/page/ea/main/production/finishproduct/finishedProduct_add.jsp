...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>js/ea/production/finishproduct/finishedProduct_add.js"></script>
  ...
  <div style="width: 100%;text-align:left;">
				<table width="100%" border="0" align="center" cellpadding="0"
					...
					<tr>
						...
						<nobr>
						<input type="button" class="menubtn butt grey" id="preservation" value="保存"  disabled="disabled"/><input type="button" 
						class="menubtn butt grey" id="addgoodtr" value="增加一行" disabled="disabled"/><input type="button" 
    ...
    <div>
    		...
    		<table style="width: 100%;"	class="ttable">
   				<tr height="20">
   					...
   					<td width="210px"><span><font class='font' size="2">公司名称：</font></span>
    						<span><input type="text" class="inputbottom" value="${companyName}" readonly="readonly"></span></td>
   					<td width="350px" align="center"><span><font class='font' size="2">对方科目：</font></span>
    						<span><input type="hidden" value="" id="subjectsid" name="utboundOrderVo.subjectID" />
								 <input type="hidden" value="" id="subjectscode" name="subjectscode">
							     <input type="text" readonly="readonly" value="" placeholder="点击选择科目"  
										class="panduan inputbottom error"  id="tosubjects" name="utboundOrderVo.subjectName" /></span></td>
   					<td width="270"><span><font class='font' size="2">单据编号：</font></span>
    						<span><input type="text" class="inputbottom" value="${ut.journalnum}" name="utboundOrderVo.journalnum" readonly="readonly" id="journalnum"></span></td>
   				</tr>
    			<tr height="20px;">
    				<td></td>
    				<td><span><font class='font' size="2">出库日期：</font></span>
    						<span><input type="text" class="inputbottom cashiDate"  name="utboundOrderVo.purchaseDate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"></span></td>
    				<td align="center"><span><font class='font' size="2">物流方式：</font></span>
    						<s:select list="%{#request.logisticsList}"
										...
										name="utboundOrderVo.logisticsType" theme="simple"></s:select>
    				...
    				<td><span><font class='font' size="2">出库人员：</font></span>
    						<span><input type="text" id="satffName" class="staffName succ inputbottom error" placeholder="请选择出库人" readonly="readonly">
	  							 <input type="hidden" class="staffName" name="utboundOrderVo.ctUserName">
	  							 <input type="hidden" class="staffId" name="utboundOrderVo.contactUserID" ></span></td>
    			</tr>
    			<tr height="20px;">
    				<td></td>
    				<td><span><font class='font' size="2">调出仓库：</font></span>
    						<span><input type="text" class="inputbottom" value="${depot.depotName}" name="utboundOrderVo.depotname" readonly="readonly">
    						<input type="hidden"  value="${depot.depotID}" name="utboundOrderVo.depotid"></span></td>
    				<td align="center"><span><font class='font' size="2">调入仓库：</font></span>
    						<span><input type="text" class="inputbottom" id="choosedepotName"  placeholder="请选择调入仓库"
    						name="utboundOrderVo.drdepotName" readonly="readonly">
    						<input type="hidden" name="utboundOrderVo.drdepotID" id="choosedepotID"/></span></td>
    				<td><span><font class='font' size="2">联系电话：</font></span>
    						<span><input type="text" class="inputbottom telephone" name="utboundOrderVo.reference"></span></td>
    			</tr>
    		</table>
    	</div>
    	<div style="position:relative;top: 100px;left:10px;border: 1px solid #90D5D5;width: 900px;height: 250px;overflow-y:scroll;">
    		<table class="table">
    		<thead>
    			<tr height="27" id="sale" style="display: none;" class="hidetr" >
    				<th width="42">序号</th>
    		...
    		<tbody id="tbody">
    			<tr height="20" style="display: none;" id="tr">
    				...
    				<td><input type="text" class="bor" readonly="readonly"></td>
    				<td><input type="text" class="bor" readonly="readonly"></td>
    				<td align="center"><a href='' class='dele'>
    	...
    	<span><span><font class='font' size="2">责 任 人：</font></span>
    						<span><input type="text" class="inputbottom" style="width: 150px;" readonly="readonly" name="utboundOrderVo.staffName" value="${staff.staffName} - ${staff.staffCode}">
    						<input type="hidden" name="utboundOrderVo.staffID" value="${staff.staffID}"></span></span>
    	<span style="float: right;"><span><font class='font' size="2">单据日期：</font></span>
    						<span><input type="text" id="date" class="inputbottom" style="width: 150px;" readonly="readonly" value="${ut.cashierDate}"></span></span>
    	</div>
    </div>
    </form>
    <%----------------支付物流方式---------------------------%>
