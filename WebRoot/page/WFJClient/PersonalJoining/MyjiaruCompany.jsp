...
<meta http-equiv="description" content="This is my page">
  ...
  <body>
	<div class="wfj11_006">
        ...
        <!--gs购买 -->
        <div class="wfj11_006_business" >
        	<c:forEach items="${productList}" var="beans">

        	<table width="100%" class="chakan" >
                <tr>
                    <input type="hidden" value="${beans[1]}"  name="ppid"     class="ppid"/>
                    <input type="hidden" value="${beans[5]}"  name="goodsid" class="goodsid"/>
                    <input type="hidden" value="${beans[6]}"  name="companyId" class="companyId"/>
                    <input type="hidden" value="${ccompanyId}"  name="ccompanyId" class="ccompanyId"/>
                </tr>
            	<tr>
                	<td width="25%" rowspan="2" class="wfj11_006_busi_left_img"><img src="<%=basePath%>${beans[3]}" /></td>
                	<td width="50%">${beans[0]}</td>
                </tr>
            	<tr>
                	<td><span>￥${beans[2]}</span></td>
                </tr>
            </table>
    	 </c:forEach>
        </div>
