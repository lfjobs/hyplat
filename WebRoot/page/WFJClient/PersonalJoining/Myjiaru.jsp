...
<meta http-equiv="description" content="This is my page">
  ...
  <link rel="stylesheet" href="<%=basePath%>/css/WFJClient/wfjapp.css" type="text/css"></link></head>
  ...
  <body>
	<div class="wfj11_006">
        ...
        <!--gs购买 -->
        <div class="wfj11_006_business" style="display:none;">
        	<c:forEach items="${productList}" var="beans">
        	<table width="100%">
            	<tr>
                	<td width="25%" rowspan="2" class="wfj11_006_busi_left_img"><a href="<%=basePath%>/ea/wfjshop/ea_doodsDetail.jspa?ppid=${beans[1]}&goodsid=${beans[5]}&companyId=${beans[6]}&ccompanyId=${ccompanyId}"><img src="<%=basePath%>${beans[3]}" /></a></td>
                	<td width="50%"><a href="<%=basePath%>/ea/wfjshop/ea_doodsDetail.jspa?ppid=${beans[1]}&goodsid=${beans[5]}&companyId=${beans[6]}&ccompanyId=${ccompanyId}">${beans[0]}</a></td>
                </tr>
            	<tr>
                	<td><a href="<%=basePath%>/ea/wfjshop/ea_doodsDetail.jspa?ppid=${beans[1]}&goodsid=${beans[5]}&companyId=${beans[6]}&ccompanyId=${ccompanyId}"><span style="color:#F74C31;">￥${beans[2]}</span></a></td>
                </tr>
            </table>
    	 </c:forEach>
        </div>
        ...
        <div class="wfj11_006_me">
        	...
        	<table width="100%">
            	<tr>
                	<td width="25%" rowspan="2" class="wfj11_006_busi_left_img"><a href="<%=basePath%>/ea/wfjshop/ea_doodsDetail.jspa?ppid=${rglist[1]}&goodsid=${rglist[5]}&companyId=${rglist[6]}&ccompanyId=${ccompanyId}"><img src="<%=basePath%>${rglist[3]}" /></a></td>
                	<td width="50%"><a href="<%=basePath%>/ea/wfjshop/ea_doodsDetail.jspa?ppid=${rglist[1]}&goodsid=${rglist[5]}&companyId=${rglist[6]}&ccompanyId=${ccompanyId}">${rglist[0]}</a></td>
                </tr>
            	<tr>
                	<td><a href="<%=basePath%>/ea/wfjshop/ea_doodsDetail.jspa?ppid=${rglist[1]}&goodsid=${rglist[5]}&companyId=${rglist[6]}&ccompanyId=${ccompanyId}"><span style="color:#F74C31;">￥${rglist[2]}</span></a></td>
                </tr>
            </table>
        	</c:forEach>
        </div>
