...
var content = '${content}';
	...
	console.log(standard);
	document.location.href = basePath+"ea/wfjplatform/ea_zhifu.jspa?goodsname="+goodsname+"&ppids="+ppids+"&ppid="+ppid+"&standard="+standard+"&money="+money+"&addre="+addre+"&content="+content;
	
	}
	function getHeight(){
		   var height =$(".lypingtai").height()-$(".lypingtai").offset().top;
...
function ajax(){
		...
		var url = basePath+"ea/wfjplatform/sajax_ea_getPlatform.jspa?goodsid=2&type=qureyd&content="+content+"&ppid="+ppid+"&addre="+addre+"&standard="+standard;
			...
			success : function (data) {
				...
				if (pageForm == null) {
					...
					for(var i = 0;i<list.length;i++){
						...
						htl.push(" <li onclick='onj(this)''> <input type='hidden' id='goodsname' value="+search[0]+"> <input type='hidden' id='ppid' value="+search[1]+"><div class='left'>"+p+"</div><div class='txt'>"+search[0]+"联营经济平台  </div> </li>");
					}
