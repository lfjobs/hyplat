...
<html>
  ...
  <body>
   <div class="wfjall">
        <div class="wfjtop">
            <ul>
                <li><a href="javascript:void(0);" target="_parent" onclick="window.history.go(-1);"><img src="<%=basePath%>images/WFJClient/return_fh.png"  style="float:left;width:32px;height:32px;"/></a><span style="margin-left:-25px;">消费会员</span></li>
            </ul>
        </div>
        <div class="wfjlogo">
