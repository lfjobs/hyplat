...
<html>
  <head>
	...
	<script type="text/javascript">
        ...
        <div class="wfjtop">
            <ul>
                <li><a href="javascript:void(0);" target="_parent" onclick="window.history.go(-1);"><img src="<%=basePath%>images/WFJClient/return_fh.png"  style="float:left;width:32px;height:32px;"/></a><span style="margin-left:-25px;">微分金店</span></li>
            </ul>
        </div>
        <div class="wfjlogo">
        ...
        <div class="wfjcontent left">
            <div class="wfj_content">
                <div class="wfj_con">
                    <ul class="wfj_title title_height2">
                        <li>产品代理商会员</li>
                    </ul>
                    <ul class="wfj_cons">
                        <li><a href="<%=basePath%>/ea/distribution/ea_getwfjAgencyVIPDetail.jspa">产品代理商VIP会员</a><span>></span></li>
                        <li><a href="<%=basePath%>/ea/distribution/ea_getwfjAgencyRetailDetail.jspa">产品代理零售商会员</a><span>></span></li>
                    </ul>
                </div>
                <div class="wfj_con">
                    ...
                    <ul class="wfj_cons">
                        <li><a href="<%=basePath%>/ea/distribution/ea_getwfjConsumerDetail.jspa">消费会员<span>></span></a></li>
                    </ul>
                </div>
                <div class="wfj_con">
                    ...
                    <ul class="wfj_cons">
                        <li><a href="<%=basePath%>/ea/wfjcustomer/ea_getlist.jspa">产品<span>></span></a></li>
                        <li><a href="<%=basePath%>/ea/buyproducts/ea_getComOrders.jspa?fkstatus=00">订单<span>></span></a></li>
                        <li><a >积分<span>></span></a></li>
                        <li><a href="<%=basePath%>/ea/distribution/ea_getwfjCommission.jspa">佣金<span>></span></a></li>
                    </ul>
                </div>
            </div>
        </div>
