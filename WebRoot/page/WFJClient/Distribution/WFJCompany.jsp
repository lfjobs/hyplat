...
<html>
  <head>
	...
	<script type="text/javascript">
        ...
        <div class="wfjtop">
            <ul>
                <li><a href="javascript:void(0);" target="_parent" onclick="window.history.go(-1);"><img src="<%=basePath%>images/WFJClient/return_fh.png"  style="float:left;width:32px;height:32px;"/></a><span style="margin-left:-25px;">公司</span></li>
            </ul>
        </div>
         <div class="wfjlogo">
        ...
        <div class="wfjcontent left">
            <div class="wfj_content">
                <div class="wfj_con">
                    ...
                    <ul class="wfj_cons">
                        <li><a href="#">高级合伙人<span>></span></a></li>
                        <li><a href="#">合伙人<span>></span></a></li>
                    </ul>
                    <ul class="wfj_title title_height1">
                        <li>微分金店</li>
                    </ul>
                    <ul class="wfj_cons">
                        <li><a href="#">微分金店<span>></span></a></li>
                    </ul>
                    <ul class="wfj_title title_height2">
                        <li>产品代理商会员</li>
                    </ul>
                    <ul class="wfj_cons">
                        <li><a href="#">产品代理商VIP会员<span>></span></a></li>
                        <li><a href="#">产品代理零售商会员<span>></span></a></li>
                    </ul>
                    <ul class="wfj_title title_height1">
                        <li>消费者会员</li>
                    </ul>
                    ...
                    <ul class="wfj_cons">
                        <li><a href="#">产品代理商VIP会员团队<span>></span></a></li>
                        <li><a href="#">产品代理零售商<span>></span></a></li>
                    </ul>
                    <ul class="wfj_title title_height2">
                        <li>消费者会员团队</li>
                    </ul>
                    <ul class="wfj_cons">
                        <li><a href="#">消费者VIP会员团队<span>></span></a></li>
                        <li><a href="#">消费会员团队<span>></span></a></li>
                    </ul>
