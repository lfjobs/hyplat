...
<html>
  <head>
	...
	<script type="text/javascript">
        ...
        <div class="pro_top">
            <ul>
                <li class="left"><a href="javascript:void(0);" target="_parent" onclick="window.history.go(-1);"><img src="<%=basePath%>images/WFJClient/return_fh.png"  style="float:left;width:32px;height:32px;margin-top:-5px;"/></a></li>
                <li class="pro_info">合伙人</li>
            </ul>
        </div>
        <div class="wfjlogo">
        ...
        <div class="all_width">
            ...
            <div class="wfjpro right">
                <div class="wfjproinfo">
                    <ul>
                        <li>
                            <img src="<%=basePath%>/images/WFJClient/Distribution/shouji1.jpg" />
                        </li>
                        <li><a href="#">华为 P8</a></li>
                    </ul>
                    <ul>
                        <li>
                            <img src="<%=basePath%>/images/WFJClient/Distribution/shouji2.jpg" />
                        </li>
                        <li><a href="#">华为 4C</a></li>
                    </ul>
                    <ul>
                        <li>
                            <img src="<%=basePath%>/images/WFJClient/Distribution/shouji3.jpg" />
                        </li>
        ...
        <div class="wfjcontent left">
            <div class="wfj_content">
                <div class="wfj_con">
                    ...
                    <ul class="wfj_cons">
                        <li><a href="#">产品代理商VIP会员</a><span>></span></li>
                        <li><a href="#">产品代理零售商会员</a><span>></span></li>
                    </ul>
                </div>
                <div class="wfj_con">
