...
<html>
  <head>
	...
	<script type="text/javascript">
        ...
        <div class="wfjtop">
            <ul>
                <li><a href="javascript:void(0);" target="_parent" onclick="window.history.go(-1);"><img src="<%=basePath%>images/WFJClient/return_fh.png"  style="float:left;width:32px;height:32px;"/></a><span style="margin-left:-25px;">高级合伙人</span></li>
            </ul>
        </div>
        <div class="wfjlogo">
            <img src="<%=basePath%>/images/WFJClient/Distribution/banner.png" />
        </div>
        <div class="all_width left">
