...
<div class="search_con01">  
	<div class="top">
        	<ul>
            	...
            	<a href="javascript:;"><li><img src="<%=basePath %>images/WFJClient/DigitalMall/num_dot.png"/></li></a>
                <div class="clear"></div>
            </ul>
    </div>
    <div class="nav">
        ...
        <div class="style">
        	<a href="javascript:void(0);" onclick="changeStyle()"><img src="<%=basePath %>images/WFJClient/DigitalMall/style_02.png" /></a>
        </div>
    </div>
...
function toSearch(){
	...
	if( proName == ""){
		...
		s+="<img src='"+basePath+"images/WFJClient/DigitalMall/noresult.png' alt=''/></div></li>";				
		$(".style1_con").append(s);
	}else{
		loaded();
	}
...
function getHeight(){
	...
	if($(".last").offset().top+$(".last").height()+$(".nav").height()-$(".top").height()*3<$(window).height()){	
				...
				if(productlist!=null){
					...
					for(var i=0;i<productlist.length;i++){
						...
						prostr+="<input type='hidden' value='"+pro[10]+"' id='ccompanyid'/>";
		              	prostr+="<div class='style1_img'><img src='"+basePath+pro[4]+"'/></div>";
		                prostr+="<h3>"+pro[0]+"</h3>";
		                prostr+="<h4>"+"￥"+pro[2]+"<span>"+pro[8]+"人已购买</span></h4>";                       
		                prostr+="</li>";
					}
					if(pagenumber == pagecount){
						prostr+="<li style='height:"+$(window).height()*0.05+"px;width:100%;clear:both;'><div style='text-align:center;height:100px;padding-top:"+$(window).height()*0.015+"px;'>无更多产品</div></li>";
					}
					$(".style1_con").append(prostr);
					getHeight();
					$(".search_con01 .goodsDetail img").css("height",$(".search_con01 .goodsDetail img").width()*0.85+'px');
				}
			}else{
				var s="<li style='height:"+($(window).height()-$(".top").height()-$(".nav").height()-$(window).height()*0.025)+"px;width:100%;clear:both;'>";
				s+="<div style='text-align:center;height:100px;padding-top:"+$(window).height()*0.015+"px;'>";
