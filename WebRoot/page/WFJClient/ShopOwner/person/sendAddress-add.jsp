    ...
    <script type="text/javascript">
		...
		$(".wfj11_017_link").click(function(){
			...
			if(p=="--请选择--"||c=="--请选择--"||d=="--请选择--"){
				...
				posturl.push("/page/WFJClient/ShopOwner/person/sendAdd.jsp?pc=");posturl.push(pc);
				posturl.push("&d=");posturl.push(d);
				posturl.push("&sccid=");posturl.push(sccid);
				posturl.push("&type=");posturl.push(type);
