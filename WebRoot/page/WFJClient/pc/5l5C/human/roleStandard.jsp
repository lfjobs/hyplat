...
<head>
    ...
    <title>岗位标准</title>
        ...
        <link rel="stylesheet" type="text/css" href="<%=basePath%>css/ea/human/roleStandard.css">
        <script src="<%=basePath%>util/layui/layui.all.js" type="text/javascript" charset="utf-8"></script>
        <script src="<%=basePath%>js/jquery-1.9.1.min.js" type="text/javascript" charset="utf-8"></script>
        <script src="<%=basePath%>js/WFJClient/pc/common.js" type="text/javascript" charset="utf-8"></script>
        <script type="text/javascript" charset="utf-8" src="<%=basePath%>js/ea/human/menu/roleStandard.js"></script>
</head>
<body class="body">
<header>
    <ul class="clearfix">
...
<div class="content">
    ...
    <section class="sec-nav sec-hide">
        <ul class="clearfix" >
            ...
            <li class="clearfix">
                <p class="power"><i class="layui-icon" style="font-size: 20px; color: #1E9FFF;vertical-align: middle;">&#xe614;</i> 页面授权</p>
            </li>
        </ul>
    </section>
