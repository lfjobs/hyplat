...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>css/WFJClient/pc/5l5C/human/outworkApplyList.css">
    <script src="<%=basePath%>js/jquery-1.9.1.min.js" type="text/javascript" charset="utf-8"></script>
    <script src="<%=basePath%>js/WFJClient/pc/common.js" type="text/javascript" charset="utf-8"></script>
    <script src="<%=basePath %>/js/WFJClient/pc/5l5C/human/outworkApplyList.js"></script>
    <style type="text/css">
        .clearfix:after {
            content: "\00A0";
            display: block;
    ...
    <div class="div-box">
        ...
        <div class="top">
            ...
            <div class="txt back_color">
                <p class="txtP">
                    <span class="txtSpan" style="width: 50%;">外勤申请时间</span>
