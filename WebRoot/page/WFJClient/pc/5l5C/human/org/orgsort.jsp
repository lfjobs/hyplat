...
<head lang="zh">
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>css/WFJClient/pc/5l5C/human/org/orgsort.css"/>
    <script src="<%=basePath%>js/jquery-1.9.1.min.js" type="text/javascript" charset="utf-8"></script>

    <script src="<%=basePath%>js/WFJClient/pc/5l5C/human/org/orgsort.js" type="text/javascript" charset="utf-8"></script>
            ...
            <td width="49%" align="right">
                <ul class="ul-select" id="select1">
                    <c:forEach items="${children}" var="item">
                        <li id="${item.organizationID}">${item.organizationName}</li>
                    </c:forEach>
                </ul>
