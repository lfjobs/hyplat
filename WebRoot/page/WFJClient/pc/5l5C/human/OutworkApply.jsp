...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>css/WFJClient/pc/5l5C/human/outworkApply.css">
    ...
    <script src="<%=basePath %>/js/WFJClient/pc/5l5C/human/outworkApply.js"></script>
    <style type="text/css">
        .clearfix:after {
            content: "\00A0";
            display: block;
            ...
            <div class="con-one">
                <ul>
                    ...
                    <li>
                        ...
                        <input type="text" id="startTime" readonly placeholder="请选择外勤开始时间">
                    </li>
                    <li>
                        <label>结束时间 <span style="color: red;">*</span></label>
                        <input type="text" id="endTime" readonly placeholder="请选择外勤结束时间">
                    </li>
                    <li>
                        <label>外勤时长</label>
                        <span id="outworkHour"></span> 小时
                    </li>
                    <li>
                        <label>外勤事由</label>
                        <input id="outworkReason" type="text" placeholder="请输入外勤事由">
                    </li>
                    <li>
                        <label>状态</label>
