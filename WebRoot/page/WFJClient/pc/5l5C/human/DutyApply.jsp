...
<head>
    ...
    <script src="<%=basePath %>/js/WFJClient/pc/5l5C/human/dutyApply.js"></script>
    <style type="text/css">
        .clearfix:after {
            content: "\00A0";
            display: block;
            ...
            <div class="con-one">
                <ul>
                    ...
                    <li>
                        <label>值班类别</label>
                        <select id="dutyType">
                            <option value="SIGN_IN_TYPE_EARLY" selected>早班</option>
                            <option value="SIGN_IN_TYPE_NIGHT">晚班</option>
                            <option value="SIGN_IN_TYPE_LATE_NIGHT">夜班</option>
                        </select>
                    </li>
                    <li>
                    ...
                    <li>
                        <label>值班内容</label>
                        <input id="dutyContent" type="text" placeholder="请输入值班内容">
                    </li>
                    <li>
                        <label>电话 <span style="color: red;">*</span></label>
                        <input id="tel" type="text" placeholder="请输入电话">
                    </li>
                    <li>
                        <label>地址 <span style="color: red;">*</span></label>
                        <input id="address" type="text" placeholder="请输入值班地址">
                    </li>
                </ul>
            </div>
            <div class="con-two">
