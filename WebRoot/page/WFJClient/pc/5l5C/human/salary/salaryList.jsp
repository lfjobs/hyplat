...
<head>
    ...
    <script src="<%=basePath %>/js/WFJClient/pc/5l5C/human/salary/salaryList.js"></script>
    <style type="text/css">
        .clearfix:after {
            content: "\00A0";
            display: block;
        ...
        <div class="con-one">
            <div class="txt_2">
                <ul>
                    <li>
                        <label>选择年份</label>
                        <select id="salaryTime"></select>
                    </li>
                </ul>
            </div>
            <div class="txt back_color">
                <p class="txtP">
                    <span class="txtSpan" style="width: 5.2rem;">月份</span>
                    <span class="txtSpan" style="width: 5.5rem;">工资级别</span>
<%--                    <span class="txtSpan" style="width: 5rem;">基本工资</span>--%>
                    ...
                    <span class="txtSpan" style="width: 5rem;">福利工资</span>
