...
<head lang="zh">
	...
	<link rel="stylesheet" type="text/css" href="<%=basePath%>css/WFJClient/pc/5l5C/human/salary/salaryLevellist.css"/>
	<script src="<%=basePath%>js/jquery-1.9.1.min.js" type="text/javascript" charset="utf-8"></script>
	<script src="<%=basePath%>js/ea/human/salaryNew/salaryLevellist.js" type="text/javascript" charset="utf-8"></script>
	<title>&lrm;</title>
...
<div class="content">
	...
	<section class="sec-nav sec-hide">
		...
		<ul class="clearfix" >
			...
			<li class="clearfix ">
				<p class="zadd"><img src="<%=basePath%>js/jqModal/css/images_blue/add.png"/>自动生成</p>

			</li>

			<li class="clearfix ">
				<p class="sadd"><img src="<%=basePath%>js/jqModal/css/images_blue/add.png"/>手动添加</p>
		...
		<ul class="ul">
			...
			<c:forEach  items="${pageForm.list}" var="item" varStatus="v">
				...
				<div class="title-pc">
					...
					<div class="p-wq date-p" title="${item.draftTime eq null?'无':fn:substring(item.draftTime,0,10)}">${item.draftTime eq null?'无':fn:substring(item.draftTime,0,10)}</div>
