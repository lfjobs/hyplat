...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>css/WFJClient/pc/5l5C/human/leaveApply.css">
    ...
    <script src="<%=basePath %>/js/WFJClient/pc/5l5C/human/leaveApply.js"></script>
    <style type="text/css">
        .clearfix:after {
            content: "\00A0";
            display: block;
            ...
            <div class="con-one">
                <ul>
                    ...
                    <li>
                        ...
                        <input type="text" id="startTime" readonly placeholder="请选择请假开始时间">
                    </li>
                    <li>
                        <label>结束时间 <span style="color: red;">*</span></label>
                        <input type="text" id="endTime" readonly placeholder="请选择请假结束时间">
                    </li>
                    <li>
                        <label>请假时长</label>
