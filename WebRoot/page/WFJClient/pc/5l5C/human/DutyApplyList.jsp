...
<head>
    ...
    <script src="<%=basePath %>/js/WFJClient/pc/5l5C/human/dutyApplyList.js"></script>
    <style type="text/css">
        .clearfix:after {
            content: "\00A0";
            display: block;
    ...
    <div class="div-box">
        ...
        <div class="top">
            ...
            <div class="txt back_color">
                <p class="txtP">
                    <span class="txtSpan" style="width: 26.5%;">地点</span>
                    <span class="txtSpan" style="width: 39%;">值班开始时间</span>
                    <span class="txtSpan" style="width: 20%;">类别</span>
                </p>
            </div>
        </div>
