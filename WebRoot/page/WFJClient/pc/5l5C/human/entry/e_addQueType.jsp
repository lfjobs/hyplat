...
<meta name="viewport"
    ...
    <link href="<%=basePath%>css/ea/production/common2.css" rel="stylesheet"
          type="text/css" />
    <link href="<%=basePath%>css/WFJClient/pc/5l5C/human/entry/e_addQueType.css" rel="stylesheet"
          type="text/css" />

    <script src="<%=basePath%>js/ea/production/resume/jquery-2.1.1.min.js"
	type="text/javascript"></script>
<script src="<%=basePath%>js/WFJClient/pc/5l5C/human/entry/e_addQueType.js"
	type="text/javascript"></script>
    ...
    <input type="submit" style="display:none;" name="submit" value="" />
        ...
        <div class="basics">
            ...
            <div class="basics_mil basics_mil2">
                <p>题库类别</p>
                <input type="text"
                       name="quesBaseType.typeName" value="${quesBaseType.typeName}" id="typeName" >
