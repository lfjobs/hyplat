...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>css/WFJClient/pc/5l5C/human/entry/e_emplydetail.css"/>
...
<div class="content" >
    ...
    <c:if test="${auditionbc.bstName ne null||auditionbc.bstName ne ''}">
        ...
        <div class="div-name">
            <label for="">笔试时间：</label>
            <input type="text"    readonly value="${auditionbc.bsDate}"/>

        </div>
    </c:if>


    <c:if test="${auditionbc.mstName ne null||auditionbc.mstName ne ''}">
        ...
        <div class="div-name">
            ...
            <input type="text"   readonly value="${auditionbc.msDate}" />

        </div>
    </c:if>


    <c:if test="${audition.auditionPoint ne null||audition.auditionPoint ne ''}">
