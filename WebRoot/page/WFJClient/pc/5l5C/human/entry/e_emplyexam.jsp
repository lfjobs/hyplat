...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>css/WFJClient/pc/5l5C/human/entry/e_emplyexam.css"/>
    <script src="<%=basePath%>js/jquery-1.9.1.min.js" type="text/javascript" charset="utf-8"></script>
    <script src="<%=basePath%>js/WFJClient/pc/5l5C/human/entry/e_emplyexam.js" type="text/javascript" charset="utf-8"></script>
...
<header>
    <ul class="clearfix">
        ...
        <li>
            ${param.vm eq "b"?"笔试结果":param.vm eq "k"?"口试结果":"综合评定"}
        </li>
    </ul>
</header>
...
<c:if test="${param.vm eq 'b'}">
    <input type="hidden"  name="audition.bsState" value="${audition.bsState}" id="bsState"/>
    <div class="div-name">
    ...
    <div class="div-name">
        ...
        <input type="text"  value="${auditionbc.auditionPointb}"  class="bj" name="audition.auditionPointb"/>

    </div>
    <div class="div-name">
        <label for="">笔试评语：</label>
        <input type="text"  value="${auditionbc.commentionb}"   class="bj" name="audition.commentionb"/>
    ...
    <c:if test="${param.vm eq 'k'}">
        <input type="hidden"  name="audition.ksState" value="${audition.ksState}" id="ksState"/>
        <div class="div-name">
        ...
        <div class="div-name">
            ...
            <input type="text"  value="${auditionbc.auditionPointk}"   class="bj" name="audition.auditionPointk"/>

        </div>
        <div class="div-name">
            <label for="">口试评语：</label>
            <input type="text"  value="${auditionbc.commentionk}"   class="bj" name="audition.commentionk"/>

        </div>

        <div class="div-name">
            <label for="">口试时间：</label>
            <input type="text"  value=""    name="audition.ksDate"  class="bj" onfocus="daytime(this);" />
    ...
    <c:if test="${param.vm eq 'z'}">
        <input type="hidden"  name="audition.zpState" value="${audition.zpState}" id="zpState"/>
        <div class="div-name">
            <label for="">笔试题库：</label>
            <input type="text"  value="${auditionbc.bstName}" readonly/>
        ...
        <div class="div-name">
            ...
            <input type="text"  value="${audition.auditionPoint}" class="bj" name="audition.auditionPoint"/>

        </div>
        <div class="div-name">
            <label for="">综合评语：</label>
            <input type="text"  value="${audition.commention}"  class="bj"  name="audition.commention"/>
...
<div class="div-bottom">
    <span onclick="examResult(1)">
       笔试合格
    </span>
    <span onclick="examResult(2)">
        笔试不合格
    </span>
