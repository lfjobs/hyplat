...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>css/ea/human/staff/resignStaff.css">
    ...
    <script type="text/javascript" charset="utf-8" src="<%=basePath%>js/ea/human/staff/resignStaff.js"></script>
</head>
<body class="body">
<header>
    <ul class="clearfix">
