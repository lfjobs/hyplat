...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>css/ea/human/staff/selectPageData.css">
...
<header>
    <ul class="clearfix">
        <li>
            <a onclick=dataBack() target="_self" >
...
<div class="content" >
    <div class="select-data"><label class="div-data-name">部门：</label><label class="data-name"></label></div>
    <article id="data" >
        <ul id="dataList" class="data-list div-mask-list"></ul>
    </article>
    <div class="div-bottom" style="display:none">
        ...
        <button class="layui-btn layui-btn-radius data-submit" style="background-color:#ef8717;font-size:16px;padding:0 30px" onclick="submitData()">
            确定&nbsp;&nbsp;
            <span class="div-data">1/100</span>
        </button>
    </div>
</div>
<!--已选数据-->
