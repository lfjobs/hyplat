...
<html>
 ...
 <link rel="stylesheet" type="text/css" href="<%=basePath%>css/WFJClient/pc/5l5C/human/orgdepartmentj.css">
		...
		<div class="pc-box">
			<div class="div-box">
				...
				<div class="container">
					<ul class="ul-con">
						<li class="clearfix">
							<p class="p-title">部门职能描述</p>
							<p class="p-height clearfix">
								部门管理   部门职能描述说明书   部门职能战区图<br />
								部门工作流程   部门工作量化成果指标管理<br />
								部门职能要求   部门安全责任书   部门目标任务设定
							</p>
							<div class="div-more">
						...
						<li class="clearfix">
							<p class="p-title">岗位设置管理</p>
							<p class="p-height">
								岗位管理   岗位说明书及要求   岗位战区图<br />
								岗位工作流程   岗位工作量化成果指标管理<br />
								岗位安全责任书   岗位薪酬设定   岗位授权管理
							</p>
							<div class="div-more">
								<img src="<%=basePath%>images/WFJClient/pc/5l5c/pic_01.png"/>
							</div>
						...
						<li class="clearfix">
							<p class="p-title">人员配备管理</p>
							<p class="p-height">
								微型企业人员配备   小型企业人员配备<br />
								中型企业人员配备   大型企业人员配备   集团人员配备
							</p>
							<div class="div-more">
								<img src="<%=basePath%>images/WFJClient/pc/5l5c/pic_01.png"/>
							</div>
						...
						<li class="clearfix">
							<p class="p-title">机构资料管理</p>
							<p class="p-height">
								机构资料入库   机构资料出库   机构资料库存<br />
								人事生产   机构设置
							</p>
							<div class="div-more">
								<img src="<%=basePath%>images/WFJClient/pc/5l5c/pic_01.png"/>
