...
<head>
    ...
    <title>岗位人员</title>
        ...
        <link rel="stylesheet" type="text/css" href="<%=basePath%>css/ea/human/postPerson.css">
        <script src="<%=basePath%>util/layui/layui.all.js" type="text/javascript" charset="utf-8"></script>
        <script src="<%=basePath%>js/jquery-1.9.1.min.js" type="text/javascript" charset="utf-8"></script>
        <script src="<%=basePath%>js/WFJClient/pc/common.js" type="text/javascript" charset="utf-8"></script>
        <script type="text/javascript" charset="utf-8" src="<%=basePath%>js/ea/human/postPerson.js"></script>
</head>
<body class="body">
<header class="header">
    <ul class="clearfix">
...
<div class="content">
    <div class="spd-content">
        <div class="dtd-oa-search-bar" >
            ...
            <input type="text" class="dtd-oa-search-bar-input" placeholder="姓名/手机号/身份证"  name="queryName" id="queryName" autocomplete="off">
            <div class="dtd-oa-search-bar-icon-wrapper close-data" onclick="clearQueryName()" style="right: 75px;">
                <i class="layui-icon">&#x1006;</i>
            </div>
            <button class="layui-btn layui-btn-primary layui-btn-sm " onclick="getData()" style="margin-left:10px;margin-top:-4px">搜索</button>
        </div>
    </div>
