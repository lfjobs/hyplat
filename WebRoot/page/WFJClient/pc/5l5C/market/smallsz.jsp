...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<%=basePath%>css/base.css"/>
		   <link rel="stylesheet" type="text/css" href="<%=basePath%>css/WFJClient/pc/5l5C/market/mallsz.css">
		...
		<div class="pc-box">
			<div class="div-box">
				...
				<div class="container">
					<ul class="ul-con">
						<li class="clearfix">
								<a href="<%=basePath%>page/WFJClient/pc/5l5C/market/mymallsz.jsp">
							<p class="p-title">我的商城收支管理</p>
							<p class="p-height">
								订单管理  现金管理  收货管理  金币 分配明细管理  聚宝盆金币池
							</p>
							<div class="div-more">
						...
						<li class="clearfix">
								<a href="<%=basePath%>page/WFJClient/pc/5l5C/market/gysmallsz.jsp">
						
							<p class="p-title">供应商商城收支管理</p>
							<p class="p-height">
								订单管理  收款单管理  批量发货管理 出库单管理  物流管理  收货管理  退 货管理  退款管理
							</p>
							<div class="div-more">
								<img src="<%=basePath%>images/WFJClient/pc/5l5c/more.png"/>
							</div>
