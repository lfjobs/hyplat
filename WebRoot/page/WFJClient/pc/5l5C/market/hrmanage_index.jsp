...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<%=basePath%>css/base.css"/>
		 <link rel="stylesheet" type="text/css" href="<%=basePath%>css/WFJClient/pc/5l5C/market/hrmanage_index.css">
		...
		<div class="pc-box">
			<div class="div-box">
				...
				<div class="container">
					<ul class="ul-con">
						<li class="clearfix">
							<a href="<%=basePath%>page/WFJClient/pc/5l5C/market/districtdc.jsp">
						
							<p class="p-title">地域调查</p>
							<p class="p-height">
								东北地区  华北地区  华东地区  华南 地区 西南地区  西北地区
							</p>
							<div class="div-more">
						...
						<li class="clearfix">
							<p class="p-title">往来关系</p>
							<p class="p-height">
								员工  合作  企业合伙创业商城会员 微分金商城业主会员  代理商商城业主会员  个人客户  个人粉丝  其他  学员  供应商  教练  联合联盟研讨会会员  在职员工
							</p>
						</li>
						<!--<li class="clearfix">
