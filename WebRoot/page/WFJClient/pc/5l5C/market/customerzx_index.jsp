...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>css/WFJClient/pc/5l5C/market/customerzx_index.css">
        ...
        <div class="container">
            <ul class="ul-con">
                <li class="clearfix">
                    <p class="p-1">客户管理</p>
                    <p class="p-2">代理商客户</p>
                    <p class="p-3">公司代理客户</p>
                    <p class="p-3">省商代理商客户</p>
                    <p class="p-3">县区代理商客户</p>
                    <p class="p-3">镇街代理商客户</p>
                    <p class="p-2">业务员客户</p>
                    <p class="p-3">经理业务客户</p>
                    <p class="p-3">主管业务客户</p>
                    <p class="p-3">业务员客户</p>
                    <p class="p-2">vip客户</p>
                    <p class="p-2">普通客户</p>
                </li>
                ...
                <li class="clearfix">
                    <a href="<%=basePath%>page/WFJClient/pc/5l5C/market/customerreg.jsp">
                        <p class="p-1">成交管理</p>
                        <p class="p-2">成交订单</p>
                        <p class="p-2">已发单</p>
                        <p class="p-3">收款发单</p>
