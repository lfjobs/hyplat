...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>css/WFJClient/pc/5l5C/menuFunclayer.css">
    ...
    <script src="<%=basePath%>js/WFJClient/pc/5l5C/menuFunclayer.js" type="text/javascript" charset="utf-8"></script>
</head>
<body id="">
<div class="pc-box">
    <div class="div-box">
        <header>
            <ul class="clearfix">
                <li>
                    <a  target="_self" class="div_return_page">
                        <img src="<%=basePath%>images/WFJClient/pc/5l5c/img_03.png"/>
                    </a>
                </li>
                <li class="li-companyName">
                    <%=companyName%>
                </li>
                <li>
