...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<%=basePath%>css/base.css"/>
		   <link rel="stylesheet" type="text/css" href="<%=basePath%>css/WFJClient/pc/5l5C/finance/szproof.css">
		...
		<div class="pc-box">
			<div class="div-box">
				...
				<div class="container">
					<ul class="ul-con">
						<li class="clearfix">
							<p class="p-title">费用使用明细账</p>
							<p class="p-height">
							
							</p>
						</li>
						<li class="clearfix">
							<p class="p-title">现金申请使用明细/跟踪</p>
							<p class="p-height">
							
							</p>
						</li>
						<li class="clearfix">
							<p class="p-title">收支凭据管理</p>
							<p class="p-height">
								
							</p>
						</li>
						<li class="clearfix">
								<a href="<%=basePath%>page/WFJClient/pc/5l5C/finance/wfjdanju.jsp">
							<p class="p-title">微分金收支单据管理</p>
							<p class="p-height">
								订单管理  收款单管理 兑现收支管理 出库单管理 物流管理 收货管理 退货管理 退款管理 金币分配明细管理 兑现申请审核 提现记录
							</p>
							<div class="div-more">
						...
						<li class="clearfix">
							<p class="p-title">财务生产管理</p>
							<p class="p-height">
								
							</p>
						</li>
						<li class="clearfix">
							<a href="<%=basePath%>page/WFJClient/pc/5l5C/finance/baobiao.jsp">
							<p class="p-title">报表</p>
							<p class="p-height">
								销售报表
							</p>
							</a>
