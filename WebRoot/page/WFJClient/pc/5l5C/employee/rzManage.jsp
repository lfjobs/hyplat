...
<div class="container" id="all_order">
    <div class="pos-top">
        ...
        <div class="box-fh2">
            <iframe src="<%=basePath%>/page/WFJClient/pc/5l5C/employee/rzEmployees.jsp?companyID=${param.companyID}"
...
<script>
    $(function () {
        ...
        $("#Inspect").click(function () {
            $("#mainframe").attr("src", basePath + "/page/WFJClient/pc/5l5C/employee/rzEmployees.jsp?companyID=" + companyID);
        });

        $("#handle").click(function () {
            $("#mainframe").attr("src", basePath + "/page/WFJClient/pc/5l5C/employee/employeesMianShiNotice.jsp?companyID=" + companyID);
        });

        $("#emergency").click(function () {
            $("#mainframe").attr("src", basePath + "/page/WFJClient/pc/5l5C/employee/employeesMianShiEnd.jsp?companyID=" + companyID);
        });
/*
        $("#NFC").click(function () {
