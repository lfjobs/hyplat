...
<div class="container" id="all_order">
    <div class="pos-top">
        ...
        <div class="box-fh2">
            <iframe src="<%=basePath%>/page/WFJClient/pc/5l5C/employee/bdEmployees.jsp?companyID=${param.companyID}"
...
<script>
    $(function () {
        ...
        $("#Inspect").click(function () {
            $("#mainframe").attr("src", basePath + "/page/WFJClient/pc/5l5C/employee/bdEmployees.jsp?companyID=" + companyID);
        });

        $("#handle").click(function () {
            $("#mainframe").attr("src", basePath + "/page/WFJClient/pc/5l5C/employee/fenPeiEmployees.jsp?companyID=" + companyID);
        });
