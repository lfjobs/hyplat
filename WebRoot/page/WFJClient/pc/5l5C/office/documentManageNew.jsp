...
<link rel="stylesheet" type="text/css" href="<%=basePath%>css/WFJClient/pc/5l5C/office/documentManageNew.css">
...
//        });
        ...
        $(".wsfl").click(function () {
            window.location.href=basePath+"/page/WFJClient/pc/5l5C/office/cateProcedure.jsp";
        });
    });
</script>
</html>
