...
<script>
    ...
    function toBack() {
        if(menuId == "receive"){
            ...
            window.location.href = basePath + "ea/scBudget/ea_toPlanCostBudgetBillSentList.jspa?menuId="+menuId;
        }else{
    ...
    function toBarCodeInfo(goodsBillsID){
        window.location.href = basePath + "ea/scBudget/ea_toPlanCostBudgetItemDetail.jspa?search="+goodsBillsID+"&showFlag=${showFlag}&departmentID=${departmentID}&cashierBillsId=${cashierBillsId}";
    }
</script>
</html>
