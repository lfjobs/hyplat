...
<head>
    ...
    <script src="<%=basePath%>js/ea/plan/selectWldw.js" type="text/javascript" charset="utf-8"></script>
...
<script type="text/javascript">
    ...
    function nav(c,keyId,type) {
        if(c=="1"){
            document.location.replace("<%=basePath%>page/WFJClient/pc/5l5C/office/plan/selectCompany.jsp?type="+type+"&keyId="+keyId);
        } else if(c=="2"){
            document.location.replace("<%=basePath%>page/WFJClient/pc/5l5C/office/plan/selectWldw.jsp?type="+type+"&keyId="+keyId);

        } else if(c=="3"){
            document.location.replace("<%=basePath%>page/WFJClient/pc/5l5C/office/plan/selectWlgr.jsp?type="+type+"&keyId="+keyId);
        }
    }
</script>
</html>
