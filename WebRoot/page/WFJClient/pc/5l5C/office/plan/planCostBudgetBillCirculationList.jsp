...
<script src="<%=basePath %>js/ea/plan/javascript.js" type="application/javascript"></script>
<%--异步获取当前登录人所在菜单--%>
...
<script>
    ...
    function circularize(){
        ...
        if(id != "" && id != null){
            window.location.href = basePath + "/page/WFJClient/pc/5l5C/office/plan/selectCompany.jsp?type=cy&keyId="+id;//?docId="+docId+"&typee=p";
        }else{
            alert("请选择要传阅的数据");
        }
    }
    ...
    //跳转查询页面
    function toQuery(){
        var url = "ea/queryUtil/ea_toPlanCostBudgetQuery.jspa?jumpType=XMJH_LB";
