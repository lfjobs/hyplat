...
<head lang="en">
    ...
    <script type="text/javascript" charset="utf-8" src="<%=basePath%>js/ea/plan/costBudgetItemUpdate.js"></script>
...
<script>
    ...
    function toBack() {
        ...
        if (editFlag == "addPage") {
            url = "ea/scBudget/ea_toAddPlanCostBudgetItem.jspa";
        }else if (editFlag == "add") {
            url = "ea/scBudget/ea_toAddPlanCostBudgetBill.jspa";
        }else{
            url = "ea/scBudget/ea_toUpdatePlanCostBudgetBill.jspa?cashierBillsId="+cashierBillsId;
        }
