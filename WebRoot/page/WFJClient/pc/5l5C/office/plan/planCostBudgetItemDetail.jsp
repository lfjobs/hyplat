...
<head lang="en">
    ...
    <script type="text/javascript" charset="utf-8" src="<%=basePath%>js/ea/plan/costBudgetItemDetail.js"></script>
...
<form enctype="multipart/form-data" name="form1" id="launchForm" action="" method="post">
    ...
    <div class="div-tianjia">
        ...
        <div class="tianjia-content">
            ...
            <input type="hidden" id="ImagesPath" name="costAddBean.ImagesPath" value="${costAddBean.attrinamec}">
            <input type="hidden" id="VideoPath" name="costAddBean.VideoPath" value="${costAddBean.attrinamec}">
            ...
            <ul class="clearfix">
                ...
                <li class="li-01 mingcheng1 clearfix">
                    <p>物品名称</p>
                    <input type="text" id="goodsName" name="costAddBean.goodsName" value="${costAddBean.goodsName}"  placeholder="请输入" />
                </li>
                ...
                <li class="li-01 tiaoma1 clearfix">
                    <p>物品条码</p>
                    <input type="text" id="barCode" name="costAddBean.barCode" value="${costAddBean.barCode}" placeholder="请输入" />
                </li>
                ...
                <li class="li-02 hangye2 clearfix">
                    <p>行业分类</p>
                    <input type="text" value="${costAddBean.tradeName }" name="costAddBean.tradeName" id="tradeName"/>
                ...
                <li class="li-02 wupin2 clearfix">
                    <p>物品类别</p>
                    <input type="text" value="${costAddBean.typeID }" readonly name="costAddBean.typeID" id="typeID"/>
                </li>
                ...
                <li class="li-02 guige2 clearfix">
                    <p>规格</p>
                    <input type="text" value="${costAddBean.guigeTypeValue}" readonly name="costAddBean.guigeTypeValue"
                           id="guigeTypeValue">
                ...
                <li class="li-01 mingcheng1 clearfix">
                    <p>数量</p>
                    <input type="text" id="budgetNumber" onchange="computeAmount()" name="costAddBean.budgetNumber" value="${costAddBean.budgetNumber}"  placeholder="请输入" />
                </li>
                <li class="li-01 mingcheng1 clearfix">
                    <p>单价</p>
                    <input type="text" id="unitPrice" onchange="computeAmount()" name="costAddBean.unitPrice" value="${costAddBean.unitPrice}"  placeholder="请输入" />
                </li>
                <li class="li-01 mingcheng1 clearfix">
                    <p>初始余额</p>
                ...
                <li class="li-01 budgetAmount clearfix">
                    <p>收方金额</p>
                    <input type="text" id="borrowAmount" name="costAddBean.borrowAmount" value="${costAddBean.borrowAmount}"  readonly />
                </li>
                <li class="li-01 budgetAmount clearfix">
                    <p>付方金额</p>
                    <input type="text" id="loanAmount" name="costAddBean.loanAmount" value="${costAddBean.loanAmount}"  readonly />
                </li>
                <li class="li-01 mingcheng1 clearfix">
                    <p>余额</p>
                    <input type="text" id="balance" name="costAddBean.balance" value="${costAddBean.balance}"  readonly/>
                </li>
