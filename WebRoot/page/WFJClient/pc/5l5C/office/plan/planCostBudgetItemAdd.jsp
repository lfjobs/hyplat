...
<head lang="en">
    ...
    <link rel="stylesheet" href="<%=basePath %>css/WFJClient/pc/5l5C/office/listPop.css">
    <script type="text/javascript" charset="utf-8" src="<%=basePath%>js/ea/plan/listPop.js"></script>
    <link rel="stylesheet" type="text/css" href="<%=basePath%>css/ea/office_ea/contract/selectWldw.css"/>
    <script  src="<%=basePath%>js/My97DatePicker/WdatePicker.js"></script>
    <script type="text/javascript" charset="utf-8" src="<%=basePath%>js/ea/plan/costBudgetItemAdd.js"></script>
    <%--    <script src="<%=basePath%>js/ea/budgetBill/companyAccount.js" type="text/javascript" charset="utf-8"></script>--%>
    <%--    <script src="<%=basePath%>js/ea/budgetBill/personalAccount.js" type="text/javascript" charset="utf-8"></script>--%>
...
<form enctype="multipart/form-data" name="form1" id="launchForm" action="" method="post">
    ...
    <div class="div-tianjia">
        ...
        <div class="tianjia-content">
            ...
            <input type="hidden" name="cashierBillsId" value="${empty costAddBean.cashierBillsId ? cashierBillsId : costAddBean.cashierBillsId}"/><%--已添加预算单id（修改用）--%>
            <%--前一页面传过来的数据--%>
            ...
            <input type="hidden" id="unitOfMeasureCode" name="costAddBean.unitofmeasurecode" value="${costAddBean.unitofmeasurecode}"/>
            ...
            <ul class="clearfix">
                ...
                <li class="li-01 jijia1 clearfix jijia">
                    <p for=""><span>*</span>计价单位</p>
                    <img src="<%=basePath %>images/WFJClient/pc/5l5c/pic_01.png" alt="">
                </li>
                <li class="li-02 jijia2 clearfix jijia">
                    <p for=""><span>*</span>计价单位</p>
                    <input type="text" id="jijiadanwei" value="${costAddBean.unitofmeasurecode }" required readonly class="">
                </li>
                <li class="li-01 mingcheng1 clearfix">
                    <p for=""><span>*</span>物品名称</p>
                    <input type="text" id="goodsName" name="costAddBean.goodsName" required value="${costAddBean.goodsName}"  placeholder="请输入" />
                </li>
                ...
                <li class="li-01 tdjl1 clearfix">
                    <p>团队奖励</p>
                    <img src="<%=basePath %>images/WFJClient/pc/5l5c/pic_01.png" alt="">
                </li>
                <li class="li-02 tdjl2 clearfix">
                    <p>团队奖励</p>
                    <input type="text" readonly value="${costAddBean.teamReward }" name="costAddBean.teamReward"
                           id="teamReward">
                </li>
<%--                <li class="li-01 mingcheng1 clearfix">--%>
<%--                    <p for=""><span>*</span>升级</p>--%>
<%--                    <input type="text" id="upgrade" name="costAddBean.goodsName" required value="${costAddBean.teamReward}"  placeholder="请输入" />--%>
<%--                </li>--%>
<%--                <li class="li-01 mingcheng1 clearfix">--%>
<%--                    <p for=""><span>*</span>奖金(元)</p>--%>
<%--                    <input type="text" id="bonus" name="costAddBean.goodsName" required value="${costAddBean.teamReward}"  placeholder="请输入" />--%>
<%--                </li>--%>
                <li class="li-01 grjl1 clearfix">
                    <p>个人奖励</p>
                    <img src="<%=basePath %>images/WFJClient/pc/5l5c/pic_01.png" alt="">
                </li>
                <li class="li-02 grjl2 clearfix">
                    <p>个人奖励</p>
                    <input type="text" readonly value="${costAddBean.personalReward }" name="costAddBean.personalReward"
                           id="personalReward">
                </li>
                <li class="li-01 tdzk1 clearfix">
                    <p>团队折扣</p>
                    <img src="<%=basePath %>images/WFJClient/pc/5l5c/pic_01.png" alt="">
                </li>
                <li class="li-02 tdzk2 clearfix">
                    <p>团队折扣</p>
                    <input type="text" readonly value="${costAddBean.teamPunishment }" name="costAddBean.teamPunishment"
                           id="teamPunishment">
                </li>
                <li class="li-01 grzk1 clearfix">
                    <p>个人折扣</p>
                    <img src="<%=basePath %>images/WFJClient/pc/5l5c/pic_01.png" alt="">
                </li>
                <li class="li-02 grzk2 clearfix">
                    <p>个人折扣</p>
                    <input type="text" readonly value="${costAddBean.personalPunishment }" name="costAddBean.personalPunishment"
                           id="personalPunishment">
                </li>
                ...
                <%--                </li>--%>
                <li class="li-01 budgetNumber clearfix">
                ...
                <li class="li-01 unitPrice clearfix">
    ...
    <%--            <div class="div-con guigeType">--%>
    <%--                <ul>--%>
    <%--                    <li id="changdu" unit="m">长度</li>--%>
    <%--                    <li id="mianji" unit="㎡">面积</li>--%>
    <%--                    <li id="lifang" unit="m³">立方</li>--%>
    <%--                    <li id="zhongliang" unit="kg">重量</li>--%>
    <%--                    <li id="shijian" unit="s">时间</li>--%>
    <%--                    <li id="geshu" unit="个">个数</li>--%>
    <%--                    <li>正确错误</li>--%>
    <%--                    <li>计分</li>--%>
    <%--                    <li id="bili" unit="%">比例</li>--%>
    <%--                    <li id="jian" unit="件">件</li>--%>
    <%--                </ul>--%>
    <%--            </div>--%>
    <%--        </div>--%>
    <%--    </div>--%>
    ...
    <div class="div-accountType">
        <div class="div-box">
            ...
            <div class="div-con accountType">
                <ul>
                    <li atype="companyPlan">单位</li>
                    <li atype="personalPlan">个人</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="div-account div-account-company">
        ...
        <div class="company-content">
            <section class="sec-search">
                ...
                <div class="div-name">
                    <label for="">手机号</label>
                    <input type="text"  id="accountPhone" placeholder="请填写公司对公账户联系方式" value="${costAddBean.accountPhone }" name="costAddBean.accountPhone"/>
                </div>
                <div class="div-name">
                    <label for="">账号</label>
    ...
    <div class="div-account div-account-companyFrom">
        ...
        <div class="company-content">
            <section class="sec-search">
                ...
                <div class="div-name">
                    <label for="">手机号</label>
                    <input type="text"  id="accountPhoneFrom" placeholder="请填写公司对公账户联系方式" value="${costAddBean.accountPhoneFrom }" name="costAddBean.accountPhoneFrom"/>
                </div>
                <div class="div-name">
                    <label for="">账号</label>
    ...
    <!-- 奖惩管理 -->
<%--    <div class="div-listPop" id="teamRewardPop"><div class="div-box"><div class="div-top clearfix"><p>团队奖励</p><div class="div-close"><img src="<%=basePath %>images/BuildPlatform/close_ico_b.png" alt=""/></div></div><div class="div-con listPop"><ul class='ul-left'><li id='升级'><span class='popValue'>升级</span></li><li id='奖金'><span class='popValue'>奖金</span></li></ul></div></div></div>--%>
</form>
<div id="prompt" >
    <center>
        <div>
