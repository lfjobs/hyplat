...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>css/WFJClient/pc/5l5C/office/signInSetup.css">
    <script src="<%=basePath%>js/jquery-1.9.1.min.js" type="text/javascript" charset="utf-8"></script>
    <script src="<%=basePath%>js/WFJClient/pc/common.js" type="text/javascript" charset="utf-8"></script>
    <script src="<%=basePath %>/js/WFJClient/pc/5l5C/office/signInSetup.js"></script>
    <style type="text/css">
        .clearfix:after {
            content: "\00A0";
            display: block;
    ...
    <div class="div-box">
        ...
        <div class="signInSetup-top">
            <div class="txt back_color">
                <p class="txtP">
                    <span class="txtSpan" style="width: 12%;">类别</span>
                    <span class="txtSpan" style="width: 36%;">签到时间</span>
                    <span class="txtSpan" style="width: 35%;">签退时间</span>
                    <span class="txtSpan" style="width: 17%;">地址</span>
                </p>
            </div>
        </div>
