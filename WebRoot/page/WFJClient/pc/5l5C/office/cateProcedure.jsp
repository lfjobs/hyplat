    ...
    <div class="pos-top">
        <div class="box-fh">
            <ul class="ul-tab ul-tab-fh clearfix">
                <li>
                    <p  data-value="c1">全部文书</p>
                </li>
                <li>
                    <p class="active" data-value="c2">办公文书</p>
                </li>
                <li>
                    <p data-value="c3">行政文书</p>
                </li>
                <li>
                    <p data-value="c4">商务文书</p>
                </li>

            </ul>
        </div>

        <div class="box-fh2" id="c1" style="display: none;">
            <iframe src="<%=basePath%>ea/androiddoc/ea_getAllFiles.jspa"
                    name="admin1" scrolling="yes" frameBorder="0"  height="100%"></iframe>
        </div>
