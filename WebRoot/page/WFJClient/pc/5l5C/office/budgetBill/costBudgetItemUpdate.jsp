...
<script>
    ...
    function toBack() {
        ...
        if (editFlag == "addPage") {
            url = "ea/scBudget/ea_toAddCostBudgetItem.jspa";
        }else if (editFlag == "add") {
            url = "ea/scBudget/ea_toAddCostBudgetBill.jspa";
        }else{
            url = "ea/scBudget/ea_toUpdateCostBudgetBill.jspa?cashierBillsId="+cashierBillsId;
        }
