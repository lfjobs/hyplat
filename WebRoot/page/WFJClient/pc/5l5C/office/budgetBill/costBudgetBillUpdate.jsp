...
<div class="content">
    <s:form id="f2" action="ea_updateCostBudgetSheet.jspa" namespace="/ea/scBudget" method="POST">
                ...
                <section class="headNav"  id="billsTypeSection">
                    ...
                    <p>
                        <input type="text" id="billsType" name="cashierBills.billsType"
                               value="${empty cashierBills.billsType ? '收入' : cashierBills.billsType}" /><%--所选项目类型--%>
                    </p>
                </section>
...
<%--    <ul class="ul_con3 ul_con4 clearfix">--%>
...
<%--下拉控制js文件--%>
<script type="text/javascript" src="<%=basePath%>js/ea/budgetBill/costBudgetBillUpdate.js"></script>
<%--调用安卓js文件--%>
...
<script>
    ...
    function toBarCodeInfo(goodsBillsID) {
        window.location.href = basePath + "ea/scBudget/ea_toCostBudgetItemUpdate.jspa?keyNum=" + goodsBillsID + "&editFlag=edit&showFlag=${showFlag}&departmentID=${departmentID}&cashierBillsId=${cashierBillsId}&menuId="+menuId+"&billsType="+billsType+"&head="+head;
    }
    ...
    function toRemoveGoodsBills(goodsBillsId) {
        ...
        if(id){
            document.location.replace(basePath + "ea/scBudget/ea_removeGoodsBillOfUpdate.jspa?keyNum=" + id+"&editFlag=edit&cashierBillsId="+cashierBillsId+"&menuId="+menuId+"&billsType="+billsType+"&head="+head);
        }
