...
<style>
    ...
    /*    color:#333;*/
    /*    font-weight:bold;*/
    /*    background:url(../../images/ea/admin/conter_03.gif) repeat-x;*/
    /*    height:23px;*/
    /*}*/
    /*table td {*/
    /*    text-align: center;*/
...
<div class="bug-con  main_hide" id="pcDiv" style="display: none;">
            ...
            <tr id="${cashierBillsID}">
                ...
                <td>
                    ...
                    <s:else>
                        ...
                        <s:elseif test="status=='50'">传阅中</s:elseif>
                    </s:else>
                </td>
...
<script>
    //添加方法
    function toAdd() {
        var url = "ea/scBudget/ea_toAddCostBudgetBill.jspa";
        var parameter = "?showFlag="+showFlag+"&companyid="+companyid+"&menuId="+menuId+"&departmentName="+menuName+"&billsType="+billsType+"&head="+head;
