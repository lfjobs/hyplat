        ...
        <div class="clearfix">
            <section class="headNav" style="display: none;">
                <ul>
                    ...
                    <input type="text" id="billsType" name="cashierBills.billsType" value="${empty cashierBills.billsType ? '采购单' : cashierBills.billsType}"
                           style="display: none;"/>
                </ul>
            </section>
...
<script>
    function toBack() {
        if(menuId == "receive"){
            ...
            window.location.href = basePath + "ea/scBudget/ea_toProjectBillSentList.jspa?menuId="+menuId+"&billsType="+billsType;
        } else{
    ...
    function toBarCodeInfo(goodsBillsID){
        window.location.href = basePath + "ea/scBudget/ea_toProjectItemDetail.jspa?search="+goodsBillsID+
