...
<head lang="zh">
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>css/datecss/calender.css" />
    ...
    <script type="text/javascript" src="<%=basePath%>js/datejs/calender.js"></script>
    <script type="text/javascript" src="<%=basePath%>js/ea/budgetBill/costBudgetCalender.js"></script>
...
<script>
    ...
    function toAdd() {
        ...
        var parameter = "?showFlag="+showFlag+"&companyid="+companyid+"&menuId="+menuId+"&departmentName="+menuName;
    ...
    function delCostSheet(){
        ...
        if(id != "" && id != null){
            ...
            if (r == true) {
                var url = "ea/scBudget/ea_delCostBudgetSheet.jspa?cashierBillsId="+id+"&menuId="+menuId;
