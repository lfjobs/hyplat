...
<%--    <script type="text/javascript" charset="utf-8" src="<%=basePath %>js/font-size.js"></script>--%>
    ...
    <script type="text/javascript">
        ...
        //     if(editFlag == "edit"){
        //         window.location.href = basePath + "ea/scBudget/ea_toUpdateProjectBill.jspa?commitFlag='no'&cashierBillsId="+cashierBillsId+"&billsType="+billsType+"&typeId="+typeId+"&typeName="+typeName;
        //     }else{
        //         window.location.href = basePath + "ea/scBudget/ea_toAddProjectBill.jspa?commitFlag='no'&billsType="+billsType+"&typeId="+typeId+"&typeName="+typeName;
        //     }
        // }

        function toBack(){
            window.location.href = basePath + "ea/scBudget/ea_toAddProjectItem.jspa?billsType=" + billsType + "&editFlag=" + editFlag;
        }
    </script>
</head>
<body>
    ...
    <div class="div-tianjia">
        <div class="tianjia-header">
            <ul class="clearfix">
                ...
                <li>
                    ${(billsType=='收入' || billsType=='支出') ? billsType.concat('单'):billsType}明细项添加
                </li>
                <li id="isupdate" style="display: none;">
                    ${(billsType=='收入' || billsType=='支出') ? billsType.concat('单'):billsType}明细项修改
                </li>
            </ul>
        </div>
