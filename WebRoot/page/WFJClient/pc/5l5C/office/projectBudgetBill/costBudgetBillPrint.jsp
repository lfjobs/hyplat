			...
			<table width="1280" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					<td height="25" align="center" style="font-weight: bold">
						${(cashierBills.billsType=='收入' || cashierBills.billsType=='支出') ? cashierBills.billsType.concat('单'):cashierBills.billsType}
					</td>
				</tr>
			</table>
			<table width="1280" border="0" cellpadding="0" cellspacing="0"
...
<%--					</td>--%>
				...
				<c:if test="${!empty cashierBillsExt.reviewerName }">
					...
					<td width="30%" align="left">
						${cashierBillsExt.reviewerName}
					</td>
					<td align="left">
						<c:if test="${!empty cashierBillsExt.reviewTime }">
							审核时间：${cashierBillsExt.reviewTime}
						</c:if>
					</td>
				</c:if>
			</table>
