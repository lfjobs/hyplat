...
<header>
    <ul class="clearfix">
        ...
        <li id = "title">
            项目订单添加
<%--            ${(billsType=='收入' || billsType=='支出') ? billsType.concat('单'):billsType}添加--%>
        </li>
    </ul>
</header>
<div class="content">
    <s:form id="f2" action="ea_saveProjectSheet.jspa" namespace="/ea/scBudget" method="POST">
            ...
            <div class="clearfix">
                <section class="headNav" id = "billsTypeSection">
                    <ul>
                        ...
                        <li>
                            <a href="javascript:nav('采购单')"><img id="srdj"
                                                                  src="<%=basePath%>images/ea/office/contract/selectp/dxseleted.png">采购单</a>
                        </li>
                        <li>
                            <a href="javascript:nav('销售单')"><img id="zcfb"
                                                                  src="<%=basePath%>images/ea/office/contract/selectp/dxwselet.png">销售单</a>
                        </li>
                    </ul>
                    <input type="text" id="billsType" name="cashierBills.billsType" value="${empty costBaseBean.billsType ? '采购单' : costBaseBean.billsType}"
                               style="display: none;" />
                </section>
...
<%--下拉控制js文件--%>
<script type="text/javascript" src="<%=basePath%>js/ea/projectBudgetBill/costBudgetBillAdd.js"></script>
<%--调用安卓js文件--%>
...
<script>
    ...
    function toBarCodeInfo(goodsBillsID) {
        window.location.href = basePath + "ea/scBudget/ea_toProjectItemUpdate.jspa?keyNum=" + goodsBillsID + "&editFlag=add&showFlag=${showFlag}&departmentID=${departmentID}&cashierBillsId=${cashierBillsId}&menuId="+menuId+"&billsType="+billsType;
    }
    ...
    function toRemoveGoodsBills() {
        ...
        if(id){
            var url = "ea_removeProjectGoodsBillOfAdd.jspa?keyNum=" + id+"&editFlag=add&menuId="+menuId+"&billsType="+billsType;
    ...
    function toBack() {
        ...
        window.location.href = basePath + "ea/scBudget/ea_toProjectBillList.jspa?menuId="+menuId+"&menuName="+menuName+"&billsType="+billsType;
    }
