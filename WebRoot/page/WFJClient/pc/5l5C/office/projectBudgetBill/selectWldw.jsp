...
<head>
    ...
    <script src="<%=basePath%>js/ea/projectBudgetBill/selectWldw.js" type="text/javascript" charset="utf-8"></script>
...
<div class="content">
    <section class="headNav">
        <ul>
            ...
            <li><p><a href="javascript:nav('2','${param.keyId}','${param.type}')"><img src="<%=basePath%>images/ea/office/contract/selectp/dxseleted.png">往来公司</a></p></li>
...
<script type="text/javascript">
    ...
    function nav(c,keyId,type) {
        if(c=="1"){
            document.location.replace("<%=basePath%>page/WFJClient/pc/5l5C/office/projectBudgetBill/selectCompany.jsp?type="+type+"&keyId="+keyId);
        } else if(c=="2"){
            document.location.replace("<%=basePath%>page/WFJClient/pc/5l5C/office/projectBudgetBill/selectWldw.jsp?type="+type+"&keyId="+keyId);

        } else if(c=="3"){
            document.location.replace("<%=basePath%>page/WFJClient/pc/5l5C/office/projectBudgetBill/selectWlgr.jsp?type="+type+"&keyId="+keyId);
        }
    }
</script>
</html>
