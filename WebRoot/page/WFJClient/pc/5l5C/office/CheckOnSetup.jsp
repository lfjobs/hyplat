...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>css/WFJClient/pc/5l5C/office/checkOnSetup.css">
    <script src="<%=basePath%>js/jquery-1.9.1.min.js" type="text/javascript" charset="utf-8"></script>
    <script src="<%=basePath%>js/WFJClient/pc/common.js" type="text/javascript" charset="utf-8"></script>
    <script src="<%=basePath %>/js/WFJClient/pc/5l5C/office/checkOnSetup.js"></script>
    <style type="text/css">
        .clearfix:after {
            content: "\00A0";
            display: block;
    ...
    <div class="div-box">
        ...
        <div class="checkOnSetup-top">
            <div class="txt back_color">
                <p class="txtP">
                    <span class="txtSpan" style="width: 29%;">考勤类别</span>
                    <span class="txtSpan" style="width: 28%;">工资级别</span>
                    <span class="txtSpan" style="width: 20%;">奖折类别</span>
<%--                    <span class="txtSpan" style="width: 20%;">奖励金额</span>--%>
                    <span class="txtSpan" style="width: 13%;">倍数</span>
                </p>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    //判断页面是否有底部导航
    if ($("*").is(".div-bottom")) {
        $(".checkOnSetup").addClass("pc-bottom");
    }
</script>
