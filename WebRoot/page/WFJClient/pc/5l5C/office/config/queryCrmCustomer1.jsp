                ...
                <div class="dataPo">
                    <s:form id="queryCrmCustomerPO" action="ea_updateData.jspa" namespace="/ea/crmCustomerPO"
                        ...
                        <div class="div-name">
                            ...
                            <input type="text"  id="userName" name="crmCustomerPO.userName"
                        ...
                        <div class="div-name">
                            <label>备注</label>
                            <input type="text"  id="extendInfo" name="crmCustomerPO.extendInfo"
                                   value="${crmCustomerPO.extendInfo}"/>
                        </div>
                        <div class="div-name">
                            <label>社会身份</label>
                            <input type="text" id="socialStatus"
                        ...
                        <div class="div-name">
                            <label>导入人</label>
                            <input type="text"  id="importerId"
                                   name="crmCustomerPO.importerId"
                                   value="${crmCustomerPO.importerId}"/>
                        </div>
                        <div class="div-name">
                            <label>证件类型</label>
                            <input type="text"  id="cardType" name="crmCustomerPO.cardType"
                        ...
                        <div class="div-name">
                            <label>添加时间</label>
                            <input type="text"  id="createdAt" name="crmCustomerPO.createdAt"
                                   value="${crmCustomerPO.createdAt}"/>
                        </div>
                        <div class="div-name">
                            <label>修改时间</label>
                            <input type="text" id="updatedAt" name="crmCustomerPO.createdAt"
