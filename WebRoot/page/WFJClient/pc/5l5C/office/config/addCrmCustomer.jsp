...
<div class="content">
    <section class="sec-list">
        <div class="div-sec-data">
            <div class="container">
                <div class="dataPo">
                    <s:form id="addCrmCustomerPO" action="sajax_ea_addData.jspa" namespace="/ea/crmCustomerPO"
                            method="POST">
                        ...
                        <div class="inputBut">
                            ...
                            <div class="updateData" onclick="addData1()">保存</div>
                            <div class="updateData"><input type="reset" value="数据重置"></div>
                        </div>
                    </s:form>
                </div>
...
<script>
    function addData1() {
        var form = document.getElementById('addCrmCustomerPO');
