...
<s:form id="specsF"  action="ea_addSpecsConfig.jspa" namespace="/ea/specs" method="POST">
    <aside class="aside_no" checkCasId="${entity.specs},${entity.specsCode}">
    <div>
<%--            <span>规格单位：</span>--%>
<%--            <br>--%>
<%--            <input type="tex" name="specsConfigAddDTO.specsType">--%>
<%--            <br>--%>
    <div class="div-name">
        <label>规格单位</label>
        <input type="text"  placeholder="请填写规格单位"  name="specsConfigAddDTO.specsType" id="specsType" value="${specsConfigAddDTO.specsType}"/>
    </div>
    <div class="div-name">
    <span>规格类型：</span>
<%--        <label for="">规格类型</label>--%>
...
<%--            <span>规格单位：</span>--%>
    <div class="div-name">
        <label >规格单位</label>
            <div id="div-a">
                <span>A：</span>
                <input type="text" placeholder="请填写规格单位" class="sel-a" name="specsConfigAddDTO.specsA" id="specsA" value="${specsConfigAddDTO.specsA}">
            </div>
            <div id="div-b">
                <span>B：</span>
