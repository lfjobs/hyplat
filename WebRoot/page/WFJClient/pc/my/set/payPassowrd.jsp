...
<head lang="en">
    ...
    <title>&lrm;</title>
    <link type="text/css" rel="stylesheet" href="<%=basePath%>css/WFJClient/pc/my/set/payPassword.css">
...
<div class="header">
    <ul>
        <li style="width: 10%;"><a href="javascript:history.go(-1)"><img src="<%=basePath%>/images/ea/office/contract/selectp/return.png"></a></li>
        <li style="width: 80%;text-align: center;">修改交易密码</li>
        <li style="width: 10%"></li>
    </ul>
</div>
<div class="content">
    <form id="myform" method="post" name = "myform" autocomplete="off">
        <input type="password" name="yspsw" placeholder="请输入原始交易密码" autocomplete="off" id="yspsw">
        <input type="password" name="newpsw" placeholder="请输入新的交易密码" autocomplete="off" id="password">
        <input type="password"  placeholder="再次输入新的交易密码" autocomplete="off"  id="password1">
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $(".wjmm").find("span").click(function(){
            ...
            document.location.href = basePath+"page/WFJClient/pc/my/set/forgetPassword.jsp?pswtype=交易"
