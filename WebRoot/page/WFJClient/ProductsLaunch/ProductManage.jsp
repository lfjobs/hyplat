...
<head lang="en">
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>css/WFJClient/baseW.css"/>
    <link rel="stylesheet" type="text/css" href="<%=basePath%>css/WFJClient/ProductManage.css"/>
    ...
    <script type="text/javascript" charset="utf-8"
            src="<%=basePath%>js/ea/marketing/wfjeshop/ProductManage.js"></script>
    <title>新版产品管理</title>
