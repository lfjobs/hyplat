...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>css/ea/office_ea/contract/selectStaffs.css?version=20230517"/>
    <%--<script src="<%=basePath%>js/font-size.js" type="text/javascript" charset="utf-8"></script>--%>
    <script src="<%=basePath%>js/jquery-1.9.1.min.js" type="text/javascript" charset="utf-8"></script>
    <script src="<%=basePath%>js/ea/marketing/wfjeshop/selectStaffs.js" type="text/javascript" charset="utf-8"></script>
...
<header>
    <ul class="clearfix">
        <li>
            <a onclick="javascript: back()" target="_self" >
