...
<body>
        ...
        <div class="wfj01_003_content">
        	<div class="wfj01_003_hidden">
            	<div class="wfj01_003_con">
            		...
            		<c:forEach items="${companyForumsList }" var="entity">
                	<div class="wfj01_003_list">
                    	<table class="wfj01_003_click01">
                        	<tr>                       		
                            	<td rowspan="2" class="wfj01_003_uploadimg"><img onclick="edit('${entity.activitiesID}')" src="<%=basePath%>${entity.picture}" /></td>
                            	...
                            	<td rowspan="2" class="wfj01_003_delete"><img onclick="toDel('${entity.activitiesID}')" src="<%=basePath%>/images/WFJClient/PersonalJoining/wfj_delete_04.png" /></td>
    ...
    var ccompanyId='${ccompanyId}';
    	$(document).ready(function(e) {
			...
			//
			$("#add").click(function(){
				window.open(basePath+"ea/industry/ea_toEditForum.jspa?ccompanyId="+ccompanyId+"&activitiesId=&user=${user}","_self");
			});	
			
			//加载公司风格
			var url=basePath+"ea/industry/sajax_ea_CompanyStyle.jspa?ccompanyId=${ccompanyId}&user=${user}";
			$.ajax({
				url : url,
				type : "get",
				async : false,
    	...
    	//编辑
		function edit(i){				
			window.location.href=basePath+"ea/industry/ea_toEditForum.jspa?activitiesId="+i+"&ccompanyId="+ccompanyId+"&user=${user}";
		}
		//删除
		function toDel(i){
			var url=basePath+"ea/industry/sajax_ea_delCompanyForum.jspa?activitiesId="+i+"&user=${user}";
			$.ajax({
				url : encodeURI(url),
				type : "post",
				async : true,
